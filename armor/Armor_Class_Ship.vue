        ...
        <div class="col-md-12">
          ...
          <div class="n1">下列的單位都是海軍單位
            <ul>
              ...
              <li>
                <img class="gg" src="~assets/FireGalleyIcon.jpg" alt=""><a href="Fire_Galley.php">火蒙衝</a>(6)→
              ...
              <li>
                <img class="gg" src="~assets/DemoRaftIcon.jpg" alt=""><a href="Demolition_Raft .php">自爆筏</a>(1)→
              ...
              <li>
                <img src="~assets/CannonGalleonIcon.jpg" alt=""><a href="Cannon_Galleon .php">火炮戰船</a>→
              ...
              <li>
                <img src="~assets/TurtleShipIcon.jpg" alt=""><a href="Turtle_Ship.php">龜甲船</a>(8)→
                <img src="~assets/TurtleShipIcon.jpg"
