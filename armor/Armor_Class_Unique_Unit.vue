            ...
            <div class="n1">
              <div class="col-md-12">
                <div class="col-md-6">
                  ...
                  <ul>
                    <li>
                      ...
                      <img class="gg" src="~assets/WBRSK.jpg"
                  ...
                  <ul>
                    <li>
                      ...
                      <img class="gg" src="~assets/TAXEM.jpg"
                  ...
                  <ul>
                    <li>
                      ...
                      <img class="gg" src="~assets/HuskarlIcon.jpg"
                  ...
                  <ul>
                    <li>
                      <img class="gg" src="~assets/MangudaiIcon.jpg" width="22" alt=""><a href="Mangudai.php">蒙古突騎</a>→
                  ...
                  <ul>
                    <li>
                      ...
                      <img class="gg" src="~assets/WarWagonIcon.jpg"
                      alt=""><a href="War_Wagon.php">精銳馬戰車</a>(<a href="Koreans.php">韓國</a>限定)</li>
                  </ul>
                  <ul>
                    <li>
                      <img src="~assets/TurtleShipIcon.jpg" alt=""><a href="Turtle_Ship.php">龜甲船</a>→
                      <img src="~assets/TurtleShipIcon.jpg" alt=""><a href="Turtle_Ship.php">精銳龜甲船</a>(<a href="Koreans.php">韓國</a>限定)</li>
                  </ul>
                  <ul>
                    <li>
                ...
                <div class="col-md-6">
                  ...
                  <ul>
                    <li>
                      <img class="gg" src="~assets/MissionaryIcon.jpg" alt=""><a href="Missionary.php">傳教士</a>(<a href="Spanish.php">西班牙</a>限定)</li>
                  </ul>
                  <ul>
                    <li>
                  ...
                  <ul>
                    <li>
                      ...
                      <img class="gg" src="~assets/New_Genoese_Crossbowman.png"
                  ...
                  <ul>
                    <li>
                      ...
                      <img class="gg" src="~assets/Magyar_Huszar_icon.jpg"
                  ...
                  <ul>
                    <li>
                      <img src="~assets/OrganGunIcon.jpg" alt=""><a href="OrganGunIcon.php">風琴炮</a>→
                      <img src="~assets/OrganGunIcon.jpg" alt=""><a href="OrganGunIcon.php">精銳風琴炮</a>(<a href="Portugese.php">葡萄牙</a>限定)</li>
                  </ul>
                  <ul>
                    <li>
                      <img src="~assets/CaravelIcon2.jpg" alt=""><a href="Caravel.php">卡拉維爾戰船</a>→
                      <img src="~assets/CaravelIcon2.jpg" alt=""><a href="Caravel.php">精銳卡拉維爾戰船</a>(<a href="Portuguese.php">葡萄牙</a>限定)</li>
                  </ul>
                  <ul>
                    <li>
