        ...
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style=" background-color:#b74711;">
              <div class="unititle" style="color: #fff;">世紀帝國的所有防禦類別</div>
            </td>
          </tr>
          <tr>
            <td style="text-align: center;padding: 20px "> <a href="Armor_Class_Infantry.php">步兵</a>· <a href="Armor_Class_Spearman.php">槍兵</a>·
              <a
              href="Armor_Class_Eagle_Warrior.php">鷹勇士</a>· <a href="Armor_Class_Archer.php">射手</a>· <a href="Armor_Class_Cavalry_Archer.php">馬弓騎兵</a>·
                <a
