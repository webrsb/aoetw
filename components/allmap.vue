          ...
          <tr>
            <td style="text-align: center;padding: 20px ">
              ...
              <nuxt-link to="/maps/Salt_Marsh">鹽沼地</nuxt-link>。<nuxt-link to="/maps/Scandinavia"
                >斯堪地維亞</nuxt-link>。<nuxt-link to="/maps/Yucatan">猶加敦</nuxt-link>。
              ...
              <nuxt-link to="/maps/Bog_Islands">沼澤</nuxt-link>。<nuxt-link to="/maps/Mangrove_Jungle"
                >紅樹林</nuxt-link>。<nuxt-link to="/maps/Pacific_Islands">太平洋群島</nuxt-link>。
              <nuxt-link to="/maps/Sandbank">沙洲</nuxt-link>。<nuxt-link to="/maps/Water_Nomad"
                >水上游牧</nuxt-link>。
            </td>
          </tr>
        </table>
