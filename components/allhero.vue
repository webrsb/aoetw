        ...
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td style="text-align: center;padding: 20px ">
              ...
              <nuxt-link to="/units/hero/Archbishop">大主教</nuxt-link>·
              <nuxt-link to="/units/hero/Archers_of_the_Eyes">神弓手</nuxt-link>·
              ...
              <nuxt-link to="/units/hero/Constable_Richemont">康斯塔伯理察蒙</nuxt-link>·
              <nuxt-link to="/units/hero/Duke_D_Alencon">阿朗松公爵</nuxt-link>·
              <nuxt-link to="/units/hero/El_Cid">熙德</nuxt-link>·
              <nuxt-link to="/units/hero/Emperor_in_a_Barrel">裝在桶裡的皇帝</nuxt-link>·
              <nuxt-link to="/units/hero/Erik_the_Red">紅衣艾立克</nuxt-link>·
              <nuxt-link to="/units/hero/Frankish_Paladin">法蘭克聖騎士</nuxt-link>·
              <nuxt-link to="/units/hero/Friar_Tuck">塔克修士</nuxt-link>·
              ...
              <nuxt-link to="/units/hero/Joan_of_Arc_Champion">聖女貞德</nuxt-link>·
              <nuxt-link to="/units/hero/Joan_the_Maid">農家女貞德</nuxt-link>·
              <nuxt-link to="/units/hero/King_Arthur">亞瑟王</nuxt-link>·
              <nuxt-link to="/units/hero/Kitabatake">北畠將軍</nuxt-link>·
              <nuxt-link to="/units/hero/Kushluk">屈出律</nuxt-link>·
              <nuxt-link to="/units/hero/La_Hire">拉海爾</nuxt-link>·
              <nuxt-link to="/units/hero/Lancelot">藍斯洛特</nuxt-link>·
              <nuxt-link to="/units/hero/Lord_de_Graville">格拉維爾領主</nuxt-link>·
              <nuxt-link to="/units/hero/Master_of_the_Templar">聖殿騎士團首領</nuxt-link>·
              <nuxt-link to="/units/hero/Minamoto">源氏</nuxt-link>·
              <nuxt-link to="/units/hero/Mordred">莫德雷德</nuxt-link>·
              <nuxt-link to="/units/hero/Ornlu_the_Wolf">灰狼歐魯</nuxt-link>·
              <nuxt-link to="/units/hero/Reynald_de_Chatillon">沙底隆的雷諾</nuxt-link>·
              <nuxt-link to="/units/hero/Richard_the_Lionheart">獅心王查理</nuxt-link>·
              ...
              <nuxt-link to="/units/hero/Shah">沙赫</nuxt-link>·
              <nuxt-link to="/units/hero/Sheriff_of_Nottingham">諾丁漢治安官</nuxt-link>·
              <nuxt-link to="/units/hero/Siegfried">齊格非</nuxt-link>·
              <nuxt-link to="/units/hero/Sieur_Bertrand">貝查德爵士</nuxt-link>·
              <nuxt-link to="/units/hero/Sieur_de_Metz">梅茲爵士</nuxt-link>·
              <nuxt-link to="/units/hero/Sir_John_Fastolf">約翰霍士道夫爵士</nuxt-link>·
              ...
              <nuxt-link to="/units/hero/Theodoric_the_Goth">哥德人狄奧多利克</nuxt-link>·
              <nuxt-link to="/units/hero/William_Wallace">威廉華勒斯</nuxt-link>
            </td>
          </tr>
          <tr>
            <td class="unit" colspan="2" style="background-color:#d2660e;">
          ...
          <tr>
            <td style="text-align: center;padding: 20px ">
              ...
              <nuxt-link to="/units/hero/Imam">伊滿</nuxt-link>·
              ...
              <nuxt-link to="/units/hero/Scythian_Scout">斯基泰斥侯</nuxt-link>·
              <nuxt-link to="/units/hero/Scythian_Wild_Woman">斯基泰的野女人</nuxt-link>·
              <nuxt-link to="/units/hero/William_the_Conqueror">征服者威廉</nuxt-link>
            </td>
          </tr>
          <tr>
            <td class="unit" colspan="2" style="background-color:#d2660e;">
          ...
          <tr>
            <td style="text-align: center;padding: 20px ">
              <nuxt-link to="/units/hero/Chand_Bhai">金德·伯勒達伊</nuxt-link>·
              <nuxt-link to="/units/hero/Cuauhtemoc">庫奧赫特莫克</nuxt-link>·
              <nuxt-link to="/units/hero/Francesco_Sforza">法蘭切斯科·斯福爾札</nuxt-link>·
              <nuxt-link to="/batt/A_New_Duk_of_Milan">米蘭新公爵</nuxt-link>·
              <nuxt-link to="/units/hero/Francisco_de_Orellana">法蘭切斯科·德·奧雷亞納</nuxt-link>·
              <nuxt-link to="/units/hero/Fredrick_Barbarossa">腓特烈一世</nuxt-link>·
              <nuxt-link to="/units/hero/Gonzalo_Pizarro">岡薩洛·皮薩羅</nuxt-link>·
              ...
              <nuxt-link to="/units/hero/Sanyogita">姍優姬妲</nuxt-link>·
              <nuxt-link to="/units/hero/Savaran">貴族首領</nuxt-link>·
              <nuxt-link to="/units/hero/Vlad_Dracula">佛列德·德古拉</nuxt-link>
            </td>
          </tr>
          <tr>
            <td class="unit" colspan="2" style="background-color:#d2660e;">
          ...
          <tr>
            <td style="text-align: center;padding: 20px ">
              <nuxt-link to="/units/hero/Abraha_Elephant">阿伯哈拉戰象</nuxt-link>·
              <nuxt-link to="/units/hero/Babur">巴卑爾</nuxt-link>·
              <nuxt-link to="/units/hero/Dagnajan">達納罕</nuxt-link>·
              <nuxt-link to="/units/hero/Envoy">使者</nuxt-link>·
              <nuxt-link to="/units/hero/Gidajan">極大汗</nuxt-link>·
              <nuxt-link to="/units/hero/Guglielmo_Embriaco">吉列爾莫·安布裡科</nuxt-link>·
              <nuxt-link to="/units/hero/Henry_II">亨利二世</nuxt-link>·
              <nuxt-link to="/units/hero/Huayan_Capac">華伊納·卡派克</nuxt-link>·
              <nuxt-link to="/units/hero/Itzcoatl">伊茲柯阿特爾</nuxt-link>·
              <nuxt-link to="/units/hero/Little_John">小約翰</nuxt-link>·
              <nuxt-link to="/units/hero/Miklos_Toldi">米克羅斯·陶笛</nuxt-link>·
              <nuxt-link to="/units/hero/Musa_ibn_Nusayr">穆薩·伊本·奴薩爾</nuxt-link>·
              ...
              <nuxt-link to="/units/hero/Richard_de_Clare">克雷爾的理查伯爵</nuxt-link>·
              <nuxt-link to="/units/hero/Su_Dingfang">蘇定方</nuxt-link>·
              <nuxt-link to="/units/hero/Sumanguru">蘇曼古魯</nuxt-link>·
              <nuxt-link to="/units/hero/Sundjata">松迪亞塔</nuxt-link>·
              <nuxt-link to="/units/hero/Tariq_ibn_Ziyad">塔里克·伊本·齊亞德</nuxt-link>·
              <nuxt-link to="/units/hero/Tristan">崔斯坦</nuxt-link>·
              <nuxt-link to="/units/hero/Yekuno_Amlak">亞庫諾·阿姆拉克</nuxt-link>·
          ...
          <tr>
            <td style="text-align: center;padding: 20px ">
              ...
              <nuxt-link to="/units/hero/Le_Trien">李篆</nuxt-link>·
              <nuxt-link to="/units/hero/Luu_Nhan_Chu">劉仁澍</nuxt-link>·
              <nuxt-link to="/units/hero/Raden_Wijaya">羅登·韋查耶</nuxt-link>·
              <nuxt-link to="/units/hero/Sunda_Royal_Fighter">巽他皇家侍衛</nuxt-link>·
              <nuxt-link to="/units/hero/Suryavarman_I">蘇利耶跋摩一世</nuxt-link>·
              <nuxt-link to="/units/hero/Tabinshwehti">德彬瑞蒂</nuxt-link>·
              <nuxt-link to="/units/hero/Udayadityavarman_I">優陀耶迭多跋摩一世</nuxt-link>·
