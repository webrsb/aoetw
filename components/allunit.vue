        ...
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style="background-color:#274a7d;">
              <div class="unititle" style="color: #fff;">
                <nuxt-link to="/units">世紀帝國II的單位</nuxt-link>
              </div>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit3">
              ...
              <nuxt-link to="/units/Heavy_Demolition_Ship">重型神風船</nuxt-link>
              <br />
              <nuxt-link to="/units/Cannon_Galleon">火炮戰船</nuxt-link>·
              <nuxt-link to="/units/Elite_Cannon_Galleon">精銳火炮戰船</nuxt-link>
              <br />
