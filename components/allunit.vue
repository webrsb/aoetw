        ...
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style="background-color:#274a7d;">
              <div class="unititle" style="color: #fff;"><nuxt-link to="/units">世紀帝國的單位</nuxt-link></div>
            </td>
          </tr>
          <tr>
            <td class="unit3" colspan="2" style="text-align: center;">
              <nuxt-link to="/units/Monk">僧侶</nuxt-link>。 <nuxt-link to="/units/Villager">村民</nuxt-link>。
          ...
          <tr>
            ...
            <td class="unit3">
              ...
              <nuxt-link to="/units/Champion">劍兵勇士</nuxt-link>。 <br />
              <nuxt-link to="/units/Eagle_Scout">鷹斥侯</nuxt-link>。
              <nuxt-link to="/units/Eagle_Warrior">鷹勇士</nuxt-link>。
              <nuxt-link to="/Elite_/units/Eagle_Warrior">精銳鷹勇士</nuxt-link>。 <br />
          ...
          <tr>
            ...
            <td class="unit3">
              ...
              <nuxt-link to="/units/Imperial_Skirmisher">帝王戰矛兵</nuxt-link>。 <br />
              <nuxt-link to="/Cavalry_/units/Archer">馬弓騎兵</nuxt-link>。
              <nuxt-link to="/Heavy_Cavalry_/units/Archer">重裝馬弓騎兵</nuxt-link>。 <br />
          ...
          <tr>
            ...
            <td class="unit3">
              ...
              <nuxt-link to="/Hus/tree/sar">匈牙利輕騎兵</nuxt-link>。 <br />
              <nuxt-link to="/units/Knight">騎士</nuxt-link>。 <nuxt-link to="/units/Cavalier">騎兵</nuxt-link>。
              <nuxt-link to="/units/Paladin">遊俠</nuxt-link>。 <br />
              <nuxt-link to="/units/Camel">駱駝騎兵</nuxt-link>。
              <nuxt-link to="/Heavy_/units/Camel">重裝駱駝騎兵</nuxt-link>。
              <nuxt-link to="/Imperial_/units/Camel">帝王駱駝騎兵</nuxt-link>。 <br />
              <nuxt-link to="/Battle_/units/animal/Elephant">矛象伕</nuxt-link>。
          ...
          <tr>
            ...
            <td class="unit3">
              ...
              <nuxt-link to="/units/Siege_Ram">重型衝撞車</nuxt-link>。 <br />
              <nuxt-link to="/units/Mangonel">輕型投石車</nuxt-link>。
              <nuxt-link to="/units/Onager">中型投石車</nuxt-link>。
              <nuxt-link to="/Siege_/units/Onager">重型投石車</nuxt-link>。 <br />
              <nuxt-link to="/units/Scorpion">弩砲</nuxt-link>。
              <nuxt-link to="/units/Heavy_Scorpion">重型弩砲</nuxt-link>。 <br />
          ...
          <tr>
            <td class="unit3" style="width: 5%;">
              <nuxt-link to="/units/Naval_Vessels">船艦單位</nuxt-link>
            </td>
            <td class="unit3">
              <nuxt-link to="/units/Galley">戰船</nuxt-link>。
              <nuxt-link to="/War_/units/Galley">弩砲戰船</nuxt-link>。
              ...
              <nuxt-link to="/units/Fast_Fire_Ship">快速火戰船</nuxt-link>。 <br />
              <nuxt-link to="/units/Demolition_Raft">自爆筏</nuxt-link>。
              <nuxt-link to="/units/Demolition_Ship">神風船</nuxt-link>。
              <nuxt-link to="/Heavy_/units/Demolition_Ship">重型神風船</nuxt-link>。 <br />
              <nuxt-link to="/units/Cannon_Galleon">火炮戰船</nuxt-link>。
              <nuxt-link to="/Elite_/units/Cannon_Galleon">精銳火炮戰船</nuxt-link>。 <br />
            ...
            <td class="unit3">
              <div class="col-md-12">
                <div class="col-md-4">
                  ...
                  <nuxt-link to="/units/Throwing_Axeman">擲斧兵</nuxt-link> <br />
                  <nuxt-link to="/units/Huskarl">哥德衛隊</nuxt-link> <br />
                  <nuxt-link to="/units/Samurai">日本武士</nuxt-link> <br />
                  <nuxt-link to="/units/Mangudai">蒙古突騎</nuxt-link> <br />
                  <nuxt-link to="/War_/units/animal/Elephant">波斯戰象</nuxt-link> <br />
                  <nuxt-link to="/units/Mameluke">奴隸兵</nuxt-link> <br />
                  <nuxt-link to="/Teutonic_/units/Knight">條頓武士</nuxt-link> <br />
                  <nuxt-link to="/units/Janissary">土耳其火槍兵</nuxt-link> <br />
                ...
                <div class="col-md-4">
                  ...
                  <nuxt-link to="/Plumed_/units/Archer">羽毛箭射手</nuxt-link> <br />
                  ...
                  <nuxt-link to="/Elephant_/units/Archer">象弓騎兵</nuxt-link> <br />
                  <nuxt-link to="/Imperial_/units/Camel">帝王駱駝騎兵</nuxt-link> <br />
                  <nuxt-link to="/Genoese_/units/Crossbowman">熱那亞弩手</nuxt-link> <br />
                  <nuxt-link to="/units/Condottiero">傭兵</nuxt-link>
                </div>
                <div class="col-md-4">
                  <nuxt-link to="/units/Magyar_Huszar">馬札爾驃騎兵</nuxt-link> <br />
                  <nuxt-link to="/units/Boyar">貴族鐵騎</nuxt-link> <br />
                  <nuxt-link to="/Camel_/units/Archer">駱駝弓騎兵</nuxt-link> <br />
                  ...
                  <nuxt-link to="/Ballista_/units/animal/Elephant">弩砲象</nuxt-link> <br />
                  <nuxt-link to="/units/Karambit_Warrior">爪刀勇士</nuxt-link> <br />
                  <nuxt-link to="/Rattan_/units/Archer">藤甲弓兵</nuxt-link> <br />
