<template>
    ...
    <div class="container">
      ...
      <table class="table not" style="margin-top:50px;">
        <tr>
          <td class="trm" style="border-top: none;" colspan="6"> <a href="Stable.php"><img class="ng" src="~assets/Stableicon.png" alt=""></a> 
            <div
    ...
    <table class="table" style="margin-top:50px;">
      <tr>
        <td class="trm" style="border-top: none;" colspan="5"> <a href="Siege_Workshop.php"><img class="ng" src="~assets/Siegeworkshopicon.png" alt=""></a> 
          <div
      ...
      <tr>
        ...
        <td class="t23 trm">
          ...
          </div><i class="fas fa-arrow-down">          </td>          <td class="t23 trm"><img class="gg" src="~assets/MangonelIcon.jpg" width="30" alt=""><div><a href="Mangonel.php">輕型投石車</a></div><i class="fas fa-arrow-down"></i>
    ...
    <table class="table" style="margin-top:50px;">
      <tr>
        <td class="trm" style="border-top: none;" colspan="8"> <a href="Castle.php"><img class="ng" src="~assets/Castleicon.png" alt=""></a> 
          <div
      ...
      <tr>
        ...
        <td class="t13 trm">
          ...
          </div><i class="fas fa-arrow-down">          </td>          <td class="t13 trm">            <img class="gg" src="~assets/PetardIcon.jpg" width="30" alt=""><div><a href="Petard.php">爆炸桶</a></div>          </td>          <td class="t13 trm"><img class="gg" src="~assets/CastleAgeUnique.png" width="30" alt=""><div><a href="Atlatl.php">擲矛器</a></div></td>          <td class="t13 trm"></td>          <td class="t13 trm"></td>          <td class="t13 trm"></td>          <td class="t13 trm"></td>          <td class="t13 trm"></td>            </tr>        <tr>          <td style=" vertical-align: middle; " class="t5 trm im"><a href="Imperial_Age.php">帝王時代</a></td>          <td class="t13 trm"><img class="gg" src="~assets/JaguarWarriorIcon.jpg" width="30" alt=""><div><a href="Jaguar_Warrior.php">精銳豹勇士</a></div></td>          <td class="t13 trm"><img class="gg" src="~assets/TrebuchetPackedIcon.jpg" width="30" alt=""><div><a href="Trebuchet.php">巨型投石機</a></div></td>          <td class="t13 trm"><img class="gg" src="~assets/Unique-tech.jpg" width="30" alt=""><div><a href="Garland_Wars.php">榮冠戰爭</a></div></td>          <td class="t13 trm not"><img class="gg" src="~assets/Hoardings.jpg" width="30" alt=""><div><a href="Hoardings.php">外架式柵樓</a></div></td>          <td class="t13 trm"><img class="gg" src="~assets/Sappers.jpg" width="30" alt=""><div><a href="Sappers.php">坑道工兵</a></div></td>          <td class="t13 trm"><img class="gg" src="~assets/Conscription.jpg" width="30" alt=""><div><a href="Conscription.php">徵兵制度</a></div></td>          <td class="t13 trm"><img class="gg" src="~assets/Spiestreason.jpg" width="30" alt=""><div><a href="Spies.php">間諜</a></div></td>           </tr>    </table> <table class="table" style="margin-top:50px;">        <tr>            <td class="trm" colspan="5" style="border-top: none;">                <a href="Town_Center.php"><img class="ng" src="~assets/Towncentericon.png" alt=""></a>                <div><a href="Town_Center.php">城鎮中心</a></div>            </td>        </tr>        <tr>            <td style=" vertical-align: middle; " class="t5 trm dr"><a href="Dark_Age.php">黑暗時代</a></td>     <td class="t23 trm"><img class="gg" src="~assets/VillagerMaleIcon.jpg" alt=""><div><a href="Villager.php">村民</a></div></td>         <td class="t23 trm"><img class="gg" src="~assets/Feudal-age-reseach.jpg" alt=""><div><a href="Feudal_Age.php">封建時代</a></div>                <i class="fas fa-arrow-down"></i> 
        </td>
        <td class="t23 trm">
    ...
    <table class="table" style="margin-top:50px;">
      <tr>
        <td class="trm" colspan="5" style="border-top: none;"> <a href="Mill.php"><img class="ng" src="~assets/Millicon.png" alt=""></a> 
      ...
      <tr>
        ...
        <td class="t23 trm">
          <img class="gg" src="~assets/Croprotation.jpg" alt=""><a href="Crop_Rotation.php"><div>輪耕</a>
    ...
    <table class="table" style="margin-top:50px;">
      <tr>
        <td class="trm" colspan="5" style="border-top: none;"> <a href="Mining_Camp.php"><img class="ng" src="~assets/Miningcampicon.png" alt=""></a> 
    ...
    <table class="table" style="margin-top:50px;">
      <tr>
        <td class="trm" colspan="10" style="border-top: none;"> <a href="Dock.php"><img class="ng" src="~assets/Dockicon.png" alt=""></a> 
          <div
    ...
    <table class="table" style="margin-top:50px;">
      <tr>
        <td class="trm" colspan="6" style="border-top: none;"> <a href="Blacksmith.php"><img class="ng" src="~assets/Blacksmithicon.png" alt=""></a> 
          <div
    ...
    <table class="table" style="margin-top:50px;">
      <tr>
        <td class="trm" colspan="5" style="border-top: none;"> <a href="Market.php"><img class="ng" src="~assets/Marketicon.png" alt=""></a> 
          <div
    ...
    <table class="table" style="margin-top:50px;">
      <tr>
        <td class="trm" colspan="9" style="border-top: none;"> <a href="Monastery.php"><img class="ng" src="~assets/Monasteryicon.png" alt=""></a> 
          <div
    ...
    <table class="table" style="margin-top:50px;">
      <tr>
        <td class="trm" colspan="9" style="border-top: none;"> <a href="University.php"><img class="ng" src="~assets/Universityicon.png" alt=""></a> 
          <div
