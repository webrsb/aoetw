<template>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>步兵鎖甲可於<a href="Castle_Age.php">城堡時代在 <a href="Blacksmith.php">兵工廠</a> 研發，可讓步兵護甲+1/+1。</p>
          </div>
           <h3>可研發文明</h3> 
          <div class="hrn1"></div>
          <div class="row">
          ...
          <div class="n1">
            <ul>
              ...
              <li><a href="Incas.php">印加</a>：村民也獲得+1/+1護甲</li>
        ...
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="unit4">
                <img src="~assets/Scalemailarmor.jpg" alt=""><a href="Scale Mail Armor.php">步兵鱗甲</a>
