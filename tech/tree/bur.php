...
<td class="t19 trm"></td>  
        ...
        <tr>
         ...
         <td class="t13 trm">
          <img class="gg" src="img/Arambaiicon.png" width="30" alt=""><div><a href="Arambai.php">飛鏢騎兵</a></div>
          </td>
          <td class="t13 trm">
            <img class="gg" src="img/PetardIcon.jpg" width="30" alt=""><div><a href="Petard.php">爆炸桶</a></div>
          </td>
          <td class="t13 trm"><img class="gg" src="img/CastleAgeUnique.png" width="30" alt=""><div><a href="Howdah.php">象轎</a></div></td>
          <td class="t13 trm"></td>
          <td class="t13 trm"></td>
          <td class="t13 trm"></td>
          <td class="t13 trm"></td>
        ...
        <tr>
          <td style=" vertical-align: middle; " class="t5 trm im"><a href="Imperial_Age.php">帝王時代</a></td>
          <td class="t13 trm">
          <img class="gg" src="img/Arambaiicon.png" width="30" alt=""><div><a href="Arambai.php">精銳飛鏢騎兵</a></div>
          </td>
          <td class="t13 trm"><img class="gg" src="img/TrebuchetPackedIcon.jpg" width="30" alt=""><div><a href="Trebuchet.php">巨型投石機</a></div></td>
          <td class="t13 trm"><img class="gg" src="img/Unique-tech.jpg" width="30" alt=""><div><a href="Manipur_Cavalry.php">曼尼普爾騎兵</a></div></td>
   ...
   <tr>
    ...
    <table class="table" style="margin-top:50px;">
        ...
        <tr>
         ...
         <td class="t11 trm"><img class="gg" src="img/Fortified-wall-research.jpg" alt=""><div><a href="Fortified Wall.php">垛牆</a></td>
        ...
        <td class="t11 trm"><img class="gg" src="img/Treadmillcrane.jpg" alt=""><div><a href="Treadmill Crane.php">滑輪起重機</a></div></td>
         <td class="t11 trm"></td>
