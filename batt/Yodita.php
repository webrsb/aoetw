        ...
        <div class="col-md-8">
          <div class="n1">
            ...
            <div class="ien"><em>    傾國傾城的公主殿下優娣忒曾是阿克蘇姆王室未來的接班人。但是她的侄子出於忌妒，誣陷她偷竊了教堂的聖物。從此，她被趕出皇室，流亡國外。在玩家的見證下看這位沒落的公主是如何一步步奪回權力的寶座，成為一代女皇。優娣忒公主復仇的故事甚至還震撼了之後數百年的衣索比亞人。</em>
              <p
              style="text-align: right;margin-top: 10px;">-遊戲中對於優娣忒戰役的介紹</p>
            </div>
            <p></p>
          </div>
          <h3>英雄</h3>
          ...
          <div class="n1">
            <div class="row">
              <div class="col-md-12">
                <p>優娣忒戰役由5個關卡組成。玩家扮演的是衣索比亞人，顏色是綠色。</p>
              </div>
              <div class="col-md-6">
                <ol>
                  <li><a href="Path_of_Exile.php">流亡之路</a>
                  </li>
                  <li><a href="The_Right_Partner.php">最佳搭檔</a>
                  </li>
                  <li><a href="A_Fallen-Crown.php">摔落的皇冠</a>
                  </li>
                  <li><a href="Broken_Stelae.php">毀壞的石碑</a>
                  </li>
                  <li><a href="Welcome_Home.php">重回故里</a>
                  </li>
                </ol>
              </div>
              <div class="col-md-6">
          ...
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style=" background-color:#375d96;;">
                <div class="unititle" style="color: #fff;">優娣忒</div>
              </td>
            </tr>
            <tr>
              <td colspan="2">
