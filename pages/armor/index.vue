      ...
      <div class="col-md-12">
        ...
        <div class="n1">
          <p>
            ...
            <a href="Eagle_Warrior.php">鷹勇士</a>你會很直覺的認為他是<a
              href="Armor_Class_Infantry.php"
              >步兵</a
            >，但很多情況例外，例如前面說的
            <a href="Eagle_Warrior.php">鷹勇士</a>他其實也是<a
              href="Armor_Class_Eagle_Warrior.php"
              >『鷹勇士』類</a
            >，他有自己的防禦類型，
            <a href="Champion.php">劍兵勇士</a>會給他很大的傷害。另一個例子是<a
              href="Camel.php"
              >駱駝騎兵</a
            >，他不在<a href="Armor_Class_Cavalry.php">騎兵類</a>，而是在自己的
            <a href="Armor_Class_Camel.php">駱駝類</a>，面對<a
              href="Spearman.php"
              >槍兵</a
            >他受的到傷害更小。
          </p>
          ...
          <p>
            簡單的說，如果一個單位有多種防禦類型，那麼攻擊他的加成就會增加，例如<a
              href="War_Elephant.php"
              >戰象</a
            >有兩個防禦類型， <a href="Armor_Class_Cavalry.php">騎兵</a>和<a
              href="Armor_Class_War_Elephant.php"
              >戰象</a
            >，而<a href="Halberdier.php">戟兵</a
            >對這兩類都有附加攻擊，分別是32和28，所以一隻
            <a href="Halberdier.php">戟兵</a>攻擊<a href="War_Elephant.php"
              >戰象</a
          ...
          <p>
            ...
            <a href="Cataphract.php">聖騎兵</a>的防禦類型是<a
        ...
        <div class="n1">
          <div class="row">
            <div class="col-md-6">
              單位類：
              <ul>
                <li><a href="Armor_Class_Infantry.php">步兵</a></li>
                <li><a href="Armor_Class_Spearman.php">槍兵</a></li>
                <li><a href="Armor_Class_Eagle_Warrior.php">鷹勇士</a></li>
                <li><a href="Armor_Class_Archer.php">射手</a></li>
                <li><a href="Armor_Class_Cavalry_Archer.php">馬弓騎兵</a></li>
                <li><a href="Armor_Class_Cavalry.php">騎兵</a></li>
                <li><a href="Armor_Class_Camel.php">駱駝</a></li>
                <li><a href="Armor_Class_War_Elephant.php">戰象</a></li>
                <li><a href="Armor_Class_Gunpowder_Unit.php">火藥單位</a></li>
                <li><a href="Armor_Class_Siege_Weapon.php">攻城武器</a></li>
                <li><a href="Armor_Class_Ram.php">衝撞車</a></li>
                <li><a href="Armor_Class_Monk.php">僧侶</a></li>
                <li><a href="Armor_Class_Ship.php">船</a></li>
                <li><a href="Armor_Class_Turtle_Ship.php">龜甲船</a></li>
                <li><a href="Armor_Class_Unique_Unit.php">特殊單位</a></li>
              </ul>
            </div>
            <div class="col-md-6">
              建築類
          ...
          <div class="hrn1"></div>
          <div class="n1">
            <a href="Elephant_Archer.php">象弓騎兵</a>有最多的防禦類型，有五種。
          </div>
          <h3>遠防</h3>
          <div class="hrn1"></div>
          <div class="n1">
                ...
                <ul>
                  ...
                  <li>
                    <img
                      ...
                      alt=""
                    /><a href="Elite_Eagle_Warrior.php">精銳鷹勇士</a>（8,<a
                      href="Incas.php"
                      >印加</a
                    >：10）
                  </li>
                ...
                <ul>
                  <li>
                    <img
                      ...
                      alt=""
                    /><a href="Rattan_Archer.php">精銳籐甲弓箭手</a>（10）
                  </li>
                  <li>
                    <img
                      class="gg"
                      ...
                      alt=""
                    /><a href="Imperial_Skirmisher.php">帝王戰矛兵</a>（9）
                  </li>
                  <li>
                    <img
                      class="gg"
                      ...
                      alt=""
                    /><a href="Elephant_Archer.php">精銳象弓騎兵</a>（9）
                  </li>
                  <li>
                  ...
                  <li>
                    <img
                      ...
                      alt=""
                    /><a href="Elite_Skirmisher.php">戰矛兵</a>（8）
                  </li>
                </ul>
              </div>
              <div class="col-md-4">
                ...
                <ul>
                  ...
                  <li>
                    <img
                      ...
                      width="22"
                      alt=""
                    /><a href="War_Elephant.php">精銳戰象</a>（7）
                  </li>
                  <li>
                    <img
                      class="gg"
                      ...
                      alt=""
                    /><a href="Battle_Elephant.php">精銳矛象伕</a>（7,<a
                      href="Burmese.php"
                      >緬甸</a
                    >：9）
                  </li>
                ...
                <ul>
                  ...
                  <li>
                    <img
                      ...
                      src="~assets/TrebuchetPackedIcon.jpg"
                      alt=""
                    /><a href="Trebuchet.php">投石機</a>（移動：8，展開後：150）
                  </li>
                  <li>
                ...
                <ul>
                  ...
                  <li>
                    <img
                      ...
                      alt=""
                    /><a href="Fast_Fire_Ship.php">快速火戰船</a>（9）
                  </li>
                  <li>
                    <img src="~assets/LongboatIcon.jpg" alt="" /><a
                      href="Longboat.php"
                  ...
                  <li>
                    <img
                      ...
                      alt=""
                    /><a href="Transport_Ship.php">運輸船</a>（9）
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div class="n1">
              ...
              <table class="table-bordered table-striped" width="100%">
                ...
                <tr>
                  ...
                  <td class="tunitc4"><a href="Howdah.php">象轎</a></td>
                ...
                <tr>
                  ...
                  <td class="tunitc4"><a href="Pavise.php">巨盾</a></td>
                  <td class="tunitc5">300F 150G</td>
                ...
                <tr>
                  ...
                  <td class="tunitc4"><a href="Carrack.php">克拉克帆船</a></td>
                ...
                <tr>
                  ...
                  <td class="tunitc4"><a href="Orthodoxy.php">東正教</a></td>
                ...
                <tr>
                  ...
                  <td class="tunitc4"><a href="Supremacy.php">霸權</a></td>
