      ...
      <div class="col-md-12">
        ...
        <div class="n1">
          <p>
            ...
            <a href="/units/Eagle_Warrior">鷹勇士</a>你會很直覺的認為他是<a
              href="/armor/Armor_Class_Infantry"
              >步兵</a
            >，但很多情況例外，例如前面說的
            <a href="/units/Eagle_Warrior">鷹勇士</a>他其實也是<a
              href="/armor/Armor_Class_Eagle_Warrior"
              >『鷹勇士』類</a
            >，他有自己的防禦類型，
            <a href="/units/Champion">劍兵勇士</a
            >會給他很大的傷害。另一個例子是<a href="/units/Camel">駱駝騎兵</a
            >，他不在<a href="/armor/Armor_Class_Cavalry">騎兵類</a
            >，而是在自己的
            <a href="/armor/Armor_Class_Camel">駱駝類</a>，面對<a
              href="/units/Spearman"
              >槍兵</a
            >他受的到傷害更小。
          </p>
          ...
          <p>
            簡單的說，如果一個單位有多種防禦類型，那麼攻擊他的加成就會增加，例如<a
              href="/War_unitsanimal/Elephant"
              >戰象</a
            >有兩個防禦類型， <a href="/armor/Armor_Class_Cavalry">騎兵</a>和<a
              href="/armor/Armor_Class_War_Elephant"
              >戰象</a
            >，而<a href="/units/Halberdier">戟兵</a
            >對這兩類都有附加攻擊，分別是32和28，所以一隻
            <a href="/units/Halberdier">戟兵</a>攻擊<a
              href="/War_unitsanimal/Elephant"
              >戰象</a
          ...
          <p>
            ...
            <a href="/units/Cataphract">聖騎兵</a>的防禦類型是<a
              href="/armor/Armor_Class_Cavalry"
              >騎兵</a
            >，但他的騎兵裝甲值是12，這代表他比其他
            <a href="/units/Cavalry_Units">騎兵</a
            >更不怕反騎兵的攻擊。另一方面，<a
              href="/Ballista_unitsanimal/Elephant"
              >弩砲象</a
            >的<a href="/armor/Armor_Class_Cavalry">騎兵防禦</a
        ...
        <div class="n1">
          <div class="row">
            <div class="col-md-6">
              單位類：
              <ul>
                <li><a href="/armor/Armor_Class_Infantry">步兵</a></li>
                <li><a href="/armor/Armor_Class_Spearman">槍兵</a></li>
                <li><a href="/armor/Armor_Class_Eagle_Warrior">鷹勇士</a></li>
                <li><a href="/armor/Armor_Class_Archer">射手</a></li>
                <li>
                  <a href="/armor/Armor_Class_Cavalry_Archer">馬弓騎兵</a>
                </li>
                <li><a href="/armor/Armor_Class_Cavalry">騎兵</a></li>
                <li><a href="/armor/Armor_Class_Camel">駱駝</a></li>
                <li><a href="/armor/Armor_Class_War_Elephant">戰象</a></li>
                <li>
                  <a href="/armor/Armor_Class_Gunpowder_Unit">火藥單位</a>
                </li>
                <li><a href="/armor/Armor_Class_Siege_Weapon">攻城武器</a></li>
                <li><a href="/armor/Armor_Class_Ram">衝撞車</a></li>
                <li><a href="/armor/Armor_Class_Monk">僧侶</a></li>
                <li><a href="/armor/Armor_Class_Ship">船</a></li>
                <li><a href="/armor/Armor_Class_Turtle_Ship">龜甲船</a></li>
                <li><a href="/armor/Armor_Class_Unique_Unit">特殊單位</a></li>
              </ul>
            </div>
            <div class="col-md-6">
              建築類
              <ul>
                <li><a href="/armor/Armor_Class_Building">建築</a></li>
                <li>
                  <a href="/Armor_Class_standard_building.php">標準建築</a>
                </li>
                <li><a href="/armor/Armor_Class_stone_defense">石頭建築</a></li>
                <li><a href="/armor/Armor_Class_wall_and_gate">牆與門</a></li>
                <li><a href="/armor/Armor_Class_Castle">城堡</a></li>
              </ul>
            </div>
          </div>
          <h3>瑣事</h3>
          ...
          <div class="n1">
            ...
            <ul>
              <li>所有<a href="/building/Archery_Range">射箭場</a>單位</li>
              <li>所有特殊的射手單位</li>
              <li>
              ...
              <li>
                <img class="gg" src="~assets/ConquistadorIcon.jpg" alt="" /><a
            ...
            <li>
              <a href="/units/Fire_Ship">火戰船系列</a
              >造成遠程傷害時也會有近戰傷害。
            </li>
            <li>所有建築都是造成遠防傷害。</li>
            <h3>具有高遠防的單位</h3>
                ...
                <ul>
                  ...
                  <li>
                    <img
                      ...
                      alt=""
                    /><a href="/Elite_units/Eagle_Warrior">精銳鷹勇士</a>（8,<a
                      href="/civs/Incas"
                      >印加</a
                    >：10）
                  </li>
                ...
                <ul>
                  <li>
                    <img
                      ...
                      alt=""
                    /><a href="/Rattan_units/Archer">精銳籐甲弓箭手</a>（10）
                  </li>
                  <li>
                    <img
                      class="gg"
                      ...
                      alt=""
                    /><a href="/units/Imperial_Skirmisher">帝王戰矛兵</a>（9）
                  </li>
                  <li>
                    <img
                      class="gg"
                      ...
                      alt=""
                    /><a href="/Elephant_units/Archer">精銳象弓騎兵</a>（9）
                  </li>
                  <li>
                    <img class="gg" src="~assets/WarWagonIcon.jpg" alt="" /><a
                      href="/units/War_Wagon"
                      >精銳馬戰車</a
                    >（8）
                  </li>
                  <li>
                    <img class="gg" src="~assets/GenitourIcon.jpg" alt="" /><a
                      href="/units/Genitour"
                      >精銳鏢槍騎兵</a
                    >（8）
                  </li>
                  <li>
                    <img
                      ...
                      alt=""
                    /><a href="/units/Elite_Skirmisher">戰矛兵</a>（8）
                  </li>
                </ul>
              </div>
              <div class="col-md-4">
                ...
                <ul>
                  ...
                  <li>
                    <img
                      ...
                      width="22"
                      alt=""
                    /><a href="/War_unitsanimal/Elephant">精銳戰象</a>（7）
                  </li>
                  <li>
                    <img
                      class="gg"
                      ...
                      alt=""
                    /><a href="/units/Battle_Elephant">精銳矛象伕</a>（7,<a
                      href="/civs/Burmese"
                      >緬甸</a
                    >：9）
                  </li>
                  <li>
                    <img
                      ...
                      alt=""
                    /><a href="/Ballista_unitsanimal/Elephant">精銳弩砲象</a
                    >（7）
                  </li>
                  <li>
                ...
                <ul>
                  ...
                  <li>
                    <img
                      ...
                      alt=""
                    /><a href="/units/Fast_Fire_Ship">快速火戰船</a>（9）
                  </li>
                  <li>
                    <img src="~assets/LongboatIcon.jpg" alt="" /><a
                      href="/units/Longboat"
                  ...
                  <li>
                    <img
                      ...
                      alt=""
                    /><a href="/units/Transport_Ship">運輸船</a>（9）
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div class="n1">
                ...
                <tr>
                  <td class="tunitc6">
                    <img
                      ...
                      alt=""
                    /><a href="/techs/Chain_Mail_Armor">步兵鎖甲</a>
                  </td>
                  <td class="tunitc4">城堡</td>
                ...
                <tr>
                  <td class="tunitc6">
                    <img
                      ...
                      alt=""
                    /><a href="/techs/Plate_Mail_Armor">步兵板甲</a>
                  </td>
                  <td class="tunitc4">帝王</td>
              ...
              <h3><a href="/techs/untech">城堡特殊科技</a></h3>
              <div class="hrn1"></div>
              <table class="table-bordered table-striped" width="100%">
                ...
                <tr>
                  ...
                  <td class="tunitc4"><a href="/techs/Howdah">象轎</a></td>
                ...
                <tr>
                  ...
                  <td class="tunitc4"><a href="/techs/Pavise">巨盾</a></td>
                  <td class="tunitc5">300F 150G</td>
                ...
                <tr>
                  ...
                  <td class="tunitc4"><a href="/techs/Orthodoxy">東正教</a></td>
                ...
                <tr>
                  ...
                  <td class="tunitc4"><a href="/techs/Supremacy">霸權</a></td>
