            ...
            <div class="col-md-12">
              <div class="col-md-4">
                <ul>
                  ...
                  <li>
                    <img width="25px" src="~assets/Millicon.png" alt="" /><a
                      href="Mill.php"
                      >磨坊</a
                    >
                  </li>
                  <li>
                    <img width="25px" src="~assets/Farmicon.png" alt="" /><a
                      href="Farm.php"
                      >農田</a
                    >
                  </li>
                  ...
                  <li>
                    <img width="25px" src="~assets/Marketicon.png" alt="" /><a
                      href="Market.php"
                      >市集</a
                    >
                  </li>
              ...
              <div class="col-md-4">
                <ul>
                  <li>
                    <img width="25px" src="~assets/Dockicon.png" alt="" /><a
                      href="Dock.php"
                      >碼頭</a
                    >
                  </li>
                  ...
                  <li>
                    <img width="25px" src="~assets/Stableicon.png" alt="" /><a
                      href="Stable.php"
                      >馬廄</a
                    >
                  </li>
              ...
              <div class="col-md-4">
                <ul>
                  <li>
                    <img width="25px" src="~assets/Gateicon.png" alt="" /><a
                      href="Gateicon_Gate.php"
                      >城門</a
                    >
                  </li>
                  <li>
                    <img width="25px" src="~assets/Outposticon.png" alt="" /><a
                      href="Outpost.php"
                      >哨站</a
                    >
                  </li>
                ...
                <ul>
                  ...
                  <li>
                    <img
                      ...
                      alt=""
                    /><a href="Karambit_Warrior.php">精銳爪刀勇士</a>(<a
                      href="Malay.php"
                      >馬來</a
                    >限定)
                  </li>
                ...
                <div class="n1">
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      (帝王戰矛兵是<a href="Vietnamese.php">越南</a
                      >及其同盟限定)
                    </li>
                    ...
                    <li>
                      ...
                      <img
                        ...
                        src="~assets/New_Genoese_Crossbowman.png"
                        alt=""
                      /><a href="Genoese_Crossbowman.php">熱那亞弩精銳手</a>(<a
                        href="Italians"
                        >義大利</a
                      >限定)
                    </li>
                    <li>
                      ...
                      <img
                        ...
                        src="~assets/Rattanarchericon.png"
                        alt=""
                      /><a href="Rattan_Archer.php">精銳藤甲弓兵</a>(<a
                        href="Vietnamese.php"
                        >越南</a
                      >限定)
                    </li>
