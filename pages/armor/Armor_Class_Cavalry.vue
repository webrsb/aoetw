  ...
  <div class="container">
    ...
    <div class="row padtop">
      ...
      <div class="col-md-12">
        <div class="spw">
          <em
            >這篇文章是將有關於騎兵系裝甲的。而關於騎兵這個兵種的請參見<a
              href="Cavalry_Units.php"
              >騎兵單位</a
            >或<a href="Cavalier.php">騎兵</a>。</em
          >
        </div>
      </div>
      <div class="col-md-12">
        ...
        <div class="n1">
          ...
          <ul>
            <li>
              <img class="gg" src="~assets/CavalryArcherIcon.jpg" alt="" /><a
                href="Cavalry_Archer.php"
                >馬弓騎兵</a
              >→
              <img class="gg" src="~assets/HeavyCavArcherIcon.jpg" alt="" /><a
            ...
            <li>
              ...
              <img class="gg" src="~assets/CataphractIcon.jpg" alt="" /><a
                href="Cataphract.php"
                >精銳聖騎兵</a
              >(16)(<a href="Byzantines.php">拜占庭</a>限定)
            </li>
            <li>
              <img
                class="gg"
              ...
              <img
                ...
                alt=""
              />
              <a href="Mangudai.php">精銳蒙古突騎</a>(<a href="Mongols.php"
                >蒙古</a
              >限定)
            </li>
            <li>
              ...
              <img
                ...
                alt=""
              />
              <a href="War_Elephant.php">精銳戰象</a>(<a href="Persians.php"
                >波斯</a
              >限定)
            </li>
            <li>
              ...
              <img class="gg" src="~assets/Saracenmamluk_icon.png" alt="" /><a
                href="Mameluke.php"
                >精銳奴隸兵</a
              >(11)(<a href="Saracens.php">薩拉森</a>限定)
            </li>
            <li>
        ...
        <div class="n1">
                ...
                <ul>
                  ...
                  <li>
                    <img
                      ...
                      src="~assets/Saracenmamluk_icon.png"
                      alt=""
                    /><a href="Mameluke.php">奴隸兵</a>(<a href="Saracens.php"
                      >薩拉森</a
                    >限定)
                  </li>
                </ul>
              ...
              <div class="col-md-4">
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <img class="gg" src="~assets/ChuKoNuIcon.jpg" alt="" />
                    <a href="Chu_Ko_Nu.php">精銳連弩兵</a>(<a href="Chinese.php"
                      >中國</a
                    >限定)
                  </li>
                  <li>
                    ...
                    <img class="gg" src="~assets/VBRSK.jpg" alt="" />
                    <a href="Berserk.php">精銳狂戰士</a>(<a href="Vikings.php"
                      >維京</a
                    >限定)
                  </li>
                  <li>
          ...
          <div class="n1">
            ...
            <div width="22" style="margin:12px 0px;">
              <strong>+5攻擊</strong>(<a href="Vikings.php">維京</a>限定)
            </div>
            <ul>
              <li>
              ...
              <li>
                ...
                <a href="Condottiero.php">傭兵</a>(如果和<a href="Italians.php"
                  >義大利</a
                >同盟的話)
              </li>
            </ul>
