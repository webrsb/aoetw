      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            房屋是遊戲內最重要的建築之一。它提供5的居住人口讓玩家訓練村民和軍隊使用，不過被摧毀時玩家也會失去5的人口上限(<a
              href="Mongols.php"
              >蒙古</a
            >研發 <a href="Nomads.php">游牧</a>後房屋毀壞人口上限也不會掉)。
          </p>
          <p>
            除了<a href="Huns.php">匈奴人</a
          ...
          <div class="col-md-12">
            <div class="n1">
              <li>
                ...
                <a href="Huns.php">匈奴人</a>或<a href="Chinese.php">中國人</a
              ...
              <li>
                ...
                <a href="Town_Center.php">城鎮中心</a>，<a
                  href="Watch_Tower.php"
                  >箭塔</a
                >或<a href="Castle.php">城堡</a
          ...
          <tr>
            ...
            <td class="tta4">
              <img
                ...
                width="30"
                alt=""
              /><a href="Nomads.php">游牧</a>:房屋被毀壞人口容納量也不會下降
            </td>
          </tr>
        </table>
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              <a href="Huns.php">匈奴</a>：不須建造房屋但遊戲開始時少100木材%
            </li>
        ...
        <div class="n1">
          ...
          <ul>
            ...
            <li>
              <a href="Mongols.php">蒙古</a>：<a href="Nomads.php">游牧</a
              >研發後房屋被毀壞人口容納量也不會下降。
            </li>
          </ul>
        </div>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="unit4"><a href="Dark_Age.php">黑暗時代</a></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit4">
              <a href="img/Armor_class_building.php">建築</a> <br />
              <a href="img/Armor_class_standard_building.php">標準建築</a>
            </td>
          </tr>
          <tr>
