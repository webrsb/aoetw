  ...
  <div class="container">
    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            房屋是遊戲內最重要的建築之一。它提供5的居住人口讓玩家訓練村民和軍隊使用，不過被摧毀時玩家也會失去5的人口上限(<a
              href="/civs/Mongols"
              >蒙古</a
            >研發 <a href="/techs/Nomads">游牧</a>後房屋毀壞人口上限也不會掉)。
          </p>
          <p>
            除了<a href="/civs/Huns">匈奴人</a
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="n1">
              <li>
                除了城牆之外，房子是遊戲中最便宜的建築物。其功能是增加人口容量。在<a
                  href="/techsage/Dark_Age"
                  >黑暗時代</a
                >，房子是玩家應該建造的第一座建築（除非他們扮演的是
                <a href="/civs/Huns">匈奴人</a>或<a href="/civs/Chinese"
                  >中國人</a
              ...
              <li>
                由於房屋價格便宜，而且建造速度快，所以在許多情況下，這些房屋被用來替代城牆作為防禦工事，尤其是在遊戲的早期階段。
              </li>
              <li>
                <a href="/civs/Khmer">高棉</a
                >讓玩家可以在防守時使用房屋作為防禦性建築，因為他們可以讓五名村民駐守在房屋內（不過不像在
                <a href="/building/Town_Center">城鎮中心</a>，<a
                  href="/units/Watch_Tower"
                  >箭塔</a
                >或<a href="/building/Castle">城堡</a
                >中進駐，駐守在房屋內的村民不能射箭）。這有助於高棉玩家減少村民損失，所以建議在繁忙的工作地點旁邊建造房屋。而且，如果他們想用房屋替代牆壁，他們可以透過駐守房子在把村民放出來移動到玩家的城鎮裡。
              </li>
              <li>
                房屋通常以成群的形式建成，以節省建築物和資源開采的空間。這樣可以優化單位在鎮上的路線，但是這也使得他們特別容易受到<a
                  href="/units/Mangonel"
                  >投石車</a
                >等 <a href="/Siege_Weapon_Unit.php">攻城武器</a>的破壞。
              </li>
            </div>
          </div>
        </div>
          ...
          <tr>
            ...
            <td class="tta4">
              <img
                ...
                width="30"
                alt=""
              /><a href="/techs/Nomads">游牧</a>:房屋被毀壞人口容納量也不會下降
            </td>
          </tr>
        </table>
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              <a href="/civs/Huns">匈奴</a>：不須建造房屋但遊戲開始時少100木材%
            </li>
            <li><a href="/civs/Incas">印加</a>：房屋提供10的居住人口%</li>
            <li><a href="/civs/Khmer">高棉</a>：房屋可駐守5名村民。</li>
            <li><a href="/civs/Malians">馬利</a>：房屋便宜15%</li>
            <li><a href="/civs/Spanish">西班牙</a>：房屋建築速度快30%。</li>
          </ul>
        </div>
        <h3>更新日誌</h3>
        <div class="hrn1"></div>
        <div class="n1">
          ...
          <ul>
            ...
            <li>
              <a href="/civs/Mongols">蒙古</a>：<a href="/techs/Nomads">游牧</a
              >研發後房屋被毀壞人口容納量也不會下降。
            </li>
          </ul>
        </div>
        ...
        <div class="col-md-4">
          <a href="/img/HouseFedualAgeHD.png"
            ><img
              class="imgn hg"
              width="200"
        ...
        <div class="col-md-4">
          <a href="/img/HouseFeudalAgeDLC.png"
            ><img
              class="imgn hg"
              width="200"
        ...
        <div class="col-md-4">
          <a href="/img/Spritesheet_house.png"
            ><img
              class="imgn hg"
              width="200"
        ...
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style=" background-color:#3c763d;;">
              <div class="unititle"><a href="#">房屋</a></div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/Houseicon.png" width="45" alt="" />
              </div>
            </td>
          </tr>
          <tr>
