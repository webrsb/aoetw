      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              <nuxt-link to="/civs/Khmer">高棉</nuxt-link>：房屋可駐守5名村民。
            </li>
            <li><nuxt-link to="/civs/Malians">馬利</nuxt-link>：房屋便宜15%</li>
            <li>
        ...
        <div class="hrn1"></div>
        <div class="col-md-4">
          <a target="_blank" href="/img/HouseDarkAge.jpg"
            ><img
              class="imgn hg"
              width="180"
        ...
        <div class="col-md-4">
          <a target="_blank" href="/img/HouseFedualAgeHD.jpg"
            ><img
              class="imgn hg"
              width="200"
        ...
        <div class="col-md-4">
          <a target="_blank" href="/img/HouseFeudalAgeDLC.jpg"
            ><img
              class="imgn hg"
              width="200"
        ...
        <div class="col-md-4">
          <a target="_blank" href="/img/Houseaokaoc.jpg"
            ><img
              class="imgn hg"
              width="200"
        ...
        <div class="col-md-4">
          <a target="_blank" href="/img/Househd.jpg"
        ...
        <div class="col-md-4">
          <a target="_blank" href="/img/Spritesheet_house.jpg"
            ><img
              class="imgn hg"
              width="200"
