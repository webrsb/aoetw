    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          ...
          <p>
            在隨機地圖中每個玩家在開始時都有一座城鎮中心。只有演進到城堡時代才能建造額外的城鎮中心，若在城堡時代前城鎮中心就被破壞那遊戲幾乎就結束了。在特定地圖中(例如游牧地圖)城堡時代前玩家可自由選擇蓋城鎮中心的位置，若不喜歡可毀掉之後在新地點重蓋一個新的。
          </p>
          <p>
            城鎮中心作為庇護所可駐紮高達15個單位，村民在城鎮中心周圍工作十分安全，敵方來襲時只要敲響警戒鐘讓村民躲入城鎮中心放箭，直到敵人被消滅或退去後再次敲鐘返回工作崗位即可。弓兵也可進入城鎮中心增加城鎮中心的攻擊力與放箭數。
          </p>
          <p>
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              一旦城堡時代到來，建立更多的城鎮中心是至關重要的，因為它允許玩家增加村民的數量和撐起整個經濟。城鎮中心應盡量建造在資源旁邊(有兩種以上資源就可考慮蓋城鎮中心)。在城堡和帝國時代失去城鎮中心往往會阻礙玩家的經濟，所以他們往往是攻擊的目標。
            </li>
            <li>
              現在的meta中有兩種策略，一種是單TC強軍事，另一種是龜家裡爆TC。單TC強軍事......；龜家裡爆TC則是藉由穩固經濟在後期贏過對手，通常國際禮儀來說會蓋3TC，但每場狀況不同會在2~4之間徘徊。
            </li>
            <li>
              修復城鎮中心不花費任何石頭，但需要花費兩倍的木頭。因此，修復幾乎被毀壞的城鎮中心(花費550木材)跟用275木材和100石頭建立一個新的。顯然後者才是明智之舉。
            </li>
          </ul>
          <h3>可訓練的單位與技術</h3>
          <div class="hrn1"></div>
        ...
        <div class="n1">
          <p>
            所有的鄉鎮都有一個行政中心，是政府權力和領導的所在地。在黑暗時代，這可能是當地領導人的居所。後來它可能是市政廳或當地主人的莊園。城鎮中心往往是儲存重要物資的地方，特別是食物生產過剩的時候可以存起來備用。城鎮中心被破壞通常意味著基礎設施的損壞。如果不能恢復，這個鎮或村就不能再運作。
          </p>
        </div>
        <h3>圖庫</h3>
        <div class="hrn1"></div>
        <div class="n1">
          <div class="col-md-12">
            <div class="col-md-4">
              <a target="_blank" href="/img/TCDarkAge.jpg"
                ><img
                  class="imgn hg"
                  width="250"
            ...
            <div class="col-md-4">
              <a target="_blank" href="/img/TCFeudalAgeHD.jpg"
                ><img
                  class="imgn hg"
                  width="250"
            ...
            <div class="col-md-4">
              <a target="_blank" href="/img/TCFeudalAgeDLC.jpg"
                ><img
                  class="imgn hg"
                  width="250"
          ...
          <div class="col-md-12">
            <div class="col-md-4">
              <a target="_blank" href="/img/Towncenteraokaoc.jpg"
                ><img
                  class="imgn hg"
                  width="250"
            ...
            <div class="col-md-4">
              <a target="_blank" href="/img/Towncenteraoe2expansions.png"
                ><img
                  class="imgn hg"
                  width="250"
            ...
            <div class="col-md-4">
              <a target="_blank" href="/img/TCImperialAgeHD.jpg"
                ><img
                  class="imgn hg"
                  width="250"
            ...
            <div class="col-md-4">
              <a target="_blank" href="/img/TCImperialAgeDLC.jpg"
                ><img
                  class="imgn hg"
                  width="250"
