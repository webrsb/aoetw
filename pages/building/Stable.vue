  ...
  <div class="container">
    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              <nuxt-link to="/civs/Slavs">斯拉夫</nuxt-link>：馬廄可提供5人口
            </li>
          </ul>
        </div>
        <h3>更新日誌</h3>
      ...
      <div class="col-md-12">
        ...
        <div class="n1">
          <div class="col-md-4">
            <nuxt-link to="/img/StableFeudalAgeHD.png"
              ><img
                class="imgn hg"
                width="180"
                src="~assets/StableFeudalAgeHD.png"
                alt=""
            /></nuxt-link>
          ...
          <div class="col-md-4">
            <nuxt-link to="/img/StableFeudalAgeDLC.png"
              ><img
                class="imgn hg"
                width="200"
                src="~assets/StableFeudalAgeDLC.png"
                alt=""
            /></nuxt-link>
            <div class="lightbox-caption" style="width:220px">
          ...
          <div class="col-md-4">
            <nuxt-link to="/img/Stableaok.png"
              ><img
                class="imgn hg"
                width="200"
                src="~assets/Stableaok.png"
                alt=""
            /></nuxt-link>
        ...
        <div class="col-md-12">
          <div class="col-md-4">
            <nuxt-link to="/img/Stablehd.png"
              ><img
                class="imgn hg"
                width="200"
                src="~assets/Stablehd.png"
                alt=""
            /></nuxt-link>
            <div class="lightbox-caption" style="width:220px">
          ...
          <div class="col-md-4">
            <nuxt-link to="/img/Spritesheet_stable.png"
              ><img
                class="imgn hg"
                width="200"
                src="~assets/Spritesheet_stable.png"
                alt=""
            /></nuxt-link>
            <div class="lightbox-caption" style="width:185px">
              <p>
                <em
                  >馬廄在封建/城堡時代在一般地圖/下雪地圖的樣子和駐紮單位時的樣子。</em
                >
              </p>
            </div>
          </div>
