      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            ...
            >和防禦建築。它是城堡的縮小版，可以訓練<nuxt-link to="/units/Konniks">保加利亞騎兵</nuxt-link
            >，<nuxt-link to="/elements/Garrison">駐軍</nuxt-link
            >可達20人，且不能被<nuxt-link to="/elements/Conversion">招降</nuxt-link
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="n1">
              <li>
                在進攻方面上，堡壘的性能可能會優於<nuxt-link to="/building/Castle">城堡</nuxt-link
            >，因為建築時間更短，並且一個城堡的成本幾乎等同堡壘。另外，堡壘與城堡訓練<nuxt-link to="/units/Konniks">保加利亞騎兵</nuxt-link>的時間是相同的，這使得能更容易地實現堡推。和城堡一樣，堡壘會根據駐紮單位來提升射箭數量。
              </li>
              <li>
                在防禦方面上，堡壘的<nuxt-link to="/elements/Attack">攻擊力</nuxt-link
            >，射程和<nuxt-link to="/elements/Hit_points">生命值</nuxt-link
            >比城堡小，並且不能製造<nuxt-link to="/units/Trebuchet">巨型投石機</nuxt-link
            >。除非沒有足夠的<nuxt-link to="/resource/Stone">石頭</nuxt-link
            >建造城堡，或是想要用相同的資源控圖或控制資源區，還是要建造城堡以製造巨型投石機。
              </li>
              <li>
                <nuxt-link to="/units/Siege_Weapons">攻城器單位</nuxt-link
            >能用比城堡大約一半的時間摧毀堡壘，因此要像城堡和<nuxt-link to="/building/Watch_Tower">箭塔</nuxt-link
            >一樣，最好把堡壘建在隘口或障礙物（城牆、懸崖、森林）後面，以免受非遠距離單位攻擊。
              </li>
               <li>
                堡壘也是升級<nuxt-link to="/techs/age/Imperial_Age">帝王時代</nuxt-link
        ...
        <div class="n1">
          <p>
            營壘可以根據駐紮單位來提升射箭數量，沒有任何駐紮時可以射出5支箭。每支箭造成9傷害(根據被傷害單位<nuxt-link
              to="/armor"
              >遠程護甲</nuxt-link
            >減少)。
          </p>
          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta2">20</td>
              <td class="tta3">14(額外9)</td>
              <td class="tta4">11(額外6)</td>
            </tr>
            <tr>
              <td class="tta1">
                <img
              ...
              <td class="tta2">20</td>
              <td class="tta3">12(額外7)</td>
              <td class="tta4">17(額外12)</td>
            </tr>
            <tr>
              <td class="tta1">
                <img
              ...
              <td class="tta2">20</td>
              <td class="tta3">15(額外10)</td>
              <td class="tta4">21(額外16)</td>
            </tr>
          </table>
          #全滿的意思是<nuxt-link to="/techs/Fletching">絕世好箭</nuxt-link
        ...
        <div class="n1"></div>
          ...
          <tr>
            ...
            <td class="tta4"><nuxt-link to="/units/Naval_Vessels">船隻</nuxt-link>，<nuxt-link
          ...
          <tr>
            ...
            <td class="tta4"><nuxt-link to="/units/Siege_Weapons">攻城武器</nuxt-link
              >，<nuxt-link to="/units/Tarkan">答剌罕騎兵</nuxt-link
              >，<nuxt-link to="/units/Huskarl">哥德衛隊</nuxt-link>，<nuxt-link
                to="/units/War_Elephant"
                >戰象</nuxt-link
              >，<nuxt-link to="/units/Cannon_Galleon">火砲戰船</nuxt-link>。</td>
          </tr>
          <tr class="tta">
            <td class="unit" colspan="2" style="text-align: center;">
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="unit4">訓練<nuxt-link to="/units/Konniks">保加利亞騎兵</nuxt-link
            ><br />攻擊敵方
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit4">
              9(<nuxt-link to="/units/Archer_Units">遠程</nuxt-link>)
            </td>
          </tr>
          <tr>
        ...
        <div class="thanks">感謝！本頁面由singsing612協助完成。</div>
      </div>
    </div>
    <div class="col-md-12">
      <h3>圖庫</h3>
