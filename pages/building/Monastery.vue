    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          ...
          <p>
            在任何具有標準勝利條件的遊戲中，修道院都是至關重要的。如果一個隊伍在他們的修道院裡擁有所有的遺跡(不需在同一個修道院或單一國家)，一個200年的計數器會開始倒數，效果類似於建造世界奇觀。如果敵方隊伍在計數器到達之前沒有搶走至少一個遺物或讓遺跡暴露於修道院外，那麼這場比賽就會結束。如果隊伍試著以取得所有遺跡做為勝利目標，建議把所有的遺跡都留在同一個修道院裡，並且用防禦性的結構和重裝單位保護，最好是<nuxt-link
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/monastery.png" alt="" />
              </div>
            </td>
          </tr>
          <tr>
