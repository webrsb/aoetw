<template>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>巨港是"世界地國II:王者崛起"資料片中馬來人進入城堡時代研發完科技"海上霸主"可以建造的特殊軍事經濟復合式建築物。巨港比碼頭有更多的生命值和視野，而且能以箭矢攻擊來犯的敵方單位。</p>
          </div>
          <h3>戰術</h3>
          <div class="hrn1">
          <div class="row">
            <div class="col-md-12">
              <div class="n1">
                ...
                <li>巨港早在《世紀帝國:征服者入侵》就有了，只是當時是一個無功能不能攻擊且蓋在海邊的建築物，外觀也與碼頭一樣。</li>
              </div>
            </div>
          </div>
          </div>
      ...
      <div class="col-md-12">
        ...
        <div class="hrn1"></div>
        <div class="n1">
          <div class="col-md-4"> <a href="img/HarboraoeII.png"><img class="imgn hg" width="180" src="~assets/HarboraoeII.png" alt=""></a> 
            <div
