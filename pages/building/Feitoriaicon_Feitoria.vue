  ...
  <div class="container">
    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            港灣大商站是非洲王朝資料片中，葡萄牙人於帝王時代可以建造的特殊建築物。不需村民蒐幫忙蒐集資源，港灣大商站每秒會給玩家0.8食物、0.8木材、0.45黃金和0.25石頭，也就是每分鐘會給48食物、48木材27黃金和15石頭。不過港灣大商站需要佔用20人口。
          </p>
        </div>
        <h3>戰術</h3>
        <div class="hrn1"></div>
        <div class="row">
          <div class="col-md-12">
            <div class="n1">
              <li>
                除了礙於人口限制之外，玩家可以建造多少個港灣大商站是沒有限制的。
                只要玩家擁有至少一個人口空間，玩家仍然可以建造一座港灣大商站（排隊的單位還是會算入這個空間）。雖然佔據20人口讓蓋港灣大商站看起來似乎不值得，但它給與免費的黃金跟石頭讓人很難評估它的實際價值。
              </li>
              <li>
                港灣大商站最適合黃金和石頭等資源耗盡的後期遊戲。
        ...
        <div class="n1">
          ...
          <ul>
            ...
            <li>
              4.8版後港灣大商站每秒給玩家0.8食物、0.8木材、0.45黃金和0.25石材
            </li>
          </ul>
        </div>
      </div>
    ...
    <div class="col-md-12">
      ...
      <div class="n1">
        <div class="col-md-4">
          <a target="_blank" href="/img/Feitoria_-_Copie.png"
            ><img
              class="imgn hg"
              width="180"
