  ...
  <div class="container">
    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            哨站是屬於世紀帝國II中的箭塔。不過不像箭塔能攻擊敵人，它主要的目的是警告玩家敵人的來襲動向。
          </p>
        </div>
        <h3>戰術要點</h3>
        <div class="hrn1"></div>
        <div class="n1">
          <ul>
            <li>
              ...
              隨著遊戲的進展，他們變得不太常見，因為輕騎兵能更好的取代它們的工作。
              此外，他們需要花費石頭，那還不如花在城堡，城牆和箭塔上更有價值。通常玩家會使用房屋和採集點(伐木場或採礦營地，木牆也可)來代替哨站探索地圖跟擴張視野。
            </li>
            <li>
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              ...
              >：哨站在黑暗/封建/城堡/帝王時代增加10%/20%/30%/40% HP
            </li>
            <li>
              <nuxt-link to="/civs/Chinese">中國</nuxt-link
              >：對哨站有利的科技在封建/城堡/帝王時代各便宜10%/15%/20%。
            </li>
            <li>
            ...
            <li>
              <nuxt-link to="/civs/Malians">馬利</nuxt-link>：哨站木頭花費-15%。
            </li>
            <li>
              <nuxt-link to="/civs/Persians">波斯</nuxt-link
              >：城鎮瞭望和城鎮巡邏在封建/城堡/帝王時代研發快10%/15%/20%。
            </li>
            <li>
      ...
      <div class="col-md-12">
        ...
        <div class="n1">
          <div class="col-md-4">
            <a target="_blank" href="/img/OutpostlosDarkAge.jpg"
              ><img
                class="imgn hg"
                width="180"
          ...
          <div class="col-md-4">
            <a target="_blank" href="/img/Outpostlosfu.jpg"
              ><img
                class="imgn hg"
                width="180"
