    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          ...
          <div class="n1">
            <ul>
              ...
              <li>
                <nuxt-link to="/civs/Malians">馬利</nuxt-link>：碼頭便宜15%。
              </li>
              <li>
        ...
        <div class="n1">
          ...
          <ul>
            <li>
              有<nuxt-link to="/civs/Vikings">維京</nuxt-link>做盟友:<nuxt-link
                to="/building/Dock"
                >碼頭</nuxt-link
              >便宜25%。
            </li>
        ...
        <div class="n1">
          <p>
            深水商船的出現讓人們建造可以讓這些船舶停泊和卸載的碼頭。這種新設計的船舶不能輕易靠岸卸貨因為可能會擱淺。與碼頭相關的是造船的造船廠。
          </p>
        </div>
      </div>
      <div class="col-md-4">
      ...
      <div class="col-md-12">
        ...
        <div class="n1">
          <div class="col-md-4">
            <a target="_blank" href="/img/DockDarkAge.jpg"
              ><img
                class="imgn hg"
                width="180"
          ...
          <div class="col-md-4">
            <a target="_blank" href="/img/DockFeudalAgeHD.jpg"
              ><img
                class="imgn hg"
                width="200"
          ...
          <div class="col-md-4">
            <a target="_blank" href="/img/DockFeudalAgeDLC.jpg"
              ><img
                class="imgn hg"
                width="200"
        ...
        <div class="col-md-12">
          <div class="col-md-4">
            <a target="_blank" href="/img/Dockaokaoc.jpg"
              ><img
                class="imgn hg"
                width="200"
          ...
          <div class="col-md-4">
            <a target="_blank" href="/img/Dockexpansions.jpg"
              ><img
                class="imgn hg"
                width="200"
          ...
          <div class="col-md-4">
            <a target="_blank" href="/img/Spritesheet_dock.jpg"
              ><img
                class="imgn hg"
                width="200"
            ...
            <div class="lightbox-caption" style="width:185px">
              <p>
                <em
                  >碼頭在封建/城堡時代在一般地圖/下雪地圖的樣子和駐紮單位時的樣子。</em
                >
              </p>
            </div>
          </div>
