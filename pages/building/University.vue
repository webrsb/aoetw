  ...
  <div class="container">
    ...
    <div class="row" style=" margin-top: 50px;">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            <a href="University.php">學院</a>或稱為大學，在<a
              href="Castle_Age.php"
              >城堡時代</a
        ...
        <div class="n1">
          <p>
            學院中的<a href="Ballistics.php">彈道學</a
            ...
            <a href="Hand_Cannoneer.php">火槍兵</a>、<a
          ...
          <div class="row">
                ...
                <ul>
                  ...
                  <li>
                    <img
                      ...
                      alt=""
                    /><a href="Bombard_Tower.php">火砲塔</a>
                  </li>
                </ul>
              </div>
            </div>
              ...
              <tr>
                ...
                <td class="tta4">
                  <img
                    ...
                    width="30"
                    alt=""
                  /><a href="Masonry.php">磚瓦技術</a>(護甲+1/+1，+3建築護甲)
                  <br />
                  <img
                    class="gg"
                    src="~assets/Architecture.jpg"
            ...
            <div class="col-md-12">
              ...
              <div class="n1">
                <ul>
                  <li>
                    <a href="Malians.php">馬利</a>：團隊學院的工作效率快80%
                  </li>
                </ul>
              </div>
              <h3>趣事</h3>
