            ...
            <p>學院中的<a href="Ballistics.php">彈道學</a>在現今遠距離作戰當道的情況下常是玩家優先研發的技術，以<a href="Crossbowman.php">弩兵</a>或是
              ...
              href="Cavalry_Archer.php">馬弓騎兵</a>當主力的打法，學院通常會一上城堡就蓋。而上了帝王後<a href="Chemistry.php">化學</a>的研發可讓攻擊更具破壞力，重點是可以獲取
                ...
                href="Hand_Cannoneer.php">火槍兵</a>、<a href="Bombard_Cannon.php">火炮</a>與 <a href="">火炮塔</a>這種高威力火藥兵種。。
                  <a
                  href="Siege_Engineers.php">攻城工程師</a>可讓攻城武器射程+1在後期也很有效用；而其他如<a href="Murder_Holes.php">垛孔</a>、<a href="Fortified_Wall.php">垛牆</a>則不符合當前戰術所以不常研發。</p>
            <h3>可訓練的單位與技術</h3>
            <div class="hrn1"></div>
            <div class="row">
              <div class="col-md-6">
                <div class="n1">
                  ...
                  <ul>
                    ...
                    <li>
                      <img class="gg" src="~assets/Fortified-wall-research.jpg" alt=""><a href="Fortified_Wall.php">垛牆</a>
                    </li>
                    <li>
                      <img class="gg" src="~assets/Ballistics.jpg" alt=""><a href="Ballistics.php">彈道學</a>
                    </li>
                    <li>
                      <img class="gg" src="~assets/Guard-tower-research.jpg" alt=""><a href="Guard_Tower.php">防禦箭塔</a>
                    </li>
                    <li>
                    ...
                    <li>
                      <img class="gg" src="~assets/Treadmillcrane.jpg" alt=""><a href="Treadmill_Crane.php">滑輪起重機</a>
                    </li>
                  </ul>
                </div>
              </div>
