    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <div class="spw">
            <em
              ...
              />本條目把學院內的<b>大型箭塔科技</b>與建築的大型箭塔寫在一起了！</em
            >
          </div>
          <p>
            <b>大型箭塔</b>於可於<nuxt-link to="/techs/age/Imperial_Age"
              >帝王時代</nuxt-link
            >在學院研發。大型箭塔可有效對付<nuxt-link to="/units/Infantry_Units"
              >步兵</nuxt-link
        ...
        <div class="n1">
          ...
          <p>
            駐紮<nuxt-link to="/units/Archer_Units">弓箭手</nuxt-link
          ...
          <p>
            ...
            >無法輕易從遠距離摧毀<nuxt-link to="/civs/Koreans">韓國人</nuxt-link
            >的箭塔。
          </p>
        </div>
        <h3>擁有文明</h3>
          ...
          <ul>
            <li>
              駱駝騎兵從<nuxt-link to="/armor/Armor_Class_Ship"
                >船艦護甲</nuxt-link
              >分類中移除，所以箭塔對他們的攻擊加成也移除，現在<nuxt-link
                to="/building/Keep"
                >大型箭塔</nuxt-link
              >對他們的攻擊是+1。
            </li>
            ...
            <li>
              ...
              >攻擊+6。在4.8版<nuxt-link to="/techs/Arrowslits"
                >箭狹槽</nuxt-link
              >只給<nuxt-link to="/building/Keep">大型箭塔</nuxt-link>攻擊+3。
            </li>
            <li>
        ...
        <div class="row">
          <div class="col-md-4">
            ...
            <div class="lightbox-caption" style="width:220px">
              <p>
                <em
                  >所有的大型箭塔(<nuxt-link to="/games/aok">帝王世紀</nuxt-link
          ...
          <div class="col-md-4">
            ...
            <div class="lightbox-caption" style="width:185px">
              <p>
                <em
                  >現實生活中在<nuxt-link to="/civs/Franks">法國</nuxt-link
                  >的木造大型箭塔(來源:維基百科)。</em
                >
              </p>
            </div>
