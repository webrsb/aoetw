    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          ...
          <p>
            火砲塔於可於<nuxt-link to="/techs/age/Imperial_Age"
              >帝王時代</nuxt-link
            >在<nuxt-link to="/building/University">學院</nuxt-link
            >研發。火砲塔具有非常高的攻擊力；但是投射的速度極慢。
          </p>
        </div>
        <h3>戰術</h3>
        <div class="hrn1"></div>
        <div class="n1">
          ...
          <p>
            火砲塔應放置在狹窄處或敵方不易進攻的位置(如懸崖或森林後面)，或是在塔的附近直接用牆圍住方可發揮最大效用。也可放置在<nuxt-link
              to="/building/Castle"
              >城堡</nuxt-link
            >/箭塔的射程範圍內給予交叉火力掩護。另外使用牆壁和城門將在一定程度上保護他們遠離衝撞車的攻擊。在海島的地圖上，在海岸線附近設置幾個火砲塔是一個明智的主意，消滅敵方艦隊同時為靠近海岸的玩家自己的艦隊提供一些火力支援。
          </p>
          <p>
          ...
          <p>
            ...
            >/土耳其<nuxt-link to="/units/Bombard_Cannon">火砲</nuxt-link
            >所威脅。
          </p>
        </div>
        <h3>文明可研發與否</h3>
        ...
        <div class="n1">
          ...
          <ul>
            <li>
              中國新科技：<nuxt-link to="/techs/Great_Wall">長城</nuxt-link>。
            </li>
            <li>韓國蓋火砲塔速度快33％。</li>
          </ul>
          <h3>
          ...
          <ul>
            <li>
              <nuxt-link to="/units/Camel">駱駝</nuxt-link>被移出<nuxt-link
                ...
                >船類</nuxt-link
              >的防禦，因此火砲塔對駱駝只有+1額外攻擊。
            </li>
            <li>
              葡萄牙的<nuxt-link to="/techs/Arquebus">火繩槍</nuxt-link
              >：火砲塔射彈速度+0.5。
            </li>
          </ul>
          <h3>
        ...
        <div class="n1">
          <ul>
            <li>
              阿茲特克與馬雅並沒有火砲塔，因此在<nuxt-link to="/games/aoc"
                >征服者入侵</nuxt-link
              >的版本中，在地圖編輯器中使用這兩個文明蓋火砲塔會變成與條頓相同的中歐風格。而到了
        ...
        <div class="n1">
          <div class="col-md-12">
            <div class="col-md-4">
              <nuxt-link to="/img/Bombardtoweraok.png"
                ><img class="imgn hg" src="~assets/Bombardtoweraok.png" alt=""
              /></nuxt-link>
              <p><em>帝王世紀的所有火砲塔風格。</em></p>
            </div>
            <div class="col-md-4">
              <nuxt-link to="/img/Bombardtowerhd.png"
                ><img class="imgn hg" src="~assets/Bombardtowerhd.png" alt=""
              /></nuxt-link>
        ...
        <div class="n1">
          <div class="col-md-12">
            到了中世紀末，大砲等火藥單位的出現改變了軍事防禦，使得城堡變得非常脆弱，它們高聳垂直的城牆，容易變成大砲狙擊的目標，而軍事工程師們開始構想建造如何不易被大砲攻擊的建築，他們在重要的渡口與其他戰略地點，於建築中安裝了大砲，以增加防禦。
          </div>
        </div>
      </div>
      <div class="col-md-4">
