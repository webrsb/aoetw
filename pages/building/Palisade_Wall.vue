  ...
  <div class="container">
    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            木牆，或稱木柵欄。在世紀帝國是一種防禦建設，雖然廉價但相當脆弱，常用於早期防禦上。木牆可以說是世紀帝國相當重要的建築，木牆不只可以防禦，還可以進攻，如在箭塔下蓋木牆可以形成免費的垛孔與安全的保護，也可以圍對方資源等。
          </p>
        </div>
        <h3>戰術</h3>
        <div class="hrn1"></div>
        <div class="row">
          <div class="col-md-12">
            <div class="n1">
              ...
              <li>
                當對手主要使用近戰單位或軍隊主要由遠程單位組成時，木牆也可以有很大的幫助。一些木牆可以阻擋和分散敵人砲火，在戰鬥中爭取決定性的數秒。
              </li>
              <li>
                木牆絕對是遊戲最偉大的建築之一，他在初期的防禦與拖延對手的進攻相當重要，如果一位玩家懂得圍牆，那實力將上升不少。木牆相當的便宜，且建築時間也短。如果常看高手的對戰紀錄，那將會發現圍牆的奧妙之處，頂尖玩家們將圍牆蓋得出神入化。
              </li>
              <li>
                木牆的作用非常多，除了最主要的功能阻止敵人進攻外，還可以圍住對方的資源，塔攻時把木牆蓋在箭塔下，阻止對方村民來拆塔，形成一個人工的垛牆。
              </li>
            </div>
          </div>
        </div>
        ...
        <div class="n1">
          <ul>
            <li>
              ...
              >：木牆在黑暗/封建/城堡/帝王時代多10%/20%/30%/40%的血量。
            </li>
            <li>
              <nuxt-link to="/civs/Chinese">中國</nuxt-link
              >：對木牆有利的技術在城堡/帝王時代價格便宜15％/20％。
            </li>
            <li>
        ...
        <div class="n1">
          <p>
            在黑暗時代，野蠻人部落因為被東方的其他部落驅趕而流離失所，輾轉在歐洲遷徙尋找土地定居。同時有很多的不法之徒四處搜刮掠奪村莊。在這些動蕩的時期，防禦性的預防措施是必要的。村莊用柵欄-用木頭建造的牆壁築起防禦設施。雖然可以建造石牆，但是木材多且易於使用，並且可以提供一小段建造石牆需要的時間。在
        ...
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style="background-color:#3c763d;;">
              <div class="unititle"><nuxt-link to="">木牆</nuxt-link></div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
