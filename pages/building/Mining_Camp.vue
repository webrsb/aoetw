  ...
  <div class="container">
    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          <p>
            中世紀的採礦十分興盛，特別是鐵，鹽，銅，錫，金，煤和銀的開採。火藥的發明大大增加了對硫磺和硝酸鹽的需求。到了公元500年，地表礦脈已經非常罕見，所以人們必須進入地下找尋新的來源。提高採礦效率和安全性促成許多重要技術的改進和發明。早期將礦車拉出礦坑的電車就是未來鐵路的前身。需要更強大的礦井泵來排出水並推動新鮮空氣後來成為了蒸汽機發明的契機。
          </p>
        </div>
      </div>
      <div class="col-md-4">
      ...
      <div class="col-md-12">
        ...
        <div class="n1">
          <div class="col-md-4">
            <a target="_blank" href="/img/Miningcampaokaoc.jpg"
              ><img
                class="imgn hg"
                width="180"
          ...
          <div class="col-md-4">
            <a target="_blank" href="/img/Mining_camp_hd.jpg"
              ><img
                class="imgn hg"
                width="200"
            ...
            /></a>
            <div class="lightbox-caption" style="width:220px">
              <p><em>所有文明的採礦營地(HD擴充資料片)。</em></p>
            </div>
          </div>
          <div class="col-md-4">
            <a target="_blank" href="/img/Spritesheet_mining_camp.png"
              ><img
                class="imgn hg"
                width="200"
                src="~assets/Spritesheet_mining_camp.png"
                alt=""
            /></a>
            <div class="lightbox-caption" style="width:220px">
              <p>
