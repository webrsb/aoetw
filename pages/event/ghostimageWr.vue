<template>
  <div class="container">
    ...
    <div class="d-flex justify-content-center">
      <div class="card" style="width: 70%;">
        <img
          id="card_picurl"
          class="card-img-top"
          src="https://imgur.com/qT99Yl7.jpg"
          alt="Card image cap"
        />
        <div class="card-body">
          <h5 id="card_title" class="card-title font-weight-bold">
            今日開服 | 開局你要選哪根塔？
          </h5>
    ...
    <div class="mb-12">
      <h3>主辦單位的話</h3>
      <p>
        幹一個比賽12個獎項，結果8個人投稿11張圖，這跟我們這邊的里長一人參選有什麼不同?還準時一開票就放鞭炮慶祝當選，不過還是依然感謝參加的人，以下公布得獎名單。
      </p>
    </div>
    <div class="col-md-12">
      <h3>鐵野豬獎</h3>
    ...
    <div class="col-md-12">
      ...
      <div style="font-size: 18px; color: #dc3545; font-weight: bold;">
        媽的啥時世紀帝國變成這麼噁心的戀愛養成遊戲了，不過這女的，我可以。不但可以陪你到齊農，你願意和我一起去韓總的愛情摩天輪嗎?
      </div>
    </div>
    <div class="col-md-12">
      <h3>宗教狂熱獎</h3>
