        ...
        <div class="col-md-4 ititle2">
          <div class="nw">
            ...
            <ul>
              ...
              <li>
                2018年9月7日:5.8改版上線，<a href="ver5-8.php">改版內容</a>
              </li>
              <li>新增<a href="http://aoetw.com/save/">記錄檔上傳區</a></li>
              <li>
                2018年1月25日:5.7改版上線，<a href="ver5-7.php">改版內容</a>
              </li>
            </ul>
          </div>
        </div>
            ...
            <div class="row" style="">
              <div class="col-md-8">
                <ul style="text-align:left;">
                  ...
                  <li>
                    <a href="Trade_Cog.php">哪一個單位</a
                    >是遊戲中移動速度最快的單位？
                  </li>
                  <li>
                    獨輪推車<a href="Wheelbarrow.php">最佳研發時機</a>怎麼看？
                  </li>
                </ul>
                <br />
