      ...
      <div class="row">
        ...
        >
         ...
         <div
          ...
          style="text-align: center;"
        >
        <a href="https://aoe2techtree.net/?lng=tw" target="_blank"><img
              width="100"
              src="~assets/u11.png"
              alt="科技樹查詢"
              class="img-circle"
         /></a>
          <h3><a href="https://aoe2techtree.net/?lng=tw" target="_blank">科技樹查詢</a></h3>
      </div>
        <div
          class="col-sm-4 col-md-3 col-xs-6 ititle"
          style="text-align: center;"
        ...
        <div
          ...
          style="text-align: center;"
        >
          <a href="https://www.ageofempires.com/games/aoeiide/" target="_blank"><img
              width="100"
              src="~assets/u12.png"
              alt="官方網站"
              class="img-circle"
          /></a>
          <h3><a href="https://www.ageofempires.com/games/aoeiide/" target="_blank">官方網站</a></h3>
        </div>
      </div>
            ...
            <div class="row">
              <div class="col-md-8">
                <ul style="text-align:left;">
                  ...
                  <li>
                    輪軸技術<nuxt-link to="/techs/Wheelbarrow"
                      >最佳研發時機</nuxt-link
                    >怎麼看？
                  </li>
                </ul>
