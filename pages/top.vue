      ...
      <div class="row" style="margin-top: 10px;border-top: 1px solid #c7c7c7;">
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
          <table class="table">
            ...
            <tr>
              <td>
                新崛起的天才玩家，控兵能力令人嘆為觀止，在許多比賽拿到僅次於
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
          <table class="table">
            ...
            <tr>
              <td>
                遊戲知識豐富，對新穎的戰術很有想法，擅長隨機地圖。負責進貢時能為團隊做好非常多小細節。
              </td>
            </tr>
            <tr>
              <td>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
          <table class="table">
            ...
            <tr>
              <td>
                初期經濟配置堪稱完美，能活用門牆房舍極短時間圍住想圍的地方。團戰單挑均強，但比賽容易失常。
              </td>
            </tr>
            <tr>
              <td>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
          <table class="table">
            ...
            <tr>
              <td>
                曾以與 Liereyy
                的絕佳配合聞名，風格偏向圍家後主要打城堡時代。因為一些衝突而對世紀失去熱情。
              </td>
            </tr>
            <tr>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
          <table class="table">
            ...
            <tr>
              <td>
                早期精通阿拉伯匈人，攻勢凌厲，肉馬與弓兵的控制都很驚人。2015突然開竅一個月內爆增五百分打上單挑榜第一。
              </td>
            </tr>
            <tr>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
          <table class="table">
            ...
            <tr>
              <td>
                團戰經驗豐富，擅長後期的指揮調度與戰鬥。在中國辦比賽、直播推廣、架設VooblyCN等貢獻良多。
              </td>
            </tr>
            <tr>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
          <table class="table">
            ...
            <tr>
              <td>阿拉伯大師賽冠軍、MoMR亞軍、淘汰計劃亞軍、4v4三季</td>
            </tr>
          </table>
        </div>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
          <table class="table">
            ...
            <tr>
              <td>
                比 Tim 圍得更兇，擅常圍城，僧投控制佳。團戰發揮穩定，與 Tim
                有良好配合。
              </td>
            </tr>
            <tr>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
          <table class="table">
            ...
            <tr>
              <td>
                TAC季軍、KotD1擊敗Yo、MoA5季軍、AD13季軍、TMW亞軍、NC17冠軍
              </td>
            </tr>
          </table>
        </div>
