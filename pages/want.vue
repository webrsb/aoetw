    ...
    <div class="row padtop">
      <div class="col-md-12">
        ...
        <div class="col-md-12">
          ...
          <div class="hrn1"></div>
          <div>
            所以，現在問題來了，眠先生需要一個團隊，來一起編輯這個網站，主要是世紀帝國II百科區的數據，版型我都已經設計好了，團隊的夥伴只需要幫忙帶入翻譯帶入英文數據即可，不需要什麼英文基礎，主要需要一些網頁人才，只要你具備下面其中一點，都歡迎加入：
            <ol>
              <li>
                <strong>最基礎的html+css</strong
                >：其實只要懂html就好，網頁以Bootstrap框架寫的，懂一點更好
              </li>
              <li>
                <strong>熱誠的心</strong>：看不懂html，但只要有心也歡迎報名。
              </li>
            </ol>
            更歡迎其他更強懂php及有開發協作網站經驗的高手加入，畢竟眠先生只是前端，後端等複雜優化網站的東西仍不太熟悉
          </div>
          <h1>作法</h1>
          <div class="hrn1"></div>
          <div>
            首要是翻譯各兵種數據，而兵種頁面我已經設計好，協做者只需要帶入數據即可，首要以數據優先，介紹那邊可以先空著，目前想法一人認領一個建築，例如我認領射箭場，我就負責寫弓兵、弩兵、強弩兵..火槍茅兵等等的頁面
          </div>
          <h1>報名</h1>
          <div class="hrn1"></div>
          <div>
