  ...
  <div class="container">
    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            騎兵鎖甲可於<a href="/techsage/Castle_Age">城堡時代</a>在<a
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="n1">
              ...
              <a href="/civs/Incas">印加</a>、 <a href="/civs/Malay">馬來</a>、
        ...
        <div class="n1">
          <em
            >"連接金屬鏈製成的盔甲是金屬鱗甲的改進版本。它有更好的一致性，並在受到損害時仍舊對士兵有良好保護。造受撞擊後鱗片可能會鬆動，但鎖甲基本會保持不變。
            由於鏈條比金屬鱗片更小更輕，讓鎖甲穿起來更加靈活且舒適。"</em
          >
        </div>
      </div>
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style=" background-color:#31b0d5;">
              <div class="unititle"><a href="#">騎兵鎖甲</a></div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
