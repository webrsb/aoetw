  ...
  <div class="container">
    ...
    <div class="row" style=" margin-top: 50px;">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            象牙劍是高棉的特殊科技，可於城堡時代在城堡研發。研發後矛象伕+3攻擊。
          </p>
        </div>
        <h3>戰術要點</h3>
        <div class="hrn1"></div>
        <div class="n1">
          <ul>
            <li>
              高棉的大象在象牙劍的加乘下變得除了有速度且更具殺傷力。高棉的還有全滿的兵工廠科技、血統和畜牧培育可以加在大象身上。如果玩家在初期想以矛象伕作為城堡時代的主要單位，象牙劍也許可以比鍛造技術優先研發。但在一般情況下應該將其看作一項兵工廠技術並在鍛造和鼓風爐研發後再研發象牙劍。
            </li>
          </ul>
        </div>
        <h3>團隊加成</h3>
