  ...
  <div class="container">
    ...
    <div class="row" style=" margin-top: 50px;">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            宗教狂熱可於<a href="Castle_Age.php">城堡時代</a>在<a
              href="Monastery.php"
              >修道院</a
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="n1">
              ...
              <a href="Incas.php">印加</a>、 <a href="Malay.php">馬來</a>、
        ...
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style=" background-color:#31b0d5;">
              <div class="unititle"><a href="">宗教狂熱</a></div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/Fervor.jpg" width="45" alt="" />
              </div>
            </td>
          </tr>
          <tr>
