      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            ...
            >研發。研發後跟柏柏同盟的<nuxt-link to="/civs">文明</nuxt-link
            >的城堡工作速率快25%。(<nuxt-link to="/elements/Team_Bonus"
              >團隊加分</nuxt-link
            >)
          </p>
        </div>
        ...
        <div class="n1">
          <ul>
            <li>
              聚居堡壘是柏柏玩家在上城堡時代後最需要研發的<nuxt-link to="/techs"
                >科技</nuxt-link
            ...
            <li>
              另外一個有趣的點是如果同盟中有兩個以上的柏柏玩家研發聚居堡壘效果是會疊加的。這讓生產大量的巨型投石機、炸藥桶和特殊單位變得相當有效率。甚至可讓研發<nuxt-link
