  ...
  <div class="container">
    ...
    <div class="row" style=" margin-top: 50px;">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            游牧是<a href="Mongols.php">蒙古</a>的特殊科技，可於<a
              href="Castle_Age.php"
              >城堡時代</a
            >在 <a href="Castle.php">城堡</a>研發。研發後<a href="House.php"
              >居住房舍</a
            >(或是蒙古包)被摧毀後人口上限數不會下降。<a href="Castle.php"
              >城堡</a
            >和
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              研發游牧後也可以自行摧毀房屋來增加<a href="Trade_Cart.php"
                >貿易馬車</a
              >的效率，減少路程。但要注意是有沒有敵軍在房屋後面乘虛而入。
            </li>
            <li>
              從版本5.5開始即使只蓋一半的房屋也適用游牧的加成，這個小漏洞讓玩家可以最小的木材花費快速增加人口空間。
            </li>
          </ul>
        </div>
        <h3>團隊加成</h3>
