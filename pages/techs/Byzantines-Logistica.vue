  ...
  <div class="container">
    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            後勤學是拜占庭的特殊科技，可於帝王時代在城堡研發。研發後聖騎兵有0.5格的踐踏傷害(額外+5攻擊)，對步兵攻擊+6。
          </p>
        </div>
        <h3>戰術要點</h3>
        <div class="hrn1"></div>
        <div class="n1">
          <ul>
            <li>
              有後勤學的拜占庭聖騎兵更能屠殺步兵單位，踐踏傷害則能有效對付一群步兵或是近戰單位。然而戟兵對聖騎兵仍舊是個威脅，應盡量避免與一大群的戟兵正面交鋒。
            </li>
            <li>
              後勤學並沒有加成在有拜占庭聖騎兵外表的英雄身上，如:阿提拉和貝里薩留
            </li>
          </ul>
        </div>
        <h3>團隊加成</h3>
