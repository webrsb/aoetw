  ...
  <div class="container">
    ...
    <div class="row" style=" margin-top: 50px;">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            擲矛器是阿茲特克的特殊科技，可於<a href="Castle_Age.php">城堡時代</a
        ...
        <div class="n1">
          <p>
            擲矛器是一個經典的Nahuatl詞語，字義為投擲器，基本上是一端帶有尖角的棍子。這種裝置被用來伸展士兵的手臂，從而以更大的動力投擲矛或飛鏢。阿茲特克戰士廣泛使用了擲矛器並且有效射程超過100米。
          </p>
        </div>
      </div>
      <div class="col-md-4">
