<template>
    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <table class="table" style="margin-top:50px;">
          <tr>
            <td class="trm not" style="border-top: none;" colspan="6"> <a href="Stable.php"><img class="ng" src="~assets/Stableicon.png" alt=""></a> 
    ...
    <tr>
      ...
      <td class="t13 trm">
        <img class="gg" src="~assets/PlumedArcherIcon.jpg" width="30" alt="">
