  ...
  <div class="container">
    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            造船匠於<a href="Imperial_Age.php">帝王時代</a>在<a href="Dock.php"
              >碼頭</a
            >
            研發。研發後船隻木材花費-20%，
            <a href="Naval_Vessels.php">所有船隻</a>的訓練速度快35%。
          </p>
        </div>
        <h3>文明可研發與否</h3>
        <div class="hrn1"></div>
        <div class="row">
          <div class="col-md-12">
            <div class="n1">
              ...
              <a href="Goths.php">哥德</a>、 <a href="Incas.php">印加</a>、
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="n1">
              ...
              <a href="Indians.php">印度</a>、 <a href="Malians.php">馬利</a>、
        ...
        <div class="n1">
          <p>
            建造和設計船隻的人被稱為造船匞。
            隨著對海上貿易和戰艦的需求增加，造船匞對沿海社區的價值也隨之增加。專業的造船匞可以用更低的成本建造更堅固的船隻。
          </p>
        </div>
      </div>
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style=" background-color:#31b0d5;">
              <div class="unititle"><a href="">造船匠</a></div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
