  ...
  <div class="container">
    ...
    <div class="row" style=" margin-top: 50px;">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            聖潔虔誠可於<a href="Castle_Age.php">城堡時代</a>在<a
              href="Monastery.php"
              >修道院</a
            >
            研發，可讓 <a href="Monk.php">僧侶</a>和<a href="Missionary.php"
              >傳教士</a
            >提升15 HP
          </p>
          <p>
            雖然遊戲內的解釋是增加50% HP，但實際上只增加15HP，<a
              href="Aztecs.php"
              >阿茲特克</a
            >和<a href="Spanish.php">西班牙</a>文明對僧侶和傳教士的加成也不影響
          </p>
          <p>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="n1">
              ...
              <a href="Berbers.php">柏柏</a>、 <a href="Mongols.php">蒙古</a>、
              <a href="Persians.php">波斯</a>、 <a href="Vikings.php">維京</a>。
            </div>
          </div>
        </div>
        <h3>文明加成</h3>
        ...
        <div class="n1">
          <p>
            實現聖潔就是要達到聖潔的生活和品格。中世紀偉大宗教的聖人通過服從神聖的文本，他們的貧窮誓言和對所有生物的尊重來爭取神聖。通過聖潔，他們啟發了其他宗教或那些不那麼忠誠的人來遵守聖潔虔誠。
          </p>
        </div>
      </div>
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style=" background-color:#31b0d5;">
              <div class="unititle"><a href="">聖潔虔誠</a></div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
