  ...
  <div class="container">
    <div class="row padtop">
      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          <em
            >"大型雙人鋸可讓兩名男子一起工作，砍下一棵樹，提高他們的生產力。第一名男子用雙手將鋸子拉向他。第二個人休息，但雙手放在鋸上。第一個男人完成動作動時，換第二個男人把鋸子拉回來，第一個人休息。雙人鋸藉由每次往復切割，並有大顆的鋸齒和更深的鋸痕，能在很短的時間內砍下樹木。由於每個操作員在拉動時都可以使用兩隻手，因此可以處理更大尺寸的樹木並輕易地拉動鋸子。"</em
          >
        </div>
      </div>
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/two-man_saw.png" class="img-fluid" alt="" />
              </div>
            </td>
          </tr>
          <tr>
