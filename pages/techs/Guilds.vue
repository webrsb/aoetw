  ...
  <div class="container">
    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            行會制度在<a href="Imperial_Age.php">帝王時代</a>在<a
              href="Market.php"
              >市集</a
            >研發。
          </p>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="n1">
              ...
              <a href="Mongols.php">蒙古</a>、 <a href="Khmer.php">高棉</a>、
        ...
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style=" background-color:#31b0d5;">
              <div class="unititle"><a href="">行會制度</a></div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/Guilds.jpg" width="45" alt="" />
              </div>
            </td>
          </tr>
          <tr>
