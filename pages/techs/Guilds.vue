  ...
  <div class="container">
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            <b>公會制度</b>(2013版稱<b>行會制度</b>)在<nuxt-link
              to="/techs/age/Imperial_Age"
              >帝王時代</nuxt-link
            >在<nuxt-link to="/building/Market">市集</nuxt-link>研發。
          </p>
          研究完成後，將<nuxt-link to="/building/Market">市集</nuxt-link
        ...
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style="background-color:#31b0d5;">
              <div class="unititle2">公會制度</div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/guilds.png" class="img-fluid" alt="" />
              </div>
            </td>
          </tr>
          <tr>
