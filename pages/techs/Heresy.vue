      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            ...
            >研發後可讓被敵方<nuxt-link to="/units/Monk">僧侶</nuxt-link
            ...
            >則直接毀壞。如果對手出了很多<nuxt-link to="/units/Monk"
              >僧侶</nuxt-link
            >，那麼異端就是必須研發的科技，即使這個<nuxt-link to="/techs"
              >科技</nuxt-link
            >非常的昂貴。
          </p>
          <p>騎馬狀態的保加利亞騎兵受異端邪說影響若被敵方僧侶招降時會死亡，但隨後會變成沒有騎馬的步兵狀態，控制權仍屬於原本的玩家而非敵方</p>
        </div>
        <h3>文明可研發與否</h3>
        <div class="hrn1"></div>
        <div class="row">
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/Heresy.png" class="img-fluid" alt="" />
              </div>
            </td>
          </tr>
          <tr>
