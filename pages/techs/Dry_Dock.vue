  ...
  <div class="container">
    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            旱碼頭是於帝王時代在<a href="Dock.php">碼頭</a>研發。研發後<a
              href="Naval_Vessels.php"
              >所有船隻</a
            >速度增加15％，
            <a href="Transport_Ship.php">運輸船</a
            >的容量增加10（共乘載20人）。旱碼頭不會提高<a href="Trade_Cog.php"
              >貿易商旅</a
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="n1">
              ...
              <a href="Vikings.php">維京</a>。 <a href="Khmer.php">高棉</a>、
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="n1">
              ...
              <a href="Goths.php">哥德</a>、 <a href="Mongols.php">蒙古</a>、
        ...
        <div class="n1">
          <ul>
            <li>
              <a href="Chinese.php">中國</a>：傾側維修術在帝王時代成本便宜20%。
            </li>
        ...
        <div class="n1">
          <p>
            需要大規模修理的船舶會駛入一個新的結構稱為旱碼頭。旱碼頭可以將水從空間中抽出創造乾燥的空間讓工人可從各個方向進入維修船隻。
          </p>
        </div>
      </div>
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/Drydock.jpg" width="45" alt="" />
              </div>
            </td>
          </tr>
          <tr>
