  ...
  <div class="container">
    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            弓兵皮甲可於<nuxt-link to="/techsage/Castle_Age">城堡時代</nuxt-link
        ...
        <div class="n1">
          <p>
            輕型部隊的布甲是在布料填充物上加了一層外層皮革。皮革輕盈有彈性，但提供了比簡單布料更多的保護。
          </p>
        </div>
      </div>
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style=" background-color:#31b0d5;">
              <div class="unititle"><nuxt-link to="#">弓兵皮甲</nuxt-link></div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
          ...
          <tr>
            ...
            <td class="unit4">
              <img
                ...
                alt=""
              /><nuxt-link to="/techs/Leather_Archer_Armor">弓兵布甲</nuxt-link>
            </td>
          </tr>
          <tr>
