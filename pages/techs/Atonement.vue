  ...
  <div class="container">
    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            贖罪可於<a href="Castle_Age.php">城堡時代</a>在<a
              href="Monastery.php"
              >修道院</a
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="n1">
              ...
              <a href="Huns.php">匈奴</a>、 <a href="Italians.php">義大利</a>、
              <a href="Japanese.php">日本</a>、 <a href="Malay.php">馬來</a>、
        ...
        <div class="n1">
          <p>
            一些最成功的宗教在他們全能的神與地球上的普通男人和女人之間達成了贖罪或和解。這是加強信徒的信仰並吸引信徒的重點。
          </p>
        </div>
      </div>
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style=" background-color:#31b0d5;">
              <div class="unititle"><a href="">贖罪</a></div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/Atonement.jpg" width="45" alt="" />
              </div>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit4">
              <a href="Monk.php">僧侶</a>和<a href="Missionary.php">傳教士</a
              >可招降敵方的僧侶和傳教士
            </td>
          </tr>
        </table>
