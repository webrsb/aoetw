  ...
  <div class="container">
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            <b>贖罪思想</b>(2013版稱<b>贖罪</b>)可於<nuxt-link
...
<nuxt-link to="/civs/Persians">波斯</nuxt-link>。
        ...
        <div class="n1">
          <ul>
            <li>
              <nuxt-link to="/civs/Lithuanians">立陶宛</nuxt-link>：贖罪思想研發速度快20。
            </li>
          </ul>
        </div>
        <h3>歷史</h3>
        ...
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style="background-color:#31b0d5;">
              <div class="unititle2">贖罪思想</div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/atonement.png" class="img-fluid" alt="" />
              </div>
            </td>
          </tr>
          <tr>
