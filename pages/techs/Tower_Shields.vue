      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              這項科技本身就像<nuxt-link to="/building/Blacksmith"
                >兵工廠</nuxt-link
              >的科技，但考慮到其成本，<nuxt-link to="/techs/Ring_Archer_Armor"
                >弓兵鏈甲</nuxt-link
              >要優先研究，因為該科技能為戰矛兵增加更多的近防和遠防，同時只少花費50<nuxt-link
                to="/resource/Gold"
                >黃金</nuxt-link
              >和節省大量<nuxt-link to="/resource/Food">食物</nuxt-link>
            </li>
            <li>
              ...
              >，所以相比擁有步兵板甲的文明，立陶宛戟兵的近防會少1。即使在長槍兵系速度提高的文明加成下，雖然遠程方面彌補了沒有步兵板甲的缺陷，和有步兵板甲文明相比也不會佔有明顯優勢。
                        ...
                        <li>故這項科技主要是搭配立陶宛的槍矛速度加成特性，能夠更快地攔截敵方的騎兵和弓兵單位。
            </li>
          </ul>
        </div>
        <h3>團隊加分</h3>
        ...
        <div class="n1">
          ...
          <ul>
            <li>
              最初塔盾可以讓槍兵系和矛兵系的遠程護甲+1。
            </li>
                        <li>
              更新檔36906實裝後，讓槍兵系和矛兵系的遠程護甲+2。
            </li>
