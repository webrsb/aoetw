  ...
  <div class="container">
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            <b>塔盾</b>是<nuxt-link to="/civs/Lithuanians">立陶宛</nuxt-link
        ...
        <div class="n1">
          <ul>
            <li>
              立陶宛没有<nuxt-link to="/techs/Plate_Mail_Armor"
                >步兵板甲</nuxt-link
              >，因此塔盾對<nuxt-link to="/units/Spearman">長槍兵</nuxt-link
              >系十分重要。而通過塔盾和其他科技加成，全滿<nuxt-link
            ...
            <li>
              這項科技本身就像<nuxt-link to="/building/Blacksmith">兵工廠</nuxt-link
              >的科技，但考慮到其成本，<nuxt-link to="/techs/Ring_Archer_Armor"
                >弓兵鏈甲</nuxt-link>要優先研究，因為該科技能為戰矛兵增加更多的近防和遠防，同時只少花費50<nuxt-link
                to="/resource/Gold">黃金</nuxt-link>和節省大量<nuxt-link to="/resource/Food">食物</nuxt-link>
            </li>
            <li>
              另外，塔盾不能在垃圾海中取得明顯的優勢。額外的<nuxt-link to="/armor">遠程護甲</nuxt-link>不會
              改變<nuxt-link to="/units/Elite_Skirmisher">戰矛兵</nuxt-link>對敵方戰矛兵的傷害
              （即使沒有塔盾，他們本來的遠程護甲（+8）已經抵消了戰矛兵的基礎傷害（+7），同時額外傷害不受遠程護甲的影響）
              ，同時因為立陶宛<nuxt-link to="/units/Halberdier">戟兵</nuxt-link>没有<nuxt-link to="/techs/Plate_Mail_Armor">步兵板甲</nuxt-link
        ...
        <div class="n1">
          ...
          <ul>
            ...
            <li>
              更新檔36906實裝後，讓槍兵系和矛兵系的遠程護甲+2，食物成本由800下調為500。
            </li>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="unit4">
              <img class="gg" src="~assets/castle.png" alt="" /><nuxt-link
                to="/building/Castle">城堡</nuxt-link>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit4">
              <nuxt-link to="/units/Spearman">長槍兵</nuxt-link>系和<nuxt-link to="/units/Skirmisher">矛兵</nuxt-link
              ><nuxt-link to="/armor">遠程護甲</nuxt-link>+2
            </td>
          </tr>
        </table>
