  ...
  <div class="container">
    <div class="row padtop">
      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          <p>
            倒鉤斧的名字來源於刀片尾端延長的長度，使得刀片比它與柄部的連接長得多。這把斧頭是弗朗西斯卡斧頭的進一步發展，弗朗西斯卡是法蘭克人被稱為法蘭克的原因。倒鉤斧可能會丟出或拿著使用。在法蘭克人發展騎兵之前，他們進行團體戰鬥。當他們接近敵人時，前排隊員會朝敵人投擲斧頭。這些會造成敵人混亂跟一些人員傷亡，並讓他們被困在自己的盾牌後面，動作也變得笨拙。法蘭克人這時會迅速接近並用額外的斧頭或劍擊殺敵人。
          </p>
        </div>
      </div>
      <div class="col-md-4">
