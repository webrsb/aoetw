  ...
  <div class="container">
    <div class="row padtop">
      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          <em
            >"由大型金屬板製成的盔甲是防禦箭矢和手持武器的最佳防御手段。它更強大能吸收更多的衝擊。師傅會使用大片鋼板敲擊出適合佩戴者身體的盔甲。製作板甲成為當時重要的工藝。在意大利製作板甲的專家會接到來自歐洲各地的護甲訂單。戰鬥或錦標賽中的戰利品常包括這些有價值的裝甲。裝甲需要定期上油以防止生鏽，這是騎士在騎士契約中的義務。板甲看起來顯得笨重，但實際上卻非常輕巧，而且設計精良。運動員騎士可以穿著盔甲進行倒立。騎士可以毫不費力地騎馬，而且不需要起重機幫助上馬。"</em
          >
        </div>
      </div>
      <div class="col-md-4">
