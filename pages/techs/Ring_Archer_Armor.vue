  ...
  <div class="container">
    ...
    <div class="row" style=" margin-top: 50px;">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            弓兵環甲可於<a href="Imperial_Age.php">帝王時代</a>在<a
              href="Blacksmith.php"
              >兵工廠</a
            >研發，可讓弓兵護甲+1/+2。
          </p>
        ...
        <div class="n1">
          ...
          <ul>
            <li>
              <a href="Indians.php">印度</a>:無法研發<a
          ...
          <ul>
            <li>
              <a href="Berbers.php">柏柏</a>:一開始無法研發<a
                href="Ring_Archer_Armor.php"
                >弓兵環甲</a
              >，在4.8版後才可以研發。
            </li>
            <li>
              <a href="Indians.php">印度</a>:可以研發<a
                href="Ring_Archer_Armor.php"
                >弓兵環甲</a
              >。
            </li>
        ...
        <div class="n1">
          <p>
            隨著中世紀的發展，輕型部隊更頻繁地被雇用去戰鬥。他們與長槍兵方陣合併編隊並支援它們。弩兵需要靠近敵人才能射擊。在攻擊要塞和城堡時，部隊常會暴露在敵人的炮火射擊下。隨著他們在戰場上更積極地進攻，輕裝部隊穿的盔甲會升級為環甲或瑣甲來保護它們。這是金屬裝甲中最輕，最靈活的裝備，並最大限度地減少了對戰鬥的干擾，同時提供比皮甲更好的保護。
          </p>
        </div>
      </div>
      <div class="col-md-4">
