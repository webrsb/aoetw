        ...
        <div class="n1">
          <p>
            隨著社區的發展，他們需要有更多的軍隊和資源來捍衛自己。<nuxt-link
              to="/techs/Town_Watch"
              >城鎮瞭望</nuxt-link
            >轉型成由當地領主提供的城鎮巡邏隊能提供更多對社區安全的保護。城鎮巡邏的範圍可能遠離社區，直到可能出現敵人的過境點。更遠的巡邏意味著更早的警告和更多時間準備防禦敵人。
          </p>
        </div>
      </div>
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style="background-color:#31b0d5;">
              <div class="unititle2">城鎮巡邏</div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/town_patrol.png" class="img-fluid" alt="" />
              </div>
            </td>
          </tr>
          <tr>
