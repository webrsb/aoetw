      ...
      <div class="col-md-8">
        <div class="n1">
          ...
          <ul>
            ...
            <li>
              最多血匈牙利輕騎兵:蒙古(115 HP，有品種且匈牙利輕騎兵+30% HP)
            </li>
            <li>
              最多血精銳草原騎兵:蒙古(124 HP，有品種且精銳草原騎兵+30% HP)
            </li>
            <li>
              最多血重裝駱駝騎兵:薩拉森(170
              HP，有品種且特殊科技狂熱給予駱駝騎兵+30 HP)
            </li>
            <li>
              最多血重裝馬弓騎兵:土耳其(100
              HP，有品種且特殊科技采邑騎兵給馬弓騎兵單位+20 HP)
            </li>
            <li>
              最多血精銳標槍騎兵:土耳其(95
              HP，有品種且特殊科技采邑騎兵給馬弓騎兵單位+20 HP)
            ...
            <li>
              最多血精銳矛象伕:越南(370 HP，有品種且特殊科技恰特拉傘給矛象伕+50
              HP)
            </li>
          </ul>
        </div>
