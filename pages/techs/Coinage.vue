  ...
  <div class="container">
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            <b>鑄幣術</b>研發後會將<nuxt-link to="/Tribute.php"
              >進貢費</nuxt-link
        ...
        <div class="n1">
          <em
            >在西歐的<nuxt-link to="/techs/age/Dark_Age">黑暗時代</nuxt-link
            >，錢幣是沒有用的，因為野蠻部落基本上是文盲，也沒有可以管理硬幣<nuxt-link
              to="/techs/Iron_Casting"
              >鑄造</nuxt-link
            >的政府組織。而這個時代的羅馬硬幣非常的粗製濫造，通常是用低廉的金屬製成，到了查理慢帝王和其他強大的王國崛起，有了能有效控制鑄幣的穩地政府，可以穩定的提供貨幣供應，對於經濟的發展有巨大的推波助瀾效用，其中最著名的便是歐洲銀幣，大概是現在美元10美分的大小，銅和青銅則是鑄造成更小的面額。</em
          >
        </div>
      </div>
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="unit4">
              將<nuxt-link to="/Tribute.php">進貢費</nuxt-link>降低至20%。
            </td>
          </tr>
        </table>
      </div>
