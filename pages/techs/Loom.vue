  ...
  <div class="container">
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            織布技術可於<nuxt-link to="/techs/age/Dark_Age">黑暗時代</nuxt-link
          ...
          <p>
            但一般來說高手並不會輕易的在早期研發織布技術，因為越晚研發，經濟將會越好，所採集的資源也更多，通常都是點下封建時代前才會研發，不過需要考慮的是打野豬時是否會因為過遠或是網路延遲而死村民，才不會因小失大。
          </p>
        </div>
        <h3>文明加成</h3>
        <div class="hrn1"></div>
        ...
        <div class="n1">
          <p>
            織布機的發明和織布能力是古代重要的技術，並成為歐洲在進入黑暗時期時能迅速恢復文明的重要元素之一。好的羊毛衣服是延長北歐人類壽命的重要資產。人類為了取得羊毛養羊然後製作成布，布業因而成為中世紀早期的重要產業之一。
          </p>
        </div>
      </div>
      <div class="col-md-4">
