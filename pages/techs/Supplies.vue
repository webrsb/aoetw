  ...
  <div class="container">
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            <b>供給</b>於《世紀帝國II:決定版》首次登場，可於<nuxt-link to="/techs/age/Feudal_Age">封建時代</nuxt-link>在
            <nuxt-link to="/building/Barracks">軍營</nuxt-link>研發。研發後民兵系的食物成本會減少15。
          </p>
        </div>
        <h3>文明可研發與否</h3>
        <div class="hrn1"></div>
        ...
        <div class="n1">
          <ul>
            <li>
              <nuxt-link to="/civs/Chinese">中國</nuxt-link>：該科技在封建/城堡/帝王時代
              >花費便宜10%/15%/20%。
            </li>
            <li>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/Suplliesicon.jpg" width="45" alt="" />
              </div>
            </td>
          </tr>
          <tr>
