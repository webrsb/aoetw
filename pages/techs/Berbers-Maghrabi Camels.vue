  ...
  <div class="container">
    ...
    <div class="row" style=" margin-top: 50px;">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            馬格拉比駱駝是柏柏的特殊科技，可於帝王時代在城堡研發。研發後駱駝騎兵/駱駝弓騎兵每分鐘回15
            HP。
          </p>
        </div>
        <h3>戰術要點</h3>
        ...
        <div class="n1">
          <ul>
            <li>
              馬格拉比駱駝的回血機制與狂戰士雷同，可讓駱駝騎兵/駱駝弓騎兵在沒有僧侶支援的情況下在戰場上支撐更久，變得更具有侵略性。但還是建議要在後方配有僧侶治療因為回血速度實在過慢。
            </li>
          </ul>
        </div>
        <h3>文明加成</h3>
        ...
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style=" background-color:#31b0d5;">
              <div class="unititle"><a href="">馬格拉比駱駝</a></div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
