  ...
  <div class="container">
    ...
    <div class="row" style=" margin-top: 50px;">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            騎兵板甲可於<a href="Imperial_Age.php">帝王時代</a>在<a
              href="Blacksmith.php"
              >兵工廠</a
            >研發，可讓騎兵護甲+1/+2。。
          </p>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="n1">
              ...
              <a href="Chinese.php">中國</a>、 <a href="Franks.php">法蘭克</a>、
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="n1">
              ...
              <a href="Mongols.php">蒙古</a>、 <a href="Vikings.php">維京</a>。
            </div>
          </div>
        </div>
        <h3>文明加成</h3>
        ...
        <div class="n1">
          <em
            >"由大型金屬板製成的盔甲是防禦箭矢和武器的最佳防御手段。它更耐衝擊，能吸收更多的能量。大面積的板甲會依馬匹大小製成符合他們的尺寸。"</em
          >
        </div>
      </div>
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style=" background-color:#31b0d5;">
              <div class="unititle"><a href="">騎兵板甲</a></div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
