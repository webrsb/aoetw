  ...
  <div class="container">
    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            垛孔可於<nuxt-link to="/techs/age/Castle_Age">城堡時代</nuxt-link
            >在<nuxt-link to="/building/University">學院</nuxt-link>
            研發。可移除箭塔和城堡的最小射程限制。
          </p>
          <p>
            垛孔於實戰中幾乎不會用，因為可以用交叉火力掩護代替，或是使用近戰單位保護(村民也可)，在城堡或箭塔旁邊蓋牆或其他建築物也可以；另外這100石頭拿去蓋額外的城鎮中心爆經濟會比研發該科技有用的多。
          </p>
        </div>
        <h3>文明加成</h3>
        <div class="hrn1"></div>
        <div class="n1">
          <ul>
            ...
            <li>
              <nuxt-link to="/civs/Teutons">條頓</nuxt-link>：該科技免費。
            </li>
          </ul>
        </div>
        <h3>團隊加成</h3>
        ...
        <div class="n1">
          ...
          <div class="n1">
            <ul>
              ...
              <li>
                就算研發波斯的特殊科技沸油，在沒有垛孔的狀況下，城堡沒有辦法對已經在最小範圍內的衝撞車造成傷害(就不能直接把油潑上去嗎?!)
              </li>
              <li>
                其實這科技名稱完全是弄錯了，原文Murder
                Holes是指建築中的一個洞，可以從那邊丟入沸油等武器攻擊敵人，而不是讓弓箭手可以向下攻擊敵人，這種科技應該名字叫做：Machicolations，中文可能翻譯為：突堞、堞口;
                堞眼。
              </li>
            </ul>
          </div>
          ...
          <div class="n1">
            ...
            <p>
              外架式柵樓是在防御者可以與之戰鬥的城牆和塔樓的頂部建造的防禦工事。他們需要伸出牆壁的垂直平面，以便能夠攻擊牆壁底部的敵人。在外架式柵樓的底部是被稱為垛孔的陷阱門。
              這些可以打開，防御者可以射箭，扔石頭，開水或燒沙直接向下。沒有垛孔，靠牆底部的敵人就會相對安全。
            </p>
          </div>
          <h3>圖庫</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <div class="col-md-12">
              <div class="col-md-4">
                <a target="_blank" href="/img/1024px-Bodiam_murder_holes.jpg"
                  ><img
                    class="imgn hg"
                ...
                <p>
                  <em
                    ...
                    >的垛孔(博丁安堡為遊戲中，不列顛、法蘭克等西歐建築城堡的原形)</em
                  >
                </p>
              </div>
              <div class="col-md-4">
                <a target="_blank" href="/img/Machicolation_Of_Wejter_Tower.jpg"
                  ><img
                    class="imgn hg"
