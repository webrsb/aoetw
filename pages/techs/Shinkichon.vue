  ...
  <div class="container">
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            <b>投擲器</b>(2013版稱<b>神機箭</b>)是<nuxt-link to="/civs/Koreans"
              >朝鮮</nuxt-link
        ...
        <div class="n1">
          <ul>
            <li>
              如果<nuxt-link to="/civs/Koreans">朝鮮</nuxt-link
              >玩家在戰場上使用<nuxt-link to="/units/Mangonel">投石車</nuxt-link
              >那研發投擲器可以讓他們的攻擊範圍勝過幾乎所有的弓兵及大部分的攻程單位。同時他們不會再被<nuxt-link
                to="/units/Galleon"
                >重型弩砲戰船</nuxt-link
              >射爽爽，這在某些海島地圖上非常有價制。研發<nuxt-link
                to="/techs/Siege_Engineers"
                >攻城工程師</nuxt-link
              >後的朝鮮投石車是遊戲中最可怕的<nuxt-link
        ...
        <div class="n1">
          <p>
            ...
            >對火藥的發明有信心，但許多人認為朝鮮的高麗王國是首先使用火箭和火藥作為武器使用。這個時期的編年史者提到高麗火箭和大砲對於他們的軍隊的成功非常重要。高麗和朝鮮王國的長期存在需要強大的軍事力量，因為在它們和一大堆潛在的敵人之間只有大海和阿姆諾克河。
          </p>
        </div>
      </div>
      <div class="col-md-4">
