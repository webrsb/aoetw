  ...
  <div class="container">
    ...
    <div class="row" style=" margin-top: 50px;">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            巨盾是<a href="Italians.php">義大利</a>的特殊科技，可於<a
              href="Castle_Age.php"
              >城堡時代</a
            >在 <a href="Castle.php">城堡</a>研發。研發後徒步<a
        ...
        <div class="n1">
          <ul>
            <li>
              如果玩家依賴弓箭手和<a href="Genoese_Crossbowman.php"
                >熱那亞弩手</a
              >做為進攻/防守的選擇，那麼巨盾要盡早研發。
            </li>
            <li>
              一開始巨盾的護甲加成只有加在熱那亞努手身上，後來在<a href="ak.php"
                >非洲王朝</a
              >資料片中才改成所有徒步弓兵都有加乘。
            </li>
            <li>
              研發巨盾與否取決於資料片版本，如果是<a href="aof.php"
                >失落的王國</a
              >版本，巨盾花費太貴玩家應該優先升級其他科技或是演進至帝王時代。
            </li>
            <li>
              在非洲王池資料片中巨盾的花費減低而且<a href="Crossbowman.php"
                >弩兵</a
        ...
        <div class="n1">
          <h3>
            <em><a href="aof.php">失落的王國</a></em>
          </h3>
          <ul>
            <li>巨盾成本為550肉300金。</li>
            <li>
              巨盾只影響<a href="Genoese_Crossbowman.php">熱那亞弩手</a>。
            </li>
          </ul>
          <h3>
          ...
          <ul>
            ...
            <li>
              巨盾現在會影響不只<a href="Genoese_Crossbowman.php">熱那亞弩手</a
              >以外的所有徒步<a href="Archer_Units.php">弓兵</a>(包括
        ...
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style=" background-color:#31b0d5;">
              <div class="unititle"><a href="">巨盾</a></div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
