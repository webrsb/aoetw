  ...
  <div class="container">
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            <b>手推車</b>可於<nuxt-link to="/techs/age/Castle_Age"
              >城堡時代</nuxt-link
          ...
          <p>
            手推人幾人研發為10大熱門問題之一，根據加拿大高手Chris與中國實況主封心的說法
          </p>
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              ...
              >：研究該科技的時間在<nuxt-link to="/techs/age/Castle_Age"
                >城堡</nuxt-link
              >/帝王時代快15%/20%/。
            </li>
          </ul>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/hand_cart.png" width="45" alt="" />
              </div>
            </td>
          </tr>
          <tr>
