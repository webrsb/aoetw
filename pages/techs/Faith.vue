      ...
      <div class="col-md-8">
        <div class="n1">
          ...
          <p>
            ...
            >不便宜(花金又花食物)，但如果對方是打<nuxt-link to="/units/Monk">僧侶</nuxt-link
            >爆，那就有研發的必要。
          </p>
          <p>
...
<nuxt-link to="/civs/Tatars">韃靼</nuxt-lin>。
        ...
        <div class="n1">
          <ul>
            <li>
              <nuxt-link to="/civs/Lithuanians">立陶宛</nuxt-link>：忠誠信仰研發速度快20%。
            </li>
          </ul>
        </div>
        <h3>更新日誌</h3>
        ...
        <div class="n1">
          ...
          <ul>
            <li><nuxt-link to="/civs/Slavs">斯拉夫</nuxt-link>:無法研發忠誠信仰。</li>
          </ul>
          <h3>
            <em><nuxt-link to="/games/aor">非洲王朝</nuxt-link></em>
          </h3>
          <ul>
            <li><nuxt-link to="/civs/Khmer">高棉</nuxt-link>:無法研發忠誠信仰。</li>
          </ul>
          <h3>
            <em><nuxt-link to="/games/de">決定版</nuxt-link></em>
          </h3>
          <ul>
            <li><nuxt-link to="/civs/Slavs">斯拉夫</nuxt-link>:可以研發忠誠信仰。</li>
            <li><nuxt-link to="/civs/Khmer">高棉</nuxt-link>:可以研發忠誠信仰。</li>
          </ul>
        </div>
        <h3>歷史</h3>
        <div class="hrn1"></div>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="unit4">
              <img class="gg" src="~assets/ImperialageDE.png" alt="" /><nuxt-link
                to="/techs/age/Imperial_Age"
                >帝王時代</nuxt-link
              >
            </td>
