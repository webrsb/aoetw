        ...
        <div class="n1">
          ...
          <ul>
            <li>
              ...
              >(有強力護腕；文明加成讓徒步弓兵於城堡/帝王射程各+1/+2；特殊科技義勇騎兵讓徒步弓兵射程+1)
            </li>
            <li>
              射程最遠矛兵:
              不列顛(有強力護腕；特殊科技義勇騎兵讓徒步弓兵射程+1)；
              <nuxt-link to="/civs/Aztecs">阿茲特克</nuxt-link
              >:(有強力護腕；特殊科技擲矛器讓矛兵系列和標槍騎兵攻擊範圍+1)
            </li>
            <li>
              射程最遠馬弓騎兵:
              <nuxt-link to="/civs/Magyars">馬扎爾</nuxt-link
              >(有強力護腕；特殊科技反曲弓讓馬弓騎兵射程+1。如果同盟有庫曼則也會影響欽察)
            </li>
            <li>
              射程最遠箭塔:
              <nuxt-link to="/civs/Koreans">朝鮮</nuxt-link
              >(有強力護腕；文明加成讓箭塔於城堡/帝王射程各+1/+2)
            </li>
            <li>
              射程最遠火炮塔:
              <nuxt-link to="/civs/Turks">土耳其</nuxt-link
              >(有強力護腕；特殊科技砲兵讓火砲塔、火砲戰船和火砲射程+2)
            </li>
            <li>
              射程最遠城堡:
