  ...
  <div class="container">
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            掠奪者是匈奴的特殊科技，可於城堡時代在城堡研發。研發後韃靼騎兵可在馬廄訓練。因為馬廄比城堡便宜，可在短時間內生產大量的韃靼騎兵。
          </p>
        </div>
        <h3>戰術要點</h3>
        <div class="hrn1"></div>
        <div class="n1">
          <ul>
            <li>
              掠奪者的研發時機十分微妙，因為很少會有需要大量韃靼騎兵上場的時候。只有要攻破敵方城門才有可能，但這樣的數量只要城堡生產就足夠了。除非玩家希望生產更多的韃靼騎兵或是石材存量不足而玩家想在對方城鎮旁邊訓練韃靼騎兵做突襲，才會研發掠奪者。否則大部分情況都不會研發。
            </li>
            <li></li>
          </ul>
        </div>
        ...
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style="background-color:#31b0d5;">
              <div class="unititle"><nuxt-link to="">掠奪者</nuxt-link></div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
