  ...
  <div class="container">
    ...
    <div class="row" style=" margin-top: 50px;">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            礦井採石是<a href="Castle_Age.php">城堡時代</a
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="n1">
              ...
              <a href="Italians.php">義大利</a>、 <a href="Khmer.php">高棉</a>、
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="n1">
              ...
              <a href="Burmese.php">緬甸</a>、 <a href="Franks.php">法蘭克</a>、
              <a href="Huns.php">匈奴</a>、 <a href="Japanese.php">日本</a>、
              <a href="Magyars.php">馬扎爾</a>、
              <a href="Saracens.php">薩拉森</a>、
              <a href="Slavs.php">斯拉夫</a>、 <a href="Turks.php">土耳其</a>、
        ...
        <div class="n1">
          <em
            >"當歐洲城堡正在建設，城鎮正在加固，日益富裕的羅馬天主教會開始建造其大教堂時，對石材的需求迅速增加。石材切割成為重要的貿易
            需要新技術才能獲得理想的石材，因為在某些地區容易得到的地表石材來源正迅速耗盡。"</em
          >
        </div>
      </div>
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style=" background-color:#31b0d5;">
              <div class="unititle"><a href="">礦井採石</a></div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
