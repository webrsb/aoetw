  ...
  <div class="container">
    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            垛口是<nuxt-link to="/civs/Teutons">條頓</nuxt-link
            >的特殊科技，可於<nuxt-link to="/techs/age/Imperial_Age"
              >帝王時代</nuxt-link
            >在
            <nuxt-link to="/building/Castle">城堡</nuxt-link
            >研發。研發後城堡攻擊範圍+3，步兵駐紮可放箭。
          </p>
        </div>
        <h3>戰術要點</h3>
        <div class="hrn1"></div>
        <div class="n1">
          <ul>
            ...
            <li>
              另一方面研發垛口後的條頓城堡，成為唯一不怕火砲攻擊的城堡(土耳其火砲例外)。
            </li>
          </ul>
        </div>
        <h3>團隊加成</h3>
        ...
        <div class="hrn1"></div>
        <div class="n1">
          垛孔已經有幾千年的歷史了，最少的例子是埃及的布恩要塞，已經可以在古老的壁畫中發現。之後希臘的邁錫尼文化也可以一窺究竟，而中國的長城也有。
        </div>
        <h3>圖庫</h3>
        <div class="hrn1"></div>
        <div class="n1">
        ...
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style="background-color:#31b0d5;">
              <div class="unititle"><nuxt-link to="">垛口</nuxt-link></div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
