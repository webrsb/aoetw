  ...
  <div class="container">
    ...
    <div class="row" style=" margin-top: 50px;">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            無政府狀態是<a href="Goths.php">哥德</a>可於<a href="Castle_Age.php"
              >城堡時代</a
            >在 <a href="Castle.php">城堡</a>研發，研發後玩家可以在<a
              href="Barracks.php"
              >軍營</a
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              研發這個科技，代表你可以將城堡投入生產<a href="Trebuchet.php"
                >投石機</a
              >，這比其他依賴城堡生產的特殊單位更有優勢(比方
              <a href="Mayans.php">馬雅</a>的<a href="Plumed_Archer.php"
                >羽毛箭射手</a
              >)。
            </li>
          </ul>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="unit4"><a href="Goths.php">哥德</a></td>
          </tr>
          <tr>
