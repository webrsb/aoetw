  ...
  <div class="container">
    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            雙刃斧是<a href="/techsage/Feudal_Age">封建時代</a
        ...
        <div class="n1">
          <ul>
            <li><a href="/civs/Burmese">緬甸</a>:雙刃斧免費。</li>
            <li>
        ...
        <div class="n1">
          <em
            >"雙刃斧一把大而重而且在兩側都有刀片的斧頭，它加速了砍伐樹木的速度。有了兩個切割邊緣，樵夫可以在刀片變鈍的時候切換，然後休息時同時磨礪兩個刃片。
            樵夫使用雙刃斧後能更快，更高效地工作。"</em
          >
        </div>
      </div>
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style=" background-color:#31b0d5;">
              <div class="unititle"><a href="#">雙刃斧</a></div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
