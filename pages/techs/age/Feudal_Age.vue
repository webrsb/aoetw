          ...
          <div class="n1">
            ...
            <div class="n1">
              ...
              <div class="n1">
                ...
                <p>
                  在達到封建時代的團隊遊戲中，製圖法可讓玩家分享盟友的視線。進貢策略也從封建時代開始，因為可以興建市場並且能夠進貢和交換資源，達到快速進入下個時代用更強大的軍隊和經濟打敗對手。
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="n1">
            <p>
              ...
              >在西元九世紀時創建法蘭西帝國，結束了歐洲的<nuxt-link
                ...
                >黑暗時代</nuxt-link
              >，也是封建時代的開始。大部分被西歐野蠻人部落統治的的地方正慢慢被地方力量收復。羅馬教會正在提供一個統一的社會結構。查理大帝試圖恢復教育，鼓勵藝術發展。然而，他的帝國在他去世後走向頹勢，新的<nuxt-link
                to="/techs/Marauders"
                >掠奪者</nuxt-link
              >破壞了他的大部分建設和制度。政治和經濟權力從國王轉移到統治層級內的地主。普通百姓在這片土地上耕耘，供養著貴族和教士。
            </p>
          </div>
        </div>
      </div>
