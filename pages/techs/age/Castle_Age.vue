        ...
        <div class="col-md-8">
          ...
          <div class="n1"><strong>民用建築</strong>
            ...
            <ul>
              ...
              <li>
                <img class="gg" src="~assets/Stonewallicon.png" width="22" alt=""><a href="Fortified_Wall.php">垛牆</a>：更厚實的城牆</li>
              <li>
          ...
          <div class="n1"><strong><a href="Monastery.php">修道院</a></strong>
            ...
            <ul>
              ...
              <li>
                <img class="gg" src="~assets/PikemanIcon.jpg" width="22" alt=""><a href="Pikeman.php">重裝長槍兵</a>：反騎兵單位。</li>
              <li>
            ...
            <ul>
              ...
              <li>
                <img class="gg" src="~assets/EliteSkirmisherIcon.jpg" width="22" alt=""><a href="Elite_Skirmisher.php">戰矛兵</a>：反弓箭手。</li>
              <li>
                <img class="gg" src="~assets/CavalryArcherIcon.jpg" width="22" alt=""><a href="Cavalry_Archer.php">馬弓騎兵</a>：移動迅速的遠距離單位。</li>
              <li>
                <img class="gg" src="~assets/Slinger_Icon.jpg" width="22" alt=""><a href="Slinger.php">投石手</a>：反步兵單位（<a href="Incas.php">印加</a>限定）</li>
              <li>
            ...
            <ul>
              ...
              <li>
                <img class="gg" src="~assets/KnightIcon.jpg" width="22" alt=""><a href="Knight.php">騎士</a>：重騎兵單位。</li>
              <li>
                <img class="gg" src="~assets/LightCavalryIcon.jpg" width="22" alt=""><a href="Light_Cavalry.php">輕騎兵</a>：快速的偵查單位。</li>
              <li>
            ...
            <ul>
              ...
              <li>
                <img class="gg" src="~assets/MangonelIcon.jpg" width="22" alt=""><a href="Mangonel.php">輕型投石車</a>：可有效打擊對方遠程部隊。</li>
              <li>
                <img class="gg" src="~assets/ScorpionIcon.jpg" width="22" alt=""><a href="Scorpion.php">弩砲</a>：可大規模擊殺步兵。</li>
              <li>
            ...
            <ul>
              ...
              <li>
                <img class="gg" src="~assets/FireShipIcon.jpg" width="22" alt=""><a href="Fire_Ship.php">火戰船</a>：反戰船單位。</li>
              <li>
                <img class="gg" src="~assets/DemoShipIcon.jpg" width="22" alt=""><a href="Demolition_Ship.php">神風船</a>：反火戰船的自殺單位。</li>
              <li>
                <img class="gg" src="~assets/LongboatIcon.jpg" width="22" alt=""><a href="Longboat.php">維京大戰船</a>：可發射多發箭矢。(<a href="Vikings.php">維京</a>限定）</li>
              <li>
                <img class="gg" src="~assets/TurtleShipIcon.jpg" width="22" alt=""><a href="Turtle_Ship.php">龜甲船</a>：發射大砲的重甲船。（<a href="Koreans.php">韓國</a>限定）</li>
              <li>
            ...
            <div class="n1"><strong><a href="Town_Center.php">城鎮中心</a></strong>
              ...
              <ul>
                ...
                <li>
                  <img class="gg" src="~assets/Ballistics.jpg" width="22" alt=""><a href="Ballistics.php">彈道學</a>：提高弓箭手的準確度。</li>
                <li>
                  <img class="gg" src="~assets/Heatedshot.png" width="22" alt=""><a href="Heated_Shot.php">預熱射擊</a>：增加城堡和箭塔對船隻的攻擊。</li>
                <li>
                  <img class="gg" src="~assets/Murderholes.jpg" width="22" alt=""><a href="Murder_Holes.php">垛孔</a>：移除城堡和箭塔的最小射程限制。</li>
                <li>
              ...
              <ul>
                ...
                <li>
                  <img class="gg" src="~assets/Chainmailarmor.jpg" width="22" alt=""><a href="Chain_Mail_Armor.php">步兵鎖甲</a>：增加步兵防禦。</li>
                <li>
                  <img class="gg" src="~assets/Bodkinarrow.jpg" width="22" alt=""><a href="Bodkin_Arrow.php">錐狀箭頭</a>：弓箭手增加攻擊與射程。</li>
                <li>
                  <img class="gg" src="~assets/Leatherarcherarmor.jpg" width="22" alt=""><a href="Leather_Archer_Armor.php">弓兵皮甲</a>：增加弓箭手防禦。</li>
                <li>
              ...
              <ul>
                ...
                <li>
                  <img class="gg" src="~assets/Fervor.jpg" width="22" alt=""><a href="Fervor.php">宗教狂熱</a>：僧侶移動變快。</li>
                <li>
                  <img class="gg" src="~assets/Sanctity.jpg" width="22" alt=""><a href="Sanctity.php">聖潔虔誠</a>：增加僧侶生命值。</li>
                <li>
                  <img class="gg" src="~assets/Atonement.jpg" width="22" alt=""><a href="Atonement.php">贖罪</a>：可以招降對方僧侶。</li>
                <li>
                  <img class="gg" src="~assets/Heresy.png" width="22" alt=""><a href="Heresy.php">異端邪說</a>：被招降的單位立即死亡。</li>
                <li>
