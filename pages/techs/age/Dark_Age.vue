    ...
    <div class="row padtop">
          ...
          <div class="n1">
            ...
            <div class="n1">
              <ul>
                ...
                <li>
                  如果地圖包括捕魚作為食物來源，建造一個碼頭和使用漁船是可行的，因為漁船比村民能更快地收集食物。而且，它讓村民能收集其他資源。此外，建議研發織布技術強化村民，避免村民意外死亡(被狼/豬咬死，被民兵/斥侯騎兵砍死)。
                </li>
                <li>
                  儘管黑暗時代讓所有的玩家幾乎沒有軍事能力，但也可以用民兵和村民快攻敵方玩家。這樣的策略可能是有風險的，因為在遊戲中期投入軍隊的時間和資源可能最後有去無回。但是如果成功，它可以快速結束遊戲。偷豬是另一個很好的策略，讓斥侯騎兵偷走一些野豬，並把它們帶回到玩家的營地。攻擊村民是另一個有用的戰術。
                </li>
              </ul>
            </div>
          </div>
      ...
      <div class="col-md-12">
        ...
        <div class="n1">
          <div class="col-md-12">
            <div class="col-md-4">
              <a target="_blank" href="/img/DarkAge.jpg"
