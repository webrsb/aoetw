  ...
  <div class="container">
    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            前置槍矛為阿拉伯打法之一，此打法給人壓迫異常，但實際上並不常見。
          </p>
          <ul>
            <li>
        ...
        <div class="n1">
          <p>
            前置槍矛為一種極具侵略的打法，流程為正常21～22p上封建，3～4村民前置軍營，上封建後補雙靶場出矛兵，配合槍兵進攻，村民可持續插塔壓迫，也可以稱作槍矛塔，還算能克制傳統的肉馬與小弓開局。
          </p>
          <strong
            ><span
        ...
        <div class="n1">
          <div class="row">
            <div class="col-md-12">
              <p>
                黑快民兵轉裝甲開局能有效防止敵人前置，現今黑快民兵開局的多，因此此打法並不多見。
              </p>
              <p>
