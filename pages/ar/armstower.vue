  ...
  <div class="container">
    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          <p>
            裝甲塔在現今的打法中非常盛行，靠著其兇猛的威力，讓敵人喘不過氣來。國際上的高手Nicov更是裝甲塔的代表。
          </p>
          <strong
            ><span
          ...
          <div>
            <ol>
              ...
              <li>
                對方失誤時:對手打豬死村民或是死斥侯、或是被偷豬，可能導致升級慢，趁勝追擊。
              </li>
          ...
          <ul>
            <p>
              蓋哪裡都可以，主要以建立根據地，可以繼續連環塔下去為主。通常對方是馬國，如馬札爾、蒙古，建議可以蓋在果樹區。如果對方打弓就先封金為主，但最重要的還是哪邊地形好封就插哪。
            </p>
          ...
          <div class="n1">
            <div class="row">
              <div class="col-md-4">
                ...
                <iframe
                  width="100%"
                  src="https://www.youtube.com/embed/j3jh2qZcxEs"
                  frameborder="0"
              ...
              <div class="col-md-4">
                ...
                <iframe
                  width="100%"
                  src="https://www.youtube.com/embed/Eo2qLprhh_0"
                  frameborder="0"
                  allow="autoplay; encrypted-media"
                  allowfullscreen
                ></iframe>
              ...
              <div class="col-md-4">
                ...
                <iframe
                  width="100%"
                  src="https://www.youtube.com/embed/F7Ua17OrIZQ"
                  frameborder="0"
                  allow="autoplay; encrypted-media"
                  allowfullscreen
                ></iframe>
              ...
              <div class="col-md-4">
                ...
                <iframe
                  width="100%"
                  src="https://www.youtube.com/embed/iVWkc_zGeyU"
                  frameborder="0"
                  allow="autoplay; encrypted-media"
                  allowfullscreen
                ></iframe>
              ...
              <div class="col-md-4">
                ...
                <iframe
                  width="100%"
                  src="https://www.youtube.com/embed/jB1v14bwujo"
                  frameborder="0"
                  allow="autoplay; encrypted-media"
                  allowfullscreen
                ></iframe>
              ...
              <div class="col-md-4">
                ...
                <iframe
                  width="100%"
                  src="https://www.youtube.com/embed/ovFVHc7gRVY"
                  frameborder="0"
                  allow="autoplay; encrypted-media"
                  allowfullscreen
                ></iframe>
