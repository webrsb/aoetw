  ...
  <div class="container">
    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          <p>
            裝甲開局非常靈活，上封建可以轉弓兵或斥侯。流程為一般升級22p，點封建後出三隻民兵騷擾對方經濟。可擋對方前置與對方的黑快，運氣好可以抓到對方蓋建築村民，甚至殺到對方村民，有騷擾到的話，即使不死村也會經濟大亂。而上封建後如果民兵沒有耗損太多，可以升級裝甲步兵，搭配後續的弓兵或斥侯進行更進一步的攻擊。
          </p>
        </div>
        <h3>流程</h3>
        <div class="hrn1"></div>
        <div class="n1">
          ...
          <div class="n1">
            <div class="row">
              ...
              <div class="col-md-4">
                <h4>MBL VS Tatho<br />雙方裝甲開局<br /></h4>
                <iframe
                  width="100%"
                  src="https://www.youtube.com/embed/eDgcMrGK2AI?list=PLBSs8pc_eAe6Mf4GRRdY_WtarywcK7zXg"
                  frameborder="0"
                  allow="autoplay; encrypted-media"
                  allowfullscreen
                ></iframe>
              ...
              <div class="col-md-4">
                <h4>Liereyy VS Viper<br />雙方裝甲開局<br /></h4>
                <iframe
                  width="100%"
                  src="https://www.youtube.com/embed/VzTsqhYfqo0"
                  frameborder="0"
                  allow="autoplay; encrypted-media"
                  allowfullscreen
                ></iframe>
