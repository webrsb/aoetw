    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          ...
          <p>
            值得一提在東南亞文明加入前，遊戲中有踐踏傷害效果的有，波斯戰象、拜占庭聖騎兵(要研發後勤學)、斯拉夫步兵(要研發王家侍從)，然而這三個文明在地理上非常靠近。（東南亞矛象伕也有踐踏效果）
            備註：踐踏傷害都是360度全受到傷害
        ...
        <div class="n1">
          <p>
            斯拉夫被稱為小塞爾特人，主要是因為同樣是步兵和攻城器文明但是斯拉夫給的文明加成比較划不來。首先是帝王時代給的王家侍從雖然可以使的斯拉夫劍勇成為遊戲中頂級步兵但因為時代過於遙遠和資源上的調配往往還沒研發就結束遊戲了，攻城器減免15%資源卻沒直接效益(因攻城器本身就很昂貴)，城堡時代的東正教讓他們僧侶有近防/遠防各+3護甲，但因為科技昂貴又要蓋城堡因此CP值上沒很高，特殊兵種貴族鐵騎本身是為了彌補沒有遊俠的斯拉夫也沒很特殊的加成，整體而言斯拉夫有強大步兵，弓箭卻很脆弱沒強弩兵/拇指環/護腕弓兵核心科技，騎兵也無駱駝和遊俠，僧侶雖然有東正教護甲但因前置條件太過嚴苛幾乎沒有實用性，更缺少忠誠信仰/異端邪說等關鍵科技也使的斯拉夫人本身蠻懼怕僧侶文明。
          </p>
          <h3>特殊單位</h3>
          <li>
            <img
