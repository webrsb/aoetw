    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          <ul>
            <li>
              <a href="civs/Turks">土耳其</a>因為大量火藥文明加成和帝王時代特殊科技火砲術(<a href="units/Bombard_Cannon">火炮</a>、火砲塔、火砲戰船攻擊距離+2)，使得土耳其火藥相關的兵種威力更加強大，另外特殊單位<a href="units/Janissary">土耳其火槍兵</a>是目前少數能在城堡時代生產的火藥單位。
            </li>
            <li>
              火槍兵最怕就是騎兵跟弓兵還有矛兵，但是<a href="units/Janissary">土耳其火槍兵</a>在大數量時是可以吃掉弓兵、騎兵甚至戰矛兵，但是基於資源消耗的不平衡是不建議的，有免費的輕騎兵/翼騎兵(舊稱匈牙利輕騎兵)可以作為反制使用。
            </li>
            <li>
              <a href="civs/Turks">土耳其</a>的火砲可說是遊戲裡最遠的火砲，條頓城堡擁有全遊戲最遠的射程13(需研發帝王時代特殊科技垛口)，因此除了土耳其火砲(要研發帝王時代特殊科技火砲術)/投石機/火砲戰船可以無損打到以外，沒有任何的攻城器可無損打到。(為了平衡所以沒有攻城工程師)
            </li>
            <li>
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              <a href="civs/Turks">土耳其</a>跟拜占庭的世界奇觀建築上非常相像，拜占庭的聖索菲亞大教堂被征服後也增加了4根柱子
            </li>
            <li><a href="civs/Turks">土耳其</a>雖說沒有戰矛兵但跟柏柏同盟後這項問題就被解決了。</li>
            <li>
              <a href="civs/Turks">土耳其</a>得火砲戰船(研發火砲術)跟遊戲裡攻擊最遠的巨型投石機(研發攻城工程師後)一樣遠。
            </li>
          </ul>
        </div>
      </div>
