      ...
      <div class="col-md-8">
        <div class="n1">
          ...
          <p>
            ...
            >，也成功滅了東羅馬帝國截斷了歐洲對外的門戶，接著參與了科學和數學，特別是在煉金術領域，後來成為現代化學的骨幹。作為一個伊斯蘭文明，他們以向西方傳播這一知識而著稱。為了體現這一成就金礦工作效率上升、免費化學。這使他們可以立即使用火藥單位。土耳其作為第一個<nuxt-link
              to="/techs/Silk_Road"
              >絲綢之路</nuxt-link
            >的火藥帝國，為了第一個火藥帝國的強大，火藥單位<nuxt-link
          ...
          <ul>
            ...
            <li>
              ...
              >，但是他們擁有遊戲裡血最多的<nuxt-link
                ...
                >重裝馬弓騎兵</nuxt-link
              >(需研發城堡時代特殊科技<nuxt-link to="/techs/Sipahi"
                >采邑騎兵</nuxt-link
            ...
            <li>
              土耳其整體是攻擊性的文明，因為欠缺兩大垃圾兵(反制兵)使得一陷入被動時對自身虧損很嚴重且大部分的單位很吃黃金/食物的消耗，玩家需要發展強大的經濟才能支撐其發展。
            </li>
          </ul>
        ...
        <div class="n1">
          <ul>
            <li>火藥單位血量+25%</li>
            <li>研發火藥科技便宜50%</li>
            <li><nuxt-link to="/techs/Chemistry">化學</nuxt-link>免費</li>
            <li>金礦採集速度+20%</li>
            <li>
              <nuxt-link to="/units/Scout_Cavalry">斥候</nuxt-link>系升級免費
            </li>
            <li>
              斥候系遠防+1
            </li>
