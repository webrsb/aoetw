<template>
  <div class="container">
    <div class="row padtop">
      <div class="col-md-12">
        <h1><img src="~assets/turks.png" />土耳其</h1>
        <div class="hrn1"></div>
      </div>
      <div class="col-md-8">
        <div class="n1">
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              <nuxt-link to="/civs/Turks">土耳其</nuxt-link
              >是遊戲唯一不能使用<nuxt-link to="/units/Elite_Skirmisher"
                >戰矛兵</nuxt-link
              >及<nuxt-link to="/units/Pikeman">重裝長槍兵</nuxt-link
            ...
            <li>
              因欠缺<nuxt-link to="/units/Pikeman">重裝長槍兵</nuxt-link
            ...
            <li>
              ...
              >因此很依賴<nuxt-link to="/units/Bombard_Cannon">火炮</nuxt-link
              >。
            </li>
            <li>
            ...
            <li>
              ...
              >也就代表跟<nuxt-link to="/civs/Vietnamese">越南</nuxt-link
            ...
            <li>
              <nuxt-link to="/civs/Turks">土耳其</nuxt-link
              >整體是攻擊性的文明，因為欠缺兩大垃圾兵(反制兵)因此一陷入被動時對自身虧損很嚴重且，大部分的單位很吃黃金/食物的消耗，玩家需要發展強大的經濟才能支撐帝國的發展。
            </li>
          </ul>
        ...
        <div class="n1">
          <ul>
            <li>火藥單位血量+25%</li>
            <li>研發火藥相關科技便宜50%</li>
            <li>免費擁有<nuxt-link to="/techs/Chemistry">化學</nuxt-link></li>
            <li>金礦採集速度+20%</li>
            <li>
              輕騎兵/翼騎兵(舊稱<nuxt-link to="/units/Hussar"
                >匈牙利輕騎兵</nuxt-link
              >)免費升級
            </li>
            <li>
        ...
        <div class="n1">
          <ul>
            <li>
              <nuxt-link to="/civs/Turks">土耳其</nuxt-link>是唯一沒有<nuxt-link
                to="/units/Elite_Skirmisher"
                >戰矛兵</nuxt-link
              >的文明，這也意味著他們在與<nuxt-link to="/civs/Vietnamese"
                >越南</nuxt-link
              >結盟時不能訓練<nuxt-link to="/units/Imperial_Skirmisher"
                >帝王戰矛兵</nuxt-link
              >。
            </li>
            <li>
            ...
            <li>
              <nuxt-link to="/civs/Turks">土耳其</nuxt-link>跟<nuxt-link
                to="/civs/Byzantines"
                >拜占庭</nuxt-link
              >的<nuxt-link to="/building/Wonder">世界奇觀</nuxt-link
              >建築上非常相像，<nuxt-link to="/civs/Byzantines"
                >拜占庭</nuxt-link
              >的聖索菲亞大教堂被征服後也增加了4根柱子
            </li>
            <li>
              <nuxt-link to="/civs/Turks">土耳其</nuxt-link
