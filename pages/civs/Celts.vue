  ...
  <div class="container">
    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            賽爾特或稱凱爾特，是西歐的步兵和攻城器文明，世紀帝國II的可使用的最初文明之一。
          </p>
          <p>
            賽爾特是用蘇格蘭、爾蘭人、威爾士人為基礎的文明。但語言是愛爾蘭蓋爾語。活耀於整個西歐歷經蠻多次遷移。
          </p>
          <p>
            賽爾特特殊單位是菘藍武士，真實歷史上有的一種兵為了讓自己更可怕會在臉上塗上藍色的漆(用菘藍這種植物製成的)，賽爾特人在十四歲時就會讓男孩上戰場也是因應當時的大量部落戰爭，從小就常在戰爭因此培育出面對戰爭的勇氣和作戰熱情，帝王時代的特殊科技賽爾特狂暴就是取自於這，然而在對蘇格蘭的戰爭中賽爾特用游擊戰造成蘇格蘭的麻煩，因此菘藍武士得特色也取自游擊戰要的速度/破壞，菘藍武士從赤裸上身/臉上藍漆..等都是有考究歷史的。
          </p>
          <p>
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              攻城器器相關科技都有(除了火砲)，此外攻擊速度+20%、血量+40%(帝王特殊科技賽爾特狂暴)、攻城器製造所工作效率+20%(團隊加分)，因此攻城器的使用是上上選。
            </li>
            <li>
              移動快速的菘藍武士對建築本身又有加成，適合打騷擾戰術，唯一缺點是本身護甲並不高，因此在有預先防禦下是很難打出一定成果。
            </li>
            <li>
              賽爾特缺點之一是他們的弓兵系統，欠缺勁弩兵/拇指環/弓兵環甲/護腕這幾項很重要的科技，因此不適合打弓兵。
            </li>
            <li>
              賽爾特的馬廠雖然說有著遊戲中最強大騎兵單位遊俠，卻沒有品種/騎兵板甲這二樣關鍵科技另外也無駱駝科技。
            </li>
            <li>
              因為擁有伐木速度+15%的文明加成，跟遊戲中最強大的攻城器，在黑森林這張遊戲地圖中被稱之為最強文明。
            </li>
            <li>
              賽爾特因弓兵系統疲弱、騎兵系統不完善的情況下擁有著最強大的攻城器和強大的步兵系統，幾乎確定是標準的打步兵的文明，因此在某些方面上很容易被針對。
            </li>
            <li>
              賽爾特的文明加成，使得賽爾特在黑暗、封建有著不錯的先天優勢。
            </li>
          </ul>
          <h3>特殊單位</h3>
          <ul>
      ...
      <div class="col-md-12">
        ...
        <div class="col-md-4">
          <div class="wimg">
            <a target="_blank" href="/img/Wondercelts.jpg"
        ...
        <div class="col-md-4">
          <div class="wimg">
            <a target="_blank" href="/img/Celts_in_III_century_BC.jpg"
              ><img
                class="imgn hg"
