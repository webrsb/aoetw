      ...
      <div class="col-md-8">
        <div class="n1">
          ...
          <p>
            ...
            <a href="Eagle_Warrior.php">鷹勇士</a>與<a href="Huskarl.php"
              >哥德衛隊</a
            >，使得弓箭手對他們的攻擊無效。
          </p>
        </div>
        ...
        <div class="n1">
          <p>
            ...
            <a href="Hand_Cannoneer.php">火槍兵</a>、遠防高達8的<a
              href="Champion.php"
              >劍兵勇士</a
            >以及<a href="Siege_Onager.php"></a
            >重型投石車，還有全遊戲最強的騎兵、
        ...
        <div class="n1">
          ...
          <a href="Sundjataa.php">松迪亞塔</a>外，其餘同時被殺。
        </div>
      </div>
      <div class="col-md-4">
