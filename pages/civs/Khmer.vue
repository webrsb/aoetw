    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          ...
          <p>
            高棉在經濟上並沒有甚麼特別的文明加成，但也不用太擔心快攻，因為可以躲進旁邊的居住房舍，而無需建造建築即可升級時代，則讓高棉能夠更快升上城堡時代去做進攻，雖然高棉並沒有一種特別突出的<nuxt-link
              to="/tree/vie"
              >科技樹</nuxt-link
          ...
          <div class="n1">
            <p>
              嚴格來說，高棉並不是一個可以上檯面的文明，至少在大比賽自選文明時，並沒有高手選過它。經濟上並無任何優勢，硬要說優勢的話，只有升級免<nuxt-link
                to="/building"
                >建築物</nuxt-link
              >這個優勢，但這優勢在<nuxt-link to="/maps/Arabia"
                >阿拉伯</nuxt-link
              >地圖中並不吃香。軍事上無任何突出的亮點，總體來講是一個不好上手的文明。
            </p>
            <h4>特殊打法</h4>
            <ul>
              <li>高棉26p直城：</li>
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              雖然高棉是2016年才新增的文明，但早在2000年，16年前<nuxt-link
                to="/games/aoc"
                >征服者入侵</nuxt-link
