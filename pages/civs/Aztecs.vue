    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          ...
          <p>
            阿茲特克是全遊戲中單挑最強的文明之一，詳見:<a href="/civs/bestciv"
              >文明優劣分析</a
            >
          </p>
        </div>
        ...
        <div class="n1">
          <p>
            ...
            <a href="/units/Galleon">重型弩砲戰船</a>的文明。因此必須依靠
            <a href="/units/Demolition_Ship">神風船</a>與<a
              href="/units/Fire_Ship"
              >火戰船</a
            >來打海戰。
          </p>
          <h3>特殊單位</h3>
        ...
        <div class="n1">
          <ul>
            <li><a href="/units/Villager">村民</a>攜帶資源量+5</li>
            <li>所有軍事單位訓練快15%</li>
            <li>
              每研發一個 <a href="/building/Monastery">修道院</a>科技，<a
                href="/units/Monk"
                >僧侶</a
              >+5HP
            </li>
            <li>遊戲初始多50黃金</li>
            <li>
              <strong>團隊加分:</strong><a href="/Relic">遺跡</a>生產黃金快33%
            </li>
          </ul>
        </div>
        <h3>科技樹</h3>
        <div class="hrn1"></div>
        <div class="n1">
          <em><a href="/tree/azt">阿茲特克科技樹</a></em>
        </div>
        <br />
        <h3>更新日誌</h3>
        <div class="hrn1"></div>
        <div class="n1">
          ...
          <ul>
            ...
            <li>豹勇士多+1遠防。</li>
            <li>
              特殊科技引入，<a href="/techs/Atlatl">擲矛器</a
              >:矛兵額外獲得+1攻擊，+1射程
            </li>
            <li></li>
            <li></li>
        ...
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style=" background-color:#e6992c;">
              <div class="unititle"><a href="#">阿茲特克</a></div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
