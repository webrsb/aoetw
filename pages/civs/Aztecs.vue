      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            ...
            <a href="Atlatl.php"></a>擲矛器是獵人和勇士使用的工具，將讓<a
              href="Elite_Skirmisher.php"
            ></a
            >矛兵將+1射程與+1攻擊，帝王時代的特殊科技
            <a href="Garland_Wars.php">榮冠戰爭</a>，讓步兵更為強大。
          </p>
          <p>
          ...
          <p>
            阿茲特克是全遊戲中單挑最強的文明之一，詳見:<a href="bestciv.php"
              >文明優劣分析</a
            >
          </p>
        </div>
        ...
        <div class="n1">
          <p>
            ...
            <a href="Galleon.php">重型弩砲戰船</a>的文明。因此必須依靠
            <a href="Demolition_Ship.php">神風船</a>與<a href="Fire_Ship.php"
              >火戰船</a
            >來打海戰。
          </p>
          <h3>特殊單位</h3>
        ...
        <div class="n1">
          <ul>
            ...
            <li>所有軍事單位訓練快15%</li>
            <li>
              每研發一個 <a href="Monastery.php">修道院</a>科技，<a
                href="Monk.php"
                >僧侶</a
              >+5HP
            </li>
        ...
        <div class="n1">
          ...
          <ul>
            ...
            <li>豹勇士多+1遠防。</li>
            <li>
              特殊科技引入，<a href="Atlatl.php">擲矛器</a
              >:矛兵額外獲得+1攻擊，+1射程
            </li>
            <li></li>
            <li></li>
