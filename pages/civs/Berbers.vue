      ...
      <div class="col-md-8">
        <div class="n1">
          ...
          <p>
            ...
            >可加快城堡工作效率。由於長期得要在沙漠戰鬥<nuxt-link
              to="/units/Camel"
              >駱駝</nuxt-link
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              柏柏擁有2個同盟加成，給予標槍騎兵的使用、城堡時代特殊科技聚居堡壘(你和同盟城堡工作效率+25%)，所以在團隊上的加成僅次於<nuxt-link
                to="/civs/Vietnamese"
                >越南</nuxt-link
              >(3個)。
            </li>
            <li>
              柏柏雖然貴為馬弓騎兵剋星但是弓兵系統裡缺<nuxt-link
                to="/units/Arbalest"
                >勁弩兵</nuxt-link
              >/
            ...
            <li>
              柏柏雖然在馬廄單位訓練成本城堡時代便宜15%、帝王時代便宜20%(馬扎爾在哭)，但是沒有<nuxt-link
                to="/units/Paladin"
                >遊俠</nuxt-link
              >(聖騎士)、東南亞獨有
            ...
            <li>
              柏柏整體上不管1V1還是團戰都有不錯的戰術方向可以使用，雖然欠缺<nuxt-link
        ...
        <div class="hrn1"></div>
        <div class="n1">
          <em><nuxt-link to="/tree/ber">柏柏科技樹</nuxt-link></em>
        </div>
        <br />
        <h3>更新日誌</h3>
        <div class="hrn1"></div>
        ...
        <div class="n1">
          <div class="col-md-12">
            <div class="col-md-4">
              <nuxt-link to="/img/Berbers_preview.png"
