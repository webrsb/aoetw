<template>
  <div class="container">
    <div class="row padtop">
      <div class="col-md-12">
        <h1><img src="~assets/vikings.png" />維京</h1>
        <div class="hrn1"></div>
      </div>
      <div class="col-md-8">
        <div class="n1">
        ...
        <div class="n1">
          <ul>
            <li>戰艦成本於封建時代-15%、城堡時代-15%、帝王時代-20%</li>
            <li>
        ...
        <div class="n1">
          ...
          <ul>
            <li>
              團隊加分:碼頭便宜15% (128<nuxt-link to="/resource/Wood"
                >木頭</nuxt-link
              >，以前是113木材)
            </li>
            <li>
              戰船成本現在每個時代成本都不同，封建81木材27黃金(-10%)、城堡76木材25黃金(-15%)、帝王72木材24黃金(-20%)
            </li>
            <li>狂戰士(非精銳)+4hp</li>
            <li>維京大戰船木頭和戰船相同。</li>
            <li>狂戰士幫成本為850食物400黃金。(原本是500食物850黃金)</li>
            <li>
          ...
          <ul>
            <li>維京大戰船不再需要城堡。</li>
            <li>維京大戰船成本為100木材50黃金。</li>
            <li>酋長的成本從700食物400黃金降低為400食物300黃金，並且多1的攻擊。</li>
            <li>酋長影響所有步兵(不僅僅是狂戰士)。</li>
            <li>4.8b版後，酋長使步兵對駱駝騎兵額外+2的攻擊。</li>
          </ul>
          <h3>
            <em><nuxt-link to="/games/aor">王者崛起</nuxt-link></em>
          </h3>
          <ul>
          <li>5.5版後，戰艦成本於封建時代-15%、城堡時代-15%、帝王時代-20%。</li>
          <li>5.7版後，酋長使步兵對駱駝騎兵額外+4的攻擊，不再是+2。</li>
          </ul>
          <h3>
