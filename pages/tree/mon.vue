          ...
          <tr>
            ...
            <td class="t15 trm">
              <img class="gg" src="~assets/ArbalestIcon.png" /><nuxt-link
                to="/units/Arbalester"
              >
                <div><nuxt-link to="/units/Arbalester">強弩兵</nuxt-link></div>
              </nuxt-link>
            </td>
            <td class="t15 trm not">
              <img
          ...
          <tr>
            ...
            <td class="t13 trm">
              <img
                ...
                alt=""
              />
              <div><nuxt-link to="/units/Mangudai">蒙古突騎</nuxt-link></div>
              <i class="fas fa-arrow-down"></i>
            </td>
            <td class="t13 trm">
            ...
            <td class="t13 trm">
              ...
              <div><nuxt-link to="/techs/Nomads">游牧</nuxt-link></div>
            </td>
            <td class="t13 trm"></td>
            <td class="t13 trm"></td>
            <td class="t13 trm"></td>
          ...
          <tr>
            ...
            <td class="t13 trm">
              <img
                ...
                alt=""
              />
              <div><nuxt-link to="/techs/Drill">鑿岩機</nuxt-link></div>
            </td>
            <td class="t13 trm">
