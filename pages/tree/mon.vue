        ...
        <table class="table" style="margin-top:50px;">
          ...
          <tr>
            ...
            <td class="t15 trm">
              ...
              <nuxt-link to="/units/Crossbowman"> <div>弩兵</div> </nuxt-link>
              <i class="fas fa-arrow-down"></i>
            </td>
            <td class="t15 trm">
            ...
            <td class="t15 trm not">
              ...
              <nuxt-link to="/units/Slinger"> <div>投石手</div> </nuxt-link>
            </td>
            <td class="t15 trm not">
              <img class="gg" src="~assets/GenitourIcon.jpg" />
              <nuxt-link to="/units/Genitour"> <div>標槍騎兵</div> </nuxt-link>
              <i class="fas fa-arrow-down"></i>
            </td>
            <td class="t15 trm">
              <img class="gg" src="~assets/Thumb_Ring.png" />
              <nuxt-link to="/techs/Thumb_Ring"> <div>拇指環</div> </nuxt-link>
            </td>
          </tr>
          <tr>
            <td style="vertical-align: middle;" class="t5 trm im">
            ...
            <td class="t15 trm">
              ...
              <nuxt-link to="/units/Arbalest"> <div>強弩兵</div> </nuxt-link>
            </td>
            <td class="t15 trm not">
        ...
        <table class="table" style="margin-top:50px;">
          ...
          <tr>
            ...
            <td class="t23 trm">
              ...
              />
              <div>
                <nuxt-link to="/Siege units/Onager" class=""
                  >重型投石車</nuxt-link
                >
              </div>
            </td>
