          ...
          <tr>
            ...
            <td class="t13 trm">
              <img
                ...
                alt=""
              />
              <div><nuxt-link to="/units/Mameluke">奴隸兵</nuxt-link></div>
              <i class="fas fa-arrow-down"></i>
            </td>
            <td class="t13 trm">
            ...
            <td class="t13 trm">
              ...
              <div><nuxt-link to="/techs/Madrasah">穆斯林學墊</nuxt-link></div>
            </td>
            <td class="t13 trm"></td>
            <td class="t13 trm"></td>
            <td class="t13 trm"></td>
          ...
          <tr>
            ...
            <td class="t13 trm">
              <img
                ...
                alt=""
              />
              <div><nuxt-link to="/units/Mameluke">精銳奴隸兵</nuxt-link></div>
            </td>
            <td class="t13 trm">
              <img
                class="gg"
            ...
            <td class="t13 trm">
              <img
                ...
                alt=""
              />
              <div><nuxt-link to="/techs/Zealotry">狂熱舉動</nuxt-link></div>
            </td>
            <td class="t13 trm">
