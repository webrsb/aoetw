      ...
      <div class="n1">
        ...
        <table class="table" style="margin-top:50px;">
          ...
          <tr>
            ...
            <td class="t19 trm">
              ...
              <i class="fas fa-arrow-down"></i><br />
              <img class="gg not" src="~assets/PaladinIcon.png" />
        ...
        <table class="table" style="margin-top:50px;">
          ...
          <tr>
            ...
            <td class="t13 trm">
              <img class="gg" src="~assets/HuskarlIcon.png" width="30" alt="" />
              <div><nuxt-link to="/units/Huskarl">哥德衛隊</nuxt-link></div>
            </td>
            <td class="t13 trm">
          ...
          <tr>
            ...
            <td class="t13 trm">
              <img class="gg" src="~assets/HuskarlIcon.png" width="30" alt="" />
              <div><nuxt-link to="/units/Huskarl">精銳哥德衛隊</nuxt-link></div>
            </td>
            <td class="t13 trm">
              <img
                class="gg"
            ...
            <td class="t13 trm">
              <img
                ...
                alt=""
              />
              <div><nuxt-link to="/techs/Perfusion">井噴</nuxt-link></div>
            </td>
        ...
        <table class="table" style="margin-top:50px;">
          ...
          <tr>
            ...
            <td class="t10 trm">
              ...
              <i class="fas fa-arrow-down"></i><br />
              <img class="gg not" src="~assets/CannonGalleonIcon.png" />
              <div>
