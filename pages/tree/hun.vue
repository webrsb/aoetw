        ...
        <table class="table">
          ...
          <tr>
            ...
            <td class="t19 trm">
              ...
              <div><a href="Tracking.php">追縱技術</a></div>
            </td>
            <td class="t19 trm"></td>
          </tr>
          <tr>
            ...
            <td class="t19 trm">
              ...
              <div><a href="Squires.php">護衛</a></div>
            </td>
            <td class="t19 trm">
              <img class="gg" src="~assets/Arson.jpg" alt="" />
              <div><a href="Arson.php">縱火</a></div>
            </td>
          </tr>
          <tr>
        ...
        <table class="table" style="margin-top:50px;">
          ...
          <tr>
            ...
            <td class="t19 trm">
              ...
              <div><a href="Bloodlines.php">品種</a></div>
            </td>
            <td class="t19 trm"></td>
            <td class="t19 trm"></td>
            <td class="t19 trm"></td>
          ...
          <tr>
            ...
            <td class="t19 trm">
              ...
              <div><a href="Light_Cavalry.php">輕騎兵</a></div>
              <i class="fas fa-arrow-down"></i>
            </td>
            <td class="t19 trm">
              <img class="gg" src="~assets/KnightIcon.jpg" />
              <div><a href="Knight.php">騎士</a></div>
              <i class="fas fa-arrow-down"></i>
            </td>
            <td class="t19 trm not">
              <img class="gg" src="~assets/CamelIcon.jpg" />
              <div><a href="Camel.php">駱駝騎兵</a></div>
              <i class="fas fa-arrow-down"></i>
            </td>
            <td class="t19 trm not">
              <img class="gg" src="~assets/Battleelephanticon.png" />
              <div><a href="Battle_Elephant.php">矛象伕</a></div>
              <i class="fas fa-arrow-down"></i>
            </td>
            <td class="t19 trm">
              <img class="gg" src="~assets/Husbandry.jpg" alt="" />
              <div><a href="Husbandry.php">畜牧培育</a></div>
            </td>
          </tr>
          <tr>
            <td style=" vertical-align: middle; " class="t5 trm im">
            ...
            <td class="t19 trm">
              ...
              <div><a href="Hussar.php">匈牙利輕騎兵</a></div>
            </td>
            <td class="t19 trm">
            ...
            <td class="t19 trm not">
              ...
              <div><a href="Heavy_Camel.php">重裝駱駝騎兵</a></div>
              <i class="fas fa-arrow-down"></i><br /><img
                class="gg not"
                src="~assets/ImperialCamelIcon.jpg"
              />
              <div>
                <a href="Imperial_Camel.php" class="not">帝王駱駝騎兵</a>
              </div>
            </td>
            <td class="t19 trm not">
              <img class="gg" src="~assets/Battleelephanticon.png" />
              <div><a href="Elite_Battle_Elephant.php">精銳矛象伕</a></div>
            </td>
            <td class="t19 trm"></td>
          </tr>
        </table>
          ...
          <tr>
            ...
            <td class="t23 trm">
              <img
                ...
                alt=""
              />
              <div><a href="Battering_Ram.php">衝撞車</a></div>
              <i class="fas fa-arrow-down"></i>
            </td>
            <td class="t23 trm">
              <img
                ...
                alt=""
              />
              <div><a href="Mangonel.php">輕型投石車</a></div>
              <i class="fas fa-arrow-down"></i>
            </td>
            <td class="t23 trm">
              <img
                ...
                alt=""
              />
              <div><a href="Scorpion.php">弩砲</a></div>
              <i class="fas fa-arrow-down"></i>
            </td>
            <td class="t23 trm">
              <img
                ...
                alt=""
              />
              <div><a href="Siege_Tower.php">攻城塔</a></div>
            </td>
          </tr>
          <tr>
            <td style=" vertical-align: middle; " class="t5 trm im">
            ...
            <td class="t23 trm">
              <img
                ...
                alt=""
              />
              <div><a href="Capped_Ram.php">裝甲衝撞車</a></div>
              <i class="fas fa-arrow-down"></i><br /><img
                class="gg"
            ...
            <td class="t23 trm not">
              ...
              <img
                ...
                alt=""
              />
              <div><a href="Siege_Onager.php" class="">重型投石車</a></div>
            </td>
            <td class="t23 trm not">
              <img
                class="gg"
                ...
                alt=""
              />
              <div><a href="Heavy_Scorpion.php">重型弩砲</a></div>
            </td>
            <td class="t23 trm not">
              <img
                class="gg"
                ...
                alt=""
              />
              <div><a href="Bombard_Cannon.php">火砲</a></div>
            </td>
          </tr>
        </table>
        ...
        <table class="table" style="margin-top:50px;">
          ...
          <tr>
            ...
            <td class="t13 trm">
              ...
              <div><a href="Tarkan.php">韃靼騎兵</a></div>
            </td>
            <td class="t13 trm">
              <img class="gg" src="~assets/PetardIcon.jpg" width="30" alt="" />
              <div><a href="Petard.php">爆炸桶</a></div>
            </td>
            <td class="t13 trm">
              <img
                class="gg"
                ...
                alt=""
              />
              <div><a href="Marauders.php">掠奪者</a></div>
            </td>
            <td class="t13 trm"></td>
            <td class="t13 trm"></td>
            <td class="t13 trm"></td>
          ...
          <tr>
            ...
            <td class="t13 trm">
              <img class="gg" src="~assets/TarkanIcon.jpg" width="30" alt="" />
              <div><a href="Tarkan.php">精銳韃靼騎兵</a></div>
            </td>
            <td class="t13 trm">
              <img
                class="gg"
            ...
            <td class="t13 trm">
              <img
                ...
                alt=""
              />
              <div><a href="Conscription.php">徵兵制度</a></div>
            </td>
            <td class="t13 trm">
              <img
                class="gg"
        ...
        <table class="table" style="margin-top:50px;">
          ...
          <tr>
            ...
            <td class="t23 trm">
              ...
              <div><a href="Villager.php">村民</a></div>
            </td>
            <td class="t23 trm">
              <img class="gg" src="~assets/Feudal-age-reseach.jpg" alt="" />
              <div><a href="Feudal_Age.php">封建時代</a></div>
              <i class="fas fa-arrow-down"></i>
            </td>
            <td class="t23 trm">
              <img class="gg" src="~assets/Loom.jpg" alt="" />
              <div><a href="Loom.php">織布技術</a></div>
            </td>
            <td class="t23 trm"></td>
          </tr>
          <tr>
            ...
            <td class="t23 trm">
              ...
              <div><a href="Town_Watch.php">城鎮瞭望</a></div>
              <i class="fas fa-arrow-down"></i>
            </td>
            <td class="t23 trm">
              <img class="gg" src="~assets/Castle-age-reseach.jpg" alt="" />
              <div><a href="Castle_Age.php">城堡時代</a></div>
              <i class="fas fa-arrow-down"></i>
            </td>
            <td class="t23 trm">
              <img class="gg" src="~assets/Wheelbarrow.jpg" alt="" />
              <div><a href="Wheelbarrow.php">獨輪推車</a></div>
              <i class="fas fa-arrow-down"></i>
            </td>
            <td class="t23 trm"></td>
          </tr>
          <tr>
            ...
            <td class="t23 trm">
              ...
              <div><a href="Town_Patrol.php">城鎮巡邏</a></div>
            </td>
            <td class="t23 trm">
              <img class="gg" src="~assets/Imperial-age-research.jpg" alt="" />
              <div><a href="Imperial_Age.php">帝王時代</a></div>
            </td>
            <td class="t23 trm">
        ...
        <table class="table" style="margin-top:50px;">
          ...
          <tr>
            ...
            <td class="t23 trm">
              ...
              <div><a href="Horse_Collar.php">馬軛</a></div>
              <i class="fas fa-arrow-down"></i>
            </td>
            <td class="t23 trm"></td>
            <td class="t23 trm"></td>
          ...
          <tr>
            ...
            <td class="t23 trm">
              ...
              <div><a href="Heavy_Plow.php">重犁</a></div>
              <i class="fas fa-arrow-down"></i>
            </td>
            <td class="t23 trm"></td>
            <td class="t23 trm"></td>
          ...
          <tr>
            ...
            <td class="t23 trm not">
              ...
              <div><a href="Crop_Rotation.php">輪耕</a></div>
            </td>
            <td class="t23 trm"></td>
            <td class="t23 trm"></td>
            <td class="t23 trm"></td>
        ...
        <table class="table" style="margin-top:50px;">
          ...
          <tr>
            ...
            <td class="t23 trm">
              ...
              <div><a href="Double-Bit_Axe.php">雙刃斧</a></div>
              <i class="fas fa-arrow-down"></i>
            </td>
            <td class="t23 trm"></td>
            <td class="t23 trm"></td>
          ...
          <tr>
            ...
            <td class="t23 trm">
              ...
              <div><a href="Bow_Saw.php">弓鋸</a></div>
              <i class="fas fa-arrow-down"></i>
            </td>
            <td class="t23 trm"></td>
            <td class="t23 trm"></td>
          ...
          <tr>
            ...
            <td class="t23 trm">
              ...
              <div><a href="Two-Man_Saw.php">雙人鋸</a></div>
            </td>
            <td class="t23 trm"></td>
            <td class="t23 trm"></td>
            <td class="t23 trm"></td>
        ...
        <table class="table" style="margin-top:50px;">
          ...
          <tr>
            ...
            <td class="t23 trm">
              ...
              <div><a href="Gold_Mining.php">採金技術</a></div>
              <i class="fas fa-arrow-down"></i>
            </td>
            <td class="t23 trm">
              <img class="gg" src="~assets/Stonemining.jpg" alt="" />
              <div><a href="Stone_Mining.php">採石技術</a></div>
              <i class="fas fa-arrow-down"></i>
            </td>
            <td class="t23 trm"></td>
            <td class="t23 trm"></td>
          ...
          <tr>
            ...
            <td class="t23 trm">
              ...
              <div><a href="Gold_Shaft_Mining.php">礦井採金</a></div>
            </td>
            <td class="t23 trm not">
        ...
        <table class="table" style="margin-top:50px;">
          ...
          <tr>
            ...
            <td class="t10 trm">
              ...
              <div><a href="Fishing_Ship.php">漁船</a></div>
            </td>
            <td class="t10 trm">
              <img class="gg" src="~assets/TransportShipIcon.jpg" />
              <div><a href="Transport_Ship.php">運輸船</a></div>
            </td>
            <td class="t10 trm"></td>
            <td class="t10 trm"></td>
            <td class="t10 trm"></td>
          ...
          <tr>
            ...
            <td class="t10 trm">
              ...
              <div><a href="Fire_Galley.php">火蒙衝</a></div>
              <i class="fas fa-arrow-down"></i>
            </td>
            <td class="t10 trm">
              <img class="gg" src="~assets/DemoRaftIcon.jpg" />
              <div><a href="Demolition_Raft.php">自爆筏</a></div>
              <i class="fas fa-arrow-down"></i>
            </td>
            <td class="t10 trm">
              <img class="gg" src="~assets/Galley.jpg" />
              <div><a href="Galley.php">戰船</a></div>
              <i class="fas fa-arrow-down"></i>
            </td>
            <td class="t10 trm">
              <img class="gg" src="~assets/TradeCogIcon.jpg" />
              <div><a href="Trade_Cog.php">貿易商旅</a></div>
            </td>
            <td class="t10 trm"></td>
            <td class="t10 trm"></td>
            <td class="t10 trm"></td>
            ...
            <td class="t10 trm">
              ...
              <div><a href="Fish_Trap.php">漁網</a></div>
            </td>
          </tr>
          <tr>
            <td style=" vertical-align: middle; " class="t5 trm ca">
            ...
            <td class="t10 trm">
              <img
                ...
                alt=""
              />
              <div><a href="Gillnets.php">流刺網</a></div>
            </td>
            <td class="t10 trm">
              <img
                class="gg"
                ...
                alt=""
              />
              <div><a href="Careening.php">傾側維修術</a></div>
              <i class="fas fa-arrow-down"></i>
            </td>
            <td class="t10 trm"></td>
            <td class="t10 trm"></td>
          ...
          <tr>
            ...
            <td class="t10 trm not">
              ...
              <div><a href="Fast_Fire_Ship.php">快速火戰船</a></div>
            </td>
            <td class="t10 trm">
              <img class="gg" src="~assets/HeavyDemoShipIcon.jpg" />
              <div><a href="Heavy_Demolition_Ship.php">重型神風船</a></div>
            </td>
            <td class="t10 trm">
              <img class="gg" src="~assets/GalleonAoE2.jpg" />
              <div><a href="Galleon.php">重型弩炮戰船</a></div>
            </td>

            <td class="t10 trm not">
              <img class="gg" src="~assets/LongboatIcon.jpg" />
              <div><a href="Longboat.php">精銳維京大戰船</a></div>
            </td>
            <td class="t10 trm not">
              <img class="gg" src="~assets/TurtleShipIcon.jpg" />
              <div><a href="Turtle_Ship.php">精銳龜甲船</a></div>
            </td>
            <td class="t10 trm not">
              <img class="gg" src="~assets/CaravelIcon2.jpg" />
              <div><a href="Caravel.php">精銳卡拉維爾戰船</a></div>
            </td>
            <td class="t10 trm not">
              <img class="gg" src="~assets/CannonGalleonIcon.jpg" />
              <div><a href="Cannon_Galleon.php">火炮戰船</a></div>
              <i class="fas fa-arrow-down"></i><br /><img
                class="gg not"
                src="~assets/CannonGalleonIcon.jpg"
              />
              <div>
                <a href="Elite_Cannon_Galleon.php" class="not">精銳火炮戰船</a>
              </div>
            </td>
            <td class="t10 trm">
              <img
                ...
                alt=""
              />
              <div><a href="Dry_Dock.php">旱碼頭</a></div>
            </td>
            ...
            <td class="t10 trm not">
              <img
                ...
                alt=""
              />
              <div><a href="Shipwright.php">造船匠</a></div>
            </td>
          </tr>
        </table>
        ...
        <table class="table" style="margin-top:50px;">
          ...
          <tr>
            ...
            <td class="t19 trm">
              ...
              <div><a href="Padded_Archer_Armor.php">弓兵布甲</a></div>
            </td>
            <td class="t19 trm">
              <img class="gg" src="~assets/Fletching.jpg" alt="" />
              <div><a href="Fletching.php">箭羽</a></div>
              <i class="fas fa-arrow-down"></i>
            </td>
            <td class="t19 trm">
              <img class="gg" src="~assets/Forging.jpg" alt="" />
              <div><a href="Forging.php">鍛造</a></div>
              <i class="fas fa-arrow-down"></i>
            </td>
            <td class="t19 trm ">
              <img class="gg" src="~assets/Scalebardingarmor.jpg" alt="" />
              <div><a href="Scale_Barding_Armor.php">騎兵鱗甲</a></div>
              <i class="fas fa-arrow-down"></i>
            </td>
            <td class="t19 trm">
              <img class="gg" src="~assets/Scalemailarmor.jpg" alt="" />
              <div><a href="Scale_Mail_Armor.php">步兵鱗甲</a></div>
              <i class="fas fa-arrow-down"></i>
            </td>
          </tr>
          <tr>
            ...
            <td class="t19 trm">
              ...
              <div><a href="Leather_Archer_Armor.php">弓兵皮甲</a></div>
              <i class="fas fa-arrow-down"></i>
            </td>
            <td class="t19 trm">
              <img class="gg" src="~assets/Bodkinarrow.jpg" alt="" />
              <div><a href="Bodkin_Arrow.php">錐狀箭頭</a></div>
              <i class="fas fa-arrow-down"></i>
            </td>
            <td class="t19 trm">
              <img class="gg" src="~assets/Ironcasting.jpg" alt="" />
              <div><a href="Iron_Casting.php">鑄造</a></div>
              <i class="fas fa-arrow-down"></i>
            </td>
            <td class="t19 trm ">
              <img class="gg" src="~assets/Chainbardingarmor.jpg" alt="" />
              <div><a href="Chain_Barding_Armor.php">騎兵鎖甲</a></div>
              <i class="fas fa-arrow-down"></i>
            </td>
            <td class="t19 trm">
              <img class="gg" src="~assets/Chainmailarmor.jpg" alt="" />
              <div><a href="Chain_Mail_Armor.php">步兵鎖甲</a></div>
              <i class="fas fa-arrow-down"></i>
            </td>
          </tr>
          <tr>
            ...
            <td class="t19 trm not">
              ...
              <div><a href="Ring_Archer_Armor.php">弓兵環甲</a></div>
            </td>
            <td class="t19 trm">
              <img class="gg" src="~assets/Bracer.jpg" alt="" />
              <div><a href="Bracer.php">護腕</a></div>
            </td>
            <td class="t19 trm">
              <img class="gg" src="~assets/Blastfurnace.jpg" alt="" />
              <div><a href="Blast_Furnace.php">鐵風爐</a></div>
            </td>
            <td class="t19 trm">
              <img class="gg" src="~assets/Platebardingarmor.jpg" alt="" />
              <div><a href="Plate_Barding_Armor.php">騎兵板甲</a></div>
            </td>
            <td class="t19 trm not">
              <img class="gg" src="~assets/Platemailarmor.jpg" alt="" />
              <div><a href="Plate_Mail_Armor.php">步兵板甲</a></div>
            </td>
          </tr>
        </table>
        ...
        <table class="table" style="margin-top:50px;">
          ...
          <tr>
            ...
            <td class="t23 trm">
              ...
              <div><a href="Cartography.php">製圖學</a></div>
              <i class="fas fa-arrow-down"></i>
            </td>
            <td class="t23 trm">
              <img class="gg" src="~assets/TradeCartIcon.jpg" />
              <div><a href="Trade_Cart.php">貿易車隊</a></div>
            </td>
            <td class="t23 trm"></td>
            <td class="t23 trm"></td>
          </tr>
          <tr>
            ...
            <td class="t23 trm">
              ...
              <div><a href="Caravan.php">大商隊</a></div>
            </td>
            <td class="t23 trm">
              <img class="gg" src="~assets/Coinage.jpg" />
              <div><a href="Coinage.php">鑄幣術</a></div>
              <i class="fas fa-arrow-down"></i>
            </td>
            <td class="t23 trm"></td>
            <td class="t23 trm"></td>
          ...
          <tr>
            ...
            <td class="t23 trm">
              ...
              <div><a href="Guilds.php">行會制度</a></div>
            </td>
            <td class="t23 trm">
              <img class="gg" src="~assets/Banking.jpg" />
              <div><a href="Banking.php">銀行制度</a></div>
            </td>
            <td class="t23 trm"></td>
            <td class="t23 trm"></td>
          </tr>
        ...
        <table class="table" style="margin-top:50px;">
          ...
          <tr>
            ...
            <td class="t11 trm not">
              <img
                ...
                alt=""
              />
              <div><a href="Missionary.php">傳教士</a></div>
            </td>
            <td class="t11 trm not">
              <img class="gg" src="~assets/Redemption.jpg" width="30" alt="" />
              <div><a href="Redemption.php">信仰救贖</a></div>
            </td>
            <td class="t11 trm">
              <img class="gg" src="~assets/Atonement.jpg" width="30" alt="" />
              <div><a href="Atonement.php">贖罪</a></div>
            </td>
            <td class="t11 trm not">
              <img
                class="gg"
          ...
          <tr>
            ...
            <td class="t11 trm">
              ...
              <div><a href="Faith.php">忠誠信仰</a></div>
            </td>
            <td class="t11 trm">
              <img
                class="gg"
                ...
                alt=""
              />
              <div><a href="Illumination.php">啟發教化</a></div>
            </td>
            <td class="t11 trm not">
              <img
                class="gg"
                ...
                alt=""
              />
              <div><a href="Block_Printing.php">雕版印刷術</a></div>
            </td>
            <td class="t11 trm not">
              <img class="gg" src="~assets/Theocracy.png" width="30" alt="" />
              <div><a href="Theocracy.php">神權統治</a></div>
            </td>
            <td class="t11 trm"></td>
            <td class="t11 trm"></td>
            <td class="t11 trm"></td>
        ...
        <table class="table" style="margin-top:50px;">
          ...
          <tr>
            ...
            <td class="t11 trm">
              ...
              <div><a href="Masonry.php">磚瓦技術</a></div>
              <i class="fas fa-arrow-down"></i>
            </td>
            <td class="t11 trm not">
              <img
                ...
                alt=""
              />
              <div><a href="Fortified_Wall.php">垛牆</a></div>
            </td>
            <td class="t11 trm">
              <img class="gg" src="~assets/Ballistics.jpg" alt="" />
              <div><a href="Ballistics.php">彈道學</a></div>
            </td>
            <td class="t11 trm not">
              <img class="gg" src="~assets/Guard-tower-research.jpg" alt="" />
              <div><a href="Guard_Tower.php">防禦箭塔</a></div>
              <i class="fas fa-arrow-down"></i>
            </td>
            <td class="t11 trm not">
              <img class="gg" src="~assets/Heatedshot.png" alt="" />
              <div><a href="Heated_Shot.php">預熱射擊</a></div>
            </td>
            <td class="t11 trm">
              <img class="gg" src="~assets/Murderholes.jpg" alt="" />
              <div><a href="Murder_Holes.php">垛孔</a></div>
            </td>
            <td class="t11 trm not">
              <img class="gg" src="~assets/Treadmillcrane.jpg" alt="" />
              <div><a href="Treadmill_Crane.php">滑輪起重機</a></div>
            </td>
            <td class="t11 trm"></td>
          </tr>
          ...
          <tr>
            ...
            <td class="t11 trm not">
              ...
              <div><a href="Architecture.php">建築學</a></div>
            </td>
            <td class="t11 trm">
              <img class="gg" src="~assets/Chemistry.jpg" alt="" />
              <div><a href="Chemistry.php">化學</a></div>
              <i class="fas fa-arrow-down"></i><br /><img
                class="gg not"
                src="~assets/Bombard-tower-research.jpg"
                alt=""
              />
              <div><a href="Bombard_Tower.php" class="not">火砲塔</a></div>
            </td>
            <td class="t11 trm not">
              <img class="gg" src="~assets/Siegeengineers.jpg" alt="" />
              <div><a href="Siege_Engineers.php">攻城工程師</a></div>
            </td>
            <td class="t11 trm not">
              <img class="gg" src="~assets/Keep-research.jpg" alt="" />
              <div><a href="Keep.php">大型箭塔</a></div>
            </td>
            <td class="t11 trm not">
              <img class="gg" src="~assets/Arrowlits.jpg" alt="" />
              <div><a href="Arrowslits.php">箭狹槽</a></div>
            </td>
            <td class="t11 trm"></td>
            <td class="t11 trm"></td>
            <td class="t11 trm"></td>
