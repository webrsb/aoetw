      ...
      <div class="n1">
        <table class="table">
          ...
          <tr>
            ...
            <td class="t19 trm">
              ...
              <img class="gg not" src="~assets/ChampionIcon.png" alt="" />
        ...
        <table class="table" style="margin-top:50px;">
          ...
          <tr>
            ...
            <td class="t13 trm">
              <img class="gg" src="~assets/TarkanIcon.png" width="30" alt="" />
              <div><nuxt-link to="/units/Tarkan">韃靼騎兵</nuxt-link></div>
            </td>
            <td class="t13 trm">
            ...
            <td class="t13 trm">
              ...
              <div><nuxt-link to="/techs/Marauders">掠奪者</nuxt-link></div>
            </td>
            <td class="t13 trm"></td>
            <td class="t13 trm"></td>
            <td class="t13 trm"></td>
          ...
          <tr>
            ...
            <td class="t13 trm">
              <img class="gg" src="~assets/TarkanIcon.png" width="30" alt="" />
              <div><nuxt-link to="/units/Tarkan">精銳韃靼騎兵</nuxt-link></div>
            </td>
            <td class="t13 trm">
              <img
                class="gg"
            ...
            <td class="t13 trm">
              <img
                ...
                alt=""
              />
              <div><nuxt-link to="/techs/Atheism">無神論</nuxt-link></div>
            </td>
