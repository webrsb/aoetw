        ...
        <table class="table" style="margin-top:50px;">
          ...
          <tr>
            ...
            <td class="t13 trm">
              ...
              <div><nuxt-link to="/units/Boyar">貴族鐵騎</nuxt-link></div>
            </td>
            <td class="t13 trm">
            ...
            <td class="t13 trm">
              ...
              <div><nuxt-link to="/techs/Orthodoxy">東正教</nuxt-link></div>
            </td>
            <td class="t13 trm"></td>
            <td class="t13 trm"></td>
            <td class="t13 trm"></td>
          ...
          <tr>
            ...
            <td class="t13 trm">
              <img class="gg" src="~assets/New_Boyar.png" width="30" alt="" />
              <div><nuxt-link to="/units/Boyar">精銳貴族鐵騎</nuxt-link></div>
            </td>
            <td class="t13 trm">
              <img
                class="gg"
            ...
            <td class="t13 trm">
              <img
                ...
                alt=""
              />
              <div><nuxt-link to="/techs/Druzhina">王家侍從</nuxt-link></div>
            </td>
            <td class="t13 trm">
