      ...
      <div class="n1">
        <table class="table">
          ...
          <tr>
            ...
            <td class="t19 trm not">
              ...
              <div>
                <nuxt-link to="/units/Eagle_Warrior not">精銳鷹勇士</nuxt-link>
              </div>
            </td>
            <td class="t19 trm not">
        ...
        <table class="table" style=" margin-top:50px;">
          ...
          <tr>
            ...
            <td class="t19 trm ">
              ...
              <i class="fas fa-arrow-down "></i>
              <br /><img class="gg not " src="~assets/PaladinIcon.jpg" />
              <div>
            ...
            <td class="t19 trm not ">
              ...
              <i class="fas fa-arrow-down"></i>
              <br /><img class="gg not " src="~assets/ImperialCamelIcon.jpg" />
              <div>
        ...
        <table class="table " style="margin-top:50px; ">
          ...
          <tr>
            ...
            <td class="t23 trm ">
              ...
              />
              <div>
                <nuxt-link to="/Siege_units/Onager " class="not"
                  >重型投石車</nuxt-link
                >
              </div>
            </td>
        ...
        <table class="table " style="margin-top:50px; ">
          ...
          <tr>
            ...
            <td class="t13 trm ">
              <img class="gg " src="~assets/SMURI.jpg" width="30" alt="" />
        ...
        <table class="table" style="margin-top:50px; ">
          ...
          <tr>
            ...
            <td class="t10 trm ">
              ...
              <i class="fas fa-arrow-down "></i>
              <br /><img class="gg " src="~assets/CannonGalleonIcon.jpg" />
              <div>
