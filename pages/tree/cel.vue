      ...
      <div class="n1">
        ...
        <table class="table" style="margin-top:50px;">
          ...
          <tr>
            ...
            <td class="t19 trm">
              ...
              <i class="fas fa-arrow-down"></i><br />
              <img class="gg" src="~assets/PaladinIcon.png" />
        ...
        <table class="table" style="margin-top:50px;">
          ...
          <tr>
            ...
            <td class="t13 trm">
              <img class="gg" src="~assets/WBRSK.png" width="30" alt="" />
              <div><nuxt-link to="/units/Woad_Raider">菘藍武士</nuxt-link></div>
            </td>
            <td class="t13 trm">
            ...
            <td class="t13 trm">
              ...
              <div><nuxt-link to="/techs/Stronghold">堡壘</nuxt-link></div>
            </td>
            <td class="t13 trm"></td>
            <td class="t13 trm"></td>
            <td class="t13 trm"></td>
