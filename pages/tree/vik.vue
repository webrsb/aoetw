      ...
      <div class="n1">
        ...
        <table class="table" style="margin-top:50px;">
          ...
          <tr>
            ...
            <td class="t13 trm">
              <img class="gg" src="~assets/VBRSK.png" width="30" alt="" />
              <div><nuxt-link to="/units/Berserk">狂戰士</nuxt-link></div>
            </td>
            <td class="t13 trm">
            ...
            <td class="t13 trm">
              ...
              <div><nuxt-link to="/techs/Chieftains">酋長</nuxt-link></div>
            </td>
            <td class="t13 trm"></td>
            <td class="t13 trm"></td>
            <td class="t13 trm"></td>
          ...
          <tr>
            ...
            <td class="t13 trm">
              <img class="gg" src="~assets/VBRSK.png" width="30" alt="" />
              <div><nuxt-link to="/units/Berserk">精銳狂戰士</nuxt-link></div>
            </td>
            <td class="t13 trm">
              <img
                class="gg"
