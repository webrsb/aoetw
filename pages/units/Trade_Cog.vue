    ...
    <div class="row" style=" margin-top: 50px;">
      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          <p>
            貿易商旅較貿易車隊的移動速度更快（1.32：1），並且貿易商旅可以從<a
              href="Careening.php"
              >傾側維修術</a
            >、 <a href="Dry_Dock.php">旱碼頭</a>、<a href="Shipwright.php"
              >造船匠</a
          ...
          <tr>
            ...
            <td class="tta4">
              <img
                ...
                style="margin: 2px;"
                alt=""
              /><a href="Sultans.php">蘇丹</a>(+10%，<a href="Indians.php"
                >印度</a
              >限定)
            </td>
          </tr>
          ...
          <tr>
            ...
            <td class="tta4">
              ...
              <img
                ...
                style="margin: 2px;"
                alt=""
              /><a href="Silk_Road.php">絲綢之路</a>(-50%，<a
                href="Italians.php"
                >義大利</a
              >限定)
            </td>
        ...
        <div class="n1">
          <ul>
            <li>
              <a href="Berbers.php">柏柏</a>：貿易商旅的移動速度提高10％。
            </li>
            <li>
            ...
            <li>
              <a href="Italians.php">義大利</a>：研究<a href="Careening.php"
                >傾側維修術</a
            ...
            <li>
              ...
              <a href="Dry Dock.php">旱碼頭</a>的速度快20％。
            </li>
            <li>
        ...
        <div class="n1">
          <ul>
            <li>
              <a href="Spanish.php">西班牙</a>：貿易商旅可以產生多25%的黃金
            </li>
            <li>
        ...
        <div class="n1">
          ...
          <ul>
            ...
            <li>
              團隊有<a href="Spanish.php">西班牙</a>人時貿易商旅多產生33%黃金。
            </li>
          </ul>
          <h3>
          ...
          <ul>
            ...
            <li>
              4.8版本後團隊有<a href="Spanish.php">西班牙</a
              >人時貿易商旅多產生25%黃金。
            </li>
          </ul>
        </div>
        ...
        <div class="n1">
          <ul>
            <li>
              <a href="Berbers.php">柏柏</a>的貿易商旅當研發<a
                href="Dry_Dock.php"
                >旱碼頭</a
              >和
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/TradeCogIcon.jpg" width="45" alt="" />
              </div>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit4">民用、<a href="Naval_Vessels.php">船</a></td>
          </tr>
          <tr>
