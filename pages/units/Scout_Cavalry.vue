    ...
    <div class="row" style=" margin-top: 50px;">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            斥候騎兵或稱斥候，在封建時代有血量優勢與速度而使得他格外具有威脅性，是克制<a
              ...
              >遠程兵種</a
            >及有效擾亂對方
            <a href="Villager.php">村民</a>的明智選擇。對抵抗僧侶招降較佳與對<a
              href="Armor_Class_Monk.php"
              >僧侶類</a
            >有+6攻擊加成。
          </p>
          <p>
        ...
        <div class="n1">
          ...
          <p>
            <a href="Magyars.php">馬扎爾</a>的斥侯更是異常的兇猛，打法請見：<a
              href="scrush.php"
              >肉馬開局</a
            >。
          </p>
        ...
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="tta4">
              <a href="Skirmisher.php">矛兵系列</a>、<a href="Villager.php"
                >村民</a
              >、<a href="Siege_Weapons.php">攻城器單位</a>、
              <a href="Archer.php">弓兵</a>、<a href="Monk.php">僧侶</a>。
            </td>
          </tr>
          <tr>
            <td class="tta1" style="width:30%">劣勢(不易對抗)</td>
            <td class="tta4">
              <a href="Infantry_Units.php">步兵單位</a>、<a
          ...
          <tr>
            ...
            <td class="tta4">
              ...
              <img src="~assets/Unique-tech.jpg" class="gg" alt="" /><a
                href="Farimba.php"
                >驃悍精神</a
              >：馬廄單位攻擊+5。<a href="Malians.php">馬利</a>限定
              <br />
              <img src="~assets/Unique-tech.jpg" class="gg" alt="" /><a
                href="Manipur_Cavalry.php"
                >曼尼普爾騎兵</a
              >:騎兵對<a href="Armor_Class_Building.php">建築</a>和
              <a href="Armor_Class_Standard_Building.php">標準建築</a>攻擊+3。<a
                href="Burmese.php"
                >緬甸</a
              >限定
            </td>
          ...
          <tr>
            ...
            <td class="tta4">
              <img
                ...
                width="30"
                alt=""
              /><a href="Scale_Barding_Armor.php">騎兵鱗甲</a>(+1/+1)
              <br />
              <img
                class="gg"
                ...
                width="30"
                alt=""
              /><a href="Chain_Barding_Armor.php">騎兵鎖甲</a>(+1/+1)
              <br />
              <img
                class="gg"
                ...
                width="30"
                alt=""
              /><a href="Plate_Barding_Armor.php">騎兵板甲</a>(+1/+2)
            </td>
          </tr>
          <tr>
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              <a href="Burmese.php">緬甸</a>：<a href="Faith.php">忠誠信仰</a
              >便宜50%。
            </li>
            <li>
            ...
            <li>
              ...
              >：斥侯血量多20%(在非洲王朝資料片上線後)，研發<a
                href="Chivalry.php"
                >騎士精神</a
              >後 <a href="Husbandry.php">畜牧培育</a>研發速度快40%
            </li>
            <li>
              <a href="Magyars.php">馬扎爾</a>：免費<a href="Forging.php"
                >鍛造</a
              >、<a href="Iron_Casting.php">鑄鐵</a>、
              <a href="Blast_Furnace.php">鼓風爐</a>科技，<a
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              <a href="Huns.php">匈奴</a>：<a href="Scout_Cavalry.php">斥侯</a
              >生產和升級效率快20%， <a href="Bloodlines.php">品種</a>與<a
                href="Husbandry.php"
                >畜牧培育</a
              >研發快20%。
            </li>
            ...
            <li>
              <a href="Teutons.php">條頓</a>：<a href="Scout_Cavalry.php"
                >斥侯</a
              >對僧侶的抗招降能力更強。
            </li>
          </ul>
        ...
        <div class="n1">
          ...
          <ul>
            <li>
              <a href="Scout_Cavalry.php">斥侯</a>獲得對僧侶+6的額外攻擊。
            </li>
          ...
          <ul>
            <li>
              <a href="Franks.php">法蘭克</a>引入<a href="Chivalry.php"
                >騎士精神</a
              >
            </li>
            <li>
              <a href="Magyars.php">馬札爾</a>:<a href="Scout_Cavalry.php"
                >斥侯</a
              >便宜10%。
            </li>
          </ul>
          ...
          <ul>
            <li>
              <a href="Berbers.php">柏柏</a>的<a href="Scout_Cavalry.php"
                >斥侯</a
              >最初從城堡時代便宜20%，4.8版本後，變成城堡/帝王各便宜15/20%。
            </li>
            <li>
              <a href="Franks.php">法蘭克人</a>的<a href="Scout_Cavalry.php"
                >斥侯</a
              >受益於文明加成有+20%HP。
            </li>
          </ul>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="unit4"><a href="Cavalry_Units.php">騎兵</a></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit4">+6對<a href="Armor_Class_Monk.php">僧侶</a></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit4">
              <img
                ...
                width="30"
                alt=""
              /><a href="Dark_Age.php">黑暗時代</a>:1.2
              <br />
              <img
                class="gg"
                src="~assets/Feudal-age-reseach.jpg"
                width="30"
                alt=""
              /><a href="Feudal_Age.php">封建時代</a>之後:1.55
            </td>
          </tr>
          <tr>
            ...
            <td class="unit4">
              ...
              <img
                ...
                width="30"
                alt=""
              /><a href="Feudal_Age.php">封建時代</a>:6
              <br />
              <img
                class="gg"
                ...
                width="30"
                alt=""
              /><a href="Castle_Age.php">城堡時代</a>:8
              <br />
              <img
                class="gg"
                ...
                width="30"
                alt=""
              /><a href="Imperial_Age.php">帝王時代</a>:10
            </td>
          </tr>
          <tr>
            <td class="unit" colspan="2" style=" background-color:#3c763d;;">
          ...
          <tr>
            ...
            <td class="unit4">
              <img
                class="gg"
                src="~assets/Light-cavalry-research.jpg"
                alt=""
              />150食物50黃金
            </td>
          </tr>
