  ...
  <div class="container">
    ...
    <div class="row padtop">
      ...
      <div class="col-md-12">
        <div class="n1">
          <p>
            “海軍艦艇”也被稱為“船隻”，是“世紀帝國II”中唯一可以穿越水面的部隊。
            他們也可以通過淺水，但不能在陸地上移動。
            由於水是除了對海軍之外所有部隊的天然和不可逾越的障礙，因此在海圖上，例如:群島，沿海或波羅的海，海軍都是至關重要的
            。
          </p>
        </div>
        <h3>概要</h3>
        ...
        <div class="n1">
          <p>
            所有海軍船隻移動速度都很快，擁有高遠程裝甲和高HP。
            因此，幾乎所有的船隻都能夠在海岸線上與陸上單位作戰，他們可以對近戰單位打帶跑；對遠程單位使用遠程攻擊並且具備良好的抗炮火能力。但是攻城武器和僧侶是他們的弱點。船隻對建築物都有攻擊加成，這使得他們是相當好清除海岸線的突襲單位，但是防禦性建築也對船隻有額外傷害加成，所以只有能從安全距離轟炸時才去攻擊這些建築。
          </p>
          <p>
            所有的船隻都在碼頭訓練，並花費木材和黃金。黑暗時代的<nuxt-link
              to="/units/Fishing_Ship"
              >漁船</nuxt-link
            >和<nuxt-link to="/units/Transport_Ship">運輸船</nuxt-link
            >只花費木材。
          </p>
        </div>
        <h3>海軍文明</h3>
        ...
        <div class="n1">
          ...
          <ul>
            ...
            <li>
              ...
              >:漁船生命值加倍、+2遠程護甲、工作速率在黑暗/封建/城堡/帝王+5%/+10%/+15%/+20%。
            </li>
            <li>
            ...
            <li>
              ...
              >：碼頭有雙倍生命值並且在封建/城堡/帝王得工作速度+10%/+15%/+20%。
            </li>
            <li>
        ...
        <div class="n1">
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tunitc5">300F 200G</td>
              <td class="tunitc6">
                戰船、維京大戰船、卡拉維爾戰船的攻擊+1。研發後可生產火藥單位。
              </td>
            </tr>
            <tr>
              <td class="tunitc6">
        ...
        <div class="col-md-12">
          ...
          <div class="n1">
            <div class="col-md-4">
              <a target="_blank" href="/img/Vesselcivilian.jpg"
                ><img
                  class="imgn hg"
                  width="180"
            ...
            <div class="col-md-4">
              <a target="_blank" href="/img/Vesselmilitary.jpg"
                ><img
                  class="imgn hg"
                  width="200"
            ...
            <div class="col-md-4">
              <a target="_blank" href="/img/Vesselunique.jpg"
                ><img
                  class="imgn hg"
                  width="200"
          ...
          <div class="col-md-12">
            <div class="col-md-4">
              <a target="_blank" href="/img/Sailsaokaoc.jpg"
                ><img
                  class="imgn hg"
                  width="200"
              ...
              <div class="lightbox-caption" style="width:185px">
                <p>
                  <em
                    >不同旗幟的船隻(以戰船為例)(帝王世紀和征服者入侵資料片)。</em
                  >
                </p>
              </div>
            </div>
            <div class="col-md-4">
              <a target="_blank" href="/img/Sailshd.jpg"
                ><img
                  class="imgn hg"
                  width="200"
