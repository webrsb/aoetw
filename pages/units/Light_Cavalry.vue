      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            ...
            >，對<nuxt-link to="/units/Monk">僧侶</nuxt-link>、<nuxt-link
        ...
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="tta4">
              <img src="~assets/faith.png" width="30" alt="" /><nuxt-link
                to="/techs/Faith"
                >忠誠信仰</nuxt-link
              >
              <br />
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              ...
              >：輕騎兵速度在城堡時代/<nuxt-link to="/techs/age/Imperial_Age"
                >帝王時代</nuxt-link
              >提升10％/15％。
            </li>
            <li>
            ...
            <li>
              <nuxt-link to="/civs/Mongols">蒙古</nuxt-link>：輕騎兵血量多30%。
            </li>
            <li>
        ...
        <div class="n1">
          ...
          <ul>
            ...
            <li>
              <nuxt-link to="/civs/Magyars">馬扎爾</nuxt-link>:輕騎兵便宜10%。
            </li>
          </ul>
          <h3>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="unit4">
              +10對<nuxt-link to="/armor/Armor_Class_Monk">僧侶類</nuxt-link>
            </td>
          </tr>
          <tr>
