...
<nuxt-link to="/civs/Viking">維京</nuxt-link>。
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              <nuxt-link to="/civs/Franks">法蘭克</nuxt-link>：重裝騎士<nuxt-link
            ...
            <li>
              立陶宛:每個放在修道院的遺跡都會給重裝騎士+1攻擊(最多+4)。
            </li>
            <li>
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              <nuxt-link to="/civs/Persians">波斯</nuxt-link>：重裝騎士對<nuxt-link
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/CavalierIcon.png" class="img-fluid" alt="" />
              </div>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit4">
              <img class="gg" src="~assets/paladin.png" alt="" />1300食物750黃金
            </td>
          </tr>
          <tr>
