  ...
  <div class="container">
    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          <p>
            弩砲戰船在任何海戰中都扮演要角的地位，在好的操作之下弩砲戰船、重型弩砲戰船通常能有效的處理<nuxt-link
          ...
          <p>
            ...
            >、 <nuxt-link to="/units/Onager">中型投石車</nuxt-link>、<nuxt-link
              ...
              >火砲</nuxt-link
            >也會對艦隊造成毀滅性打擊。
            <br />另外，僧侶也是一大威脅，特別是沒有研發<nuxt-link
              to="/techs/Faith"
              >忠誠信仰</nuxt-link
            >
          </p>
      ...
      <div class="col-md-12">
        ...
        <div class="n1">
          <div class="col-md-12">
            ...
            <div class="col-md-4">
              <nuxt-link to="/img/Galleon.png"
                ><img class="imgn hg" src="~assets/Galleon.png" alt=""
              /></nuxt-link>
              <p><em>一群重型弩炮戰船。</em></p>
            </div>
            <div class="col-md-4">
              <nuxt-link to="/img/GalleonHD.png"
                ><img class="imgn hg" src="~assets/GalleonHD.png" alt=""
              /></nuxt-link>
              <p><em>各種重型弩炮戰船(世紀帝國和征服者入侵資料片)。</em></p>
            </div>
            <div class="col-md-12">
              <div class="col-md-4">
                <nuxt-link to="/img/GalleonDLC.png"
                  ><img class="imgn hg" src="~assets/GalleonDLC.png" alt=""
                /></nuxt-link>
