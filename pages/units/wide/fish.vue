      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          <ul>
            <li>
              <img
                src="~assets/FishAOEIIicon.png"
                width="22"
                style="margin-right: 5px;"
                alt=""
              /><strong>沿岸魚群</strong
              >:200食物，通常在岸邊就可以找到，所以可以透過村民收集，漁船也可以，但收集食物的速度比深海魚慢些。
            </li>
            <li>
              <img
                src="~assets/FishAOEIIicon.png"
            ...
            <li>
              <img
                ...
                alt=""
              /><strong>箱龜</strong
              >:200食物，與沿岸魚群一樣，於岸邊可以捕獲，村民可以採收，通常出現在亞洲地圖上。
            </li>
          </ul>
        </div>
        <h3>瑣事</h3>
        ...
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style="background-color:#b086b5;">
              <div class="unititle"><nuxt-link to="">魚類</nuxt-link></div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
