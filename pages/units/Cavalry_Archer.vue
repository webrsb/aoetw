    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          ...
          <p>
            除了<nuxt-link to="/civs/Aztecs">阿茲特克</nuxt-link>、<nuxt-link
              to="/civs/Incas"
              >印加</nuxt-link
            >與<nuxt-link to="/civs/Mayans">馬雅</nuxt-link
            >外，所以文明都可以使用。
          </p>
        </div>
        <h3>戰術</h3>
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              ...
              >：血量在城堡/帝王時代增加15%/20%。免費<nuxt-link
        ...
        <div class="n1">
          ...
          <ul>
            ...
            <li>
              ...
              >:特殊科技<nuxt-link to="/techs/Recurve_Bow">反曲弓</nuxt-link
              >給予馬弓騎兵+1射程。
            </li>
            <li>
              <nuxt-link to="/civs/Turks">土耳其</nuxt-link
              >:引進特殊科技<nuxt-link to="/techs/Sipahi">采邑騎兵</nuxt-link
              >P。
            </li>
          </ul>
          <h3>
          ...
          <ul>
            <li>
              <nuxt-link to="/civs/Magyars">馬扎爾</nuxt-link
              >:5.5版本後特殊科技<nuxt-link to="/techs/Recurve_Bow"
                >反曲弓</nuxt-link
              >給予馬弓騎兵+1射程和+1攻擊。
            </li>
          </ul>
        ...
        <div class="n1">
          <p>
            ...
            最主要的就是馬弓騎兵，當時他們是火力和速度的獨特組合，他們幾乎可以跨越幾乎任何一種地形，出乎意料地伏擊敵人，並在必要時在重騎兵或步兵部隊作出反應之前撤出。蒙古人特別擅長打帶跑和伏擊戰術，避免一對一戰鬥的同時也打得敵人完全失去信心，馬弓騎兵在開闊的地面上擁有非常大的操縱空間。但是對於要塞攻城和需要一對一的戰鬥則毫無應對策略。“
          </p>
        </div>
      </div>
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style="background-color:#3c763d;;">
              <div class="unititle"><nuxt-link to="">馬弓騎兵</nuxt-link></div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
          ...
          <tr>
            ...
            <td class="unit4">
              <img
                class="gg"
                src="~assets/Heavy-cavalry-archer-resear.jpg"
                alt=""
              />900食物500黃金
            </td>
          </tr>
      ...
      <div class="col-md-12">
        ...
        <div class="n1">
          ...
          <div class="col-md-4">
            <a target="_blank" href="/img/Cavalryarcher.png"
