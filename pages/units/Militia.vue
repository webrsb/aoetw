          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <tr>
                ...
                <td class="tta4">
                  <img class="gg" src="~assets/Unique-tech.jpg" width="30" alt=""><a href="Forced_Levy.php">強制徵兵</a>:軍營步兵單位訓練不需花黃金，<a href="Malay.php">馬來</a>限定。</td>
              </tr>
          </table>
          <h3>剋裝甲步兵的單位與建築</h3>
          <div class="hrn1"></div>
        ...
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="unit4">
                <img class="gg" src="~assets/Barracks-logo.jpg" alt=""><a href="Barracks-logo.php">軍營</a>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4">
                <img class="gg" src="~assets/ManAtArmsIcon.jpg" alt=""><a href="Man-at-Arms.php">裝甲步兵</a>
              </td>
            </tr>
            <tr>
              <td class="unit3">升級成本</td>
              <td class="unit4">
                <img class="gg" src="~assets/Man-at-arms-research.jpg" alt="">100肉45金</td>
            </tr>
            <tr>
