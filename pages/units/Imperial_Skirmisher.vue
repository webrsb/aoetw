    ...
    <div class="row padtop">
        ...
        <div class="n1">
          ...
          <p>
            ...
            <nuxt-link to="/civs/Aztecs">阿茲特克</nuxt-link>、<nuxt-link
              to="/civs/Britons"
              >不列顛</nuxt-link
            >、<nuxt-link to="/civs/Byzantines">拜占庭</nuxt-link>和
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              ...
              >：帝王戰矛兵生產快20%。研發<nuxt-link to="/techs/Thumb_Ring"
                >拇指環</nuxt-link
              >速度快20%。
            </li>
            <li>
          ...
          <tr>
            ...
            <td class="unit4">
              ...
              <br />+3對<nuxt-link to="/armor/Armor_Class_Spearman"
                >槍兵類</nuxt-link
              >
              <br />+3對<nuxt-link to="/armor/Armor_Class_Cavalry_Archer"
                >馬弓騎兵</nuxt-link
              >
            </td>
          </tr>
      ...
      <div class="col-md-12">
        ...
        <div class="n1">
          ...
          <div class="col-md-4">
            <a target="_blank" href="/img/Imperial_Skirmisher_group.jpg"
              ><img
                class="imgn hg"
