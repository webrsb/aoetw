        ...
        <div class="n1">
          <p>
            “Woad是在不列顛群島發現的一種植物，可以從中提取藍色色素，塞爾特戰士在戰鬥前用這種色素塗抹自己，讓自己看起來更加可怕並且使他們的敵人感到不安。塞爾特戰士一直在襲擊<nuxt-link
              to="/civs/Britons"
              >英國</nuxt-link
            >和歐洲的發展地區例如，蘇格蘭人最初是愛爾蘭侵略者，他們從英國北部的皮克特人手中奪取的土地最後成為蘇格蘭;當英國人試著征服居住在中世紀愛爾蘭，威爾士和蘇格蘭的塞爾特人時，英國<nuxt-link
              to="/units/Knight"
              >騎士</nuxt-link
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/WBRSK.png" width="45" alt="" />
              </div>
            </td>
          </tr>
          <tr>
