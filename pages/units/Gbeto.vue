  ...
  <div class="container">
    ...
    <div class="row padtop">
        ...
        <div class="n1">
          <ul>
            <li>
              ...
              <nuxt-link to="/units/Elite_Eagle_Warrior">精銳鷹戰士</nuxt-link
            ...
            <li>
              ...
              >。馬騎弓兵即便完全升級後對上這些單位仍非常頭痛。第二，飛刀女獵手不怕
      ...
      <div class="col-md-12">
        ...
        <div class="n1">
          <div class="col-md-4">
            <gallery src="~assets/Tumblr_nxo1o0aN0R1tnh0y7o2_400.png"
              ><img
                class="imgn hg"
          ...
          <div class="col-md-4">
            <gallery src="~assets/Gbeto_Attacking.jpg"
