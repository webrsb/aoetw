    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              <nuxt-link to="/civs/Chinese">條頓</nuxt-link
              >：爪刀勇士更難被招降。
            </li>
          </ul>
        </div>
      ...
      <div class="col-md-12">
        ...
        <div class="n1">
          <div class="col-md-12">
            <div class="col-md-4">
              <gallery src="~assets/Karambit_Warrior_group.jpg"
                ><img
                  class="imgn hg"
            ...
            <div class="col-md-4">
              <gallery src="~assets/Karambits.png"
                ><img class="imgn hg" src="~assets/Karambits.png" alt=""
              /></gallery>
              <p><em>兩個爪刀勇士只佔一人口。</em></p>
            </div>
            <div class="col-md-4">
              <gallery src="~assets/Karambit_knife.jpg"
