    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          <div class="ien">
            <p>
              卡拉維爾戰船是葡萄牙人在早期現代時期廣泛使用的輕型帆船，用於長途航行。葡萄牙人為探索非洲海岸而發展起來的，這艘輕型帆船的主要優勢在於它能夠以驚人的速度迎風航行迎風。"尼娜"和"平塔"是克里斯托弗哥倫佈在1492年曆史性的航行到新世界時使用的三艘船中的其中兩艘，其實就是卡拉維爾戰船。
            </p>
          </div>
        </div>
      </div>
