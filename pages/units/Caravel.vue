      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            ...
            >中訓練。它是艘可以像弩砲一樣傷害多個單位的<nuxt-link
        ...
        <div class="n1">
          <p>
            卡拉維爾戰船的攻擊可以傷害一直線上的單位，讓他們能殺死在岸邊的群聚單位或是在海上擊沉多艘敵方<nuxt-link
              to="/units/Naval_Vessels"
              >船艦</nuxt-link
            >。
          </p>
          <p>
            卡拉維爾戰船在大多數戰鬥表現中都比<nuxt-link to="/units/War_Galley"
              >弩砲戰船</nuxt-link
            >好，然而在1對1的戰鬥中他們會輸給<nuxt-link to="/units/War_Galley"
              >弩砲戰船</nuxt-link
            >，精銳卡拉維爾戰船則會輸給<nuxt-link to="/units/Galleon"
              >重型弩砲戰船</nuxt-link
            >。若是論打群架，卡拉維爾戰船則可以輕易地用穿透傷害戰勝他們。
          </p>
          <p>
            ...
            >的話玩家的經濟必須相當的好才行。但如果同時有這兩種<nuxt-link
              to="/units/Naval_Vessels"
              >船隻</nuxt-link
            >的話前者可以做輸出主力，後者則做肉盾，足以應付敵方的任何艦隊。
          </p>
        </div>
        <h3>更多數據</h3>
        <div class="hrn1"></div>
          ...
          <tr>
            ...
            <td class="tta4">
              ...
              <img
                ...
                style="margin: 2px;"
                alt=""
              /><nuxt-link to="/techs/Carrack">克拉克帆船</nuxt-link>(護甲+1/+1)
            </td>
          </tr>
          <tr>
        ...
        <div class="n1">
          <ul>
            <li>
              卡拉維爾戰船會對作弊單位中的<nuxt-link to="/units/hero/Saboteur"
                >破壞者</nuxt-link
            ...
            <li>
              如果卡拉維爾戰船與近戰單位搏鬥時，弩會向後發射，就像被該單位的劍反射了一樣。
            </li>
          </ul>
        </div>
        <h3>歷史</h3>
        ...
        <div class="n1">
          <div class="ien">
            <p>
              卡拉維爾戰船是<nuxt-link to="/civs/Portuguese">葡萄牙人</nuxt-link
              >在早期現代時期廣泛使用的輕型帆船，用於長途航行。葡萄牙人為探索非洲海岸而發展起來的，這艘輕型帆船的主要優勢在於它能夠以驚人的速度迎風航行迎風。"尼娜"和"平塔"是克里斯托弗哥倫佈在1492年曆史性的航行到新世界時使用的三艘船中的其中兩艘，其實就是卡拉維爾戰船。
            </p>
          </div>
        </div>
        <h3>圖庫</h3>
          ...
          <tr>
            ...
            <td class="unit4">
              <img
                ...
                alt=""
              />750<nuxt-link to="/resource/Food">食物</nuxt-link> 475黃金
            </td>
          </tr>
          <tr>
