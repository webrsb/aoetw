    ...
    <div class="row padtop">
      ...
      <div class="col-md-12">
        ...
        <div class="n1">
          <div class="col-md-12">
            <div class="col-md-4">
              <gallery src="~assets/AOF35_Imperial_Camel.jpg"
                ><img
                  class="imgn hg"
                  width="250"
            ...
            <div class="col-md-4">
              <gallery src="~assets/AOF36_Imperial_Camel.jpg"
                ><img
                  class="imgn hg"
            ...
            <div class="col-md-12">
              ...
              <div class="col-md-4">
                <gallery src="~assets/Indians_preview.jpg"
              ...
              <div class="col-md-4">
                <gallery src="~assets/Imperial_Camel_AoFE.jpg"
                  ><img
                    class="imgn hg"
