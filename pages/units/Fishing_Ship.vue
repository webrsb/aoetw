  ...
  <div class="container">
    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            漁船在海上算是一個弱小的單位，負責捕魚增加肉的生產，可以在<a
              href="Dock.php"
              >碼頭</a
            >訓練。
          </p>
          ...
          <p>
            值得一提的是幾個文明，<a href="Japanese.php">日本</a
            >的漁船工作效率極高，而<a href="Italians.php">義大利</a
            >的漁船相當便宜，
            <a href="Malay.php">馬來</a>的漁網有無限的食物採集量。
          </p>
        </div>
        <h3>更多數據</h3>
        <div class="hrn1"></div>
          ...
          <tr>
            ...
            <td class="tta4">
              <img
                ...
                alt=""
              /><a href="Careening.php">傾側維修術</a>(護甲+0/+1)
              <br />
              <img
                class="gg"
                ...
                style="margin: 2px;"
                alt=""
              /><a href="Carrack.php">克拉克帆船</a>(護甲+1/+1，<a
                href="Portuguese.php"
                >葡萄牙</a
              >限定)
            </td>
          ...
          <tr>
            ...
            <td class="tta4">
              <img
                ...
                alt=""
              /><a href="Shipwright.php">造船匠</a>(+54%)
            </td>
          </tr>
          <tr>
            ...
            <td class="tta4">
              <img
                ...
                src="~assets/Shipwright.jpg"
                alt=""
              /><a href="Shipwright.php">造船匠</a>(-20%)
            </td>
          </tr>
        </table>
            ...
            <div class="col-md-12">
              <div class="col-md-6">
                ...
                <ul>
                  ...
                  <li>
                    <img src="~assets/LongboatIcon.jpg" class="gg" alt="" /><a
                      href="Longboat.php"
                      >精銳維京大戰船</a
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              <a href="Byzantines.php">緬甸</a>：研究<a href="Faith.php"
                >忠誠信仰</a
              >便宜50％。
            </li>
            <li><a href="Celts.php">賽爾特</a>：在視野內的動物不會被轉化</li>
            <li>
              <a href="Chinese.php">中國</a>：有利於漁船的科技在城堡/帝王便宜
              15/20％
            </li>
            <li>
              <a href="Italians.php">義大利</a>：漁船便宜20％。研究<a
                href="Gillnets.php"
                >流刺網</a
              >， <a href="Dry Dock.php">旱碼頭</a>和<a href="Shipwright.php"
                >造船匠</a
              >便宜50％。
            </li>
            <li>
            ...
            <li>
              ...
              >：漁船訓練的速度在封建/城堡/帝王提高10%/15%/20%，<a
                href="Careening.php"
                >傾側維修術</a
              >和
              <a href="Gillnets.php">流刺網</a
              >的研究速度在城堡/帝王提高15%/20％。研究<a href="Dry Dock.php"
                >旱碼頭</a
              >快20％。
            </li>
        ...
        <div class="n1">
          <ul>
            <li>
              <a href="Teutons.php">條頓</a>：隊伍中的漁船對招降的抵抗力更強。
            </li>
          </ul>
        </div>
        <h3>更新日誌</h3>
        ...
        <div class="n1">
          ...
          <ul>
            <li>
              1.0版本<a href="Shipwright.php">造船匠</a
              >還可減少35%的船隻訓練時間。
            </li>
          ...
          <ul>
            <li>
              <a href="Italians.php">義大利</a>:5.5版本後漁船現在便宜20%。
            </li>
            <li>
            ...
            <li>
              <a href="ver5-8.php">5.8版</a>後義大利魚船花費60W → 64W (其他文明
              75W)
            </li>
        ...
        <div class="n1">
          <div class="ien">
            <p>
              中世紀造船，航海技術和導航技術大幅改善。這些進步的結果是漁船的捕魚範圍和效率更大。歐洲，北非和亞洲海岸的豐富水域提供了豐富的海產，可以通過乾燥和鹽漬來保存。保存的魚，特別是鱈魚，在中世紀後期成為重要的貿易品。
            </p>
          </div>
        </div>
      </div>
        ...
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style=" background-color:#3c763d;;">
              <div class="unititle"><a href="Fishing Ship.php">漁船</a></div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/FishingShipIcon.jpg" width="45" alt="" />
              </div>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit4">平民、<a href="Naval_Vessels.php">船</a></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit4"><a href="Armor_Class_Ship.php">船</a></td>
          </tr>
          <tr>
    ...
    <div class="col-md-12">
      ...
      <div class="n1">
        <div class="col-md-12">
          <div class="col-md-4">
            <a href="img/Fishingship.png"
              ><img class="imgn hg" src="~assets/Fishingship.png" alt=""
            /></a>
            <p><em>一群漁船。</em></p>
          </div>
          <div class="col-md-4">
            <a href="img/Fishingshipworking.png"
              ><img class="imgn hg" src="~assets/Fishingshipworking.png" alt=""
            /></a>
            <p><em>工作中的漁船。</em></p>
          </div>
          <div class="col-md-4">
            <a href="img/Fishingshipworkingtrap.png"
              ><img
                class="imgn hg"
                src="~assets/Fishingshipworkingtrap.png"
                alt=""
            /></a>
            <p><em>收集漁網食物的漁船。</em></p>
          </div>
