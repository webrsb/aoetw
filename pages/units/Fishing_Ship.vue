      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          ...
          <ul>
            ...
            <li>
              <nuxt-link to="/civs/Italians">義大利</nuxt-link>:漁船視野+2。
            </li>
          </ul>
          <h3>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="unit4">
              平民、<nuxt-link to="/units/Naval_Vessels">船</nuxt-link>
            </td>
          </tr>
          <tr>
    ...
    <div class="col-md-12">
      ...
      <div class="n1">
        <div class="col-md-12">
          ...
          <div class="col-md-4">
            <nuxt-link to="/img/Fishingshipworking.png"
              ><img class="imgn hg" src="~assets/Fishingshipworking.png" alt=""
            /></nuxt-link>
            <p><em>工作中的漁船。</em></p>
          </div>
          <div class="col-md-4">
            <nuxt-link to="/img/Fishingshipworkingtrap.png"
              ><img
                class="imgn hg"
