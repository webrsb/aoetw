  ...
  <div class="container">
    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            ...
            <nuxt-link to="/units/Infantry_Units">步兵</nuxt-link>與<nuxt-link
              to="/units/Villager"
              >村民</nuxt-link
            >，但對抗<nuxt-link to="/units/Knight">騎士</nuxt-link>、
        ...
        <div class="n1">
          ...
          <p>
            ...
            >一戰，甚至控制戰場。混搭一些<nuxt-link to="/units/Pikeman"
              >槍兵</nuxt-link
          ...
          <div class="n1">
            ...
            <div class="n1">
              <ul>
                ...
                <li>
                  ...
                  >：弩兵<nuxt-link to="">視野</nuxt-link>+2。
                </li>
                <li>
            ...
            <div class="n1">
              ...
              <ul>
                ...
                <li>
                  引入<nuxt-link to="/techs/Heresy">異端邪說</nuxt-link>。
                </li>
                <li>
                  <nuxt-link to="/civs/Britons">不列顛</nuxt-link
                  >:引進<nuxt-link to="/techs/Yeomen">義勇騎兵</nuxt-link
                  >，只能在帝王時代研發。
                </li>
              </ul>
              <h3>
      ...
      <div class="col-md-12">
        ...
        <div class="n1">
          <div class="col-md-4">
            <gallery src="~assets/Archerline.png"
              ><img class="imgn hg" src="~assets/Archerline.png" alt=""
            /></gallery>
            <p><em>弓兵系</em></p>
          </div>
          <div class="col-md-4">
            <gallery src="~assets/Crossbowman.png"
