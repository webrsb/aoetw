      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          <ul>
            ...
            <li><nuxt-link to="/civs/Huns">匈奴</nuxt-link>：造價便宜20%。</li>
        ...
        <div class="n1">
          ...
          <ul>
            <li>成本減為40木材65黃金。</li>
            <li>
              <nuxt-link to="/civs/Huns">匈奴</nuxt-link>:重裝馬弓騎兵便宜25％。
            </li>
            <li>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/HeavyCavArcherIcon.png" class="img-fluid" alt="" />
              </div>
            </td>
          </tr>
          <tr>
