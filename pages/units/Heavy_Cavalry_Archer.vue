      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            ...
            >的兵種。但因為他是騎馬的<nuxt-link to="/units/Archer_Units"
              >遠程單位</nuxt-link
            >，因此懼怕<nuxt-link to="/units/Elite_Skirmisher">戰矛兵</nuxt-link
        ...
        <div class="n1">
          <p>
            升級重裝馬弓騎兵非常昂貴，即使在<nuxt-link
              ...
              >城堡時代</nuxt-link
            >屯了大量的<nuxt-link to="/units/Cavalry_Archer">馬弓騎兵</nuxt-link
            ...
            >，而不是研發重裝馬弓。<nuxt-link to="/units/Skirmisher"
              >矛兵</nuxt-link
            >和<nuxt-link to="/units/Mangonel">投石車</nuxt-link>對於<nuxt-link
          ...
          <p>
            ...
            >絕對是<nuxt-link to="/civs/Huns">匈人</nuxt-link>、<nuxt-link
              to="/civs/Mongols"
              >蒙古人</nuxt-link
            ...
            >。<nuxt-link to="/civs/Huns">匈人</nuxt-link>則是有便宜的<nuxt-link
              to="/units/Cavalry_Archer"
              >馬弓騎兵</nuxt-link
            >，<nuxt-link to="/civs/Saracens">薩拉森</nuxt-link>對<nuxt-link
              to="/armor/Armor_Class_Building"
              >建築</nuxt-link
            >有攻擊加成，而<nuxt-link to="/civs/Magyars">馬扎爾</nuxt-link
            ...
            >的優勢，在高海拔戰鬥則有傷害加成，團隊加分讓馬弓視野加2可以輔助以上的馬弓文明，並且透過<nuxt-link
              to="/techs/Silk_Armor"
              >絲護甲</nuxt-link
            >可以+1近防和遠防增加攻擊的抗性；<nuxt-link to="/civs/Cumans"
              >庫曼</nuxt-link
        ...
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="tta4">
              ...
              5.5版後的<nuxt-link to="/civs/Magyars">馬扎爾</nuxt-link>限定
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="tta4">
              <img
                ...
                width="30"
                alt=""
              /><nuxt-link to="/techs/Thumb_Ring">拇指環</nuxt-link>(+11%)
            </td>
          </tr>
          <tr>
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              <nuxt-link to="/civs/Bulgarians">保加利亞</nuxt-link
              >：兵工廠重裝馬弓騎兵科技升級所需食物-50%。
            </li>
            <li>
              <nuxt-link to="/civs/Chinese">中國</nuxt-link
              >：對重裝馬弓騎兵有利的科技在帝王時代便宜20%。
            </li>
            <li>
            ...
            <li><nuxt-link to="/civs/Huns">匈人</nuxt-link>：造價便宜20%。</li>
            <li>
              <nuxt-link to="/civs/Koreans">朝鮮</nuxt-link>：重裝馬弓騎兵木材成本便宜20%。重裝馬弓騎兵護甲升級免費。
            </li>
            <li><nuxt-link to="/civs/Mongols">蒙古</nuxt-link>：射速快25%。</li>
            <li>
              <nuxt-link to="/civs/Portuguese">葡萄牙</nuxt-link
              >:重裝馬弓騎兵<nuxt-link to="/resource/Gold">黃金</nuxt-link
              >成本減少20%。重裝馬弓騎兵科技研發速度+30%。
            </li>
            <li>
              <nuxt-link to="/civs/Saracens">薩拉森</nuxt-link>：對<nuxt-link
            ...
            <li>
              <nuxt-link to="/civs/Tatars">韃靼</nuxt-link>：重裝馬弓騎兵高地戰鬥傷害+50%。<nuxt-link to="/techs/Thumb_Ring">拇指環</nuxt-link>免費。
            </li>
            <li>
              <nuxt-link to="/civs/Turks">土耳其</nuxt-link>：<nuxt-link
                to="/techs/Chemistry"
            ...
            <li>
              ...
              >：血量增加20%。免費<nuxt-link to="/techs/Conscription"
                >徵兵技術</nuxt-link
              >。
            </li>
          </ul>
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              ...
              >：重裝馬弓騎兵生產快20%。研發<nuxt-link to="/techs/Thumb_Ring"
                >拇指環</nuxt-link
              >和<nuxt-link to="/techs/Parthian_Tactics">安息人戰術</nuxt-link
              >的速度快20%。
            </li>
            ...
            <li>
              <nuxt-link to="/civs/Tatars">韃靼</nuxt-link>：重裝馬弓騎兵視野+2。
            </li>
            <li>
        ...
        <div class="n1">
          ...
          <ul>
            ...
            <li>重裝馬弓騎兵訓練時間為27秒。</li>
            <li>
              對<nuxt-link to="/units/Spearman">長槍兵</nuxt-link>攻擊+2。
            </li>
            ...
            <li>
              <nuxt-link to="/civs/Huns">匈人</nuxt-link>:重裝馬弓騎兵便宜30％。
            </li>
          </ul>
          <h3>
          ...
          <ul>
            <li>成本減為40木材65黃金。</li>
            <li>
              <nuxt-link to="/civs/Huns">匈人</nuxt-link>:重裝馬弓騎兵便宜25％。
            </li>
            <li>
          ...
          <ul>
            <li>
              <nuxt-link to="/civs/Magyars">馬扎爾</nuxt-link
              >:5.5版本後特殊科技反曲弓給予重裝馬弓騎兵+1射程和+1攻擊。
            </li>
          </ul>
          <h3>
          ...
          <ul>
            ...
            <li>
                ...
                重裝馬弓騎兵在帝王vs標準建築+4攻擊力。
            </li>
            <li>
              (39284更新)
              <nuxt-link to="/civs/Portuguese">葡萄牙</nuxt-link>重裝馬弓騎兵的黃金成本少20%。
            </li>
            <li>
              (39284更新)
              <nuxt-link to="/civs/Koreans">朝鮮</nuxt-link
              >重裝馬弓騎兵的木材成本從–15%改為-20%。
            </li>
            <li>
              (42848更新) 朝鮮重裝馬弓騎兵護甲升級免費。
            </li>
            <li>
              (42848更新)
              <nuxt-link to="/civs/Bulgarians">保加利亞</nuxt-link
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="unit4">
              +2對<nuxt-link to="/armor/Armor_Class_Spearman">槍兵類</nuxt-link>
            </td>
          </tr>
          <tr>
