    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
          ...
          <ul>
            ...
            <li>
              飛鏢騎兵可說是<nuxt-link to="/techs/age/Castle_Age"
                >城堡時代</nuxt-link
              >最強大的兵種之一，不是針對飛鏢騎兵的單位上很容易吃虧加大自己的損害。
            </li>
          </ul>
        </div>
        <h3>更多數據</h3>
        ...
        <div class="n1">
          <ul>
            <li>
              緬甸:研究<nuxt-link to="/techs/Faith">忠誠信仰</nuxt-link>便宜50%
            </li>
          </ul>
        </div>
        <h3>團隊加成</h3>
        ...
        <div class="n1">
          ...
          <ul>
            <li>
              最初飛鏢騎兵的攻擊是18(精銳是20)，移動速度則是
              1.35。5.7改版後攻擊力下調為17/19(精銳)，移動速度則降為 1.3。
            </li>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="unit4">
              對<nuxt-link to="/armor/Armor_Class_Ram">衝撞車系</nuxt-link>+2
            </td>
          </tr>
          <tr>
