    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          <ul>
            <li>
              羽毛弓箭手的攻擊力比大多數弓箭手都要低，但是具有更高的HP和更高的移動速度，足以跟上一些騎兵的速度。這使他們能夠有效地成為馬雅文明的馬弓騎兵執行打帶跑戰術。羽毛弓箭兵對大多數步兵有攻擊加成，除了
              ...
              >之外。雖然他們的生命值提高了，而且比大多數弓箭手還要多，然而他們還是很容易會被騎兵殲滅。如果是複數羽毛箭射手的話像<nuxt-link
                to="/units/Hussar"
                >匈牙利輕騎兵</nuxt-link
              >的弱小騎兵可以輕鬆應付；然而
              <nuxt-link to="/units/Paladin">遊俠</nuxt-link
              >仍是一個威脅，因為他們有足夠的攻擊力可以快速殺死羽毛箭射手，而且3的遠程護甲讓他們每次只受到羽毛箭射手2點傷害，這意味著他們在殺死羽毛箭射手前可以坦90下攻擊。
            </li>
            <li>
        ...
        <div class="n1">
          <p>
            “中美洲的土著人已經會製作弓，並將其用於戰鬥中，然而，與亞洲複合弓或英國長弓相比，他們的弓技術還不是很先進。與其他所有馬雅戰士一樣，弓箭手穿著與眾不同的服裝，因此指揮官可以區分他們的部隊並放置在合適的小組。弓箭手的地位遠低於其他戰士隊伍，因此有較低技術和技能的人會進入他們的隊伍
