  ...
  <div class="container">
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            <b>羽毛箭射手</b>是<nuxt-link to="/games/aoc">征服者入侵</nuxt-link
            >資料片中<nuxt-link to="/civs/Mayans">馬雅</nuxt-link>的<nuxt-link
              to="/units/Unique_Unit"
              >特殊單位</nuxt-link
            >，能夠在<nuxt-link to="/techs/age/Castle_Age">城堡時代</nuxt-link
            >的<nuxt-link to="/building/Castle">城堡</nuxt-link
            >中訓練。是個速度快裝甲好的<nuxt-link to="/units/Archer_Units"
              >弓兵</nuxt-link
            >。其相對較高的訓練成本被<nuxt-link to="/civs/Mayans"
              >馬雅人</nuxt-link
            >的<nuxt-link to="/civs">文明</nuxt-link
            >加成所降低，使其成為最具成本效益的<nuxt-link to="/units/Archer"
              >弓箭手</nuxt-link
            >之一。
          </p>
          <p>
            羽毛箭射手可以在<nuxt-link to="/techs/age/Imperial_Age"
              >帝王時代</nuxt-link
            >升級為<nuxt-link to="/units/Plumed_Archer"
              >精銳羽毛箭射手</nuxt-link
            >。
          </p>
        </div>
        ...
        <div class="n1">
          <ul>
            <li>
              羽毛弓箭手的<nuxt-link to="/elements/Attack">攻擊力</nuxt-link
              >比大多數弓箭手都要低，但是具有更高的HP和更高的移動速度，足以跟上一些<nuxt-link
                to="/units/Cavalry_Units"
                >騎兵</nuxt-link
              >的速度。這使他們能夠有效地成為馬雅文明的<nuxt-link
                to="/units/Cavalry_Archer"
                >馬弓騎兵</nuxt-link
              >執行打帶跑戰術。羽毛弓箭兵對大多數<nuxt-link
                to="/units/Infantry_Units"
                >步兵</nuxt-link
              >有攻擊加成，除了<nuxt-link to="/units/Huskarl"
                >哥德衛隊</nuxt-link
              >、<nuxt-link to="/units/Eagle_Warrior">鷹勇士</nuxt-link
              >、<nuxt-link to="/units/Condottiero">傭兵</nuxt-link>和<nuxt-link
                to="/units/Samurai"
                >日本武士</nuxt-link
              >之外。雖然他們的<nuxt-link to="/elements/Hit_points"
                >生命值</nuxt-link
              >提高了，而且比大多數弓箭手還要多，然而他們還是很容易會被騎兵殲滅。如果是複數羽毛箭射手的話像<nuxt-link
                to="/units/Hussar"
                >匈牙利輕騎兵</nuxt-link
              >的弱小騎兵可以輕鬆應付；然而<nuxt-link to="/units/Paladin"
                >遊俠</nuxt-link
              >仍是一個威脅，因為他們有足夠的攻擊力可以快速殺死羽毛箭射手，而且3的<nuxt-link
                to="/armor"
                >遠程護甲</nuxt-link
              >讓他們每次只受到羽毛箭射手2點傷害，這意味著他們在殺死羽毛箭射手前可以坦90下攻擊。
            </li>
            <li>
              在大多數情況下，羽毛箭射手都跟<nuxt-link to="/units/Eagle_Warrior"
                >鷹勇士</nuxt-link
              >搭配，因為兩個單位的移動速度都足夠快，可以執行突襲戰術，雙方都擁有良好的HP，並且覆蓋了彼此的主要弱點。和其他弓箭手一樣，羽毛箭射手對<nuxt-link
                to="/units/Siege_Weapons"
                >攻城武器</nuxt-link
              >的攻擊很脆弱，尤其是<nuxt-link to="/units/Mangonel"
                >投石車</nuxt-link
              >，不過65HP可以讓他們承受<nuxt-link to="/units/Onager"
                >中型投石車</nuxt-link
              >兩次的攻擊（<nuxt-link to="/units/Siege_Onager"
                >重型投石車</nuxt-link
              >還是一炮），並運用他們的速度輕鬆躲避敵人攻擊。<nuxt-link
                to="/units/Rattan_Archer"
                >藤甲弓兵</nuxt-link
              >可以輕鬆擊敗羽毛弓箭手即使羽毛弓箭手本身也具有不俗的遠程護甲。<nuxt-link
        ...
        <div class="n1">
          <ul>
            <li>
              ...
              >：羽毛箭射手在<nuxt-link to="/techs/age/Castle_Age"
                >城堡</nuxt-link
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              ...
              >：羽毛箭射手<nuxt-link to="/elements/Line_of_Sight"
                >視野</nuxt-link
              >+2。
            </li>
            <li>
        ...
        <div class="n1">
          ...
          <ul>
            <li>羽毛箭射手花費46木材46黃金。</li>
            <li>升級到精銳羽毛箭射手需要500食物1000木材。</li>
          </ul>
          <h3>
        ...
        <div class="n1">
          <p>
            “中美洲的土著人已經會製作弓，並將其用於戰鬥中，然而，與亞洲複合弓或<nuxt-link
              to="/civs/Britons"
              >英國</nuxt-link
            >長弓相比，他們的弓技術還不是很先進。與其他所有馬雅戰士一樣，弓箭手穿著與眾不同的服裝，因此指揮官可以區分他們的部隊並放置在合適的小組。弓箭手的地位遠低於其他戰士隊伍，因此有較低技術和技能的人會進入他們的隊伍具有地位和野心的人會加入了鷹勇士隊，在那裡他們有機會在戰場上奪取俘虜。“
          </p>
          <p>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/PlumedArcherIcon.png" class="img-fluid" alt="" />
              </div>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit4">
              ...
              >攻擊+2 <br />對<nuxt-link to="/armor/Armor_Class_Infantry"
                >步兵</nuxt-link
              >+1/+2(精銳) <br />對<nuxt-link
                to="/armor/Armor_Class_Condottiero"
                >傭兵</nuxt-link
              >+1/+2(精銳)
            </td>
          </tr>
          ...
          <tr>
            ...
            <td class="unit4">
              <img
                ...
                alt=""
              />700<nuxt-link to="/resource/Food">食物</nuxt-link>1000木材
            </td>
          </tr>
          <tr>
