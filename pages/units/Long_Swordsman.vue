  ...
  <div class="container">
    ...
    <div class="row" style=" margin-top: 50px;">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            長劍兵是一個步兵單位，升到城堡時代可以在<a href="Barracks.php"
              >軍營</a
            >訓練。
          </p>
        </div>
        ...
        <div class="n1">
          ...
          <p>
            長劍士是<a href="Castle_Age.php">城堡時代</a
            >的基本步兵單位。能夠擊敗除了<a href="Knight.php">騎士</a>和
            <a href="Archer.php">弓箭手</a
            >外所有的城堡時代單位，長劍兵也對建築物有攻擊加成，但因為行動遲緩、血量也不高，他仍不是一個良好的主力進攻單位，除非對手出了非常多的
            <a href="Eagle_Warrior.php">鷹勇士</a>
          </p>
          <p>
            早期<a href="aoc.php">《世紀帝國II:征服者入侵</a
            >》前的版本，長劍兵可說是一個雞肋單位，基本上沒有玩家會去生產，而到了被遺忘的王朝，長劍兵進一步的被強化，在現今
            <a href="Eagle_Warrior.php"></a
        ...
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="tta4">
              <a href="Skirmisher.php">矛兵</a>、<a href="Scout_Cavalry.php"
                >駱駝</a
              >、 <a href="Eagle_Scout.php">鷹勇士</a>、<a href="Spearman.php"
                >輕騎兵</a
              >、<a href="Villager.php">重裝長槍兵</a>。
            </td>
          </tr>
          <tr>
            ...
            <td class="tta4">
              ...
              <a href="Janissary.php">土耳其火槍兵</a>、<a href="Slinger.php"
                >投石手</a
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              <a href="Burmese.php">緬甸</a>：長劍兵在封建/城堡/帝王時代有
              +1/+2/+3攻擊。
            </li>
            ...
            <li>
              <a href="Goths.php">哥德</a>：長劍兵便宜35％並對<a
              ...
              <a href="Arson.php">縱火</a>和升級雙手劍兵的速度快100%。
            </li>
            ...
            <li>
              <a href="Malians.php">馬利</a>：長劍兵在城堡/帝王時代有 +2/+3
              遠程護甲。
            </li>
            <li>
              <a href="Portuguese.php">葡萄牙</a>：長劍兵黃金成本減少15％。
            </li>
            <li>
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              <a href="Goths.php">哥德</a>：長劍兵訓練和升級快20%。研發<a
                href="Tracking.php"
                >追縱技術</a
        ...
        <div class="n1">
          ...
          <ul>
            <li>長劍兵現在有55HP。</li>
            <li>
              長劍兵擁有+2攻擊VS<a href="Armor_Class_Standard_Building.php"
                >標準建築</a
              >。
            </li>
            <li>長劍兵遠防是0。</li>
          ...
          <ul>
            <li>
              長劍兵擁有+4攻擊VS<a href="Armor_Class_Eagle_Warrior.php"
                >鷹勇士</a
              >。
            </li>
            <li>長劍兵現在擁有1的遠防。</li>
          ...
          <ul>
            <li>長劍兵現在有60HP。</li>
            <li>
              長劍兵擁有+3攻擊VS<a href="Armor_Class_Standard_Building.php"
                >標準建築</a
              >。
            </li>
            <li>
              長劍兵擁有+6攻擊VS<a href="Armor_Class_Eagle_Warrior.php"
                >鷹勇士</a
              >。
            </li>
          </ul>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/LongswordsManIcon.jpg" width="45" alt="" />
              </div>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit4">
              +6對<a href="Armor_Class_Eagle_Warrior.php">鷹勇士</a>
          ...
          <tr>
            ...
            <td class="unit4">
              <img class="gg" src="~assets/ManAtArmsIcon.jpg" alt="" /><a
