          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <tr>
                ...
                <td class="tta4">
                  <img class="gg" src="~assets/Unique-tech.jpg" width="30" alt=""><a href="Perfusion.php">灌注士氣</a>:軍營步兵單位訓練不需花黃金，<a href="Malay.php">馬來</a>限定。</td>
              </tr>
          </table>
          <h3>剋長劍兵的單位與建築</h3>
          <div class="hrn1"></div>
        ...
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="unit4">
                <img class="gg" src="~assets/Tw-handed-swordsman-researc.jpg" alt="">300肉100金</td>
            </tr>
            <tr>
