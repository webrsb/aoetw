  ...
  <div class="container">
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            <b>薩金特衛兵</b>是<nuxt-link to="/civs/Sicilians"
              >西西里</nuxt-link
        ...
        <div class="n1">
          <ul>
            <li>
              薩金特衛兵是一個超級特殊的<nuxt-link to="/units/Infantry_Units">步兵單位</nuxt-link
              >，他們能建造<nuxt-link to="/building/Donjon">城樓</nuxt-link
              >，並且可以在<nuxt-link to="/techs/age/Feudal_Age">封建時代</nuxt-link
              >的城樓中訓練。封建時代的薩金特衛兵與<nuxt-link to="/units/Man-at-Arms">裝甲步兵</nuxt-link
              >相比，他們擁有相同<nuxt-link to="/elements/Hit_points">血量</nuxt-link
              >，<nuxt-link to="/armor">近防</nuxt-link
              >和遠防比裝甲步兵高，但<nuxt-link to="/elements/Attack">攻擊力</nuxt-link
              >和視野低。不過，薩金特衛兵成本更高，並且需要花費200<nuxt-link to="/resource/Stone">石頭</nuxt-link
              >和75<nuxt-link to="/resource/Wood">木材</nuxt-link
              >建造城樓訓練。
            </li>
            <li>
              薩金特衛兵能建造城樓的能力衍生出類似<nuxt-link to="/ar/towerrush">塔攻</nuxt-link
              >的打法-城樓攻，這打法的配置和策略大致與塔攻相似。另外薩金特衛兵建造城樓的時間和<nuxt-link to="/units/Villager">村民</nuxt-link
              >一樣，因此村民在蓋完第一座城樓時就可以返回基地採集資源，而且城樓可以<nuxt-link to="/elements/Garrison">駐守</nuxt-link
              >10個單位，可以配合<nuxt-link to="/units/Archer">弓兵</nuxt-link
              >增加城樓箭數，再通過城樓訓練薩金特衛兵繼續建造城樓。
            </li>
            <li>
              一旦到達<nuxt-link to="/techs/age/Castle_Age">城堡時代</nuxt-link
              >，薩金特衛兵會獲得+15血量（總計60），+3攻擊力（總計8），+2遠防和+1近防（總計3/3護甲），與<nuxt-link to="/units/Long_Swordsman">長劍兵</nuxt-link
              >相比，城堡時代的薩金特衛兵更能抵禦弓箭和近戰攻擊，加上西西里有減少額外攻擊的文明加成，使薩金特衛兵能應對不同類型的單位。城堡時代後，除非缺乏石頭建造城樓或城堡，薩金特衛兵基本上是首選步兵。另外，<nuxt-link to="/units/Militia">民兵</nuxt-link
              >系仍然是對抗<nuxt-link to="/units/Eagle_Warrior">鷹勇士</nuxt-link
              >的更好選擇，在某些情況下還是有可能出動長劍兵。<nuxt-link to="/techs/age/Imperial_Age">帝王時代</nuxt-link
              >後，精銳薩金特衛兵仍然比<nuxt-link to="/units/Champion">劍兵勇士</nuxt-link
              >好。其裝甲是高遠防<nuxt-link to="/units/Huskarl">哥德衛隊</nuxt-link
              >和高近防<nuxt-link to="/units/Teutonic_Knight">條頓武士</nuxt-link
              >的融合中間體。
            </li>
            <li>
              西西里特殊科技<nuxt-link to="/techs/First_Crusade">第一次十字軍東征</nuxt-link
              >可以使所有<nuxt-link to="/building/Town_Center">城鎮中心</nuxt-link
              >（最多5座）一次性生產10個薩金特衛兵。即使已經達到人口上限仍然可以研發，可以在緊急情況下研發，從而快速增加軍隊數量突襲對手。
            </li>
          </ul>
        </div>
        <h3>更多數據</h3>
        ...
        <div class="n1 bonuses">
          以下單位擁有對薩金特衛兵的額外傷害，按造殺傷力排列。(由於西西里減免額外傷害33%的文明加成，實際上造成的傷害皆偏低)
          <div class="n1">
            <div class="row">
              <div class="col-md-6">
          ...
          <ul>
            <li>
              <nuxt-link to="/civs/Berbers">柏柏</nuxt-link>：<nuxt-link
                to="/techs/Kasbah"
                >聚居堡壘</nuxt-link
              >能夠提高薩金特衛兵的生產速度還有加速<nuxt-link
                to="/techs/Conscription"
                >徵兵技術</nuxt-link
              >和<nuxt-link to="/techs/First_Crusade">第一次十字軍東征</nuxt-link
              >的研究時間(快25%)。
            </li>
            <li>
              <nuxt-link to="/civs/Bulgarians">保加利亞</nuxt-link>：<nuxt-link
                ...
                >兵工廠</nuxt-link
              >提升薩金特衛兵護甲和怯薛攻擊的科技研發快80％。
            </li>
            <li>
              <nuxt-link to="/civs/Goths">哥德</nuxt-link>：研發<nuxt-link to="/techs/Squires">護衛技術</nuxt-link>、<nuxt-link
                to="/techs/Arson"
                >縱火</nuxt-link
              >的時間快20%。
            </li>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          <tr>
            ...
            >
              <div class="unititle" style="color: #fff">薩金特衛兵</div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
          ...
          <tr>
            ...
            <td class="unit4">45(城堡時代+15)/75(精銳)</td>
          </tr>
          <tr>
            <td class="unit3">攻擊</td>
            <td class="unit4">5(城堡時代+3)/11(精銳)(近戰)</td>
          </tr>
          <tr>
            ...
            <td class="unit4">
              對<nuxt-link to="/armor/Armor_Class_Eagle_Warrior"
                >鷹勇士</nuxt-link
              >+2/+3(精銳) <br />對<nuxt-link to="/armor/Armor_Class_Standard_Building"
                >標準建築</nuxt-link
              >+2/+3(精銳)
            </td>
          </tr>
          ...
          <tr>
            ...
            <td class="unit4">1(城堡時代+2)/4(精銳)</td>
          </tr>
          <tr>
            <td class="unit3">遠防</td>
            <td class="unit4">2(城堡時代+1)/4(精銳)</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit4">
              <img class="gg" src="~assets/ShotelIcon.png" alt="" />精銳薩金特衛兵
            </td>
          </tr>
          <tr>
