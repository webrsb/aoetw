    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
          ...
          <div class="n1">
            <div class="col-md-12">
              <div class="col-md-6">
                ...
                <div style="margin:12px 0px;"><strong>+21攻擊</strong></div>
                <ul>
                  <li>
                    <img
                      class="gg"
        ...
        <div class="n1">
          <ul>
            <li>
              <nuxt-link to="/civs/Aztecs">阿茲特克</nuxt-link>：傭兵生產快15%。
            </li>
            <li>
            ...
            <li>
              <nuxt-link to="/civs/Vikings">維京</nuxt-link>：傭兵多20% HP。
            </li>
          </ul>
        </div>
        <h3>團隊加成</h3>
        ...
        <div class="n1">
          <ul>
            <li>
              傭兵是少數四種對<nuxt-link to="/units/Eagle_Warrior"
                >鷹勇士</nuxt-link
      ...
      <div class="col-md-12">
        ...
        <div class="n1">
          <div class="col-md-4">
            <a target="_blank" href="/img/Condottiero_Group.jpg"
              ><img
                class="imgn hg"
                width="250"
          ...
          <div class="col-md-4">
            <a target="_blank" href="/img/Per.jpg"
        ...
        <div class="col-md-12">
          <div class="col-md-4">
            <a target="_blank" href="/img/Genoese_&_Condottiero.jpg"
              ><img
                class="imgn hg"
                width="250"
