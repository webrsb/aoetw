      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              ...
              >：兵<nuxt-link to="/building/Blacksmith">兵工廠</nuxt-link
              >匈牙利輕騎兵科技升級所需食物-50%。
            </li>
            <li>
              <nuxt-link to="/civs/Burmese">緬甸</nuxt-link>：<nuxt-link
        ...
        <div class="n1">
          ...
          <ul>
            ...
            <li>
              (37650更新)
              匈牙利輕騎兵攻擊動畫更短。雖然這不會影響輸出，但可以更好的追擊單位。
            </li>
            <li>
        ...
        <div class="n1">
          <div class="row">
            <div class="col-md-4">
              <gallery
                ><img class="imgn hg" src="~assets/Hussars.png" alt=""
              /></gallery>
              <p><em>一群匈牙利輕騎兵。</em></p>
            </div>
          </div>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/HussarIcon.png" class="img-fluid" alt="" />
              </div>
            </td>
          </tr>
          <tr>
