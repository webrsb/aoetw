...
<nuxt-link to="/civs/Viking">維京</nuxt-link>。
        ...
        <div class="n1">
          ...
          >、速度都是頂尖。一隊40隻遊俠可無視任何阻礙，消滅任何準備不足的單位或是<nuxt-link
            ...
            >建築</nuxt-link
          >。<nuxt-link to="/civs/Franks">法蘭克</nuxt-link
          >雖然缺乏品種，但受益於文明加成給遊俠額外20%HP，讓法蘭克的遊俠是全遊戲中血最厚的；<nuxt-link to="/civs/Lithuanians">立陶宛</nuxt-link
          ...
          <div class="n1">
            ...
            <div class="n1">
              <ul>
                <li>
                  <nuxt-link to="/civs/Berbers">柏柏</nuxt-link>：<nuxt-link
                    to="/techs/Kasbah"
                    >聚居堡壘</nuxt-link
                  >能夠加速<nuxt-link to="/techs/Conscription"
                    >徵兵技術</nuxt-link
                  >的研究時間(快25%)。
                </li>
                <li>
              ...
              >:研發忠誠信仰和異端邪說的速度快20%。
                ...
                <li>
                  <nuxt-link to="/civs/Persians">波斯</nuxt-link
                  >：遊俠對<nuxt-link to="/armor/Armor_Class_Archer"
                    >射手類</nuxt-link
                  >+2攻擊。
                </li>
                <li>
                  <nuxt-link to="/civs/Teutons">條頓</nuxt-link
                  >：遊俠對<nuxt-link to="/units/Monk">僧侶</nuxt-link
                  >抵抗力更強。
                </li>
              </ul>
            </div>
            ...
            <div class="n1">
              <ul>
                ...
                <li>
                  ...
                  >和<nuxt-link to="/units/Turtle_Ship">龜甲船</nuxt-link>。
                </li>
                <li>
                  ...
                  >為地區性<nuxt-link to="/units/Unique_Unit"
                    >特殊單位</nuxt-link
                  >。)
                </li>
                <li>所有遊俠文明皆是歐洲或中東風格。決定版發行後中亞的庫曼也可以訓練遊俠。</li>
                <li>
            ...
            <div class="n1">
              <div class="row">
                ...
                <div class="col-md-4">
                  <gallery
                    ><img class="imgn hg" src="~assets/IMG_20190725_161218.png" alt=""
                  /></gallery>
                  <p><em>決定版的遊俠。</em></p>
                </div>
              </div>
