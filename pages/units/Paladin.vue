      ...
      <div class="col-md-8">
          ...
          <div class="col-md-12">
            <div class="n1">
              ...
              >、<nuxt-link to="/civs/Spanish">西班牙</nuxt-link>、<nuxt-link
                to="/civs/Teutons"
                >條頓</nuxt-link
              >、<nuxt-link to="/civs/Cumans">庫曼</nuxt-link>、<nuxt-link to="/civs/Lithuanians">立陶宛</nuxt-link>。
            </div>
          </div>
        </div>
        <div class="row">
        ...
        <div class="n1">
          ...
          >遊俠比一般遊俠多12HP，是全遊戲最強大的遊俠；波斯（和其同盟）則是可以給弓兵多2的額外傷害，尤其對付打馬弓騎兵猶為明顯；<nuxt-link
            to="/civs/Lithuanians"
            >立陶宛</nuxt-link
          >遊俠則每擁有1個聖物就能加1攻，最多加4攻可達到22攻，攻擊加滿能和法蘭克競爭最強遊俠寶座。條頓的遊俠則是缺跑速，但血統和攻防都有因此仍可以用，且有額外多1的近防；而<nuxt-link
            to="/civs/Byzantines"
            >拜占庭</nuxt-link
          >與塞爾特遊俠則是重看不重用。
        </div>
        ...
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="tta4">
               <img class="gg" src="~assets/unique_tech.png" alt="" />馬蹬：攻擊速度快25%，保加利亞限定
            </td>
          </tr>
          <tr>
            <td class="tta1" style="width:10%">
          ...
          <div class="n1 bonuses">
            ...
            <div class="n1">
              ...
              <ul>
                ...
                <li>
                  保加利亞：更新檔39606後特殊科技馬蹬影響所有騎兵單位，但失去遊俠，因此攻速快25%的遊俠只可能在自訂戰役的編輯模式使用。
                </li>
                <li>
                  條頓：更新檔39606後，馬廄單位於城堡時代開始近戰防禦+1。
                </li>
              </ul>
            </div>
            <h3>趣事</h3>
            ...
            <div class="n1">
              <ul>
                ...
                <li>為了平衡，遊俠的攻速(1.93)比重裝騎士(1.83)還慢。</li>
                <li>
                ...
                <li>
                  <nuxt-link to="/civs/Magyars">馬扎爾</nuxt-link>是<nuxt-link
                    to="/games/aof"
                    >失落的帝國</nuxt-link
                  >之後，在決定版實裝前唯一的遊俠文明。而決定版實裝的四個新文明中，最初有三個文明有遊俠且科技都全滿，只有韃靼文明沒有遊俠；更新檔39606之後把保加利亞的遊俠拿掉了。
                </li>
              </ul>
            </div>
            <h3>歷史</h3>
