  ...
  <div class="container">
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            遊俠，新譯名為聖騎士。遊俠是<nuxt-link to="/techs/age/Imperial_Age"
              >帝王時代</nuxt-link
    ...
    <div class="col-md-12">
      ...
      <div class="n1 bonuses">
        ...
        以下技術可讓以下單位對遊俠有額外攻擊力
        <div class="n1">
          <img class="gg" src="~assets/CastleAgeUnique.png" width="22" alt="" />
          ...
          <ul>
            <li>
              <img class="gg" src="~assets/MilitiaIcon.jpg" alt="" /><nuxt-link
                to="/units/Militia"
                >民兵</nuxt-link
              >→
              <img
            ...
            <li>
              ...
              >(如果和<nuxt-link to="/civs/Italians">義大利</nuxt-link>同盟的話)
            </li>
          </ul>
        </div>
      </div>
      ...
      <div class="n1">
        <ul>
          ...
          <li>
            ...
            <nuxt-link to="/techs/Blast_Furnace">鼓風爐</nuxt-link>科技
          </li>
          <li>
            <nuxt-link to="/civs/Spanish">西班牙</nuxt-link
            >：兵工廠升級科技免黃金
      ...
      <div class="n1">
        <ul>
          <li>
            遊俠升級成本1300食物、750黃金是遊戲中第四貴的，只輸戰象、投石車和聖騎兵。然而，如果你考慮到升級遊俠前你還得升級成騎兵，那麼成本就是1600食物和1050黃金，則只有投石車與戰象更高。
          </li>
