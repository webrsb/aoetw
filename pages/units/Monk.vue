    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          ...
          <p>
            <em
              >請見主條目：<nuxt-link to="/elements/Conversion"
                >招降</nuxt-link
              ></em
            >
          </p>
        ...
        <div class="n1">
          ...
          <iframe
            width="300"
            src="https://www.youtube.com/embed/hf1gCiqfwx8"
            frameborder="0"
        ...
        <div class="n1">
          <ul>
            <li>
              <nuxt-link to="">阿茲特克</nuxt-link
              >：修道院每項技術研發可讓僧侶獲得+5 HP。
            </li>
            <li>
              <nuxt-link to="/civs/Burmese">緬甸</nuxt-link
              >：使僧侶受益的技術便宜50％。
            ...
            <li>
              <nuxt-link to="">中國</nuxt-link
              >：受益僧侶的技術在城堡/帝國時代分別便宜15％/ 20％。
            </li>
            <li>
              <nuxt-link to="">葡萄牙</nuxt-link>：僧侶黃金成本減少了15％。
            </li>
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              <nuxt-link to="">條頓</nuxt-link>：僧侶的團隊對招降更有抵抗力。
            </li>
            <li>
              <nuxt-link to="/civs/Burmese">緬甸</nuxt-link
              >：可以看到所有遺跡的起始位置
        ...
        <div class="n1">
          ...
          <ul>
            <li>
              <nuxt-link to="/techs/Fervor">宗教狂熱</nuxt-link>影響所有僧侶。
            </li>
            <li>拜占庭僧侶治療速度快200%。</li>
          </ul>
          <h3>
          ...
          <ul>
            ...
            <li>
              引入<nuxt-link to="/techs/Theocracy">神權統治</nuxt-link
              >與<nuxt-link to="/techs/Heresy">異端邪說</nuxt-link>
            </li>
          ...
          <ul>
            ...
            <li>
              薩拉森引入新科技<nuxt-link to="/techs/Madrasah"
                >穆斯林學墊
              </nuxt-link>
            </li>
            <li>
              西班牙引入新科技<nuxt-link to="/techs/Inquisition"
                >異端審判</nuxt-link
              >
            </li>
          </ul>
        ...
        <div class="n1">
          <ul>
            <li>
              僧侶是遊戲中唯二兩個只需要黃金生產的單位，另一個是<nuxt-link
                to="/units/Missionary"
                >傳教士</nuxt-link
              >。
            </li>
            <li>
              僧侶是遊戲中唯三同種單位，卻有不同的外表之一，另外兩個是<nuxt-link
                to="/units/Villager"
                >村民</nuxt-link
              >與<nuxt-link to="/units/Trade_Cart">貿易車隊</nuxt-link>。
            </li>
            <li>
