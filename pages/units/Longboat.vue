    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          <ul>
            <li>
              維京大戰船移動得比<nuxt-link to="/units/Galleon"
                >重型弩砲戰船</nuxt-link
              >快。
            </li>
            <li>
            ...
            <li>
              維京大戰船在破壞<nuxt-link to="/building">建築</nuxt-link
              >跟攻擊陸上單位的命中率上比重型弩砲戰船好。
            </li>
            <li>
              整體來說精銳維京大戰船比重型弩砲戰船表現更佳(特別是速度)，不過考慮到訓練成本時他們的價值其實大致相同。
            </li>
          </ul>
        </div>
        <h3>更多數據</h3>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/LongboatIcon.png" class="img-fluid" alt="" />
              </div>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit4">
              +9/+11(精銳)對<nuxt-link to="/armor/Armor_Class_Ship"
                >船</nuxt-link
              >
              <br />+7/+8(精銳)對<nuxt-link to="/armor/Armor_Class_Building"
                >建築</nuxt-link
              >
