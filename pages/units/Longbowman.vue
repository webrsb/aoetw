      ...
      <div class="col-md-8">
          ...
          <ul>
            <li>
              ...
              >能夠提高長弓兵的生產速度還有加速<nuxt-link
                ...
                >徵兵制度</nuxt-link
              >和<nuxt-link to="/techs/Yeomen">義勇騎兵</nuxt-link
              >的研究時間(快25%)。
            </li>
            <li>
            ...
            <li>
              ...
              <img
                ...
                width="30"
                alt=""
              /><nuxt-link to="/techs/Ballistics">彈道學</nuxt-link>研究快80%。
            </li>
            <li>
        ...
        <div class="n1">
          ...
          <ul>
            <li>
              ...
              >獲得+2的攻擊vs<nuxt-link to="/armor/Armor_Class_Spearman"
                >槍兵</nuxt-link
              >
            </li>
            <li>
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              遊戲中的長弓兵箭袋都是背上身上，而現實中的長弓兵箭袋都是掛在腰間。
            </li>
          </ul>
        </div>
        <h3>歷史</h3>
