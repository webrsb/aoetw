      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          <div class="row">
            <div class="col-md-4">
              <gallery
                ><img class="imgn hg" src="~assets/Onagers.png" alt=""
              /></gallery>
              <p><em>中型投石車</em></p>
            </div>
            <div class="col-md-4">
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/OnagerIcon.png" alt="" />
              </div>
            </td>
          </tr>
          <tr>
