        ...
        <div class="n1">
          <ul>
            ...
            <li>
              ...
              <nuxt-link to="/units/Fire_Galley">火戰船</nuxt-link
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="unit4">1(遠攻) <br />0(近戰)</td>
          </tr>
          <tr>
      ...
      <div class="col-md-12">
        ...
        <div class="n1">
          <div class="col-md-12">
            ...
            <div class="col-md-4">
              <nuxt-link to="/img/Firegalley (1).png"
                ><img class="imgn hg" src="~assets/Firegalley (1).png" alt=""
              /></nuxt-link>
              <p><em>一群火蒙衝。</em></p>
            </div>
            <div class="col-md-4">
              <nuxt-link to="/img/Firegalley.png"
                ><img class="imgn hg" src="~assets/Firegalley.png" alt=""
              /></nuxt-link>
