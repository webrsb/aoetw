...
<nuxt-link to="/civs/Viking">維京</nuxt-link>。
        ...
        <div class="n1">
          ...
          <p>
            火炮和投石機是遊戲中射程最長，最昂貴的攻城武器。火炮比投石機更具機動性，因為它不需要像投石機那樣組/拆裝。但是投石機的黃金和木材成本都要比火砲便宜25（意大利人和葡萄牙人除外，他們有額外減免），而且每個文明都能使用；而火砲則僅適用於某些文明。投石機也可以用來摧毀樹木。

火炮的攻擊相比投石機更為精確，也可以對部隊造成飛濺傷害，但射程較短，也可能傷害友軍。它們對目標的傷害遠少於投石機，但射速更快，投射物飛行速度更快。總體而言，火炮在通用性方面優於投石機，因為它們對建築物和單位都有效，但是在破壞敵方建築物時投石機的射程和攻擊力是無與倫比。
          </p>
        </div>
        <h3>更多數據</h3>
        <div class="hrn1"></div>
        ...
        <div class="n1">
          <ul>
            ...
            <li>
             <nuxt-link to="/civs/Lithuanians">立陶宛</nuxt-link>：忠誠信仰和異端邪說研發速度快20%。
            </li>
          </ul>
        </div>
        <h3>更新日誌</h3>
