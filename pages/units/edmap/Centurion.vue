  ...
  <div class="container">
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            <b>百夫長</b>首次在《<nuxt-link to="/games/aof"
              >世紀帝國II:失落的帝國</nuxt-link
            >》登場。百夫長是一個不能被訓練的<nuxt-link to="/units"
              >單位</nuxt-link
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          <tr>
            ...
            >
              <div class="unititle" style="color: #fff">百夫長</div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/Centurionicon.png" width="45" alt="" />
              </div>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit4">
              +12對<nuxt-link to="/armor/Armor_Class_Infantry">步兵</nuxt-link>
      ...
      <div class="col-md-12">
        ...
        <div class="n1">
          <div class="col-md-12">
            <div class="col-md-4">
              <gallery
                ><img class="imgn hg" src="~assets/Centurion.png" alt=""
              /></gallery>
              <p><em>一群百夫長</em></p>
            </div>
          </div>
