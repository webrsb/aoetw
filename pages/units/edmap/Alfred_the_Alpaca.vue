            ...
            <div class="col-md-4">
              <gallery
                ><img
                  class="imgn hg"
                  width="250"
                  src="~assets/Alfred_the_alpaca.png"
                  alt=""
              /></gallery>
              <p><em>一群武裝羊駝。</em></p>
            </div>
            <div class="col-md-4">
              <gallery
                ><img
                  class="imgn hg"
                  width="250"
                  src="~assets/Llama_alfred.jpg"
                  alt=""
              /></gallery>
              <p><em>一般羊駝(上)與武裝羊駝(下)。</em></p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/Alfred_icon.jpg" alt="" />
              </div>
            </td>
          </tr>
          <tr>
