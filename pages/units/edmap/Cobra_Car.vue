    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            <img
              src="~assets/Cobracar_00.png"
              width="120"
              alt=""
            />眼鏡蛇汽車（以前稱為謝爾比眼鏡蛇）是世紀帝國II的一個作弊單元。
          ...
          <p>
            ...
            自己。出於某種原因，從眼鏡蛇射擊的射擊可以對陷入他們的攻擊範圍的友軍（包括其他眼鏡蛇）造成高傷害。正因為如此，這些汽車群集擠在試圖拆除堡
            壘或奇蹟等強化結構時，可能會意外地開火併相互毀壞對方。
          </p>
        </div>
        <h3>遊戲中的對話?!</h3>
        <div class="hrn1"></div>
