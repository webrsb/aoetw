      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            ...
            >，也能在地圖編輯器找到。羅馬士兵不能被訓練，根據數據顯示其與<nuxt-link
            ...
            <div class="col-md-4">
              <gallery
                ><img
                  class="imgn hg"
                  width="250"
                  src="~assets/Roman_Legionary.jpg"
                  alt=""
              /></gallery>
              <p><em>美術家對西元1世紀中到3世紀的羅馬士兵描繪圖。</em></p>
            </div>
            <div class="col-md-4">
              <gallery
                ><img
                  class="imgn hg"
                  width="250"
                  src="~assets/LateRomanLegionary.jpg"
                  alt=""
              /></gallery>
              <p><em>扮演西元5世紀羅馬士兵的表演家。</em></p>
            </div>
          </div>
        </div>
      </div>
        ...
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style="background-color:#3c763d;">
              <div class="unititle"><nuxt-link to="">羅馬士兵</nuxt-link></div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/Legionaryicon.png" class="img-fluid" alt="" />
              </div>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit4">
              <nuxt-link to="/techs/games/aof">失落的帝國</nuxt-link>
            </td>
          </tr>
          <tr>
            <td class="unit" colspan="2" style="background-color:#3c763d;">
          ...
          <tr>
            ...
            <td class="unit4">
              +2對<nuxt-link to="/armor/Armor_Class_Eagle_Warrior"
                >鷹勇士</nuxt-link
              >
              <br />+10對<nuxt-link to="/armor/Armor_Class_Infantry"
                >步兵</nuxt-link
              >
              <br />+10對<nuxt-link to="/armor/Armor_Class_Standard_Condottiero"
                >傭兵</nuxt-link
              >
