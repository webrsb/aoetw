  ...
  <div class="container">
    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            藤甲弓兵是<nuxt-link to="/games/aor">拉惹的崛起</nuxt-link
            >資料片中越南的特殊單位，能夠在<nuxt-link to="/techs/age/Castle_Age"
              >城堡時代</nuxt-link
            >的
        ...
        <div class="n1">
          <ul>
            <li>
              藤甲弓兵有能與哥德衛隊相提並論的高遠程護甲，對遠程單位的炮火幾乎免疫。即便是戰矛兵、標槍騎兵也難以殺死他們，弩炮和防禦建築的傷害對他們也猶如抓癢。
            </li>
            <li>
              藤甲弓手在弓箭手單位中有不錯的速度和攻擊力，僅次於排名第一的羽毛箭射手。這讓他們能追擊敗退的敵方弓箭手，也能從大群的戰矛兵和攻城武器的攻擊下逃跑。他們也能藉速度優勢襲擊敵方村民，靠著高遠程護甲即便是城鎮中心的砲火也處之泰然。
            </li>
            <li>
              由於缺乏近戰護甲，藤甲弓兵非常懼怕近戰單位。哥德衛隊、速度快的步兵(特別是鷹勇士)、騎兵都能把他們撕成碎片。他們的造價不斐，如果沒有在戰場上發揮效果連帶會拖累整個經濟。藤甲弓兵與茅象伕、步兵單位配合是不錯的組合，能互相彌補缺點同時有很好的進攻效果。
            </li>
            <li>
              與弩兵不同，藤甲弓兵可以善用速度躲避投石車的攻擊，意味著玩家如果有精細的操作那麼投石車在藤甲弓兵面前就猶如砧板上的一塊肉。反過來說對上藤甲弓兵玩家不應該只用一台投石車應戰，數台的投石車仍舊可以對複數的藤甲弓兵造成巨量傷害的。
            </li>
          </ul>
        </div>
        <h3>更多數據</h3>
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              <nuxt-link to="/civs/Magyars">馬札爾</nuxt-link>：藤甲弓兵視野+2。
            </li>
            <li>
        ...
        <div class="n1">
          ...
          <ul>
            ...
            <li>
              <nuxt-link to="/ver-5.8">5.8版</nuxt-link>後，藤甲弓兵/精銳 血量
              35/40 → 40/45。
            </li>
          </ul>
        </div>
        ...
        <div class="n1">
          <div class="col-md-12">
            <div class="col-md-4">
              <a target="_blank" href="/img/Rattan_vs_Cavalry_Archers.jpg"
                ><img
                  class="imgn hg"
