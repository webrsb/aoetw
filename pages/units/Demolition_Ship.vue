  ...
  <div class="container">
    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            神風船在<nuxt-link to="/techs/age/Castle_Age">城堡時代</nuxt-link
            >的<nuxt-link to="/building/Dock">碼頭</nuxt-link
            >可以訓練。在戰船升級成弩炮戰船時，自爆筏會自動升級為神風船。
          </p>
          <p>
            神風船上裝滿了爆炸物，可以對敵方的船隻，碼頭，被困在淺灘地地面單位，以及任何靠近岸邊的地方造成巨量傷害。
          </p>
          <p>
            除<nuxt-link to="/civs/Koreans">韓國</nuxt-link
            >外，所有文明均可使用自爆筏。
          </p>
        </div>
        <h3>戰術</h3>
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              ...
              >：有利於神風船的科技在城堡/帝王時代便宜15%/20％。神風船HP+50%。
            </li>
            <li>
        ...
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style="background-color:#3c763d;;">
              <div class="unititle"><nuxt-link to="">神風船</nuxt-link></div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
      ...
      <div class="col-md-12">
        ...
        <div class="n1">
          <div class="col-md-12">
            ...
            <div class="col-md-4">
              <a target="_blank" href="/img/Demoship.png"
                ><img class="imgn hg" src="~assets/Demoship.png" alt=""
              /></a>
              <p><em>一群神風船。</em></p>
            </div>
            <div class="col-md-4">
              <a target="_blank" href="/img/DemolitionShipHD.png"
            ...
            <div class="col-md-12">
              <div class="col-md-4">
                <a target="_blank" href="/img/DemolitionShipDLC.png"
                  ><img
                    class="imgn hg"
