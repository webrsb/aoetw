    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          ...
          <ul>
            ...
            >，且城堡時代的特殊科技<nuxt-link to="/techs/Tusk_Swords"
              >象牙劍</nuxt-link
            >就可以讓矛象伕攻擊+3，攻擊達到了17，絕對是所有大象中近戰威力最強的，不過高棉沒有
        ...
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="tta4">
              近戰單位、<nuxt-link to="/armor/Armor_Class_Building"
                >建築物</nuxt-link
              >
            </td>
          </tr>
        ...
        <div class="n1">
          ...
          <ul>
            ...
            <li>
              最初矛象伕升級為精銳要800F/500G，時間為80秒，5.7版後大幅增加為1200F/900G，時間為100秒。
            </li>
            <li>
              <nuxt-link to="/civs/Burmese">緬甸</nuxt-link>:<nuxt-link
                to="/techs/Howdah"
                >象轎</nuxt-link
              >最初給予+1/+2的防禦，5.7版後降為+1/+1。
            </li>
            <li>
              <nuxt-link to="/civs/Vietnamese">越南</nuxt-link>:<nuxt-link
                to="/techs/Chatras"
        ...
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="unit4">
              <img
                class="gg"
                src="~assets/Battleelephantupgrade.png"
                alt=""
              />1200食物900黃金
            </td>
          </tr>
      ...
      <div class="col-md-12">
        ...
        <div class="n1">
          <div class="col-md-12">
            <div class="col-md-4">
              <a target="_blank" href="/img/Battle_Elephant_and_Elite.jpg"
                ><img
                  class="imgn hg"
            ...
            <div class="col-md-4">
              <a target="_blank" href="/img/Battle_Elephant_group.jpg"
                ><img
                  class="imgn hg"
