      ...
      <div class="row padtop">
        ...
        <div class="col-md-8">
          <div class="n1">
            ...
            <p>象弓騎兵可以在<nuxt-link to="/techs/age/Imperial_Age">帝王時代</nuxt-link>升級為精銳象弓騎兵。</p>
          </div>
           <h3>戰術要點</h3>
          <div class="hrn1"></div>
          <div class="n1">
          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4">
                <p>
                  <img class="gg" src="~assets/Bloodlines.png" width="30" alt=""><nuxt-link to="/techs/Bloodlines">品種</nuxt-link>(+20)</p>
              </td>
            </tr>
            <tr>
              ...
              <td class="tta4">
                <p>
                  <img class="gg" src="~assets/Fletching.jpg" width="30" alt=""><nuxt-link to="/techs/Fletching">箭羽</nuxt-link>(+1)</p>
                <p>
                  <img class="gg" src="~assets/Bodkinarrow.jpg" width="30" alt=""><nuxt-link to="/techs/Bodkin_Arrow">錐狀箭頭</nuxt-link>(+1)</p>
                <p>
                  <img class="gg" src="~assets/Bracer.jpg" width="30" alt=""><nuxt-link to="/techs/Bracer">護腕</nuxt-link>(+1)</p>
                <p>
                  <img class="gg" src="~assets/Chemistry.jpg" width="30" alt=""><nuxt-link to="/techs/Chemistry">化學</nuxt-link>(+1)</p>
                <p>
                  <img class="gg" src="~assets/Parthian-Tactics.jpg" width="30" alt=""><nuxt-link to="/techs/Parthian_Tactics">帕提亞戰術</nuxt-link>(+2對長槍兵)</p>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="tta4">
                <p>
                  <img class="gg" src="~assets/Thumb_Ring.png" width="30" alt=""><nuxt-link to="/techs/Thumb_Ring">拇指環</nuxt-link>(+18%)</p>
              </td>
            </tr>
            <tr>
              ...
              <td class="tta4">
                <p>
                  <img class="gg" src="~assets/Ballistics.jpg" width="30" alt=""><nuxt-link to="/techs/Ballistics">彈道學</nuxt-link>(對移動目標命中率上升)</p>
              </td>
            </tr>
            <tr>
              ...
              <td class="tta4">
                <p>
                  <img class="gg" src="~assets/Paddedarcherarmor.jpg" width="30" alt=""><nuxt-link to="/techs/Padded_Archer_Armor">弓兵布甲</nuxt-link>(+1/+1)</p>
                <p>
                  <img class="gg" src="~assets/Leatherarcherarmor.jpg" width="30" alt=""><nuxt-link to="/techs/Leather_Archer_Armor">弓兵皮甲</nuxt-link>(+1/+1)</p>
                <p>
                  <img class="gg" src="~assets/Ringarcherarmor.jpg" width="30" alt=""><nuxt-link to="/techs/Ring_Archer_Armor">弓兵環甲</nuxt-link>(+1/+2)</p>
                <p>
                  <img class="gg" src="~assets/Parthian-Tactics.jpg" width="30" alt=""><nuxt-link to="/techs/Parthian_Tactics">帕提亞戰術</nuxt-link>(+1/+2)</p>
              </td>
            </tr>
            <tr>
              ...
              <td class="tta4">
                <p>
                  <img class="gg" src="~assets/Husbandry.jpg" width="30" alt=""><nuxt-link to="/techs/Husbandry">畜牧培育</nuxt-link>(+10%)</p>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="tta4">
                <p>
                  <img class="gg" src="~assets/Conscription.jpg" width="30" alt=""><nuxt-link to="/techs/Conscription">徵兵制度</nuxt-link>(+33%)</p>
              </td>
            </tr>
          </table>
           ...
           <h3>剋象弓騎兵的單位與建築</h3> 
          <div class="hrn1"></div>
          <div class="n1">以下單位擁有對象弓騎兵的額外傷害，按照傷殺力排列。
            <div class="n1">
              <div class="col-md-12">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                  ...
                  <ul>
                    <li>
                      <img class="gg" src="~assets/HuskarlIcon.jpg" alt=""><nuxt-link to="/units/Huskarl">精銳歌德衛隊</nuxt-link>(<nuxt-link to="/civs/Goth">歌德</nuxt-link>限定)</li>
                    <li>
                  ...
                  <ul>
                    ...
                    <img class="gg"          src="~assets/Imperialskirmishericon.png"
                      alt=""/><nuxt-link to="/units/Imperial_Skirmisher"
                      >帝王戰矛兵</nuxt-link>(<nuxt-link to="/civs/Vietnamese">越南</nuxt-link>和同盟限定)
                  </li>
                  </ul>
                ...
                <div style="margin:12px 0px;"><strong>+4攻擊</strong>
                  ...
                  <ul>
                    ...
                    <li>
                        ...
                        <img class="gg" src="~assets/ChuKoNuIcon.jpg" alt=""> <nuxt-link to="/units/Chu_Ko_Nu">精銳連弩兵</nuxt-link>(<nuxt-link to="/civs/Vikings">維京</nuxt-link>限定)</li>
                      
                      <li>
                        <img class="gg" src="~assets/JaguarWarriorIcon.jpg" alt=""><nuxt-link to="/units/Jaguar_Warrior">豹勇士</nuxt-link>→
                        <img class="gg" src="~assets/JaguarWarriorIcon.jpg" alt=""> <nuxt-link to="/units/Jaguar_Warrior">精銳豹勇士</nuxt-link>(<nuxt-link to="/civs/Vikings">維京</nuxt-link>限定)</li>
                ...
                <div class="col-md-12">以下技術可讓以下單位對象弓騎兵有額外攻擊力
                  <div class="n1">
          ...
          <div class="n1">
            <ul>
              <li><nuxt-link to="/civs/Berbers">柏柏</nuxt-link>：<nuxt-link to="/techs/Kasbah">聚居堡壘</nuxt-link>能夠提高象弓騎兵的生產速度還有加速徵兵技術的研究時間(快25%)</li>
              <li><nuxt-link to="/civs/Britons">不列顛</nuxt-link>：研究拇指環和帕提亞戰術速度快20%。</li>
              <li><nuxt-link to="/civs/Huns">匈奴</nuxt-link>：研究品種和畜牧培育速度快80%。</li>
              <li><nuxt-link to="/civs/Malians">馬利</nuxt-link>：研究化學和彈道學速度快80%。</li>
              <li><nuxt-link to="/civs/Teutons">條頓</nuxt-link>：象弓騎兵更不容易被招降。</li>
            </ul>
          </div>
           <h3>更新日誌</h3>
          <div class="hrn1"></div>
          <div class="n1">
            ...
            <ul>
              <li><nuxt-link to="/ver-5.8">5.8版</nuxt-link>後，象弓騎兵對弓兵防禦類型 -2 → 0，對反弓兵防禦類型0 → -2</li>
            </ul>
          </div>
           <h3>趣事</h3>
          <div class="hrn1"></div>
        ...
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="unit4"><nuxt-link to="/units/Archer_Units">弓兵</nuxt-link>；<nuxt-link to="/units/Cavalry_Units">騎兵</nuxt-link></td>
            </tr>
            <tr>
          ...
          <tr>
            ...
            <tr>
              ...
              <td class="unit4">對<nuxt-link to="/armor/Armor_class_stone_defense">石造建築</nuxt-link>+3/+4(精銳)
                <br/>對<nuxt-link to="/armor/Armor_class_building">一般建築</nuxt-link>+3/+4(精銳)</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4"><nuxt-link to="/armor/Armor_Class_Archer">弓兵</nuxt-link>
                <br/><nuxt-link to="/armor/Armor_Class_Cavalry_Archer">馬騎弓兵(-2)</nuxt-link>
            ...
            <tr>
              ...
              <td class="unit4">
                <img class="gg" src="~assets/ElephantArcherIcon.jpg" alt="">精銳象弓騎兵</td>
            </tr>
            <tr>
