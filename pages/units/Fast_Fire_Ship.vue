        ...
        <div class="n1">
          <p>
            儘管快速火戰船在與<nuxt-link to="/units/Galleon"
              >重型弩砲戰船</nuxt-link
            >的對抗中表現更好，但是重型弩炮戰船的低成本和長射程，可以增加偵察的安全性和降低成本在大規模的對抗中，重型弩炮戰船可以輕易地運用長射程擊敗一群快速火戰船，但是如果得到其他海軍的適當支援，一支重型火戰船可以輕易地將一群重型弩炮戰船擊沉。快速火戰船在面對<nuxt-link
        ...
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="tta4">
              ...
              >(+1，<nuxt-link to="/civs/Byzantines">拜占庭</nuxt-link>限定)
            </td>
          </tr>
          <tr>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="unit4">3(遠攻) <br />1(近戰)</td>
          </tr>
          <tr>
            <td class="unit3">傷害加成</td>
            <td class="unit4">
              +4對<nuxt-link to="/armor/Armor_Class_Ship">船</nuxt-link>
              <br />+3對<nuxt-link to="/armor/Armor_Class_Turtle_Ship"
                >龜甲船</nuxt-link
              >
              <br />+3對<nuxt-link to="/armor/Armor_Class_Building"
                >建築</nuxt-link
              >
            </td>
          </tr>
          ...
          <tr>
            ...
            <td class="unit4">
              <img class="gg" src="~assets/FireShipIcon.jpg" alt="" /><nuxt-link
                to="/units/Fire_Ship"
                >火戰船</nuxt-link
              >
            </td>
      ...
      <div class="col-md-12">
        ...
        <div class="n1">
          <div class="col-md-12">
            ...
            <div class="col-md-4">
              <nuxt-link to="/img/Fastfireship.png"
                ><img class="imgn hg" src="~assets/Fastfireship.png" alt=""
              /></nuxt-link>
              <p><em>一群快速火戰船。</em></p>
            </div>
            <div class="col-md-4">
              <nuxt-link to="/img/FFireShipHD.png"
                ><img class="imgn hg" src="~assets/FFireShipHD.png" alt=""
              /></nuxt-link>
              <p><em>各種快速火戰船(世紀帝國和征服者入侵資料片)。</em></p>
            </div>
            <div class="col-md-12">
              <div class="col-md-4">
                <nuxt-link to="/img/FFireShipDLC.png"
                  ><img class="imgn hg" src="~assets/FFireShipDLC.png" alt=""
                /></nuxt-link>
