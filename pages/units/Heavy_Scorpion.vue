  ...
  <div class="container">
    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            重裝弩砲可訓練於攻城武器製造所，他發射大型箭矢，可對敵人造成貫穿，但只有目標單位會受到全部的傷害，其他單位只會受到一半的傷害。不像投石車，弩砲不會傷害友方單位，所以在近距離的肉搏戰相當好用。
          </p>
        </div>
        <h3>戰術</h3>
        <div class="hrn1"></div>
        <div class="n1">
          <p>
            重裝弩砲對步兵，弓箭手和僧侶等速度慢的單位非常有效，因為速度慢的單位容易被弩砲貫穿攻擊。但弩砲對於快速的步兵，如<nuxt-link
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              <nuxt-link to="/civs/Koreans">高棉</nuxt-link>：重型弩炮+1射程。
            </li>
            <li>
        ...
        <div class="n1">
          ...
          <ul>
            <li>重型弩砲有5的射程。</li>
            <li>
              重型弩砲有0的<nuxt-link to="/elements/Frame_delay"
                >開火間隔</nuxt-link
              >
            </li>
            <li>
              重型弩砲的<nuxt-link to="/elements/Frame_delay"
                >開火間隔</nuxt-link
              >為0
            </li>
            <li>
          ...
          <ul>
            <li>重型弩砲射程為7。</li>
            <li>
              重型弩砲有7的<nuxt-link to="/elements/Frame_delay"
                >開火間隔</nuxt-link
              >。
            </li>
            <li>
          ...
          <div class="n1">
            <div class="col-md-12">
              <div class="col-md-4">
                <gallery src="~assets/Heavyscorpion.png"
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="unit4">
              +8 vs<nuxt-link to="/armor/Armor_Class_War_Elephant"
                >戰象</nuxt-link
              >
              <br />+4 vs<nuxt-link to="/armor/Armor_Class_Building"
                >建築</nuxt-link
              >
              <br />+2 vs<nuxt-link to="/armor/Armor_Class_Ram"
                >衝撞車</nuxt-link
              >
            </td>
          </tr>
