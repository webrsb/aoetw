  ...
  <div class="container">
    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          <p>
            弩砲對步兵，弓箭手和僧侶等速度慢的單位非常有效，因為速度慢的單位容易被弩砲貫穿攻擊。但弩砲對於快速的步兵，如<nuxt-link
        ...
        <div class="n1">
          ...
          <div class="n1">
            <ul>
              <li>
                以前《世紀帝國II:征服者入侵》的中文版本，把弩砲直接翻譯成蠍子。
              </li>
          ...
          <div class="n1">
            <div class="col-md-12">
              <div class="col-md-4">
                <a target="_blank" href="/img/Scorpion.png"
              ...
              <div class="col-md-4">
                <a target="_blank" href="/img/Scorpion_Ballista.jpg"
                  ><img
                    class="imgn hg"
