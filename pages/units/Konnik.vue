<template>
  <div class="container">
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <b>蒙古騎射手</b>或稱<b>甲冑騎兵</b>，是<nuxt-link to="/civs/Byzantines"
            >拜占庭</nuxt-link
        ...
        <div class="n1">
          <ul>
            <li>
              <strong
                ><nuxt-link to="/units/Halberdier">戟兵</nuxt-link>:</strong
              >
            </li>
            <p>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="unit4">110/150(精銳)/45(下馬)</td>
          </tr>
          <tr>
            <td class="unit3">攻擊</td>
            <td class="unit4">12/12(精銳)/12(下馬)(近戰)</td>
          </tr>
          <tr>
            <td class="unit3">攻擊加成</td>
            <td class="unit4">
              +9/+12(精銳)對<nuxt-link to="/armor/Armor_Class_Infantry"
                >步兵</nuxt-link
              >
              <br />+9/+10(精銳)對<nuxt-link to="/armor/Armor_Class_Condottiero"
                >傭兵</nuxt-link
              >
            </td>
          </tr>
          ...
          <tr>
            ...
            <td class="unit4">2/0(下馬)</td>
          </tr>
          <tr>
            <td class="unit3">遠防</td>
            <td class="unit4">1/0(下馬)</td>
          </tr>
          <tr>
