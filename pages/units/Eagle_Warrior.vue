  ...
  <div class="container">
    ...
    <div class="row" style=" margin-top: 50px;">
      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          <p>
            由於鷹勇士遠防相當高，甚至比<a href="Knight.php">騎士</a
            >還高，高達3，總體防禦高達5，就算在<a href="Town_Center.php"
              >城鎮中心</a
            >底下也可以盡情屠殺 <a href="Villager.php">村民</a>。也是所有<a
          ...
          <strong>反制</strong>
          <p>
            要在城堡時代對付鷹勇士是相當困難的，能有效克制鷹勇士只有<a
              href="Knight.php"
              >騎士</a
            >，而<a href="Knight.php">騎士</a
            >量少會跟不上鷹勇士出的速度，對方也會出
            <a href="Monk.php">僧侶</a>甚至<a href="Pikeman.php">重裝長槍兵</a
            >反制，適時的可以配點<a href="Scorpion.php">弩砲</a>+
            <a href="Knight.php">騎士</a>，<a href="Scorpion.php">弩砲</a
            >攻擊12還有貫穿攻擊，打老鷹和<a href="Monk.php">僧侶</a
            >都是不錯，重點是家裡要圍好，配合
            <a href="Castle.php"></a
            >城堡與騎士，不要給鷹勇士鬧到，拖到後期，老鷹國就相對沒有城堡這麼可怕。非常不建議出<a
              href="Long_Swordsman.php"
              >長劍兵</a
            >，即使 <a href="Long_Swordsman.php">長劍兵</a>打鷹勇士很快，但<a
              href="Long_Swordsman.php"
              >長劍兵</a
            >耗資源，且走的太慢，又非常怕弩兵，對方看你這麼多
            <a href="Long_Swordsman.php">長劍兵</a>，轉<a href="Crossbowman.php"
              >弩兵</a
            >甚至<a href="Plumed_Archer.php">羽毛箭射手</a>都可以輕易解決。
          </p>
          <p>
            而特殊兵種是快速步兵的也可以考慮，例如馬來的<a
              href="Karambit_Warrior.php"
              >爪刀勇士</a
            >、馬利的<a href="Gbeto.php">飛刀女獵手</a>、賽爾特的
            <a href="Woad_Raider.php">菘藍武士</a>與衣索比亞的<a
              href="Shotel_Warrior.php"
              >彎刀勇士</a
            >都非常適合打鷹勇士，但說到城堡時代打鷹勇士最強的莫過於
            <a href="Incas.php">印加</a>的<a href="Slinger.php">投石手</a>了。
          </p>
        </div>
        <h3>更多數據</h3>
        <div class="hrn1"></div>
        ...
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="tta4">
              <a href="Archer_Units.php">弓兵</a>、<a href="Siege_Weapons.php"
                >攻城單位</a
          ...
          <tr>
            ...
            <td class="tta4">
              <a href="Cataphract.php">聖騎兵</a>、<a href="Boyar.php"
                >貴族鐵騎</a
              >、<a href="Hand_Cannoneer.php">火槍兵</a>、
              <a href="Infantry_Units.php">步兵</a>、<a href="Slinger.php"
                >投石手</a
              >。
            </td>
          </tr>
          ...
          <tr>
            ...
            <td class="tta4">
              ...
              <img
                ...
                width="30"
                alt=""
              /><a href="Iron_Casting.php">鑄造</a>(+1) <br />
              <img
                class="gg"
                src="~assets/Blastfurnace.jpg"
                width="30"
                alt=""
              /><a href="Blast_Furnace.php">鼓風爐</a>(+2) <br />
              ...
              <img
                ...
                width="30"
                alt=""
              /><a href="Garland_Wars.php">榮冠戰爭</a>:步兵攻擊+4，<a
                href="Aztecs.php"
                >阿茲特克</a
              >限定。
            </td>
          ...
          <tr>
            ...
            <td class="tta4">
              <img
                ...
                width="30"
                alt=""
              /><a href="Scale_Mail_Armor.php">步兵鱗甲</a>(+1/+1) <br />
              <img
                class="gg"
                src="~assets/Chainmailarmor.jpg"
                width="30"
                alt=""
              /><a href="Chain_Mail_Armor.php">步兵鎖甲</a>(+1/+1) <br />
              <img
                class="gg"
                src="~assets/Platemailarmor.jpg"
                width="30"
                alt=""
              /><a href="Plate_Mail_Armor.php">步兵板甲</a>(+1/+2) <br />
              <img src="~assets/Unique-tech.jpg" class="gg" alt="" /><a
                href="Couriers.php"
                >信使</a
              >(+1/+2，<a href="Incas.php">印加</a>，從<a href="ak.php"
                >非洲王朝</a
              >資料片開始)
            </td>
          </tr>
          <tr>
            ...
            <td class="tta4">
              ...
              <img class="gg" src="~assets/Unique-tech.jpg" alt="" /><a
                href="Couriers.php"
                >信使</a
              >(+10%，<a href="Incas.php">印加</a>限定，只在<a href="aof.php"
                >失落的帝國</a
              >資料片有)
            </td>
          </tr>
        ...
        <div class="n1">
          ...
          <a href="Armor_Class_Infantry.php">步兵單位</a>都有加成。
          <div class="n1">
            <div class="row">
              <div class="col-md-6">
                ...
                <ul>
                  <li>
                    ...
                    <a href="Teutonic_Knight.php">條頓武士</a>→
                ...
                <ul>
                  <li>
                    ...
                    <a href="Woad_Raider.php">精銳菘藍武士</a>
                  </li>
                  <li>
              ...
              <div class="col-md-6">
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <a href="Shotel_Warrior.php">精銳彎刀勇士</a>
                  </li>
                  <li>
                    <img
                      class="gg"
                      ...
                      alt=""
                    /><a href="Jaguar_Warrior.php">豹勇士</a>→
                    <img
                      class="gg"
                      src="~assets/JaguarWarriorIcon.jpg"
                      alt=""
                    /><a href="Jaguar_Warrior.php">精銳豹勇士</a>
                  </li>
                </ul>
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              <a href="Goths.php">哥德</a>：鷹勇士訓練和升級快20%。研發<a
                href="Tracking.php"
                >追縱技術</a
        ...
        <div class="n1">
          ...
          <ul>
            ...
            <li>
              鷹勇士對<a href="Armor_Class_Cavalry.php">騎兵</a
              >有+3的攻擊加成，對<a href="Armor_Class_Camel.php">駱駝</a>和
              <a href="Armor_Class_Ship.php">船艦</a>額外+1。
            </li>
            <li>
              <a href="Incas.php">印加</a>:<a href="Couriers.php">信使</a
              >給予鷹勇士+10％的移動速度。
            </li>
            <li>鷹勇士改變外觀。</li>
          </ul>
          ...
          <ul>
            ...
            <li>
              5.7版本後鷹勇士現在對<a href="Armor_Class_Camel.php">駱駝單位</a
              >攻擊+2。
            </li>
          </ul>
        </div>
        ...
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style=" background-color:#3c763d;;">
              <div class="unititle"><a href="">鷹勇士</a></div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/EagleWarriorIcon.jpg" width="45" alt="" />
              </div>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit4">
              +8 vs <a href="Armor_Class_Monk.php">僧侶</a> <br />
              +3 vs<a href="Armor_Class_Siege_Weapon.php">攻城武器</a> <br />
              +3 vs <a href="Armor_Class_Cavalry.php">騎兵</a> <br />
              +2 vs <a href="Armor_Class_Camel.php">駱駝騎兵</a> <br />
              +1 vs <a href="Armor_Class_Ship.php">船隻</a>
            </td>
          </tr>
          <tr>
