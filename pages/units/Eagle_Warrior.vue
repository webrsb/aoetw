  ...
  <div class="container">
    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          <p>
            由於鷹勇士遠防相當高，甚至比<a href="/units/Knight">騎士</a
            >還高，高達3，總體防禦高達5，就算在<a href="/building/Town_Center"
              >城鎮中心</a
            >底下也可以盡情屠殺 <a href="/units/Villager">村民</a>。也是所有<a
          ...
          <p>
            要在城堡時代對付鷹勇士是相當困難的，能有效克制鷹勇士只有<a
              href="/units/Knight"
              >騎士</a
            >，而<a href="/units/Knight">騎士</a
            >量少會跟不上鷹勇士出的速度，對方也會出
            <a href="/units/Monk">僧侶</a>甚至<a href="/units/Pikeman"
              >重裝長槍兵</a
            >反制，適時的可以配點<a href="/units/Scorpion">弩砲</a>+
            <a href="/units/Knight">騎士</a>，<a href="/units/Scorpion">弩砲</a
            >攻擊12還有貫穿攻擊，打老鷹和<a href="/units/Monk">僧侶</a
            >都是不錯，重點是家裡要圍好，配合
            <a href="/building/Castle"></a
            >城堡與騎士，不要給鷹勇士鬧到，拖到後期，老鷹國就相對沒有城堡這麼可怕。非常不建議出<a
              href="/units/Long_Swordsman"
              >長劍兵</a
            >，即使 <a href="/units/Long_Swordsman">長劍兵</a>打鷹勇士很快，但<a
              href="/units/Long_Swordsman"
              >長劍兵</a
            >耗資源，且走的太慢，又非常怕弩兵，對方看你這麼多
            <a href="/units/Long_Swordsman">長劍兵</a>，轉<a
              href="/units/Crossbowman"
              >弩兵</a
            >甚至<a href="/Plumed_units/Archer">羽毛箭射手</a>都可以輕易解決。
          </p>
          <p>
            而特殊兵種是快速步兵的也可以考慮，例如馬來的<a
              href="/units/Karambit_Warrior"
              >爪刀勇士</a
            >、馬利的<a href="/units/Gbeto">飛刀女獵手</a>、賽爾特的
            <a href="/units/Woad_Raider">菘藍武士</a>與衣索比亞的<a
              href="/units/Shotel_Warrior"
              >彎刀勇士</a
            >都非常適合打鷹勇士，但說到城堡時代打鷹勇士最強的莫過於
            <a href="/civs/Incas">印加</a>的<a href="/units/Slinger">投石手</a
            >了。
          </p>
        </div>
        <h3>更多數據</h3>
        ...
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="tta4">
              <a href="/units/Archer_Units">弓兵</a>、<a
          ...
          <tr>
            ...
            <td class="tta4">
              <a href="/units/Cataphract">聖騎兵</a>、<a href="/units/Boyar"
                >貴族鐵騎</a
              >、<a href="/units/Hand_Cannoneer">火槍兵</a>、
              <a href="/units/Infantry_Units">步兵</a>、<a href="/units/Slinger"
                >投石手</a
              >。
            </td>
          </tr>
        ...
        <div class="n1">
          <ul>
            <li>
              <a href="/civs/Aztecs">阿茲特克</a>：鷹勇士生產速度提高15％。
            </li>
          </ul>
        </div>
        <h3>團隊加成</h3>
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              <a href="/civs/Goths">哥德</a>：鷹勇士訓練和升級快20%。研發<a
                href="/techs/Tracking"
                >追縱技術</a
            ...
            <li><a href="/civs/Teutons">條頓</a>：鷹勇士更不容易被招降。</li>
          </ul>
        </div>
        <h3>更新日誌</h3>
        <div class="hrn1"></div>
        <div class="n1">
          ...
          <ul>
            <li>
              鷹勇士多了一個前身，<a href="/units/Eagle_Scout">鷹斥侯</a>。
            </li>
            <li>鷹勇士有55HP與3的遠防。</li>
            <li>訓練時間為32秒。</li>
            <li>升級鷹勇士的費用為300食物/200黃金。</li>
            <li>
              鷹勇士對<a href="/armor/Armor_Class_Cavalry">騎兵</a
              >有+3的攻擊加成，對<a href="/armor/Armor_Class_Camel">駱駝</a>和
              <a href="/armor/Armor_Class_Ship">船艦</a>額外+1。
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              5.7版本後鷹勇士現在對<a href="/armor/Armor_Class_Camel"
                >駱駝單位</a
              >攻擊+2。
            </li>
          </ul>
        ...
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="unit4">
              ...
              +3 vs <a href="/armor/Armor_Class_Cavalry">騎兵</a> <br />
              +2 vs <a href="/armor/Armor_Class_Camel">駱駝騎兵</a> <br />
