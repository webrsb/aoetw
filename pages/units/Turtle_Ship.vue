    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        ...
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="tta4">
              ...
              >(近距離)、在岸邊的<nuxt-link to="/building">建築物</nuxt-link
              >、在岸邊和淺灘的陸地單位。
            </td>
          </tr>
          <tr>
        ...
        <div class="n1">
          ...
          <ul>
            <li>
              訓練龜甲船需要先建造<nuxt-link to="/building/Castle"
                >城堡</nuxt-link
              >。
            </li>
        ...
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style="background-color:#3c763d;;">
              <div class="unititle"><nuxt-link to="">龜甲船</nuxt-link></div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
      ...
      <div class="col-md-12">
        ...
        <div class="n1">
          <div class="col-md-12">
            ...
            <div class="col-md-12">
              <div class="col-md-4">
                <a target="_blank" href="/img/Turtle_Ship_paint.jpg"
                  ><img
                    class="imgn hg"
