      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              <nuxt-link to="/civs/Malay">馬來</nuxt-link>：精銳矛象伕便宜30%。
            </li>
            <li>
        ...
        <div class="n1">
          ...
          <ul>
            ...
            <li>
              最初精銳矛象伕升級為精銳要800F/500G，時間為80秒，5.7版後大幅增加為1200F/900G，時間為100秒。
            </li>
            <li>
    ...
    <div class="col-md-12">
      ...
      <div class="n1">
        <div class="col-md-12">
          ...
          <div class="col-md-4">
            <a target="_blank" href="/img/Elitebattleelephant.png"
