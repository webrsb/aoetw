  ...
  <div class="container">
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            國王是世紀帝國二的特殊單位。本身是無用的單位，無法攻擊任何事物，或對經濟做出貢獻，
            但在遊戲早期可以用於偵察地圖。國王只出現在戰役和弒君模式中，也可於地圖編輯器中使用
            。是不可訓練之單位。 。
          </p>
          <p>訊息中圖像上方縮寫的翻譯</p>
          <p>EU:歐洲</p>
        ...
        <div class="n1">
          <p>
            國王隊擁有中等生命值（75），但沒有攻擊或盔甲。在弒君遊戲中，失去國王的玩家立即失
            去了遊戲。因此，自己的國王必須不惜一切代價得到保護和保持血量，敵國的位置應始終是自
            己侵略的中心。國王的行動非常迅速，從一開始就有很高的視線，並且不會被野生動物襲擊。
            這使得他們非常適合在早期比賽中偵察城鎮的外圍，由於城鎮中心和城堡會射箭，在
            敵人的領土內偵察得太深是危險的。每個玩家在進行一場弒君遊戲時都會先從一座城堡開始
            ，一旦周圍環境偵察完畢，建議駐軍國王在裡面。在比賽后期，他應該永遠留在牆壁後面，並進
            入一個安全的城堡。像英雄一樣，國王不能被招降，但他們不像英雄，不會重生生命值。
          </p>
          <p>國王在他們的文明語言中有自己獨特的聲音片段。</p>
          <p>自非洲王國以來，國王現在有不同的模組，使其可以識別他們的起源。</p>
        </div>
        <h3>英雄</h3>
        <div class="hrn1"></div>
        <div class="n1">
