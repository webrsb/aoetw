  ...
  <div class="container">
    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        ...
        <div class="hrn1"></div>
        <div class="n1">
          以下單位擁有對奴隸兵的額外傷害，按造傷殺力排列。
          <div class="n1">
            <div class="row">
              <div class="col-md-6">
                <div style="margin:12px 0px;"><strong>+58攻擊</strong></div>
                <ul>
                  <li>
                    <img
                      class="gg"
                ...
                <div style="margin:12px 0px;"><strong>+27攻擊</strong></div>
                <ul>
                  <li>
                    <img
                      class="gg"
              ...
              <div class="col-md-12">
                ...
                <div class="n1">
                  ...
                  <div width="22" style="margin:12px 0px;">
                    <strong>+9攻擊</strong>(對<nuxt-link
                      to="/armor/Armor_Class_Cavalry"
                      >騎兵類</nuxt-link
                    >+5攻擊，對
                    <nuxt-link to="/armor/Armor_Class_Camel"
                      >駱駝騎兵類</nuxt-link
                    >+4攻擊，總共+9)
                  </div>
                  <ul>
      ...
      <div class="col-md-12">
        ...
        <div class="n1">
          <div class="col-md-4">
            <a target="_blank" href="/img/Saracenmamluk.png"
              ><img class="imgn hg" src="~assets/Saracenmamluk.png" alt=""
            /></a>
            <p><em>奴隸兵</em></p>
          </div>
          <div class="col-md-4">
            <a target="_blank" href="/img/Mameluke.png"
              ><img class="imgn hg" src="~assets/Mameluke.png" alt=""
            /></a>
            <p><em>一群奴隸兵</em></p>
          </div>
          <div class="col-md-4">
            <a target="_blank" href="/img/Mameluke_history.jpg"
