  ...
  <div class="container">
    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            裝甲步兵，到<a href="/techsage/Feudal_Age">封建時代</a>就可以在<a
        ...
        <div class="n1">
          <p>
            裝甲步兵，在封建時代對地人的打擊和干擾方面非常好用。由於速度較慢，對弓箭手尤其弱。可以訓練一些矛兵來對付弓箭手。而著名的<a
              href="/mantower.php"
              >裝甲塔戰術</a
            >更是讓新手聞風喪膽。裝甲步兵是打得贏斥候的。
          </p>
          <p>
            一搬來說，<a href="/civs/Japanese">日本</a>、<a href="/civs/Celts"
              >賽爾特人</a
            >、<a href="/civs/Aztecs">阿茲特克</a>與
          ...
          <tr>
            ...
            <td class="tta4">
              <a href="/units/Skirmisher">矛兵</a>、<a
                ...
                >斥侯</a
              >、 <a href="/units/Eagle_Scout">鷹斥侯</a>、<a
                href="/units/Spearman"
                >槍兵</a
        ...
        <div class="n1">
          <ul>
            <li>
              <a href="/civs/Aztecs">阿茲特克</a>：裝甲步兵生產速度提高15％。
            </li>
            <li>
              <a href="/civs/Burmese">緬甸</a>：裝甲步兵在封建/城堡/帝王時代有
              +1/+2/+3攻擊。
            </li>
            <li><a href="/civs/Celts">賽爾特</a>：裝甲步兵移動加快15％。</li>
            <li>
            ...
            <li>
              ...
              <a href="/techs/Arson">縱火</a>和升級長劍兵的速度快100%。
            </li>
            <li><a href="/civs/Japanese">日本</a>：裝甲步兵攻速快33％。</li>
            <li>
            ...
            <li>
              <a href="/civs/Malians">馬利</a>：裝甲步兵在封建/城堡/帝王時代有
              +1/+2/+3 遠程護甲。
            </li>
            <li>
              <a href="/civs/Portuguese">葡萄牙</a>：裝甲步兵黃金成本減少15％。
            </li>
            <li>
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              <a href="/civs/Goths">哥德</a>：裝甲步兵訓練和升級快20%。研發<a
                href="/techs/Tracking"
                >追縱技術</a
            ...
            <li><a href="/civs/Teutons">條頓</a>：裝甲步兵更不容易被招降。</li>
          </ul>
        </div>
        <h3>更新日誌</h3>
        <div class="hrn1"></div>
        <div class="n1">
          ...
          <ul>
            <li>
              裝甲步兵對<a href="/armor/Armor_Class_Standard_Building"
                >標準建築</a
              >+1攻擊。
            </li>
            <li>裝甲步兵遠防是0。</li>
          ...
          <ul>
            <li>
              裝甲步兵擁有+2攻擊VS<a href="/armor/Armor_Class_Standard_Building"
                >標準建築</a
              >。
            </li>
          </ul>
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              馬來的民兵系再研發<a href="/Forced Levy.php">強制徵兵</a
              >後不用黃金。
            </li>
            <li>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="unit4">
              +2對<a href="/armor/Armor_Class_Eagle_Warrior">鷹勇士</a>
              <br />+2對<a href="/armor/Armor_Class_Standard_Building"
                >標準建築</a
              >
            </td>
          </tr>
