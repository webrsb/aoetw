  ...
  <div class="container">
    ...
    <div class="row" style=" margin-top: 50px;">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            裝甲步兵，到<a href="Feudal_Age.php">封建時代</a>就可以在<a
              href="Barracks.php"
              >軍營</a
        ...
        <div class="n1">
          ...
          <p>
            一搬來說，<a href="Japanese.php">日本</a>、<a href="Celts.php"
              >賽爾特人</a
            >、<a href="Aztecs.php">阿茲特克</a>與
          ...
          <tr>
            ...
            <td class="tta4">
              <a href="Skirmisher.php">矛兵</a>、<a href="Scout_Cavalry.php"
                >斥侯</a
              >、 <a href="Eagle_Scout.php">鷹斥侯</a>、<a href="Spearman.php"
                >槍兵</a
        ...
        <div class="n1">
          <ul>
            <li>
              <a href="Aztecs.php">阿茲特克</a>：裝甲步兵生產速度提高15％。
            </li>
            <li>
              <a href="Burmese.php">緬甸</a>：裝甲步兵在封建/城堡/帝王時代有
              +1/+2/+3攻擊。
            </li>
            ...
            <li>
              <a href="Goths.php">哥德</a>：裝甲步兵從封建時代開始便宜35％並對<a
              ...
              <a href="Arson.php">縱火</a>和升級長劍兵的速度快100%。
            </li>
            ...
            <li>
              <a href="Malians.php">馬利</a>：裝甲步兵在封建/城堡/帝王時代有
              +1/+2/+3 遠程護甲。
            </li>
            <li>
              <a href="Portuguese.php">葡萄牙</a>：裝甲步兵黃金成本減少15％。
            </li>
            <li>
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              <a href="Goths.php">哥德</a>：裝甲步兵訓練和升級快20%。研發<a
                href="Tracking.php"
                >追縱技術</a
        ...
        <div class="n1">
          ...
          <ul>
            <li>
              裝甲步兵對<a href="Armor_Class_Standard_Building.php">標準建築</a
              >+1攻擊。
            </li>
            <li>裝甲步兵遠防是0。</li>
            <li>
          ...
          <ul>
            <li>
              裝甲步兵擁有+2攻擊VS<a href="Armor_Class_Standard_Building.php"
                >標準建築</a
              >。
            </li>
          </ul>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="unit4">
              +2對<a href="Armor_Class_Eagle_Warrior.php">鷹勇士</a>
