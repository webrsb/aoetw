      ...
      <div class="col-md-8">
        ...
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="tta4">
              大量需集中單位、<nuxt-link to="/units/Villager">村民</nuxt-link
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/OrganGunIcon.png" width="45" alt="" />
              </div>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit4">
              對<nuxt-link to="/armor/Armor_Class_Ram">衝撞車系</nuxt-link>+1
            </td>
          </tr>
          <tr>
            <td class="unit3">
          ...
          <tr>
            ...
            <td class="unit4">
              <img class="gg" src="~assets/OrganGunIcon.png" alt="" />精銳風琴砲
            </td>
          </tr>
          <tr>
