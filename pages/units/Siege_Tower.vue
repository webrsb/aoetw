      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            攻城塔是一種攻城武器單位，他引進自失落的帝國，一開始他只能在某些戰役或是地圖編輯器中使用，但是非洲王國推出後，他便可以在<nuxt-link
              ...
              >攻城武器製造所</nuxt-link
            >訓練。它本身並不能攻擊，只能把友軍單位神不知鬼不覺的運送到
            <nuxt-link to="">牆</nuxt-link>內。
          </p>
        </div>
        <h3>戰術</h3>
        <div class="hrn1"></div>
        ...
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="tta4">
              近戰單位、<nuxt-link to="/units/Magyar_Huszar"
                >馬札爾驃騎兵</nuxt-link
        ...
        <div class="n1">
          ...
          <div class="n1">
              ...
              <ul>
                ...
                <li>
                  蒙古的攻城塔塞滿步兵速度是1.7，是路上最快的單位之一，速度甚至超越了有<nuxt-link
                    to="/techs/Husbandry"
                    >畜牧培育</nuxt-link
                  >的 <nuxt-link to="/units/Hussar">輕騎兵</nuxt-link>。
                </li>
                <li>
                  AOE
            ...
            <div class="n1">
              <div class="col-md-12">
                <div class="col-md-4">
                  <a target="_blank" href="/img/Siegetower.jpg"
                    ><img class="imgn hg" src="~assets/Siegetower.jpg" alt=""
                  /></a>
                  <p><em>一群攻城塔</em></p>
                </div>
                <div class="col-md-4">
                  <a target="_blank" href="/img/Siege_Tower_attacking.png"
                    ><img
                      class="imgn hg"
