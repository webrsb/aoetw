      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          <p>
            ...
            >初期，<nuxt-link to="/units/Mangonel">輕型投石車</nuxt-link
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              ...
              >：輕型投石車<nuxt-link to="/elements/Rate_of_Fire"
                >攻擊速度</nuxt-link
              >快25%
            </li>
            <li>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/MangonelIcon.png" class="img-fluid" alt="" />
              </div>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit4">
              <img class="gg" src="~assets/onager.png" alt="" />800<nuxt-link
                to="/resource/Food"
                >食物</nuxt-link
              >500黃金
            </td>
