  ...
  <div class="container">
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            <b>草原槍兵</b>是<nuxt-link to="/techs/age/Castle_Age"
              >城堡時代</nuxt-link
          ...
          <p>
            只有<nuxt-link to="/civs/Cumans">庫曼</nuxt-link>與<nuxt-link to="/civs/Tatars">韃靼</nuxt-link>可以使用。
          </p>
        </div>
        <h3>戰術</h3>
        <div class="hrn1"></div>
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              <nuxt-link to="/civs/Franks">法蘭克</nuxt-link>：騎士+2視野。
            </li>
            <li>
        ...
        <div class="n1">
          <ul>
            <li>
              儘管騎士在遊戲中配備著劍，但他們在馬背上作戰的主要武器是長矛。騎兵隊最初是使用長矛作戰直到後來換成劍。
            </li>
            <li>
              騎士是遊戲中唯四沒有任何攻擊加成的單位(剩下的是<nuxt-link
                to="/units/Militia"
                >民兵</nuxt-link
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="unit4">60/80</td>
          </tr>
          <tr>
            <td class="unit3">攻擊</td>
            <td class="unit4">10/12(近戰)</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit4">
              <img
                class="gg"
                src="~assets/Cavalier-research.jpg"
                alt=""
              />900食物550黃金
            </td>
          </tr>
