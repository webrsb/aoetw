  ...
  <div class="container">
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            <b>精銳戰矛兵</b>（在HD以前玩家習慣講<nuxt-link
              to="/units/Skirmisher"
              >矛兵</nuxt-link
            >，升級為戰矛兵。）是<nuxt-link to="/techs/age/Castle_Age"
              >城堡時代</nuxt-link
            >對抗<nuxt-link to="/units/Archer_Units">弓箭手</nuxt-link
            >的單位，對<nuxt-link to="/units/Archer_Units">弓箭手</nuxt-link
          ...
          <p>
            除了<nuxt-link to="/civs/Turks">土耳其人</nuxt-link>，所有<nuxt-link
              to="/civs"
              >文明</nuxt-link
            >都有精銳戰矛兵。
          </p>
          <p>
            ...
            >和他的同盟有<nuxt-link to="/units/Imperial_Skirmisher"
              >帝王戰矛兵</nuxt-link
            >。
          </p>
        </div>
        ...
        <div class="n1">
          <p>
            ...
            <nuxt-link to="/units/Archer">弓箭手</nuxt-link>、<nuxt-link
              to="/units/Spearman"
              >長槍兵</nuxt-link
            >與其他遠程單位外，精銳戰矛兵顯得非常虛弱，他們攻擊、<nuxt-link
          ...
          <p>
            由於精銳戰矛兵生產不用<nuxt-link to="/resource/Gold">黃金</nuxt-link
            >，所以是一個<nuxt-link to="/units/Trash_Unit">垃圾兵單位</nuxt-link
            >，在缺少黃金時期，是非常重要的兵種，由於成本低、訓練時間短，在某些情況下，可以用數量壓制對手。
          </p>
          <p>
            精銳戰矛兵對<nuxt-link to="/units/Spearman">槍兵</nuxt-link
            >有額外的傷害，雙方數量少時，槍兵將獲勝，但數量一多起來，精銳戰矛兵將克制槍兵。
          </p>
        </div>
        <h3>更多數據</h3>
        <div class="hrn1"></div>
          ...
          <tr>
            ...
            <td class="tta4">
              ...
              <img src="~assets/unique_tech.png" class="gg" alt="" /><nuxt-link
                ...
                >安地斯彈弓</nuxt-link
              >:精銳戰矛兵和<nuxt-link to="/units/Slinger">投石手</nuxt-link
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              ...
              >：對精銳戰矛兵有利的<nuxt-link to="/techs">科技</nuxt-link
            ...
            <li>
              <nuxt-link to="/civs/Vietnamese">越南</nuxt-link
              >：精銳戰矛兵在<nuxt-link to="/techs/age/Castle_Age"
                >城堡</nuxt-link
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              ...
              >：精銳戰矛兵生產快20%。研發<nuxt-link to="/techs/Thumb_Ring"
                >拇指環</nuxt-link
              >速度快20%。
            </li>
            <li>
              <nuxt-link to="/civs/Magyars">馬扎爾</nuxt-link
              >：精銳戰矛兵<nuxt-link to="/elements/Line_of_Sight"
                >視野</nuxt-link
              >+2。
            </li>
            <li>
            ...
            <li>
              <nuxt-link to="/civs/Vietnamese">越南</nuxt-link
              >:可升級為<nuxt-link to="/units/Imperial_Skirmisher"
                >帝王戰矛兵</nuxt-link
              >。
            </li>
          </ul>
        ...
        <div class="n1">
          ...
          <ul>
            <li>
              精銳戰矛兵對<nuxt-link to="/armor/Armor_Class_Spearman"
                >槍兵</nuxt-link
              >攻擊+3。
            </li>
        ...
        <div class="n1">
          <ul>
            <li>
              戰矛兵系是所有單位最便宜的，與<nuxt-link to="/units/Spearman"
                >槍兵</nuxt-link
              >相同，所需60資源，且不用黃金。
            </li>
            <li>
        ...
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style="background-color:#3c763d;">
              <div class="unititle2">精銳戰矛兵</div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/EliteSkirmisherIcon.png" class="img-fluid" alt="" />
              </div>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit4">
              <img
                class="gg"
                src="~assets/imperial_skirmisher.png"
                alt=""
              />300木材450黃金
            </td>
          </tr>
