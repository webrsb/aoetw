  ...
  <div class="container">
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            <b>戰矛兵</b>是<nuxt-link to="/techs/age/Castle_Age"
              >城堡時代</nuxt-link
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              <nuxt-link to="/civs/Vietnamese">越南</nuxt-link
              >：戰矛兵血量增加20%。<nuxt-link to="/techs/Conscription"
                >徵兵技術</nuxt-link
              >免費。
            </li>
          </ul>
        ...
        <div class="n1">
          <ul>
            <li>
              矛兵系是所有單位最便宜的，與<nuxt-link to="/units/Spearman"
                >槍兵</nuxt-link
              >相同，所需60資源，且不用黃金。
            </li>
            <li>
