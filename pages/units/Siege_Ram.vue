        ...
        <div class="n1">
          <p>
            ...
            >才能研發，在許多高手心目中，有沒有重型衝撞車為判定一個<nuxt-link
              to="/civs"
              >文明</nuxt-link
            >，後帝王強不強的關鍵原因之一。除了對於<nuxt-link to="/building"
              >建築物</nuxt-link
            >強大的破壞力，給對手的視覺震撼力也是相當可怕。
          </p>
          <p>重型衝撞車移動速度與駐紮數量前後比較</p>
          <ul>
            <li>
              駐紮<nuxt-link to="/units/Infantry_Units">步兵</nuxt-link
              >數量0→移動速度0.6 (<nuxt-link to="/units/War_Elephant"
                >戰象</nuxt-link
              >移動速度0.6)
            </li>
            <li>
        ...
        <div class="n1">
          <p>
            ...
            >，你不用再為了移動速度問題，困擾是否要將步兵駐紮在<nuxt-link
              ...
              >衝撞車</nuxt-link
            >內，且<nuxt-link to="/elements/Hit_points">生命值</nuxt-link
            >變成270，耐打程度有顯助的提升。
          </p>
          <p>
          ...
          <p>
            ...
            >文明也非常適合研發重型衝撞車，塞爾特不只有生產快速的優勢，更有特殊科技<nuxt-link
          ...
          <p>
            ...
            >由於可以在城堡時代就研發裝甲衝撞車，因此上帝王時代後，在實力相當的情況下可以比其他文明更快升級至重型衝撞車並發起進攻，較為可惜的是該文明沒有攻城工程師。
          </p>
          <p>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/SiegeRamIcon.png" class="img-fluid" alt="" />
              </div>
            </td>
          </tr>
          <tr>
