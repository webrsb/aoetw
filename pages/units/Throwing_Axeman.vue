  ...
  <div class="container">
    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
          ...
          <tr>
            ...
            <td class="tta4">
              <img
                ...
                width="30"
                alt=""
              /><nuxt-link to="/techs/Bearded_Axe">倒鉤斧</nuxt-link>(+1)
            </td>
          </tr>
          <tr>
        ...
        <div class="n1">
          ...
          <ul>
            ...
            <li>擲斧兵移動速度為0.9。</li>
            <li>
              擲斧兵(非精銳)的<nuxt-link to="/elements/Frame_delay"
                >開火間隔</nuxt-link
              >為12。
            </li>
          ...
          <ul>
            ...
            <li>
              ...
              >:引入<nuxt-link to="/techs/Bearded_Axe">倒鉤斧</nuxt-link>。
            </li>
          </ul>
          <h3>
      ...
      <div class="col-md-12">
        ...
        <div class="n1">
          <div class="col-md-4">
            <a target="_blank" href="/img/Throwingaxeman.png"
              ><img
                class="imgn hg"
                width="180"
          ...
          <div class="col-md-4">
            <a target="_blank" href="/img/Francisca.jpg"
              ><img
                class="imgn hg"
                width="200"
