        ...
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style="background-color:#3c763d;;">
              <div class="unititle"><nuxt-link to="">自爆筏</nuxt-link></div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
          ...
          <tr>
            ...
            <td class="unit4">
              +180對<nuxt-link to="/armor/Armor_Class_Building">建築</nuxt-link>
            </td>
          </tr>
          <tr>
      ...
      <div class="col-md-12">
        ...
        <div class="n1">
          <div class="col-md-12">
            ...
            <div class="col-md-4">
              <a target="_blank" href="/img/Demoraft.png"
                ><img class="imgn hg" src="~assets/Demoraft.png" alt=""
              /></a>
              <p><em>一群自爆筏。</em></p>
            </div>
            <div class="col-md-4">
              <a target="_blank" href="/img/DemolitionRaft.png"
