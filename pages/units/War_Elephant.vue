    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
          ...
          <ul>
            <li>
              戰象非常強悍，但是速度也很慢，<nuxt-link to="/units/Archer_Units"
                >遠程</nuxt-link
              >作戰單位容易對它們造成更多傷害。戰象在遊戲中的分類為騎兵，這使的它們對付<nuxt-link
                to="/units/Spearman"
                >長槍兵</nuxt-link
              >系的時候會受到非常大的傷害，分別受到+30，+47，+60(按升級順序來說)。
            </li>
            <li>
            ...
            <li>
              ...
              >雖然沒有<nuxt-link to="/units/Halberdier">戟兵</nuxt-link
              >一樣的超高攻擊加成(+60)
            </li>
            ...
            <li>
              ...
              >系對於戰象有攻擊加成(+6，升級後為+8)，且弩砲有穿透傷害，所以碰到大量的弩砲記得要迴避。
            </li>
            <li>
            ...
            <li>
              由於造成踐踏傷害，進入白刃戰時，請盡量讓戰象被敵方單位包圍形成混戰。因為超高的<nuxt-link
          ...
          <tr>
            ...
            <td class="tta4">
              <img
                ...
                width="30"
                alt=""
              /><nuxt-link to="/techs/Mahouts">象伕</nuxt-link>(+30%，<nuxt-link
                to="/civs/Persians"
                >波斯</nuxt-link
              >
              限定) <br />
          ...
          <tr>
            ...
            <td class="tta4">
              <img
                ...
                width="30"
                alt=""
              /><nuxt-link to="/techs/Faith">忠誠信仰</nuxt-link>(+33%)
            </td>
          </tr>
          <tr>
          ...
          <div class="n1">
            <div class="row">
              <div class="col-md-6">
                ...
                <div style="margin:12px 0px;"><strong>+47攻擊</strong></div>
                <ul>
                  <li>
                    <img
                      class="gg"
        ...
        <div class="n1">
          <ul>
            <li>
              升級完成的精銳戰象有620生命值，比一幢<nuxt-link
                to="/techs/age/Dark_Age"
                >黑暗時代</nuxt-link
              >的<nuxt-link to="/building/House">房屋</nuxt-link
              >擁有更多生命值。
            </li>
            <li>
        ...
        <div class="n1">
          <p>
            ...
            >得到了大象。戰象是對敵軍的有力部隊，特別是對沒有碰過他們的軍隊。他們非常難以殺死，但仍難以控制。如果他們能夠被引導到敵方陣型中，敵軍幾乎總是陷於混亂狀態甚至被踐踏而死。
          </p>
        </div>
        <h3>圖庫</h3>
        <div class="hrn1"></div>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/WarElephantIcon.png" width="45" alt="" />
              </div>
            </td>
          </tr>
          <tr>
