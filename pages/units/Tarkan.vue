  ...
  <div class="container">
          ...
          <tr>
            ...
            <td class="unit4">
              ...
              <img class="gg" src="~assets/Stable-logo.jpg" alt="" /><nuxt-link
                to="/building/Stable"
                >馬廄</nuxt-link
              >(<nuxt-link to="/techs/Marauders">掠奪者</nuxt-link>研發後)
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit4">
              ...
              <br />+10對<nuxt-link to="/armor/Armor_Class_Castle"
                >城堡</nuxt-link
              >
              <br />+8/+10(精銳)對<nuxt-link to="/armor/Armor_Class_Building"
                >建築類</nuxt-link
              >
    ...
    <div class="col-md-12">
      ...
      <div class="n1">
        <div class="col-md-12">
          <div class="col-md-4">
            <a target="_blank" href="/img/Tarkan.png"
              ><img class="imgn hg" src="~assets/Tarkan.png" alt=""
            /></a>
            <p><em>一群韃靼騎兵。</em></p>
          </div>
          <div class="col-md-4">
            <a target="_blank" href="/img/A_Tarkan.png"
