  ...
  <div class="container">
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <p>
          犀牛在《世紀帝國 II HD:
          拉惹的崛起》首次出現，有400的肉，但不會被馴化，必須去狩獵或是用斥候或是村民射箭引誘到城鎮中心圍捕，400的肉量比野豬提供的多，是初期相當龐大的食物來源，讓犀牛與象並列世紀帝國II中最有價值的野生食物來源。犀牛只會出現在東南亞地圖上。犀牛跟野豬和象會攻擊激怒牠的單位，不過不一樣的是犀牛通常一群會有三隻左右，最好要一定數量村民去獵殺或是一個村民當誘餌其他村民放箭圍捕比較好。
        </p>
        <h3>文明優勢</h3>
        <div class="hrn1"></div>
        <div class="n1">
