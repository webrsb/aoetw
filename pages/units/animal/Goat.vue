  ...
  <div class="container">
    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <p>
          山羊在《世紀帝國 II HD:
          非洲王朝》出現，是可馴化的動物，山羊主要替代羊出現在非洲地圖上。
        </p>
        <p>
          初期的山羊很重要，因為還不能種田，隨著遊戲後期種田效率提昇，山羊也不那麼重要了。
        </p>
        <p>
          山羊也會被拿來探地圖，雖然視線不高，且存在被偷走的風險，但是在島嶼或是圍城這種封閉的地圖上，那麼將非常安全。
        </p>
        <p>
          賽爾特人對於山羊的控制有獨特的優勢，就是只要在賽爾特單位的視野內，山羊就無法被其他玩家控制。
        </p>
        <p>每隻山羊總共有100的食物。</p>
        <h3>文明優勢</h3>
        <div class="hrn1"></div>
        ...
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style=" background-color:#b086b5;">
              <div class="unititle"><a href="#">山羊</a></div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
