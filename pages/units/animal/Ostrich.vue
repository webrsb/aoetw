  ...
  <div class="container">
    ...
    <div class="row" style=" margin-top: 50px;">
      ...
      <div class="col-md-8">
        <p>
          鴕鳥在《世紀帝國 II HD:
          非洲王朝》中是可獵捕的動物，通常三隻一群，一隻有140的肉，但不會被馴化，必須去狩獵或是用斥侯趕回城鎮中心，是初期相當快速的食物來源。村民獵殺鴕鳥至少要兩箭，而最少3個村民殺鴕鳥會比較有效率。一般來說打封建開打的遊戲，並不會去鴕鳥旁邊蓋磨坊，而是會用斥侯趕回資源採集點，而趕鴕鳥的技巧對新手來說相當困難，必須練習再練習，不斷的練習。鴕鳥只會出現在非洲地圖上。
        </p>
        <h3>文明優勢</h3>
        <div class="hrn1"></div>
        <div class="n1">
        ...
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style=" background-color:#b086b5;">
              <div class="unititle"><a href="">鴕鳥</a></div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
