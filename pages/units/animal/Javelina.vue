<template>
  <div class="container">
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <p>
          <b>爪哇野豬(Javelina)</b>在《<nuxt-link to="/games/aoc"
            >世紀帝國II：征服者入侵</nuxt-link
          >》首次引入，它有75點生命值，也比鹿要難殺死得多。
          村民們必須集體出擊才能收獲這樣大的獵物，任何落單的村民都將落得死亡的下場。爪哇野豬提供340食物，比大多數可捕獵動物要多得多。
          它是野豬在功能和外觀上完全相同的美洲版本。
        </p>
        <h3>文明優勢</h3>
        <div class="hrn1"></div>
        <div class="n1">
        ...
        <div class="n1">
          <ul>
            <li>
              “
              javelina”一詞源自西班牙的jabalina，意為“雌性野豬”和用來獵取野豬的矛（javelin）。
            </li>
            <li>
              儘管在遊戲中看起來與以前版本的野豬相同，但真正的爪哇野豬更小，臉更短，下巴的尖長牙在閉上嘴時不會突出嘴外。他們吃的也比野豬更素食。
              然而，當受傷或受到威脅時，它們仍然是危險的動物。
            </li>
          </ul>
        </div>
        <h3>圖庫</h3>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/Iron-boar-icon-aoe2.png" alt="" />
              </div>
            </td>
          </tr>
          <tr>
