  ...
  <div class="container">
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <p>
          象在《世紀帝國 II HD:
          非洲王朝》首次出現，象有400的肉，但不會被馴化，必須去狩獵或是用斥候或是村民射箭引誘到城鎮中心圍捕，400的肉量比野豬提供的多，是初期相當龐大的食物來源，讓象與犀牛並列世紀帝國II中最有價值的野生食物來源。象只會出現在非洲或印度地圖上。象與野豬一樣會攻擊激怒牠的單位，象的移動速度快且近戰攻擊力高，最好要一定數量村民去獵殺或是一個村民當誘餌其他村民放箭圍捕比較好。第一隻象通常在10p的時候誘捕到城鎮中心殺掉，第二隻大概是17p左右打，當然也可以偷對方家的象。
        </p>
        <h3>文明優勢</h3>
        <div class="hrn1"></div>
        <div class="n1">
