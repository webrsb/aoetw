      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            ...
            帝王世紀》中的一名騎兵英雄，只可以在戰役編輯器中找到。薩瓦蘭重騎兵沒有出現在原先《世紀帝國
            II HD: 帝王世紀》的戰役中，反而在《世紀帝國 II HD:
            失落的帝國》的戰役中出現好幾次。薩瓦蘭重騎兵有聖騎兵的外觀，但比一般聖騎兵有較高的HP，不過裝甲和攻擊反而比較低。由於屬於英雄單位，因此不能被招降且會回血(在征服者資料片後)，他也會受騎兵科技加成的影響。
          </p>
          <p></p>
        </div>
      </div>
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/Belisariusicon.png" width="80" alt="" />
              </div>
            </td>
          </tr>
          <tr>
