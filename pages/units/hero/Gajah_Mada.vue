  ...
  <div class="container">
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            加查·馬達是個步兵英雄，在"王者崛起"資料片的戰役"班師勤王"、"風雲變色"還有地圖編輯器中出現，在遊戲中的外貌是拿劍跟盾的步兵。加查·馬達不能被招降而且會自行回血。
          </p>
          ...
          <p>
            ...
            ，因創造該帝國的鼎盛時期而著名。234,239。他曾經立了名為帕拉帕誓言（的誓言，宣布他在為滿者伯夷征服整個約當今印尼的整個群島之前,不吃任何有香料的食物。在現代的印度尼西亞，他作為重要的民族英雄，以及國家統一與愛國主義的象徵。
          </p>
        </div>
        <div></div>
        <div></div>
