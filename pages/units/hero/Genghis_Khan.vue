  ...
  <div class="container">
    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          <p>
            成吉思汗，即元太祖，蒙古人，蒙古帝國奠基者、政治家、軍事統帥，皇帝（蒙古帝國大汗）。名鐵木真。1206年春天—1227年8月25日在位，在位22年。1206年他登基時，諸王和群臣為他上蒙語尊號成吉思汗。
          </p>
        </div>
        <h3>介紹</h3>
        <div class="hrn1"></div>
        <div class="n1">
          <p>
            成吉思汗是一位馬弓騎兵的英雄，只有在地圖編輯器與成吉思汗戰役中登場，但他不能被玩家控制。成吉思汗是全遊戲中最強的英雄，不能被招降，且會自己回血。
          </p>
        </div>
        <h3>芝麻小事</h3>
        <div class="hrn1"></div>
        <div class="n1">
          <ul>
            <li>
              成吉思汗在他自己的戰役第一關:嚴酷的考驗中登場，第一次也是最後一次。
            </li>
            <li>
              在舊版本1.0c以前，直接與成吉思汗改變外交關係為敵對，與他說完話後他會停下來打你，看到他停下後，解任務拿僧侶即可招降成吉思汗，使得這關變得非常容易。
            </li>
          </ul>
        </div>
      </div>
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="unit4">弓箭手(+2) <br />騎兵(+2) <br />特殊單位</td>
          </tr>
          <tr>
