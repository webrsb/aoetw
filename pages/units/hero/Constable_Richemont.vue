  ...
  <div class="container">
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            <strong>康斯塔伯理察蒙</strong>是《<nuxt-link to="/games/aok"
            ...
            >編輯器中找到。現實中他是被稱為“歷峰歷險記”的亞瑟·德·歷史蒙特:<nuxt-link
              to="/civs/Franks"
              >法國</nuxt-link
            >貴族和百年戰爭中的老兵。康斯塔伯理察蒙出現在<nuxt-link
              to="/batt/Joan_of_Arc"
              >聖女貞德戰役</nuxt-link
            >“完美的受難者”的最後場景中。康斯塔伯理察蒙會受<nuxt-link
              to="/units/Cavalry_Units"
              >騎兵</nuxt-link
            ><nuxt-link to="/techs">科技</nuxt-link
            >加成的影響，但不會受<nuxt-link to="/civs">文明</nuxt-link
            >或<nuxt-link to="/elements/Team_Bonus">團隊加分</nuxt-link
