  ...
  <div class="container">
    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            蘭斯洛特，亞瑟王傳說中的角色。圓桌騎士武藝最強者，曾用一枝樹枝打敗費洛特。傳說是在湖中被養大的，所以又名湖上騎士。蘭斯洛特為亞瑟王的勝利提供了莫大的幫助，但是最後亞瑟王的敗亡也是起因於他。作為背叛者的事蹟非常有名，最後並沒有得到亞瑟王的制裁，而是成為一名修道士。
          </p>
        </div>
        ...
        <div class="n1">
          <p>
            蘭斯洛特是一名騎兵英雄，遊戲中以遊俠的形象出現。作為最強圓桌騎士的他，沒有出現在任何戰役裡面，只能在遊戲編輯器裡面找到。
          </p>
          <ul>
            <li>作為英雄單位，蘭斯洛特不能被招降，且會自己回復生命值。</li>
            <li>
              蘭斯洛特被歸類為騎兵，所有騎兵的加成對他都有效果，比方法蘭克的血量加成。
            </li>
        ...
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style=" background-color:#d01022;">
              <div class="unititle"><a href="">蘭斯洛特</a></div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
      ...
      <div class="col-md-12">
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              號稱是最強的圓桌騎士，但是遊戲內甚至無法打贏身為背叛者的莫德雷德。
            </li>
        ...
        <div class="n1">
          <p>
            蘭斯洛特出身於法國，傳說中在其父死後，就被梅林的情人薇薇安(也就是給予亞瑟王聖劍的湖中聖女)偷去，並且在水下撫養成高貴的騎士。
          </p>
          <p>
          ...
          <p>
            亞瑟王最後追趕至法國，並捉拿蘭斯洛特成功，但由於莫德雷德的叛亂，亞瑟王選擇原諒了蘭斯洛特。被騎士精神促使，蘭斯洛特要求幫忙平亂，卻遭到高文爵士拒絕。
          </p>
          <p>
