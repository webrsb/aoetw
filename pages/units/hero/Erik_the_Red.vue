      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            ...
            帝王世紀》中的一名步兵英雄，可以在戰役"芬特蘭撒格(1000)"和戰役編輯器中找到。紅衣艾立克的外觀是狂戰士，但有更多的生命值。由於他屬於英雄單位，因此不能被招降且會回血(在征服者資料片後)，不過回血速度跟其他英雄一樣，不因狂戰士特性有加速回血，他也會受步兵科技加成的影響
            。
          </p>
          <p></p>
        </div>
