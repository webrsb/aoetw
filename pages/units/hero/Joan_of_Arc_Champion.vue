    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          ...
          <p>
            在決定版新增的DLC─西方霸主中新增的勃根地戰役最後一關「聖女殞落」，該戰役玩家的陣營是勃根地，因此聖女貞德和法國軍隊以敵對勢力登場。該戰役可以說是圍攻巴黎一役中，勃根地方面的行動，任務目標就是突破康比涅，並把貞德擊落馬下俘虜。由於勃根地的故事從貞德被處刑前一天開始講起，因此最終也終於貞德之死；隨著觀看者的角度不同，在好人菲利普的眼中，貞德就只是一個昧於政治現實的傻瓜。
          </p>
        </div>
        <h3>出場戰役</h3>
        <div class="hrn1"></div>
