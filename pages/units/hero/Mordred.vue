  ...
  <div class="container">
    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            莫德雷德，亞瑟之子，是亞瑟王與同母異父的姐姐莫歌絲亂倫生下的兒子，名義上是亞瑟的姪子，大多數有關莫德雷德的描述都是關於劍欄之戰，也就是莫德雷德背叛亞瑟王的故事。
          </p>
        </div>
        ...
        <div class="n1">
          <p>
            莫德雷德是一名騎兵英雄，遊戲中以遊俠的形象出現。成功使卡美洛崩壞的他，沒有出現在任何戰役裡面，只能在遊戲編輯器裡面找到他。
          </p>
          <ul>
            <li>作為英雄單位，莫德雷德不能被招降，且會自己回復生命值。</li>
            <li>
              莫德雷德被歸類為騎兵，所有騎兵的加成對他都有效果，比方波斯的對弓兵加成。
            </li>
        ...
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style="background-color:#d01022;">
              <div class="unititle"><nuxt-link to="">莫德雷德</nuxt-link></div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
      ...
      <div class="col-md-12">
        ...
        <div class="n1">
          ...
          <p>
            卡姆蘭戰役(劍欄之戰)：537年，莫德雷德叛變，並占領卡美洛，亞瑟聞訊由法國趕回不列顛，雙方在卡姆蘭決戰，亞瑟以聖槍殺死莫德雷德，卻也被莫德雷德砍成重傷。
          </p>
          <p>
