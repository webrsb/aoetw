  ...
  <div class="container">
    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            <strong>哈羅德哈左德</strong>是《世紀帝國 II HD:
            征服者入侵》中的一名步兵英雄，他只能在戰役編輯器中使用。哈羅德哈左德在現實中是1046~1066的挪威國王。
          </p>
          <p>
            哈羅德哈左德擁有狂戰士的外觀，但攻擊方式是像擲斧兵丟斧頭，攻擊速度極快（比起一般單位的2.03，他的攻擊間隔僅有1)，然而命中率卻是可憐的30%，移動速度也遠比狂戰士快(1.32的移動速度可媲美騎士的1.35)。
          </p>
          <p>
            哈羅德哈左德受步兵科技的加成影響，由於他屬於英雄單位，因此不能被招降且會回血
        ...
        <div class="n1">
          <ul>
            <li>
              哈羅德哈左德首次出現在戰役"哈斯汀斯(1066)"。一開始他的軍隊攻擊英國但失敗了，後來他與征服者威廉結盟。
            </li>
          </ul>
        </div>
        <h3>圖庫</h3>
        ...
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style=" background-color:#d01022;">
              <div class="unititle"><a href="">哈羅德哈左德</a></div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
