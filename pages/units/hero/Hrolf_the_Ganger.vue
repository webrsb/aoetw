  ...
  <div class="container">
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            <strong>首領荷夫</strong>是《<nuxt-link to="/games/aok"
              >世紀帝國II：帝王世紀</nuxt-link
            >》中的一名<nuxt-link to="/units/Infantry_Units">步兵英雄</nuxt-link
            >，只可以在<nuxt-link to="/batt">戰役</nuxt-link
            >編輯器中找到。首領荷夫現實中是諾曼底的第一個<nuxt-link
              to="/civs/Vikings"
              >維京</nuxt-link
            >統治者羅洛公爵，有時他也被稱為Göngu-Hrólfr。首領荷夫有<nuxt-link
              to="/units/Berserk"
              >狂戰士</nuxt-link
            >的外貌但有更好的戰鬥力，不過移動速度比一般狂戰士慢，他會受<nuxt-link
