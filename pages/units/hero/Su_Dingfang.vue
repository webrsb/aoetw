  ...
  <div class="container">
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            蘇定方是個弓兵英雄，在"世界地國II:非洲王朝"資料片的地圖編輯器中出現。他是以唐代同名的中國將軍為命名，該名將軍把唐帝國西部邊界擴大到塔里木盆地以外的地方。
          </p>
          <p>
            在遊戲中蘇定方的外型是連弩兵。他會受到所有弓兵科技加成的影響。他不能被招降而且會自行回血。
          </p>
        </div>
        <div></div>
        <div></div>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/ChuKoNuIcon.jpg" width="80" alt="" />
              </div>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit4">14(遠程) <br />0(近戰)</td>
          </tr>
          <tr>
