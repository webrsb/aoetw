    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          <h2>冷知識</h2>
          <p>
            Dave lweis是製作世紀帝國的工作室的員工之一，現在就職於Robot
            Entertainment,他參與了世紀帝國所有系列所有資料片的製作，世紀帝國製作組的元老級人物。Dave
            lweis
            還參與製作著名游戲《光環》（也譯作《光暈》）和《獸人必須死1，2》
          </p>
        </div>
      </div>
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style="background-color:#d01022;">
              <div class="unititle"><nuxt-link to="">VMDL</nuxt-link></div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
