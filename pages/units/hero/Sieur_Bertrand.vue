      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            ...
            帝王世紀》中的一名騎兵英雄，可以在戰役編輯器中找到。現實中他是百年戰爭中的老兵並和他的同伴梅茲爵士在1429年護送聖女貞德從沃庫勒爾到支農。這史實也忠實反映梅茲爵士出現在聖女貞德戰役“一個不大可能的彌賽亞”的場景中。貝查德爵士有騎士的外貌但有更好的戰鬥力。由於他屬於英雄單位，因此不能被招降且會回血(在征服者資料片後)
            。
          </p>
          <p></p>
        </div>
        ...
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style=" background-color:#d01022;">
              <div class="unititle"><a href="">貝查德爵士</a></div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
