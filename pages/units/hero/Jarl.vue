  ...
  <div class="container">
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            <strong>雅爾</strong>是《<nuxt-link to="/games/aof"
          ...
          <p>
            ...
            >"<nuxt-link to="/batt/York_865">約克城(865)</nuxt-link>"中，作為登陸隊伍的一部分，玩家必須在異教徒軍隊抵達之前在不列顛群島上建立一個基地。雅爾應該用來打<nuxt-link
              to="/units/Monk"
              >僧侶</nuxt-link
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/Jarlicon.png" width="80" alt="" />
              </div>
            </td>
          </tr>
          <tr>
