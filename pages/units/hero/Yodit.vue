  ...
  <div class="container">
    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            優娣忒是個步兵英雄，只在"世界地國II:非洲王朝"資料片中的地圖編輯器出現，戰役中則會以優娣忒公主的身分出現在"流亡之路"。
          </p>
        ...
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style="background-color:#d01022;">
              <div class="unititle"><nuxt-link to="">優娣忒</nuxt-link></div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/Yoditicon.png" width="80" alt="" />
              </div>
            </td>
          </tr>
          <tr>
