  ...
  <div class="container">
    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            <strong>蘇利耶跋摩一世</strong
            >是《拉惹的崛起》中的一名騎兵英雄。蘇利耶跋摩一世系列戰役講述他如何逐步獲得權力並建造屬於他的高棉帝國。由於他屬於英雄單位，因此不能被招降且會回血。
          </p>
        </div>
        <h3>歷史</h3>
        <div class="hrn1"></div>
        ...
        <p>
          他的統治持續了約40年，他花了大量時間平定戰亂，捍衛王位。為鞏固他的政治權力，他邀請約四千名當地官員到皇家宮殿宣誓效忠於他。他信佛教但不禁止人們繼續信奉印度教。
        </p>
        <p>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="unit4">騎兵(+10) <br />戰象(+10) <br />特殊單位</td>
          </tr>
          <tr>
