  ...
  <div class="container">
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            達納罕是個馬騎弓兵英雄，只在"世界地國II:非洲王朝"資料片中的地圖編輯器和戰役"摔落的皇冠"裡優娣忒的陣營中出現，達納罕的名字是以建立在九世紀中葉的同名埃塞俄比亞王國的衣索比亞統治者所以命名。
          </p>
          <p>
            在遊戲中達納罕的外型很獨特不過類似象弓騎兵，他會受到所有馬騎弓兵、弓兵和騎兵科技加成的影響。他不能被招降而且會自行回血。
          </p>
        </div>
        <div></div>
        <div></div>
        ...
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style="background-color:#d01022;">
              <div class="unititle"><nuxt-link to="">達納罕</nuxt-link></div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
          ...
          <tr>
            ...
            <td class="unit4">
              <nuxt-link to="">弓兵<br />騎兵<br />英雄</nuxt-link>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit4">
              騎兵 <br />弓兵(-2) <br />馬騎弓兵 <br />戰象 <br />特殊單位
            </td>
          </tr>
          <tr>
