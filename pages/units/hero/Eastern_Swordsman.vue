  ...
  <div class="container">
    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            “帝國時代II：被遺忘的時代”中一名不可分割的步兵部隊的東方劍客。它出現在幾個活動場景中，也可以在場景編輯器中找到。
          </p>
          <p>
            東方劍客與北歐劍客具有完全相同的數據，並且僅與普通長劍客不同，因為他們對建築物缺乏攻擊獎勵。
          </p>
          <p>
            兩個值得注意的現象分別是在帝國的廢墟和印度的Estado da，Francisco de
            Almeida戰役中的第三和第四場景。
          </p>
        </div>
        <div class="n1">
          <h2>冷知識</h2>
          <p>
            事實上雖然都翻譯為劍士，但是在現實中東方劍士可以被分爲用劍（雙刃）和刀（單刃）的不同兵種。中國將領熱愛使用劍，而一般的士卒多用刀，劍在中國古代史一種較高級的階層喜愛的武器。另外，印度和一些東南亞國家使用時多配合盾和長矛使用，這與游戲中東方劍士的形象有所區別。
          </p>
        </div>
      </div>
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style=" background-color:#d01022;">
              <div class="unititle"><nuxt-link to="">東方劍士</nuxt-link></div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
