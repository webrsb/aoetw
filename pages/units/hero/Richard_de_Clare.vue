  ...
  <div class="container">
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            克雷爾的理查伯爵是個騎兵英雄，在"世界地國II:非洲王朝"資料片的地圖編輯器中出現。他是以一位威爾士-諾曼的領主所命名的，他主導了愛爾蘭入侵諾曼的行動。
          </p>
          <p>
            在遊戲中克雷爾的理查伯爵的外型是輕騎兵。他會受到所有騎兵科技加成的影響。他不能被招降而且會自行回血。
          </p>
        </div>
        <div></div>
        <div></div>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/Richarddeclareicon.png" width="80" alt="" />
              </div>
            </td>
          </tr>
          <tr>
