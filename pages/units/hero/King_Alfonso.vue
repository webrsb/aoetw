    ...
    <div class="row" style=" margin-top: 50px;">
      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          <ul>
            <li>
              阿方索國王第一次出現是在席德戰役的"兄弟鬩牆"作為席德的對手和萊昂的國王。在戰役中阿方索最後殺死了自己的兄弟桑喬國王並成為萊昂和卡斯蒂利亞的國王。
            </li>
            <li>
              在戰役"黑衛隊"席德必須求助於阿方索國王的幫助避免他死於柏柏人的刀下。
            </li>
          </ul>
        </div>
      </div>
        ...
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style=" background-color:#d01022;">
              <div class="unititle"><a href="">阿方索國王</a></div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/Kingalfonsoicon.png" width="80" alt="" />
              </div>
            </td>
          </tr>
          <tr>
