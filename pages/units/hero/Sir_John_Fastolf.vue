      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            ...
            帝王世紀》中的一名騎兵英雄，可以在聖女貞德第三戰役"羅亞爾河大掃蕩"和戰役編輯器中找到，在該戰役中玩家破壞一座英國城堡後約翰霍士道夫爵士就會攻擊玩家的城鎮，而且他非常傲慢會嘲笑玩家和貞德的軍隊，玩家殺死他後他會說出"我為英國而死!"這句話。現實中約翰霍士道夫爵士是百年戰爭中的一名騎士，他以指揮英軍在帕提戰役中戰鬥而著名。約翰霍士道夫爵士的外觀是騎士，由於他屬於英雄單位，因此不能被招降且會回血。(在征服者資料片後)
          </p>
          <p>
        ...
        <div class="n1">
          <div class="col-md-12">
            <div class="col-md-5">
              ...
              <p>
                <em
                  >在戰役"羅亞爾河大掃蕩"中約翰霍士道夫爵士攻擊玩家城鎮並被長槍兵圍繞著(磨坊旁邊)。</em
                >
              </p>
            </div>
          </div>
        ...
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style="background-color:#d01022;">
              <div class="unititle">
                <nuxt-link to="">約翰霍士道夫爵士</nuxt-link>
              </div>
            </td>
          </tr>
          <tr>
