    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          ...
          <p>
            1433年黎元龍繼位，是為黎太宗，因年幼，由黎察執掌朝政。劉仁澍與黎察不和，被黎察誅殺。1484年黎聖宗為他平反，追贈太傅、永國公的爵位。
          </p>
        </div>
        <div></div>
        <div></div>
        ...
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style="background-color:#d01022;">
              <div class="unititle"><nuxt-link to="">劉仁澍</nuxt-link></div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/Luunhanchuicon.png" width="80" alt="" />
              </div>
            </td>
          </tr>
          <tr>
