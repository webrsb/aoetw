  ...
  <div class="container">
    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            <strong>格拉維爾領主</strong>是《世紀帝國 II HD:
            帝王世紀》中的一名弓兵英雄，可以在戰役編輯器中找到。現實中他是代表了在巴黎圍城期間指揮法國弓箭手的弩手吉恩·德·格拉維爾（Jean
            de
            Graville）。格拉維爾領主出現在聖女貞德戰役“完美的受難者”的最後場景中。他具有與強弩兵相似的攻擊和射程，但是擁有自己的頭像並有更多的生命值。格拉維爾領主會受弓兵科技加成的影響。由於他屬於英雄單位，因此不能被招降且會回血(在征服者資料片後)
            。
          </p>
          <p></p>
        </div>
