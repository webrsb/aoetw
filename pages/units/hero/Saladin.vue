  ...
  <div class="container">
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            <strong>沙拉丁</strong>是《世紀帝國 II HD:<nuxt-link to="/games/aof"
              >失落的帝國</nuxt-link
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/Saladinicon.png" width="80" alt="" />
              </div>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit4">
              對<nuxt-link to="/armor/Armor_Class_Cavalry">騎兵</nuxt-link>+12
            </td>
          </tr>
          <tr>
            <td class="unit3">
