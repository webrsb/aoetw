  ...
  <div class="container">
    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            華伊納-卡派克是個弓兵英雄，在"世界地國II:非洲王朝"資料片之後版本的地圖編輯器出現，華伊納-卡派克的名字是以建立印加帝國的統治者所命名，當時他把帝國擴展到了最大規模和範圍，從厄瓜多爾，哥倫比亞西南部到北部，再到南部的智利和阿根廷。然而帝國在他死後分裂成兩個實體，不久之後就都被西班牙的征服者征服。
          </p>
          <p>
            在遊戲中華伊納-卡派克的外型是投石手，他會受到所有弓兵科技加成的影響。他不能被招降而且會自行回血。
          </p>
        </div>
        <div></div>
        <div></div>
        ...
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style=" background-color:#d01022;">
              <div class="unititle">
                <nuxt-link to="">華伊納-卡派克</nuxt-link>
              </div>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit4">對步兵+10 <br />對衝撞車+1 <br />對長槍兵+1</td>
          </tr>
          <tr>
