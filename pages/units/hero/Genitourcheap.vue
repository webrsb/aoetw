    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          <h2>冷知識</h2>
          <p>
            它最初計劃成為西班牙特殊兵種，代替戰茅兵，但被征服者取代。在非洲王國中，馬勇士以標槍騎兵的形式，被作為伯伯爾的特殊單位。
          </p>
        </div>
      </div>
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style=" background-color:#d01022;">
              <div class="unititle"><nuxt-link to="">馬勇士</nuxt-link></div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
          ...
          <tr>
            ...
            <td class="unit4">3，4(菁英)</td>
          </tr>
          <tr>
            <td class="unit3">最小攻擊範圍</td>
            <td class="unit4">1</td>
          </tr>
          <tr>
