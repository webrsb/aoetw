    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          <ul>
            <li>
              薩拉丁的第四個戰役"耶路撒冷攻城戰"，玩家一開始會有幾名神弓手作防守用。
            </li>
            <li>
              在薩拉丁最後戰役"獅子與惡魔"中玩家也會有一些神弓手做防守工作。
            </li>
            <li>
              在巴巴羅薩最後戰役"沉睡的皇帝"中，薩拉丁變成玩家敵人並有幾名神弓手在他的軍隊中。
            </li>
          </ul>
        </div>
      </div>
        ...
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style=" background-color:#d01022;">
              <div class="unititle"><nuxt-link to="">神弓手</nuxt-link></div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/Archersoftheeyesicon.png" width="80" alt="" />
              </div>
            </td>
          </tr>
          <tr>
