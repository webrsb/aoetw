  ...
  <div class="container">
    ...
    <div class="row" style=" margin-top: 50px;">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            屈出律是一位在成吉思汗第二關：<a href="A_Life_of_Revenge.php"
              >復仇的人生</a
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/Kushlukicon.png" width="80" alt="" />
              </div>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit4">
              <a href="Cavalry_Units.php">騎兵</a> <br />英雄
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit4">
              <a href="Armor_Class_Cavalry.php">騎兵</a>(+2)
            </td>
          </tr>
          <tr>
