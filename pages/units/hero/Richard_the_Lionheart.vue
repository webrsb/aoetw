  ...
  <div class="container">
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            <strong>獅心王查理</strong>是《世紀帝國 II HD:
            帝王世紀》中的一名步兵英雄，可以在戰役編輯器中找到，在"沉睡的皇帝"、"獅子與惡魔"、"塞普勒斯(1191)"等戰役中也有它的身影。現實中的狮心王理查德是英國的理查一世，他與菲利普·奧古斯都和弗雷德里克·巴巴羅薩一起被譽為第三次十字軍東征中的核心基督教人物。它的外觀是遊俠，由於他屬於英雄單位，因此不能被招降且會回血(在征服者資料片後)。
          </p>
          <p></p>
        </div>
      </div>
