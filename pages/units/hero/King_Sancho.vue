  ...
  <div class="container">
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            <strong>桑喬國王</strong>是《<nuxt-link to="/games/aoc"
              >世紀帝國II：征服者入侵</nuxt-link
            >》中的一名<nuxt-link to="/units/hero">英雄</nuxt-link
            >，也出現在<nuxt-link to="/batt">戰役</nuxt-link
            >"手足相殘"與他的兄弟阿方索對決，他同樣能在戰役編輯器中使用。桑喬國王不能攻擊，但移動速度快而且有很大的<nuxt-link
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/Kingsanchoicon.png" width="80" alt="" />
              </div>
            </td>
          </tr>
          <tr>
