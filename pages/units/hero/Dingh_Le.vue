  ...
  <div class="container">
    <div class="row padtop">
      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          <p>
            他的原型來自於<nuxt-link to="/civs/Vietnamese">越南</nuxt-link
            >歷史上的知名人物丁禮，他也是梨利的姪子。他既勇猛、狡詐又武功高強。他在年輕時曾擔任<nuxt-link
              to="/units/hero/Le_Loi"
              >黎利</nuxt-link
            >的<nuxt-link to="/techs/Squires">護衛</nuxt-link
            >。他和梨來在<nuxt-link to="/units/hero/Le_Loi">黎利</nuxt-link
            >發起藍山起義後不久就率先加入，他同時也是梨利最信賴的人之一。1427年，
            <nuxt-link to="/units/hero/Wang_Tong">王通</nuxt-link
            >出擊藍山軍的將領黎阮，丁禮率兵五百人前去救援。因兵少，在途中遭到<nuxt-link
              to="/units/hero/Wang_Tong"
              >王通</nuxt-link
            >夾擊，丁禮被俘，後被斬首。
          </p>
        </div>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/Dinhleicon.png" width="80" alt="" />
              </div>
            </td>
          </tr>
          <tr>
