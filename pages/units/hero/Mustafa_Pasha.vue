  ...
  <div class="container">
    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            穆斯塔法帕夏是個火藥單位英雄，在"世界地國II:非洲王朝"資料片之後版本的地圖編輯器出現，穆斯塔法帕夏的名字是以同名的土耳其軍事領導人所命名，該名領導者是鄂圖曼帝國最後試圖擴張到中歐和東歐的中心人物。
          </p>
          <p>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/JanissaryIcon.jpg" width="80" alt="" />
              </div>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit4">
              <nuxt-link to="">火藥單位<br />英雄</nuxt-link>
            </td>
          </tr>
          <tr>
