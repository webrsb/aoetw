  ...
  <div class="container">
    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            <strong>蓋佐斯爾立</strong>是《世紀帝國 II HD:
            帝王世紀》中的一名騎兵英雄，可以在聖女貞德最後戰役"完美的烈士"和戰役編輯器中找到。蓋佐斯爾立是聖女貞德戰役系列的旁白，也是遊戲中虛擬百年戰爭後期的領導者。蓋佐斯爾立的外觀是遊俠，但會有更多的生命值、護甲和移動速度(如果玩家使用法蘭克文明的話)，不過攻擊速度比一般的遊俠慢。由於他屬於英雄單位，因此不能被招降且會回血(在征服者資料片後)，他也會受騎兵科技加成的影響，但不會受到文明加成的影響
            。
          </p>
          <p></p>
        </div>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/Guyjosselyneicon.png" width="80" alt="" />
              </div>
            </td>
          </tr>
          <tr>
