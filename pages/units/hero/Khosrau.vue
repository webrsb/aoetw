      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            ...
            II HD: 失落的帝國》布哈拉戰役中的主要腳色，他領導著薩珊王朝的波斯人
            在戰鬥中擊敗匈奴和突厥。他擁有象弓騎兵的外觀，也受所有加成騎兵弓兵科技的影響(包含帕提亞戰術)。由於他屬於英雄單位，因此不能被招降且會回血
            。
          </p>
          <p></p>
        </div>
        ...
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style=" background-color:#d01022;">
              <div class="unititle"><nuxt-link to="#">霍斯勞</nuxt-link></div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
          ...
          <tr>
            ...
            <td class="unit4">
              <nuxt-link to="#">騎兵<br />弓兵<br />英雄</nuxt-link>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit4">對標準建築+12 <br />對石造建築+4</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit4">
              弓兵(-2) <br />騎兵 <br />馬騎弓兵 <br />戰象 <br />特殊單位
            </td>
          </tr>
          <tr>
