          ...
          <ul>
            <li>
              土耳其火槍兵最初的設定是成為重裝步行<nuxt-link to="/units/Archer"
                >弓箭手</nuxt-link
              >，而不是特殊的火槍兵，因為更符合世紀帝國II中世紀時代的歷史。土耳其火槍兵也可以升級為特殊的火槍兵，後來由於已經有特殊<nuxt-link
                to="/units/Archer_Units"
                >射手單位</nuxt-link
              >存在而改變。
            </li>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/JanissaryIcon.png" class="img-fluid" alt="" />
              </div>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit4">
              對<nuxt-link to="/armor/Armor_Class_Ram">衝撞車</nuxt-link
              >攻擊+2/+3(精銳)
            </td>
          </tr>
          <tr>
