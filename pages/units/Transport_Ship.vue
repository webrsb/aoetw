  ...
  <div class="container">
    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          <p>
            從<nuxt-link to="/techs/age/Dark_Age">黑暗時代</nuxt-link
            >開始，運輸船就可以在水上進行偷襲、偵查。也可以利用運輸船來欺騙敵人；玩家可以用幾個便宜的單位駐防在運輸船內，並讓對手來追擊他們。引開敵人的主力，趁機發動攻擊。
          </p>
          <p>
          ...
          <tr>
            ...
            <td class="tta4">
              <img
                ...
                alt=""
              /><nuxt-link to="/techs/Gillnets">流刺網</nuxt-link>(+25%)
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="tta4">
              <img
                ...
                src="~assets/Careening.jpg"
                alt=""
              /><nuxt-link to="/techs/Careening">傾側維修術</nuxt-link>(+5)
              <br />
              <img
                style="margin: 2px;"
                class="gg"
        ...
        <div class="n1">
          ...
          <ul>
            <li>
              運輸船在<nuxt-link to="/techs/age/Feudal_Age">封建時代</nuxt-link
              >就可以訓練。
            </li>
            <li>
          ...
          <ul>
            <li>
              運輸船在<nuxt-link to="/techs/age/Dark_Age">黑暗時代</nuxt-link
              >就可以訓練。
            </li>
            <li>
              <nuxt-link to="/civs/Vikings">維京</nuxt-link
      ...
      <div class="col-md-12">
        ...
        <div class="n1">
          <div class="col-md-12">
            <div class="col-md-4">
              <nuxt-link to="/img/Transportship.png"
                ><img class="imgn hg" src="~assets/Transportship.png" alt=""
              /></nuxt-link>
              <p><em>一群運輸船。</em></p>
            </div>
            <div class="col-md-4">
              <nuxt-link to="/img/TransportShipHD.png"
                ><img class="imgn hg" src="~assets/TransportShipHD.png" alt=""
              /></nuxt-link>
              <p><em>各種運輸船(世紀帝國和征服者入侵資料片)。</em></p>
            </div>
            <div class="col-md-4">
              <nuxt-link to="/img/TransportShipDLC.png"
                ><img class="imgn hg" src="~assets/TransportShipDLC.png" alt=""
              /></nuxt-link>
