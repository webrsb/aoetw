  ...
  <div class="container">
    <div class="row padtop">
      ...
      <div class="col-md-8">
        ...
        以下科技可讓以下單位對運輸船有額外<nuxt-link to="/elements/Attack"
          >攻擊力</nuxt-link
        >
        <div class="n1">
          <div class="row">
        ...
        <div class="n1">
          <div class="row">
            ...
            <div class="col-md-4">
              ...
              <p>
                <em
                  >各種運輸船(世紀帝國II和<nuxt-link to="/games/aoc"
                    >征服者入侵</nuxt-link
                  >資料片)。</em
                >
              </p>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/TransportShipIcon.png" class="img-fluid" alt="" />
              </div>
            </td>
          </tr>
          <tr>
