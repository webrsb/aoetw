      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          ...
          <ul>
            ...
            <li>
              哥德衛隊現在對<nuxt-link to="/armor/Armor_Class_Archer"
                >弓兵</nuxt-link
              >攻擊+3，精銳的+4。
            </li>
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              哥德衛隊是唯一一個對弓箭手有攻擊加值的近戰步兵部隊。而弓箭手是步兵部隊的主要弱點，這讓哥德衛隊成為最通用的步兵部隊。
            </li>
            <li>
              其實哥德衛隊有兩種，因為無政府狀態關係，加上世紀帝國2系統沒辦法讓一種單位有兩種建築物可以生產，所以需要複製一套哥德衛隊模組給軍營使用，在AI部分若不寫軍營版哥德衛隊生產的話，即使研發了無政府狀態AI也不會用軍營生產哥德衛隊。
            </li>
          </ul>
        </div>
        <h3>歷史</h3>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/HuskarlIcon.png" class="img-fluid" alt="" />
              </div>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit4">
              ...
              >+2/+3(精銳) <br />對<nuxt-link
                ...
                >鷹勇士</nuxt-link
              >+2/+3(精銳) <br />對<nuxt-link to="/armor/Armor_Class_Archer"
                >弓兵</nuxt-link
              >+6/+10(精銳)
            </td>
          </tr>
