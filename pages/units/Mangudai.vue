  ...
  <div class="container">
    <div class="row padtop">
      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          <p>
            蒙古突騎非常適合攻擊<nuxt-link to="/units/Monk">僧侶</nuxt-link
            ...
            >等移動緩慢的單位，也能夠用於突襲徒步<nuxt-link
              ...
              >弓兵</nuxt-link
            >。此外對<nuxt-link to="/units/Siege_Weapons">攻城器</nuxt-link
            ...
            >禦工事。雖然蒙古突騎擁有對<nuxt-link to="/units/Siege_Weapons"
              >攻城器</nuxt-link
          ...
          <ul>
            ...
            <li>
              ...
              >。此外蒙古突騎對<nuxt-link to="/armor/Armor_Class_Siege_Weapon"
                >攻城武器</nuxt-link
              >有加成，可以輕鬆射爆<nuxt-link to="/units/Battering_Ram"
                >衝撞車</nuxt-link
              >。盡可能的使用蒙古突騎才是上策。
            </li>
          </ul>
          ...
          <ul>
            <li>
              ...
              >快，所以蒙古突騎的傷害輸出較高，此外，因為<nuxt-link
                ...
                >帕提亞戰術</nuxt-link
              >的關係，蒙古突騎有+2攻擊vs<nuxt-link to="/units/Spearman"
                >長槍兵</nuxt-link
              >。
            </li>
            <li>
            ...
            <li>
              ...
              >在<nuxt-link to="/armor/Armor_Class_Cavalry_Archer"
                >馬弓騎兵</nuxt-link
              >防禦有+2，所以更不怕<nuxt-link to="/units/Skirmisher"
                >矛兵</nuxt-link
        ...
        <div class="n1">
          ...
          <ul>
            <li>
              蒙古突騎對<nuxt-link to="/armor/Armor_Class_Siege_Weapon"
                >攻城武器</nuxt-link
              >攻擊+3(精銳+5)。
            </li>
            <li>蒙古突騎開火速率為2.03。</li>
          ...
          <ul>
            <li>
              蒙古突騎對<nuxt-link to="/armor/Armor_Class_Spearman"
                >長槍兵</nuxt-link
              >攻擊+1。
            </li>
          ...
          <tr>
            ...
            <td class="unit4">
              對<nuxt-link to="/armor/Armor_Class_Siege_Weapon"
                >攻城武器</nuxt-link
              >+3/+5(精銳) <br />對<nuxt-link to="/armor/Armor_Class_Spearman"
                >槍兵類</nuxt-link
              >+1
            </td>
          </tr>
