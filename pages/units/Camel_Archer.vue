    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              駱駝弓騎兵比一般的馬騎弓兵有更高生命，有回復力(柏柏人的<nuxt-link
            ...
            <li>
              ...
              >造成的傷害也不如完全升級的重裝馬騎弓兵。但是由於是<nuxt-link
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              駱駝弓騎兵比蒙古突騎成本便宜5木5金。精銳升級也是駱駝弓騎兵比較便宜
            </li>
            <li>
              整體來說蒙古突騎移動速度快且火力更猛；而駱駝弓騎兵則是HP比較高更耐打、能回血而且護甲分類讓他們受到傷害更少。
            </li>
        ...
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="tta4">
              ...
              <br />
              <img src="~assets/Bracer.jpg" width="30" alt="" /><nuxt-link
                to="/techs/Bracer"
                >護腕</nuxt-link
              >(+1)
              <br />
        ...
        <div class="n1">
          ...
          <ul>
            <li>
              駱駝弓騎兵對<nuxt-link to="/armor/Armor_Class_Infantry"
                >步兵單位</nuxt-link
              >攻擊+1。
            </li>
            <li>
              駱駝弓騎兵有60HP(精銳是65)，對<nuxt-link
                to="/armor/Armor_Class_Camel"
                >反駱駝騎兵</nuxt-link
          ...
          <ul>
            <li>
              5.3改版後不再對<nuxt-link to="/armor/Armor_Class_Infantry"
                >步兵單位</nuxt-link
              >有攻擊加成。
            </li>
            <li>
        ...
        <div class="n1">
          <p>
            歷史上，柏柏爾人是聞名的沙漠掠奪者。他們騎駱駝是因為他們非常適合在沙漠上快速移動。在騎駱駝時使用弓將極大地幫助突襲。
          </p>
        </div>
      </div>
      <div class="col-md-4">
      ...
      <div class="col-md-12">
        ...
        <div class="n1">
          <div class="col-md-12">
            <div class="col-md-4">
              <a target="_blank" href="/img/Tumblr_nxo1o0aN0R1tnh0y7o6_400.png"
                ><img
                  class="imgn hg"
                  width="250"
            ...
            <div class="col-md-4">
              <a target="_blank" href="/img/Aoe2_CamelArcher_Preview.jpg"
                ><img
                  class="imgn hg"
                  width="250"
            ...
            <div class="col-md-4">
              <a target="_blank" href="/img/AOE2_CamelArcher_WIP-1024x787.jpg"
                ><img
                  class="imgn hg"
                  width="250"
            ...
            <div class="col-md-12">
              <div class="col-md-4">
                <a target="_blank" href="/img/Camel_archery.jpg"
                  ><img
                    class="imgn hg"
                    width="250"
              ...
              <div class="col-md-4">
                <a target="_blank" href="/img/1518454054853.jpg"
                  ><img
                    class="imgn hg"
                    width="250"
