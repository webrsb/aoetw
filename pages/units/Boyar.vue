      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              ...
              >對貴族鐵騎有一定的破壞力，雖然決定版後斯拉夫擁有忠誠信仰，但因為速度不快又缺少<nuxt-link
                to="/techs/Heresy"
                >異端邪說</nuxt-link
              >，導致貴族鐵騎容易成為敵方僧侶招降的目標。
            </li>
            <li>
              ...
              >等反騎兵單位以及日本武士這個反特殊單位對貴族鐵騎有一定的破壞力，雖然近防很高但跟以上單位交手時優勢沒很明顯。決定版中多了一個新天敵──立陶宛文明的烈堤司，因為該兵種在和軍事單位交手時無視護甲值，又可能因為聖物有額外的攻擊力，和除了上述以外的近戰單位相比能完全輕鬆地打敗貴族鐵騎。
            </li>
            <li>
        ...
        <div class="n1">
          ...
          <ul>
            ...
            <li>
              36906更新:貴族鐵騎的速度從1.4降低到1.3；貴族鐵騎的遠防由1/2增加為2/3。
            </li>
          </ul>
        </div>
        <h3>趣事</h3>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/New_Boyar.png" alt="" />
              </div>
            </td>
          </tr>
          <tr>
