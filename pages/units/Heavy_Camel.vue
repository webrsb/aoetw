  ...
  <div class="container">
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            <b>重裝駱駝騎兵</b>是<nuxt-link to="/techs/age/Imperial_Age"
              >帝王時代</nuxt-link
        ...
        <div class="hrn1"></div>
        <div class="n1">
          重裝駱駝騎兵在<nuxt-link to="/techs/age/Imperial_Age"
            >帝王時代</nuxt-link
          >，除了對抗騎兵系兵種外對大部分的兵種都趨於弱勢，不過在今天馬橫行天下的情況下，他仍非常的好用。
        </div>
        <h3>更多數據</h3>
        <div class="hrn1"></div>
        <div class="n1"></div>
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              <nuxt-link to="/civs/Chinese">中國</nuxt-link
              >：對重裝駱駝騎兵有利的<nuxt-link to="/techs">科技</nuxt-link
              >在帝王時代便宜/20%。
            </li>
            <li>
              <nuxt-link to="/civs/Indians">印度</nuxt-link
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              <nuxt-link to="/civs/Teutons">條頓</nuxt-link
              >：重裝駱駝騎兵對<nuxt-link to="/units/Monk">僧侶</nuxt-link
              >抵抗力更強。
            </li>
          </ul>
        </div>
        ...
        <div class="n1">
          ...
          <ul>
            ...
            <li>移動速度為1.4。</li>
            <li>
              重裝駱駝騎兵的<nuxt-link to="/armor">防禦類型</nuxt-link
              >有包括<nuxt-link to="/armor/Armor_Class_Cavalry"
                >騎兵護甲</nuxt-link
          ...
          <ul>
            ...
            <li>移動速度增加到1.45。</li>
            <li>
              重裝駱駝騎兵的防禦類型移除了<nuxt-link
                to="/armor/Armor_Class_Cavalry"
                >騎兵護甲</nuxt-link
              >，但加入<nuxt-link to="/armor/Armor_Class_Ship"
                >船艦護甲</nuxt-link
              >，這讓重裝駱駝騎兵對他們本身也有攻擊加成。
            </li>
          ...
          <ul>
            <li>
              重裝駱駝騎兵不再受到<nuxt-link to="/armor/Armor_Class_Ship"
                >船艦護甲</nuxt-link
        ...
        <div class="hrn1"></div>
        <div class="n1">
          <strong>駱駝為何剋馬？：</strong>
          <p>
            世紀帝國中的設定，駱駝打馬單位是有加成的，其實是有原因的。中國有句俗語：瘦死的駱駝比馬大，駱駝天生體積比馬還要大，馬看到龐然大物會害怕是正常。其次是駱駝身上有反芻動物特有的味道，馬一聞到那味道便不受控制。
          </p>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/HeavyCamelIcon.jpg" width="45" alt="" />
              </div>
            </td>
          </tr>
          <tr>
