      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="unit4">
              +280對<nuxt-link to="/armor/Armor_Class_Building">建築</nuxt-link>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit4">
              <img class="gg" src="~assets/DemoShipIcon.jpg" alt="" /><nuxt-link
      ...
      <div class="col-md-12">
        ...
        <div class="n1">
          <div class="col-md-12">
            ...
            <div class="col-md-4">
              <gallery src="~assets/Heavydemo.jpg"
                ><img class="imgn hg" src="~assets/Heavydemo.jpg" alt=""
              /></gallery>
              <p><em>一群重型神風船。</em></p>
            </div>
            <div class="col-md-4">
              <gallery src="~assets/HDemolitionShipHD.png"
            ...
            <div class="col-md-12">
              <div class="col-md-4">
                <gallery src="~assets/HDemolitionShipDLC.png"
                  ><img
                    class="imgn hg"
