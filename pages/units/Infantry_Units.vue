  ...
  <div class="container">
    ...
    <div class="row padtop">
        ...
        <div class="n1">
          <table class="table-bordered table-striped" width="100%">
            ...
            <tr>
              ...
              <td class="tunitc6">
                <nuxt-link to="/units/Eagle_Warrior">鷹勇士</nuxt-link>+40 HP。
              </td>
            </tr>
            <tr>
              <td class="tunitc6">
      ...
      <div class="col-md-12">
        ...
        <div class="n1">
          <div class="col-md-4">
            <a target="_blank" href="/img/Infantryunitsbarracks.jpg"
              ><img
                class="imgn hg"
                width="180"
          ...
          <div class="col-md-4">
            <a target="_blank" href="/img/Infantryunitscastle.jpg"
              ><img
                class="imgn hg"
                width="200"
