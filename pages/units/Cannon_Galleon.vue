  ...
  <div class="container">
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            <b>火砲戰船</b>在<nuxt-link to="/techs/age/Imperial_Age"
              >帝王時代</nuxt-link
            >的<nuxt-link to="/building/Dock">碼頭</nuxt-link
            >可以訓練。要訓練火砲戰船得先研發火砲戰船<nuxt-link to="/techs"
              >科技</nuxt-link
            >。
          </p>
        </div>
        ...
        <div class="n1">
          <p>
            火砲戰船的射程遠比<nuxt-link to="/building/Castle">城堡</nuxt-link
          ...
          <p>
            ...
            >的火砲戰船比其他<nuxt-link to="/civs">文明</nuxt-link>的<nuxt-link
        ...
        以下科技可讓以下單位對火砲戰船有額外<nuxt-link to="/elements/Attack"
          >攻擊力</nuxt-link
        >
        <div class="n1">
          <div class="row">
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              ...
              >：訓練火砲戰船的<nuxt-link to="/resource/Gold">黃金</nuxt-link
              >花費減少15%，火砲戰船HP+10％。
            </li>
            <li>
              <nuxt-link to="/civs/Spanish">西班牙</nuxt-link
              >：火砲戰船自身有<nuxt-link to="/techs/Ballistics"
                >彈道學</nuxt-link
              >加成而且砲彈速度更快。
            </li>
            <li>
        ...
        <div class="n1">
          <div class="row">
            ...
            <div class="col-md-4">
              ...
              <p>
                <em
                  >各種火砲戰船(世紀帝國II和<nuxt-link to="/games/aoc"
                    >征服者入侵</nuxt-link
                  >資料片)。</em
                >
              </p>
