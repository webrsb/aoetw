  ...
  <div class="container">
    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            火炮戰船在帝王時代的碼頭可以訓練。要訓練火炮戰船得先研發火炮戰船科技。
          </p>
        </div>
        <h3>戰術</h3>
        <div class="hrn1"></div>
        <div class="n1">
          <p>
            火炮戰船的射程遠比城堡和火炮塔遠，而且對建築物有額外傷害加成，可說是"海上的火炮"(速度比火炮稍快)。火炮戰船有不錯的傷害，但是緩慢的開火速率，砲彈飛行時間長，有最小射程限制等缺點讓他們對船隻的攻擊幾乎沒有抵抗能力，尤其是
          ...
          <p>
            一般來說，火炮戰船主要用來清理敵方海岸線的建築物，偶爾騷擾範圍內的地面單位。他們不應該用來對付敵方的船隻，而且如果海上威脅沒有完全消失的話，他們很容易就會被消滅。
          </p>
          <p>
            西班牙的火炮戰船比其他文明的射速要快(每秒飛行7格而不是每秒飛行1.39格)，而且有<nuxt-link
              to="/techs/Ballistics"
              >彈道學</nuxt-link
            >加成可以更容易擊中移動目標。
          </p>
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              <nuxt-link to="/civs/Italians">義大利</nuxt-link
              >：訓練火炮戰船成本便宜20%。研究<nuxt-link to="/techs/Careening"
                >傾側維修術</nuxt-link
              >，
              <nuxt-link to="/Dry building/Dock">旱碼頭</nuxt-link>和<nuxt-link
                to="/techs/Shipwright"
                >造船匠</nuxt-link
              >便宜50％。升級成精銳火炮戰船的花費便宜50%。
            </li>
            <li>
              <nuxt-link to="/civs/Persians">波斯</nuxt-link
              >：火炮戰船訓練的速度在帝王提高20%。研究<nuxt-link
                to="/techs/Careening"
                >傾側維修術</nuxt-link
              >、
            ...
            <li>
              <nuxt-link to="/civs/Portuguese">葡萄牙</nuxt-link
              >：訓練火炮戰船的黃金花費減少15%，火炮戰船HP+10％。
            </li>
            <li>
              <nuxt-link to="/civs/Spanish">西班牙</nuxt-link
              >：火炮戰船自身有彈道學加成而且砲彈速度更快。
            </li>
            <li>
              <nuxt-link to="/civs/Turks">土耳其</nuxt-link
              >：火炮戰船HP+25%。升級精銳火炮戰船話費-50%。
            </li>
            <li>
              <nuxt-link to="/civs/Vikings">維京</nuxt-link
              >：火炮戰船訓練的費用在帝王減少20%。
        ...
        <div class="n1">
          ...
          <ul>
            ...
            <li>
              <nuxt-link to="/civs/Turks">土耳其</nuxt-link>:火炮戰船的HP+50%。
            </li>
          </ul>
          <h3>
          ...
          <ul>
            ...
            <li>
              <nuxt-link to="/civs/Huns">匈奴</nuxt-link>:可以訓練火炮戰船。
            </li>
            <li>
              <nuxt-link to="/civs/Spanish">西班牙</nuxt-link
              >:火炮戰船受彈道學加成而且砲彈速度更快。
          ...
          <ul>
            ...
            <li>
              <nuxt-link to="/civs/Huns">匈奴</nuxt-link>:火炮戰船從科技樹移除。
            </li>
            <li>
              <nuxt-link to="/civs/Italians">義大利</nuxt-link
              >:火炮戰船便宜15%。
            ...
            <li>
              <nuxt-link to="/civs/Spanish">西班牙</nuxt-link
              >:火炮戰船自身有彈道學(不須研發彈道學)而砲彈速度變為7格/秒(~3.6倍快)。
            </li>
          </ul>
          <h3>
        ...
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style="background-color:#3c763d;;">
              <div class="unititle"><nuxt-link to="">火炮戰船</nuxt-link></div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
          ...
          <tr>
            ...
            <td class="unit4">
              ...
              >、<nuxt-link to="/units/Naval_Vessels">船</nuxt-link>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit4">
              ...
              <br />+15對<nuxt-link to="/armor/Armor_Class_Infantry"
                >步兵</nuxt-link
              >
              <br />+15對<nuxt-link to="/armor/Armor_Class_Archer"
                >弓兵</nuxt-link
              >
              <br />+15對<nuxt-link to="/armor/Armor_Class_Cavalry"
                >騎兵</nuxt-link
              >
            </td>
          </tr>
          ...
          <tr>
            ...
            <td class="unit4">
              <img
                class="gg"
                src="~assets/Cannongalleonresearch.png"
                alt=""
              />火炮戰船
            </td>
          </tr>
          ...
          <tr>
            ...
            <td class="unit4">
              <img
                class="gg"
                src="~assets/Elite-cannon-galleon-resear.jpg"
                alt=""
              />525木材 500黃金
            </td>
          </tr>
