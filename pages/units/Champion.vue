  ...
  <div class="container">
    ...
    <div class="row" style=" margin-top: 50px;">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            劍兵勇士又稱為冠軍劍士，可以在帝王時代<a href="Barracks.php">軍營</a
            >被訓練。這是民兵系的最高等。
          </p>
        </div>
        <h3>文明可訓練與否</h3>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="n1">
              ...
              <a href="Magyar.php">馬札爾</a>、 <a href="Malians.php">馬利</a>、
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="n1">
              ...
              <a href="Huns.php">匈奴</a>、 <a href="Khmer.php">高棉</a>、
              <a href="Malay.php">馬來</a>、 <a href="Mayans.php">馬雅</a>、
        ...
        <div class="n1">
          <p>
            他們對建築物和<a href="Eagle_Warrior.php">鷹勇士</a
          ...
          <p>
            ...
            <a href="Malians.php">馬利</a>的+3遠程護甲和
            <a href="Aztecs.php">阿茲特克</a>、
            <a href="Burmese.php">緬甸</a
        ...
        <div class="n1">
          <ul>
            <li>
              <a href="Aztecs.php">阿茲特克</a>：劍兵勇士生產速度提高15％。
            </li>
            <li>
              <a href="Burmese.php">緬甸</a>：劍兵勇士在帝王時代有+3攻擊。
            </li>
            ...
            <li>
              <a href="Goths.php">哥德</a>：劍兵勇士便宜35％並對<a
            ...
            <li>
              <a href="Malians.php">馬利</a>：劍兵勇士在帝王時代有 +3 遠程護甲。
            </li>
            <li>
              <a href="Portuguese.php">葡萄牙</a>：劍兵勇士黃金成本減少15％。
            </li>
            <li>
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              <a href="Goths.php">哥德</a>：劍兵勇士訓練和升級快20%。研發<a
                href="Tracking.php"
                >追縱技術</a
        ...
        <div class="n1">
          ...
          <ul>
            <li>
              劍兵勇士擁有+3攻擊VS<a href="Armor_Class_Standard_Building.php"
                >標準建築</a
              >。
            </li>
            <li>劍兵勇士遠防是0。</li>
            <li>
              <a href="Goths.php">哥德</a>:在帝王時代，劍兵勇士成本便宜25%。
            </li>
          </ul>
          <h3>
          ...
          <ul>
            <li>
              劍兵勇士擁有+6攻擊VS<a href="Armor_Class_Eagle_Warrior.php"
                >鷹勇士</a
              >。
            </li>
            <li>劍兵勇士現在擁有1的遠防。</li>
            ...
            <li>
              <a href="Goths.php">哥德</a>:1.0c後，哥德劍兵勇士便宜35%。引入<a
                href="Perfusion.php"
                >灌注士氣</a
              >
            </li>
          ...
          <ul>
            <li>
              劍兵勇士擁有+4攻擊VS<a href="Armor_Class_Standard_Building.php"
                >標準建築</a
              >。
            </li>
            <li>
              劍兵勇士擁有+8攻擊VS<a href="Armor_Class_Eagle_Warrior.php"
                >鷹勇士</a
              >。
            </li>
          </ul>
        ...
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style=" background-color:#3c763d;;">
              <div class="unititle"><a href="">劍兵勇士</a></div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/ChampionIcon.jpg" width="45" alt="" />
              </div>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit4">
              <img class="gg" src="~assets/2HandedswordsmanIcon.jpg" alt="" /><a
