      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          ...
          <p>
            ...
            >來說，劍兵勇士是一個非常重要的選擇。這包括<nuxt-link
              to="/civs/Malians"
              >馬利</nuxt-link
            >的+3<nuxt-link to="/armor">遠程護甲</nuxt-link>和
            <nuxt-link to="/civs/Aztecs">阿茲特克</nuxt-link>、<nuxt-link
              to="/civs/Burmese"
              >緬甸</nuxt-link
        ...
        <div class="n1">
          ...
          <ul>
            ...
            <li>
              ...
              >科技，劍兵勇士對<nuxt-link to="/armor/Armor_Class_Cavalry"
                >騎兵單位</nuxt-link
              >有+5攻擊。
            </li>
            <li>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="unit4">
              <nuxt-link to="/armor/Armor_Class_Infantry"></nuxt-link>步兵
            </td>
          </tr>
          <tr>
