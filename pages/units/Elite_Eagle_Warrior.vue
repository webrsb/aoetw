      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          ...
          <p>
            ...
            >為他們的鷹勇士加防禦，這防禦讓他們可以不用怕任何弓(含<nuxt-link
              to="/building/Castle"
              >城堡</nuxt-link
            >)。高防禦鷹勇士配合<nuxt-link to="/civs/Incas">印加</nuxt-link
            >的<nuxt-link to="/units/Kamayuk">槍隊長</nuxt-link>與<nuxt-link
              to="/units/Slinger"
              >投石手</nuxt-link
            >，組成了印加堅不可破的防線，除了遇到<nuxt-link
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              ...
              >：精銳鷹勇士訓練和升級快20%。研發<nuxt-link to="/techs/Squires"
                >護衛技術</nuxt-link
              >、<nuxt-link to="/techs/Arson">縱火</nuxt-link
        ...
        <div class="n1">
          ...
          <ul>
            <li>精銳鷹勇士改變外觀。</li>
            <li>
              精銳鷹勇士對<nuxt-link to="/armor/Armor_Class_Camel"
                >駱駝</nuxt-link
              >攻擊+2。
            </li>
            <li>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="unit4">
              +10 vs <nuxt-link to="/armor/Armor_Class_Monk">僧侶</nuxt-link
              ><br />+5 vs<nuxt-link to="/armor/Armor_Class_Siege_Weapon"
                >攻城武器</nuxt-link
              >
              <br />+4 vs<nuxt-link to="/armor/Armor_Class_Cavalry"
                >騎兵</nuxt-link
              ><br />+3 vs<nuxt-link to="/armor/Armor_Class_Camel"
                >駱駝騎兵</nuxt-link
              ><br />+2 vs<nuxt-link to="/armor/Armor_Class_Ship"
                >船隻</nuxt-link
              ><br />
              +2 vs<nuxt-link to="/armor/Armor_Class_Fishing_Ship"
                >漁船</nuxt-link
              >
            </td>
          </tr>
