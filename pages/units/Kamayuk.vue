  ...
  <div class="container">
    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          ...
          <ul>
            ...
            <li>
              4.8改版後槍隊長對<nuxt-link to="/armor/Armor_Class_War_Elephant"
                >戰象單位</nuxt-link
              >+20攻擊。
            </li>
          </ul>
          ...
          <ul>
            <li>
              5.7改版後槍隊長對<nuxt-link to="/armor/Armor_Class_Camel"
                >駱駝騎兵類</nuxt-link
              >+6攻擊，精銳+10。
            </li>
          </ul>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="unit4">
              對<nuxt-link to="/armor/Armor_Class_War_Elephant"
                >戰象類</nuxt-link
              >+20 <br />對<nuxt-link to="/armor/Armor_Class_Cavalry"
                >騎兵類</nuxt-link
              >+8/+12(精銳) <br />對<nuxt-link to="/armor/Armor_Class_Camel"
                >駱駝騎兵類</nuxt-link
              >+6/+10(精銳)
            </td>
          </tr>
          ...
          <tr>
            ...
            <td class="unit4">
              <img class="gg" src="~assets/Kamayukicon.png" alt="" />精銳槍隊長
            </td>
          </tr>
          <tr>
      ...
      <div class="col-md-12">
        ...
        <div class="n1">
          <div class="col-md-4">
            <a target="_blank" href="/img/Kamayuk.png"
              ><img class="imgn hg" src="~assets/Kamayuk.png" alt=""
            /></a>
            <p><em>一群槍隊長</em></p>
          </div>
          <div class="col-md-4">
            <a target="_blank" href="/img/Kamayuk_attack_paladin.jpg"
              ><img
                class="imgn hg"
          ...
          <div class="col-md-4">
            <a target="_blank" href="/img/Kamayuk_&_Slinger.jpg"
