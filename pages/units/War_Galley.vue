  ...
  <div class="container">
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            <b>弩砲戰船</b>或稱<b>加利恩帆船</b>，在<nuxt-link
        ...
        <div class="n1">
          <p>
            在海戰中，重要的是快速升級到城堡時代、研發弩砲戰船，因為這大大減低了研發戰船的時間(60秒→36秒)，而且因為戰船是海戰中相對比較弱小的攻擊單位，所以非常建議趕快升級成弩砲戰船。
          </p>
          <p>
            弩砲戰船在任何海戰中都扮演要角的地位，在好的操作之下弩砲戰船、<nuxt-link
              to="/units/Galleon"
              >重型弩砲戰船</nuxt-link
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              ...
              >：有利於弩砲戰船<nuxt-link to="/techs">科技</nuxt-link
              >在城堡/帝王便宜15%/20％
            </li>
            <li>
            ...
            <li>
              ...
              >：弩砲戰船訓練減少15%<nuxt-link to="/resource/Gold"
                >黃金</nuxt-link
              >成本，弩砲戰船+10％HP。
            </li>
            <li>
              <nuxt-link to="/civs/Saracens">薩拉森</nuxt-link
              >：弩砲戰船<nuxt-link to="/elements/Rate_of_Fire"
                >攻擊速度</nuxt-link
              >提高25%。
            </li>
            <li>
            ...
            <li>
              ...
              >：弩砲戰船在<nuxt-link to="/techs/age/Castle_Age">城堡</nuxt-link
        ...
        <div class="n1">
          ...
          <ul>
            <li>
              <nuxt-link to="/civs/Vikings">維京</nuxt-link
              >：弩砲戰船在封建/<nuxt-link to="/techs/age/Castle_Age"
                >城堡</nuxt-link
              >/帝王時代便宜10%/15%/20%
            </li>
          </ul>
        ...
        <div class="n1">
          <ul>
            <li>
              弩砲戰船是遊戲中唯四升級後所有<nuxt-link to="/civs"
                >文明</nuxt-link
        ...
        <div class="n1">
          <div class="ien">
            <p>
              弩砲戰船是一艘更大更完善的戰鬥艦。它擁有更多的<nuxt-link
        ...
        <div class="n1">
          <div class="row">
            ...
            <div class="col-md-4">
              ...
              <p>
                <em
                  >各種弩砲戰船(世紀帝國II和<nuxt-link to="/games/aoc"
                    >征服者入侵</nuxt-link
                  >資料片)。</em
                >
              </p>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/WarGalley.png" alt="" />
              </div>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit4">
              <img class="gg" src="~assets/GalleonAoE2.png" alt="" /><nuxt-link
                to="/units/Galleon"
                >重型弩砲戰船</nuxt-link
              >
            </td>
          ...
          <tr>
            ...
            <td class="unit4">
              <img class="gg" src="~assets/galleon.png" alt="" />400<nuxt-link
                to="/resource/Food"
                >食物</nuxt-link
              >315黃金
            </td>
