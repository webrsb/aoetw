    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          ...
          。 大地之母單位 -
          拜占庭重騎兵x1、重裝馬弓騎兵x2、強弩兵x2、精銳戰矛兵x1、彎刀勇士x1、斧槍兵x2、快速火戰船x1、重型爆破船x2、運輸船x2
          <h2>主要任務</h2>
          <div class="hrn1"></div>
          <div class="n1">
            <ol>
          ...
          <div class="n1">
            <ul>
              ...
              <li>
                在標準難度下，你有一名僧侶跟隨你。但在中等和難以上，你就得靠自己了。
              </li>
            </ul>
            <h2>斥候</h2>
            <div class="hrn1"></div>
            <div class="n1">
              <ul>
                <li>
                  蘇利耶跋摩的使臣 (水藍) 在高棉帝國 (黃色)
                  西邊出發。等在前方的有崇山峻嶺、突兀森郁，更有暗礁險灘、窮山惡水。
                </li>
                <li>
                  此次出使西域，目標是安達曼海上的小港口。使臣可以從這裡坐船至南印度上的朱羅王國拜訪。
                </li>
                <li>
                  傳說中的湄南河穿過地圖中央，雖然這個季節不容易找到可以跋涉過河的地方，但東面的碼頭也許能夠讓你碰碰運氣。
                </li>
                <li>
              ...
              <div class="n1">
                <ul>
                  ...
                  <li>
                    在路途上遇見的大地之母單位會提供部分路徑資訊，可供參考。
                  </li>
                  <li>
                    安達曼海位於緬甸西南邊，實際地圖距離比起遊戲中描述的還要更遠。
                  </li>
                  <li>
                    朱羅王朝(300-1279)存在於南印度的古老政權，以善戰聞名。在我國大宋典籍中被稱為「注輦」。
                  </li>
                </ul>
              </div>
            </div>
        ...
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style="background-color:#375d96;">
              <div class="unititle">九死一生</div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/Suryavarman I-3.jpg" alt="" />
              </div>
            </td>
          </tr>
          <tr>
