    ...
    <div class="row" style=" margin-top: 50px;">
      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          <div class="ien">
            <em>
              8世紀初，塔里克·伊本·齊亞德準備帶領<a href="Berbers.php">柏柏人</a
        ...
        <div class="n1">
          <p>
            塔里克·伊本·齊亞德在遊戲戰役中為<a href="Genitour.php">標槍騎兵</a
        ...
        <div class="n1">
          <div class="row">
            ...
            <div class="col-md-6">
              <ol>
                <li><a href="The_Battle_of_Guadalete.php">瓜達萊特之戰</a></li>
                <li>
                  <a href="Consolidation_and_Subjugation.php">攻城拔寨</a>
                </li>
                <li><a href="Divide_and_Conquer.php">縱橫捭闔</a></li>
                <li>
                  <a href="Crossing_the_Pyrenees.php">穿越庇里牛斯山脈</a>
                </li>
                <li><a href="Razzia.php">突襲</a></li>
              </ol>
            </div>
            <div class="col-md-6">
