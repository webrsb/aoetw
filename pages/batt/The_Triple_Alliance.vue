      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          ...
          <div class="n1">
            <ul>
              <li>
                你的斥侯回報:蒙特蘇馬的部隊(綠色)一開始只有少量的鷹勇士，我們必須拜訪三國同盟中的另外兩個成員，特拉科潘(黃色)和特斯科科(紫色)。
              </li>
              <li>
          ...
          <ul>
            <li>
              玩家一開始有4個鷹勇士要到他們瑪雅和阿茲特克盟友，特拉科潘（黃色）和特斯科科（紫色）傳遞開戰協定。之後，玩家將接收一些村民，並摧毀特拉斯卡拉人（紅色）的四個城鎮中心。之後盟友就會背叛成為敵人，玩家必須打敗他們才能贏得勝利。
            </li>
            <li>
          ...
          <ul>
            <li>
              (bug)中間的神廟任務玩家將需要攜帶10名“精銳”豹勇士，不過玩家只能演進到城堡時代。
            </li>
            <li>
              當玩家向盟友特斯科科和特拉科潘要求一同作戰時他們似乎不喜歡或是不情願地遵守玩家的命令。這是他們未來背叛的最大暗示。
            </li>
            <li>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="unit4"><a href="Reign_of_Blood.php">血親統治</a></td>
          </tr>
          <tr>
