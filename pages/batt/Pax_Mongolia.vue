  ...
  <div class="container">
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            <b>蒙古治下的和平（蒙古太平）</b>為<nuxt-link to="/batt/Genghis_Khana"
              >成吉思汗(戰役)</nuxt-link
        ...
        <div class="n1">
          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tc6">
                匈牙利（紫色）<nuxt-link to="/civs/Teutons">條頓</nuxt-link>→馬扎爾
              </td>
            </tr>
          </table>
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              中型投石車與<nuxt-link to="/units/Siege_Onager">重型投石車</nuxt-link
              >可以夷平樹林。
            </li>
          </ul>
                  <h2>決定版變更點</h2>
