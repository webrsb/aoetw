        ...
        <div class="n1">
          ...
          <table class="table-bordered" width="100%">
            <tr>
              ...
              <td class="tc2">1,000木頭，200食物，1,000黃金</td>
          ...
          <dl class="dl-horizontal">
            <dt>開場單位：</dt>
            <dd>1位輕騎兵、6位騎士、10位重裝長槍兵、6位弩兵。</dd>
            <dt>大地之母單位:</dt>
            <dd>無。</dd>
          </dl>
          <h2>主要任務</h2>
        ...
        <div class="n1">
          ...
          <div class="n1">
            <ul>
              ...
              <li>
                雖然猛獅亨利實際上是巴巴羅薩的對手，也試圖擴張他自身的權威，但他其實從未對巴巴羅薩宣戰。他被巴巴羅薩放逐的原因並不是因為背叛，而是抗命，因為他拒絕支持巴巴羅薩在北義大利的軍事行動。
              </li>
              <li>亨利實際上就是巴巴羅薩劇情的敘述者（旁白）。</li>
              <li>
                在劇情中，這關是唯二有玩家從超過兩萬分起始的關卡，也就是猛獅亨利與波蘭。另外一個是失落帝國戰役中約克城戰役。
              </li>
              <li>
