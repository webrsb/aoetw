      ...
      <div class="col-md-8">
        <div class="n1">
          ...
          <p>
            在這個劇情裡，玩家必須倚賴米蘭的市場供給資源，在多數時間裏，你都必須仰仗米蘭公爵的<nuxt-link
              to="/resource/Gold"
              >黃金</nuxt-link
            >供應，才得以在市場上採買你所需的資源。玩家侵略托斯卡尼郊外之後，就會自動演進到<nuxt-link
        ...
        <div class="n1">
          ...
          <div class="n1">
            <ol>
              ...
              <li>帶斯福爾扎去比阿琴薩城。</li>
              <li>
                突襲托斯卡納城：摧毀四座邊遠的市中心和25座其它的<nuxt-link
                  to="/building"
                  >建築</nuxt-link
                >。
              </li>
              <li>
                回到比阿琴薩城的<nuxt-link to="/building/Monastery"
                  >修道院</nuxt-link
                >。
              </li>
              <li>第二部分：威尼斯攻擊</li>
              ...
              <li>
                消滅卡馬尼奧拉的增援兵。不要讓他們越過克雷莫納城的<nuxt-link
        ...
        <div class="n1">
          ...
          <div class="n1">
            <ol>
              <li>
                一如往常，斯福爾扎是一定要活下來的，當玩家在保衛克雷莫納免於卡馬尼奧拉的侵略時，必須注意不要讓他的軍隊越過城牆。保衛帕維亞和米蘭免於威尼斯人進攻之時，也要注意不要讓米蘭的<nuxt-link
                  to="/building/Castle"
                  >城堡</nuxt-link
                >被攻垮，公爵維斯康堤更是一定要活著。
              </li>
              <li>
                玩家開始時會擁有一隊由斯福爾扎率領的傭兵，斯福爾扎正在前往會晤米蘭公爵的路上。米蘭的<nuxt-link
                  to="/building/Market"
                  >市集</nuxt-link
                >會被贈給玩家，玩家在整個遊戲過程中都必需仰賴它提供資源。航向皮亞琴察之前，玩家會在米蘭城外召集一些聖<nuxt-link
                  to="/units/Knight"
                  >騎士</nuxt-link
                >。路上，玩家會遇到一些土匪，斯福爾扎說他們看起來像威尼斯人。
              </li>
              <li>
                當玩家抵達比阿琴薩城後，玩家會掌控那邊的<nuxt-link
                  to="/building/Stable"
                  >馬廄</nuxt-link
                >與<nuxt-link to="/building/Blacksmith">兵工廠</nuxt-link
                >，接著玩家就可以著手準備掠奪托斯卡納城，摧毀那邊二十五座建築物，包括佛羅倫斯城外的四座<nuxt-link
                  to="/building/Town_Center"
                  >城鎮中心</nuxt-link
                >。玩家不應該試圖進入擁有完整防禦的佛羅倫斯，一旦玩家踏入他們的領土，佛羅倫斯人就會把你視為敵人。
              </li>
              <li>
                完成掠奪後，玩家應該已經可以前往克雷莫納了，一旦登上<nuxt-link
              ...
              <li>
                斯福爾扎一定要見到克雷莫納的首長，才好取得當地的<nuxt-link
                  to="/building/Barracks"
                  >軍營</nuxt-link
                >訓練軍隊，協助抵抗卡馬尼奧拉的入侵。入侵的軍隊由<nuxt-link
                  to="/units/Hand_Cannoneer"
                  >火槍兵</nuxt-link
                >與火砲組成，所以建議玩家只要訓練傭兵即可，因為他們對<nuxt-link
                  to="/armor/Armor_Class_Gunpowder_Unit"
                  >火藥單位</nuxt-link
                >有攻擊加成。卡馬尼奧拉的軍隊會集中火力攻擊西面的城牆，試圖進入克雷莫納。玩家一定要阻止他們，否則遊戲就算輸了。
              </li>
              <li>
                擊敗卡馬尼奧拉的軍隊後，斯福爾扎就準備坐船前往米蘭。河道上有卡馬尼奧拉的火砲戰船，一旦發現玩家就會進行攻擊。如果玩家損失僅有的兩台運輸船，在西方，也就是玩家登陸皮亞琴察那邊，會一直出現新的船隻來替代。
              </li>
              <li>
                一旦威尼斯戰船被摧毀，玩家必須準備面對卡馬尼奧拉並擊敗他的軍隊。此時，玩家基地附近的米蘭<nuxt-link
                  to="/building/Dock"
                  >碼頭</nuxt-link
                >將由“卡馬尼奧拉的衛軍”接管。
              </li>
              <li>
                當斯福爾扎回到米蘭、見過公爵之後，玩家會接手帕維亞城，並準備面對威尼斯人的入侵。威尼斯人會入侵米蘭或者帕維亞，在這過程中，米蘭公爵必須存活、米蘭的城堡也不可以倒下。在這個階段，玩家會有一些<nuxt-link
                  to="/units/Villager"
                  >村民</nuxt-link
                >可以採集資源，不過用處不大，因為他們極有可能被威尼斯的軍隊攻擊。
              </li>
              <li>
              ...
              <li>
                如果你沒有登上兩艘運輸船，只登上其中一艘，火砲戰船就不會攻擊你。如果你用<nuxt-link
                  to="/units/Trebuchet"
                  >巨型投石機</nuxt-link
                >殺掉所有準備伏擊馬拉泰斯塔軍隊的<nuxt-link
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="unit4">
              <nuxt-link to="/games/aof">失落的帝國</nuxt-link>第四章之二
            </td>
          </tr>
          <tr>
