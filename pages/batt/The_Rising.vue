<template>
  ...
  <div class="container">
    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            <b>叛變</b
            >為聖女貞德戰役的第四關關卡，戰役描述法軍解放3座英軍控制的城市，並讓法國王子加冕成為法國國王（查理七世）。
          </p>
        </div>
        <h2>遊戲者</h2>
    ...
    <div class="n1">
      <ul>
        <li>
          取得河流的控制權或許是個不錯的策略，不過可別浪費太多寶貴的資源在船艦的製造上。
        </li>
      ...
      <div class="n1">
        <ul>
          ...
          <li>
            在進入帝王時代之後，玩家可以建造一座世界奇觀。但是，這不會導致勝利。
          </li>
          <li>
            這是“<nuxt-link to="/batt/Joan_of_Arc">聖女貞德</nuxt-link
            >”戰役中唯一除了貞德以外沒有其他英雄的場景。
          </li>
      ...
      <div class="n1">
        ...
        <li>
          下一個目標是特洛伊斯。特洛伊斯在地圖東邊。在河流穿越處有他們的城牆，不過另外一側則完全沒有防備。它們會訓練重裝長槍兵和騎士，也會訓練弩砲戰船。玩家持續發展經濟(村民數建議到50左右，不要高於50)並在原沙朗的位置建造軍事建築物(馬廄、修道院、兵工廠和攻城器製造所)還有第二個城鎮中心，如果有488石頭可以蓋一座城堡做防禦，將貞德留在原本的基地內，開始訓練以騎士為主力的部隊，3~5台的衝撞車，並在兵工廠跟馬廄升級他們，就可以攻打特洛伊斯了，也可以升級到帝王時代升級遊俠、裝甲衝撞車和巨型投石機。可以直接派一些村民到特洛伊斯的市集旁邊蓋城堡提供軍隊在攻擊時的火力掩護，記得也在前線蓋馬廄跟攻城器製造所，城鎮中心陷落後特洛伊斯也會投降。
        </li>
        <div class="col-md-12">
          <div class="col-md-6">
        ...
        <li>
          現在你要面對最危險的敵人理姆斯，理姆斯在地圖北邊深處有座防禦要塞，他們在這場戰役中是可怕的對手。他們會以長弓兵、輕騎兵、騎士、投石車和巨型投石機對付玩家，不過你不去打他們就不會出來。理姆斯有垛牆、大型箭塔和城堡防衛基地，而且時間拉長城堡會增加到3~4座擋在城鎮中心前面，還有軍隊防禦著基地。玩家在攻擊理姆斯時會承受非常嚴重的損傷，用巨型投石機跟衝撞車攻破城門，用遊俠對付其他部隊，然後用所有軍隊集中攻擊城鎮中心來獲得最後勝利。
        </li>
        <div class="col-md-12">
          <div class="col-md-6">
            <img
