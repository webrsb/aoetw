    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          ...
          <p>
            <b>亡命之徒（擒獲）</b
            >為松迪亞塔戰役的第一關劇情關卡，此關描述松迪亞塔逃離索索偵查軍隊的追殺，尋求附近村莊的庇護來開始成為西非霸主的開端。
          </p>
        </div>
        <h2>玩家</h2>
        <div class="hrn1"></div>
        <div class="n1">
          ...
          <table class="table-bordered" width="100%">
            <tr>
              ...
              <td class="tc2">0木材，0食物，0黃金，0石礦</td>
          ...
          <div class="n1">
            ...
            <div class="n1">
              ...
              <div class="n1">
                <ol>
                  <li>
                    一開始你只能往西北方走，沿路上會遇到一些軍隊加入你，也會遇到一些敵人。由於困難模式一開始守城會很累，所以盡量保持兵力比較好。除了最一開始的2投石車3步兵之外（用你的英雄上去單挑，沒血就先跑），其餘的小規模敵軍都可以小心繞過。可以將你的部隊設為不還擊狀態，每繞過一批敵軍就存一次檔。一共會拿到3騎士、3長槍兵、4馬弓、4弩兵。
                  </li>
                  <li>
                    過河的時候會遇到一批大的敵軍，善用兵種相剋跟控兵技巧把損傷降到最低吧！
                  </li>
                  <li>
                    過河之後，先不要去接觸村莊，因為一接觸村莊敵人就會開始生兵進攻，先用你的英雄把周圍環境探勘完畢。村莊西南方有一個小型的敵軍基地，用你的英雄去把木牆拆了，先殺投石車再殺弓兵，裡面有一坨金礦待會可以考慮開採。
                  </li>
                  <li>
                    這裡有一個偷吃步，由於你的英雄會回血，還有3點遠防，所以箭塔在短時間內是無法將他殺死的。由於取得城鎮之前敵人不會生兵，
                  ...
                  <li>
                    黃色城鎮木牆蓋成那副德性，位置也不好，實在是難攻難守，並不是一個紮營的好地方。因此先用所有食物生產村民，旗幟插在村莊西方的一處空地，那裏有好幾隻斑馬、兩頭大象、更西邊還有一大坨金礦。不斷生村民來殺動物。盡速衝城堡。
                  </li>
                  <li>
                    村民生到一半敵軍就來了，此時小心不要讓城鎮中心剛生的村民把敵軍引過來。只要看到敵軍，立刻就把旗幟插在城鎮中心自己身上，
                  ...
                  <li>
                    升城堡之後，立刻集結所有村民在你的臨時營地蓋一座城鎮中心跟城堡。兩者距離一個農田寬，互相照應。之後就努力爆經濟、點科技。優先把城垛射孔跟彈道學點出來，再出一堆弩兵把城堡塞滿，你的村民就安全了。注意敵人在你升城堡之後會出衝車來撞城。所以要盡速生出幾隻飛刀女兵來對付衝車。
                    （但要小心等衝車靠近再攻擊，否則飛刀很脆弱，被敵人弓箭手弄幾下就掛了）
                  </li>
                  <li>
                    接下來一直出騎士，掩護你的村民到處採礦，再出一支僧侶放在城鎮旁邊幫忙補血，等騎士累積到20隻，直接衝到敵人家摧毀軍事建築取得勝利。不小心被全軍覆沒就再出第二波，直到勝利為止。
                  </li>
                  <li>
