    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <div class="ien">
            <em
              >蘇格蘭戰士試圖阻止配備精良的英國軍隊入侵，要學會操縱高地人的指令，就要了解世紀帝國2:帝王世紀的基本概念，包括如何建立經濟，如何訓練你的士兵，而更重要的是:如何攻擊和打敗你的敵人。如果你是即時戰略遊戲的新手的話，你將要學習你必須知道的事情。如果你已經玩過原來的世紀帝國你就很快可以掌握新的特色，例如防禦和陣形。</em
            >
          ...
          <p>
            威廉·華勒斯（英語：William
            Wallace，中古蓋爾語：Uilliam.Uallas；現代蘇格蘭蓋爾語：Uilleam
            Uallas；1272年－1305年8月23日），是蘇格蘭的<nuxt-link
              to="/units/Knight"
              >騎士</nuxt-link
            >、貴族、愛國人士，他在蘇格蘭獨立戰爭中領導了一支反抗武裝力量。遊戲中帶領玩家體驗新手任務對抗英格蘭軍隊的<nuxt-link
              to="/batt"
              >戰役</nuxt-link
            >
          </p>
        ...
        <div class="n1">
          <p>
            威廉·華勒斯（William Wallace）是一位<nuxt-link to="/units/Champion"
              >劍兵勇士</nuxt-link
            ...
            >，並能夠自動回復HP（自<nuxt-link to="/units/Conquistador"
              >征服者</nuxt-link
        ...
        <div class="n1">
          <div class="row">
            ...
            <div class="col-md-6">
              <img src="~assets/w1.jpg" width="300" alt="" />
              <p>威廉華勒斯戰役地圖</p>
            </div>
          </div>
          <h3>芝麻小事</h3>
          ...
          <div class="n1">
            ...
            <ul>
              <li>
                遊戲中，直到2015年<nuxt-link to="/games/ak">非洲王國</nuxt-link
                >資料片登場的英雄<nuxt-link to="/units/hero/Abraha_Elephant"
                  >阿伯哈拉戰象</nuxt-link
                >才能在單一戰鬥中擊敗華勒斯。
              </li>
              <li>
                華勒斯最著名的描繪就是在奧斯卡金像獎得獎史詩片《英雄本色》裡，這是參考了威廉·華勒斯史實與史詩《華勒斯》改編的美國電影，
                由梅爾·吉勃遜執導、製片並主演，Randall Wallace編劇，1995年上映。
                此片由於衆多史實錯誤而飽受批評，但商業上仍然大大賣座，並獲得當年奧斯卡獎5個獎項。
              </li>
            </ul>
          </div>
        </div>
