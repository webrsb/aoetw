    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          <ul>
            <li>
              你的斥侯回報：優娣忒和薩繆爾（綠色）剛剛從阿克蘇姆主城逃離出來，他們還得找到一條可以離開阿克蘇姆帝國國境的路。
            </li>
            <li>
            ...
            <li>
              河邊東北部的敵營（紫色）守住通往河流的要道。他們有一支由弓箭手、斥侯騎兵和東方盾劍兵組成的軍隊。
            </li>
            <li>
              林中東邊的營地（橘色）是唯一一座沒有城牆的敵營，但是要他們高塔聳立，也不可小覷。他們主要訓練斥侯騎兵、弓箭手和一些重裝長槍兵。
            </li>
          </ul>
        </div>
      </div>
