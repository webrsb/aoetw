    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          <ul>
            <li>
              你的斥候回報：優娣忒和薩繆爾（綠色）剛剛從阿克蘇姆主城逃離出來，他們還得找到一條可以離開阿克蘇姆帝國國境的路。
            </li>
            <li>
            ...
            <li>
              山中的要塞（青色）是阻擋向北的山路的堡壘。他們將會訓練一支由民兵，重裝長槍兵和戰矛兵組成的軍隊。
            </li>
            <li>
              河邊東北部的敵營（紫色）守住通往河流的要道。他們有一支由弓箭手、斥候騎兵和東方盾劍兵組成的軍隊。
            </li>
            <li>
              林中東邊的營地（橘色）是唯一一座沒有城牆的敵營，但是要他們高塔聳立，也不可小覷。他們主要訓練斥候騎兵、弓箭手和一些重裝長槍兵。
            </li>
          </ul>
        </div>
      </div>
      ...
      <div class="col-md-12">
        ...
        <ul>
          ...
          <li>
            不用去管任何的守衛，只要不攻擊他們都不會有事。南邊的運輸船雖然讓到達地圖東南方的旗幟看起來很容易，但河流守衛的嚴密防守讓這個任務根本不可能實現，而且500黃金可以拿來做更多其他事。除非玩家在對付極大汗之餘有餘力剷平河流守衛，不然就是上岸時讓軍隊先上，然後優娣忒偷偷溜過河流守衛的視線到達旗幟處，或是對自己的閃躲技術有信心的可以試著用運輸船閃過箭塔跟弓兵攻擊在距離極大汗東邊營地的河對岸下船。
          </li>
          <div class="col-md-12">
            <div class="col-md-6">
              <gallery
