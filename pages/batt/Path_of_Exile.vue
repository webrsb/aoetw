  ...
  <div class="container">
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            <b>流亡之路</b>是《世紀帝國 II HD：<nuxt-link to="/games/ak"
              >非洲王國</nuxt-link
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              ...
              <ol>
                <li>
                  給西南方的阿克蘇姆守衛500<nuxt-link to="/resource/Gold"
                    >黃金</nuxt-link
                  >可取得2輛<nuxt-link to="/units/Battering_Ram"
                    >輕型衝撞車</nuxt-link
                  >。
                </li>
                <li>
                  給南方的阿克母<nuxt-link to="/building/Dock">碼頭</nuxt-link
                  >500黃金可得到一輛<nuxt-link to="/units/Transport_Ship"
                    >運輸船</nuxt-link
                  >（點擊碼頭付錢）。
                </li>
              </ol>
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              河邊東北部的敵營（紫色）守住通往河流的要道。他們有一支由<nuxt-link
                to="/units/Archer"
                >弓箭手</nuxt-link
            ...
            <li>
              林中東邊的營地（橘色）是唯一一座沒有<nuxt-link
                to="/building/Stone_Wall"
                >城牆</nuxt-link
              >的敵營，但是他們高塔聳立，也不可小覷。他們主要訓練斥候騎兵、弓箭手和一些重裝長槍兵。
            </li>
          </ul>
        </div>
      </div>
        ...
        <ul>
          ...
          <li>
            ...
            >），玩家會遭受嚴重的損失。東邊的營地有許多<nuxt-link
              ...
              >箭塔</nuxt-link
            >，有一個小孔可以跑進去，利用箭塔的最小射程限制並在<nuxt-link
              to="/elements/Hit_points"
              >血量</nuxt-link
            >低時撤退恢復。迂迴消耗塔的血量，把西邊第一個塔跟<nuxt-link
              to="/building/Blacksmith"
              >兵工廠</nuxt-link
            >還有東邊兩個塔拆掉後，打掉東邊<nuxt-link to="/building/Gate"
              >城門</nuxt-link
            >清空道路。
          </li>
          <div class="row">
