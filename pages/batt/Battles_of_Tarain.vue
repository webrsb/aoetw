    ...
    <div class="row" style="margin-top: 50px;">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p></p>
          <p>
            塔蘭村之戰為失落帝國戰役中布里斯比羅吉劇情戰役的第四關（也是該劇情最後一關）。
          </p>
        </div>
        <h2>玩家</h2>
        <div class="hrn1"></div>
        ...
        <div class="n1">
          ...
          <div class="n1">
            <ol>
              <li>
                你可以隨意搭配不同的兵種組合來指揮這場戰鬥，但是要隨機應變，弓箭手應站在大象後面遠端射擊，騎兵則善於兩翼包抄。
              </li>
              <li>要記得為你的軍隊獲得經驗獎勵，這可以幫你贏下第一場戰鬥。</li>
              <li>切斷敵軍的供給線可以削弱巴廷達的抵抗力量。</li>
              <li>
                古爾在北邊遠處的大本營易守難攻，如果能早點去攻打的話比晚點去好。
              </li>
              <li>
                別只派一種兵力去作戰，因為他們的忠誠度可能會受戰局影響。(玩家生產的象弓騎兵會在古爾夜襲時叛變)
              </li>
            </ol>
          </div>
        </div>
        ...
        <div class="n1">
          <ul>
            <li>
              布里斯比羅吉‧兆汗（紅）的大軍在戰場南邊集結了，其中有中裝和輕步兵、步弓兵、駱駝騎兵、僧侶、騎士和大象。
            </li>
            <li>
              默罕穆德‧古爾的大軍（綠）佔據了戰場的西北角，他的單位有馬弓騎兵、輕騎兵、駱駝騎兵、馬木留克奴隸兵、騎兵和騎驢僧侶。此外，古爾的軍隊在北邊有座大本營。
            </li>
            <li>
              巴廷達（黃）是西北角上的一座防衛森嚴的城池，駐紮軍隊有馬弓騎兵、重裝長槍兵和戰矛兵。
            </li>
            <li>
              塔蘭村（水藍）是東南邊的一座小村莊，它們是中立的，但是我們可以利用它來和兆汗人做貿易。
            </li>
          </ul>
        </div>
      </div>
