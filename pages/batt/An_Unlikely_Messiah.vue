    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            <b>一個不太可能的彌賽亞</b
            >是在貞德戰役第一個劇情關卡，這是描述2位英雄貝查德斯歐力、梅茲的斯歐力與法國軍隊護送貞德至齊儂的任務。
          </p>
        </div>
        <h2>玩家</h2>
        <div class="hrn1"></div>
        ...
        >
          <ul>
            ...
            <li>保護你的兩名騎士。他們是你最佳的戰士，並且熟知地形。</li>
            <li>別擔心經濟問題-儘管將貞德送達目的地就是了。</li>
            <li>
              還要特別注意貞德的健康：如果她的健康有惡化的現象，則盡量別讓她靠近危險的情況。
            </li>
          </ul>
          <h3>芝麻小事</h3>
          <div
          ...
          <ul>
            ...
            <li>
              在地圖的最西邊的角落（齊儂城內），隱藏在樹木中的英軍的劍兵勇士可以防止英軍被擊敗。有可能用遠程單位殺死他，這將自動擊敗英軍。
            </li>
            <li>
            ...
            <li>
              這是所有貞德戰役中能使用“農家女貞德”的場景，第二關開始至第五關都是騎馬作戰。
            </li>
          </ul>
        </div>
      </div>
