        ...
        <div class="n1">
          ...
          <div class="n1">
            <ol>
              ...
              <li>
                血洗京都，要把平氏家族的所有<nuxt-link to="/building/Barracks"
                  >軍營</nuxt-link
                >，所有防禦工事和負隅頑抗的守城者都殺死，帶他們的主公平清盛的人頭回來覆命！
              </li>
            </ol>
          </div>
          <h3>次要任務</h3>
          ...
          <ul>
            ...
            <li>
              俱利伽羅峠指的是越<nuxt-link to="/civs/Chinese">中國</nuxt-link
              >與加賀國的邊境關口，是個險要的斷崖。
            </li>
            ...
            <li>
              據說木曾義仲在此戰中曾使用中國田單的火牛戰術，後來事後認為是捏造。
            </li>
            <li>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="unit4">
              <nuxt-link to="/games/aof">失落的帝國</nuxt-link>戰役第七章之七
            </td>
          </tr>
          <tr>
