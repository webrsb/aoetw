    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            <b>礪波山（1183）</b
            >是失落帝國的戰役之一，描述1183年日本源平合戰期間的俱利伽羅峠之戰，以及木曾義仲的上洛（進軍京都）。
          </p>
        </div>
        <h2>玩家</h2>
        <div class="hrn1"></div>
        <div class="n1">
          ...
          <div class="col-md-12">
            ...
            <dl class="dl-horizontal">
              <dt>開場：</dt>
              <dd>
                騎兵x2，重裝馬弓騎兵x2，雙手劍兵x2，強弩兵x2，精銳日本武士x3，戟兵x2，貿易車x1。
              </dd>
              <dt>大地之母單位：</dt>
              <dd>無。</dd>
            </dl>
          ...
          <div class="n1">
            <ol>
              ...
              <li>
                血洗京都，要把平氏家族的所有軍營，所有防禦工事和負隅頑抗的守城者都殺死，帶他們的主公平清盛的人頭回來覆命！
              </li>
            </ol>
          </div>
          <h3>次要任務</h3>
          ...
          <div class="n1">
            <ol>
              <li>
                把鎌倉主城運送過來的糧草車安全送往礪波山城內的宮殿，每輛糧草車的貨物可換1,000金子。
              </li>
              <li>
          ...
          <div class="n1">
            <ul>
              ...
              <li>
                北条氏（黃色）在東邊有一座城池，由他們的首領北条時政所掌管。北条時政痛恨平家，只希望在破解礪波山之圍之後加入源氏勢力。
              </li>
              <li>
                平家軍（橘色）是你早期的主要對手。想要給礪波山解圍的話，你必須把他們前置的攻城武器場摧毀，注意還有三座軍營在守衛河道。
              </li>
              <li>
                平氏守衛（綠色）在城外四處巡邏，他們的村民為平家提供了糧草供應。
              </li>
              <li>
                平氏的主城京都（青綠色）固若金湯，由大量防衛塔和城堡守衛著，從未被攻破過，倘若城牆被攻破，大批的敵軍就會衝去防守。
              </li>
              <li>
          ...
          <ul>
            ...
            <li>
              先挖取石頭來蓋城堡，城堡蓋在離礦藏近的地方，或是直接蓋在第一個平家軍軍營的門口，利用城堡來壓制他們。
            </li>
            <li>
              敵人大部分以步兵為主，馬弓騎兵能夠有效防衛，但是別忘了針對衝撞車生產一些步兵。
            </li>
            <li>
              敵人不會生產投石機，所以城堡加上數個箭塔，再搭配十幾個長槍兵就足以防守。
            </li>
            <li>
            ...
            <li>
              源氏帶來的軍隊是很強大的騎兵，擁有8/6的防禦，12的攻擊力，還有250的變態生命值與自然回血。只要他們沒有死，都可以加入下一場戰鬥。
            </li>
          ...
          <ul>
            <li>
              這場戰役描寫的其實不只是俱利伽羅峠之戰一役而已，而是從那次戰役一直到攻陷京都。
            </li>
            <li>俱利伽羅峠指的是越中國與加賀國的邊境關口，是個險要的斷崖。</li>
            <li>源氏其實就是源賴朝，真正的源家掌權者。</li>
            <li>
              木曾義仲的本名是源義仲，是源賴朝的表親，因為在木曾谷長大而得此名。
            </li>
            <li>
              歷史上的北条時政是源賴朝的岳父，但其實跟木曾義仲不合，在真正的俱利伽羅峠之戰也不曾出手幫助過木曾義仲。後來甚至親手消滅了義仲的勢力。
            </li>
            <li>
              本戰役的最終大魔王平清盛，歷史上其實早在這場戰役發生的兩年前死於熱病。而歷史上真正領導這場戰役的平維盛則連露臉都沒有。
            </li>
            <li>
              歷史上真正守衛能登國（遊戲中的"燈塔"）的是平通盛與平忠度，而不是平清房。
            </li>
            <li>
              據說木曾義仲在此戰中曾使用中國田單的火牛戰術，後來認為事後是捏造。
            </li>
            <li>
              京都在古代日本被分類為畿內，其實在歷史上沒有這麼堅固，反而因為地處平原周圍環山而常常被攻陷。
            </li>
            ...
            <li>
              歷史上的木曾義仲確實曾經進軍並掌管京都，但是卻因為剛愎自用與縱容軍隊暴行，最終被源家討伐。
            </li>
            <li>真正的平氏在1185年的壇之浦之戰滅亡。</li>
            <li>
              源家的勢力在1333年與鎌倉幕府一起進入了歷史，前北条家也滅亡（後北条就是戰國有名的北条早雲，世紀帝國II日本AI的常用名稱）。
            </li>
            <li>
              源平合戰最終導致日本真正進入數百年的幕府時代，也可以算是封建時代的開端。
            </li>
          </ul>
        </div>
      </div>
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="unit4">失落的帝國戰役第七章之七</td>
          </tr>
          <tr>
