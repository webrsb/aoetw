  ...
  <div class="container">
    <div class="row padtop">
      <div class="col-md-12">
            ...
            >
              <p>
                <nuxt-link to="/games/aok"
                  ><img src="~assets/aoe2_base.png" class="gg" />帝王世紀</nuxt-link
                ><span class="arror">➠</span>
              </p>
              <p>
                <nuxt-link to="/games/aoc"
                  ><img src="~assets/aoe2_dlc0.png" class="gg" />征服者入侵</nuxt-link
                ><span class="arror">➠</span>
              </p>
              <p>
                <nuxt-link to="/games/aof"
                  ><img src="~assets/aoe2_dlc1.png" class="gg" />失落的帝國</nuxt-link
                ><span class="arror">➠</span>
              </p>
              <p>
                <nuxt-link to="/games/ak"
                  ><img src="~assets/aoe2_dlc2.png" class="gg" />非洲王國</nuxt-link
                ><span class="arror">➠</span>
              </p>
              <p>
                <nuxt-link to="/games/aor"
                  ><img src="~assets/aoe2_dlc3.png" class="gg" />王者崛起</nuxt-link
                ><span class="arror">➠</span>
              </p>
              <p>
            ...
            <div class="toc" ref="shadow">
              ...
              <p>
                <nuxt-link to="#a10">【阿拉里克】</nuxt-link>、<nuxt-link
                  to="#a11"
                  >【德古拉】</nuxt-link
                >、<nuxt-link to="#a12">【巴里】</nuxt-link>、<nuxt-link
                  to="#a13"
                  >【斯福爾札】</nuxt-link
                >、<nuxt-link to="#a14">【帕查庫特克】</nuxt-link>、<nuxt-link
                  to="#a15"
                  >【布里斯比羅吉】</nuxt-link
                >、<nuxt-link to="#a16">【失落的帝國戰役】</nuxt-link>
              </p>
              <p>
                ...
                >、<nuxt-link to="#a20">【游娣特】</nuxt-link>
              </p>
              <p>
                <nuxt-link to="#a21">【加查‧馬達】</nuxt-link>、<nuxt-link
                  to="#a22"
                  >【蘇利耶跋摩一世】</nuxt-link
                >、<nuxt-link to="#a23">【莽應龍】</nuxt-link>、<nuxt-link
                  to="#a24"
                  >【黎利】</nuxt-link
                >
              </p>
              ...
              <p>
                <nuxt-link to="#a29">【長腿愛德華】</nuxt-link>、<nuxt-link
                  to="#a30"
                  >【大公爵】</nuxt-link
                >、<nuxt-link to="#a31">【歐特維爾家族】</nuxt-link>
              </p>
            </div>
          </div>
        </div>
          ...
          <div class="col-md-4" style="margin-top: 10px;">
            <table class="table-bordered" width="100%">
              ...
              <tr>
                <td>
                  <div class="unitcontent">
                    <nuxt-link to="/batt/The_Battle_of_the_Frigidus"
                      >冷河戰役</nuxt-link
                    >
                  </div>
                </td>
              ...
              <tr>
                <td>
                  <div class="unitcontent">
                    <nuxt-link to="/batt/The_Belly_of_the_Beast"
                      >深入虎穴</nuxt-link
                    >
                  </div>
                </td>
          ...
          <div class="col-md-4" style="margin-top: 10px;">
            <table class="table-bordered" width="100%">
              ...
              <tr>
                <td>
                  <div class="unitcontent">
                    <nuxt-link to="/batt/The_Dragon_Spreads_His_Wings_DE"
                      >火龍展翅(DE)</nuxt-link
                    >
                  </div>
                </td>
          ...
          <div class="col-md-4" style="margin-top: 10px;">
            <table class="table-bordered" width="100%">
              ...
              <tr>
                <td>
                  <div class="unitcontent">
                    <nuxt-link to="/batt/The_Rebellion_of_Melus_DE"
                      >邁勒斯叛變(DE)</nuxt-link
                    >
                  </div>
                </td>
          ...
          <div class="col-md-4" style="margin-top: 10px;">
            <table class="table-bordered" width="100%">
              ...
              <tr>
                <td>
                  <div class="unitcontent">
                    <nuxt-link to="/batt/Mercenaries_and_Masters"
                      >傭兵與主人</nuxt-link
                    >
                  </div>
                </td>
              ...
              <tr>
                <td>
                  <div class="unitcontent">
                    <nuxt-link to="/batt/ His_Own_Man">主宰自我</nuxt-link>
                  </div>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td>
                  <div class="unitcontent">
                    <nuxt-link to="/batt/Blood_and_Betrayal"
                      >血與背叛</nuxt-link
                    >
                  </div>
                </td>
          ...
          <div class="col-md-4" style="margin-top: 10px;">
            <table class="table-bordered" width="100%">
              ...
              <tr>
                <td>
                  <div class="unitcontent">
                    <nuxt-link to="/batt/A_New_Power_Arises"
                      >新銳崛起</nuxt-link
                    >
                  </div>
                </td>
              ...
              <tr>
                <td>
                  <div class="unitcontent">
                    <nuxt-link to="/batt/War_of_Brothers">手足之戰</nuxt-link>
                  </div>
                </td>
              </tr>
              <tr>
                <td>
                  <div class="unitcontent">
                    <nuxt-link to="/batt/The_Falcon's_Nest">獵鷹之巢</nuxt-link>
                  </div>
                </td>
              </tr>
              <tr>
          ...
          <div class="col-md-4" style="margin-top: 10px;">
            <table class="table-bordered" width="100%">
              ...
              <tr>
                <td>
                  <div class="unitcontent">
                    <nuxt-link to="/batt/The_Fate_of_India"
                      >印度的命運</nuxt-link
                    >
                  </div>
                </td>
          ...
          <div class="col-md-4" style="margin-top: 10px;">
            <table class="table-bordered" width="100%">
              ...
              <tr>
                <td>
                  <div class="unitcontent">
                    <nuxt-link to="/batt/Poyang_Lake_1363"
                      >鄱陽湖（1163）</nuxt-link
                    >
                  </div>
                </td>
          ...
          <div class="col-md-4" style="margin-top: 10px;">
            <table class="table-bordered" width="100%">
              ...
              <tr>
                <td>
                  <div class="unitcontent">
                    <nuxt-link to="/batt/Ruins_of_Empires"
                      >帝國的廢墟</nuxt-link
                    >
                  </div>
                </td>
        ...
        <h3><strong>決定版戰役:西方霸主</strong></h3>
        <div class="row">
