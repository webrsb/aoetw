    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          <ul>
            <li>
              這場戰役就像在玩一場死鬥遊戲。雖然遊戲一開始幾乎就要準備作戰，但別忘了要收集資源以補充你的損失。
            </li>
          </ul>
        </div>
        <h2>斥侯</h2>
        ...
        <div class="n1">
          ...
          <div class="n1">
            <ul>
              ...
              <li>
                與此同時，派斥侯去探索地圖並找到敵方基地。軍隊建成後，派村民去收集資源。並在奄蔡附近部署軍隊，要帶一些村民。然後在那裏建造城堡，奄蔡應該會立刻反擊並攻擊城堡。將軍隊的設置為防衛狀態，攻城武器一但出現就立刻拿下。
              </li>
              <li>
              ...
              <li>
                最後是西羅馬帝國。如果玩家仍然有很多資源，生產一些騎士，因為他們比輕騎兵更耐用。雙線夾擊西羅馬帝國，他們的軍隊會更快被耗盡，而且在城市被毀時，他們就無法在別處重建（堵住他們）。在他們的軍隊被耗盡之前，不要去攻擊。然後，製造一些炸藥桶或攻城武器來摧毀他們的城堡。如果玩家選擇攻城武器，他們必須被保護免受敵方近戰單位的傷害。然後摧毀他們的市鎮中心（如果他們試圖重建，請確保它們石頭用完了，或者摧毀它們），玩家所要做的就是殺死剩下的敵方單位並摧毀剩餘的敵方建築物。
              </li>
              <li>
