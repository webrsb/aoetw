      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          ...
          <dl class="dl-horizontal">
            <dt>開場單位：</dt>
            <dd>
              阿拉里克、阿陶爾夫、蘇勒上尉、1位護衛長槍兵（HP75）、1位輕騎兵（HP20）、3位重裝長槍兵、3位弓兵、2位馬騎弓兵、1台輕型投石車。
            </dd>
            <dt>大地之母單位：</dt>
            <dd>無</dd>
          </dl>
        ...
        <div class="n1">
          ...
          <div class="n1">
            <ol>
              <li>
                玩家將首先看見哥德部隊被更強大的羅馬軍團擊敗，而在哥德村莊，阿拉里克會派遣一個斥侯在兩個平民村莊進行調查。
              </li>
              <li>
                斥侯必須存活，直到調查完兩個村莊並向阿拉里克回報為止。因為斥侯的生命值很低，盡量避免戰鬥，有三個軍團弓箭手會在路上伏擊你。
              </li>
              <li>
                斥侯必須首先在西北村莊進行調查，那裡有一個由一名長槍兵守衛的橋樑。警衛會阻止斥侯並通知後面有一支軍隊。然後，斥侯必須調查西部村莊，在第一村莊的南邊。市場邊上的一名線人（長槍兵）會通知他在村子南面的一個營地（馬吉斯將軍營-黃色）看到羅馬軍隊。
              </li>
              <li>
