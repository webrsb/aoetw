    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            <b>席德的流亡歲月</b
            >是席德戰役的第三個場景，席德被阿方索國王流放後尋找一位新君主的故事。
          </p>
        </div>
        <h2>玩家</h2>
        <div class="hrn1"></div>
        <div class="n1">
          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              <td class="tc6">
                <div class="p1" width="11%">玩家2</div>
              </td>
              <td class="tc6" width="40%">阿方索國王的軍隊（藍色）西班牙</td>
              <td class="tc6">
                <div class="p3" width="11%">玩家3</div>
              </td>
          ...
          <ul>
            ...
            <li>
              對方戰力不高，不用太畏懼如果上帝王后就可以派大軍和數量巨型投石車，一路打進去。
            </li>
          </ul>
          <h3>快速破關</h3>
          <div class="hrn1"></div>
