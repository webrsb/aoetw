    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <div class="ien">
            <em
              >西元十一世紀初，高棉王國四分五裂、強敵環伺。只有蘇利耶跋摩王子有能力與魄力一一打敗各路勁敵光復高棉。然而打江山易，守江山難。蘇利耶跋摩能否擴大基業，吞併強鄰。開創屬於自己的千秋霸業呢？</em
            >
          ...
          <p>
            <b>蘇利耶跋摩一世</b
            >（？-1050），吳哥王朝君主。原本為吳哥王朝將領。主君<nuxt-link
              to="/units/hero/Udayadityavarman_I"
              >優陀耶迭多跋摩一世</nuxt-link
            >由於血系問題不純正而爆發統治危機。蘇利耶跋摩隨即發動政變弒君，開始了為期九年的全國動亂。蘇利耶跋摩一世擊敗政敵登基之後，對內便開始了一系列的大型建設。包含了水庫與佛寺確立權威；對外則大舉擴張，將領土延伸到今天泰國中北部以及向東進入寮國境內。遊戲中便是以蘇利耶跋摩一世的擴張之路為主軸。
          </p>
        </div>
        <h3>英雄</h3>
        <div class="hrn1"></div>
        ...
        <div class="n1">
          <div class="row">
            <div class="col-md-12">
              <p>
                蘇利耶跋摩一世戰役由5個關卡組成。玩家扮演的是<nuxt-link
                  to="/civs/Khmer"
                  >高棉人</nuxt-link
                >，顏色是水藍。
              </p>
            ...
            <div class="col-md-6">
              <ol>
                <li><nuxt-link to="/batt/Usurpation">揭竿而起</nuxt-link></li>
                <li>
                ...
                <li><nuxt-link to="/batt/Nirvanapada">千古偉業</nuxt-link></li>
              </ol>
            </div>
            <div class="col-md-6">
          ...
          <div class="n1">
            ...
            <ul>
              ...
              <li>九年動亂與擴張：</li>
              在優陀耶迭多跋摩死後，蘇利耶跋摩與另外一位<nuxt-link
                to="/civs/Malay"
                >馬來</nuxt-link
              >裔的領主「<nuxt-link to="/units/hero/Jayaviravarman"
                >闍耶羅跋摩</nuxt-link
              >」相互爭奪王位。雙方互有勝負，吳哥王朝陷入九年內戰。最後由蘇利耶跋摩一世獲勝。在蘇利耶跋摩一世取得大位後，其將重心放於對外經略。與<nuxt-link
                to="/civs/Indians"
                >印度</nuxt-link
              >南方王國<nuxt-link to="/batt/Forge_an_Alliance"
                >締結同盟</nuxt-link
              >，並對鄰國的孟族、占族進行一系列的侵略行動。將吳哥王朝的疆域擴大不少。
              <li>蘇利耶跋摩一世的評價：</li>
              由於蘇利耶跋摩一世終究屬於篡位者之一，是以在歷史評價上地位反不及其先祖與後嗣。由於高棉帝國存續史料較少，我們只能從鄰近史料記載窺知一二。真正被提及的大多是其武功，將高棉帝國的版圖跨入寮國與泰國境內。
            </ul>
          </div>
        </div>
      </div>
