      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          ...
          <div class="n1">
            <ul>
              <li>
                因為初始島嶼上的資源與地盤都有限，所以你要盡快擴張到其他島嶼去。
              </li>
              <li>
            ...
            <div class="n1">
              <ul>
                ...
                <li>
                  這附近有一座投誠於滿者伯夷的村莊，我們只要找到村莊就可以使用他們的碼頭。
                </li>
                <li>
                ...
                <li>
                  在更遠的南方有魯烏人（黃色）。他們的戰備非常先進，島嶼上有許多防禦塔守衛著。難以征服，他們也擅長使用火藥，所以會靠著炮艦與火炮塔來守衛陣地。
                </li>
              </ul>
              <h2>細節</h2>
              <div class="hrn1"></div>
              <div class="n1">
                <ul>
                  <li>
                    本關以海戰為主，登陸作戰雖然能夠確保征服，但對於速戰速決較少幫助。
                  </li>
                  <li>
                    古戴人 -
                    13世紀時，婆羅洲東南邊（今加里曼丹省）的小型區域治權。後遭滿者伯夷征服。
                  </li>
                  <li>
                    望加錫人 -
                    13世紀末，佔據南蘇拉威西島的區域治權。漢稱「錫江」。後遭滿者伯夷征服。
                  </li>
                  <li>
                    魯烏人 -
                    13世紀末，佔據南蘇拉威西島的區域治權。後遭滿者伯夷征服。
                  </li>
                </ul>
              </div>
            </div>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/Gajah Mada 4.jpg" alt="" />
              </div>
            </td>
          </tr>
          <tr>
