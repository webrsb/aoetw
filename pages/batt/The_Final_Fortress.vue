    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p></p>
          <p>
            <b>決戰東都</b>為<nuxt-link to="/batt/Le_Loi">黎利戰役</nuxt-link
            >的第六關劇情關卡（最後一關），此關描述<nuxt-link
              to="/civs/Vietnamese"
              >越南</nuxt-link
            ><nuxt-link to="/units/hero/Le_Loi">黎利</nuxt-link
            >在經歷多年抗明<nuxt-link to="/batt">戰役</nuxt-link
            >後，攻陷東都（今清化市）的經過。
          </p>
        </div>
        <h2>玩家</h2>
        ...
        <div class="n1">
          ...
          <p>
            ...
            >x32、斧<nuxt-link to="/units/Spearman">槍兵</nuxt-link
          ...
          <div class="n1">
            <ol>
              <li>
                摧毀明軍陣地內所有<nuxt-link to="/building/Castle"
                  >城堡</nuxt-link
                >，以擊敗他們。
              </li>
          ...
          <ul>
            <li>
              明軍在他們的陣地外建造了一座秘密兵器工廠，如果你能摧毀它的話就可以削弱明軍的軍力。
            </li>
          </ul>
        </div>
        <h2>任務提示</h2>
        ...
        <div class="n1">
          <ul>
            ...
            <li>最好盡快擊潰明軍前鋒。</li>
            <li>
              面對大批明軍時，可以善用<nuxt-link to="/units/Siege_Weapons"
                >攻城武器</nuxt-link
              >。
            </li>
        ...
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img
                  src="~assets/(map)Le_Loi - 6.The_Final_Fortress.jpg"
                  alt=""
                />
              </div>
            </td>
          ...
          <tr>
            ...
            <td class="unit4">
              <nuxt-link to="/games/aor">王者崛起</nuxt-link>第四章之六
            </td>
          </tr>
          <tr>
