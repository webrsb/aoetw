    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          ...
          <p>
            <b>決戰東都</b
            >為黎利戰役的第六關劇情關卡（最後一關），此關描述越南黎利在經歷多年抗明戰役後，攻陷東都（今清化市）的經過。
          </p>
        </div>
        <h2>玩家</h2>
        <div class="hrn1"></div>
        <div class="n1">
          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tc6" width="38%">明軍（藍色）中國</td>
              <td class="tc6">
          ...
          <h3>開場</h3>
          <p>。 英雄 - 黎利x1</p>
          <p>。 軍事單位 - 精銳矛象伕x2、劍兵勇士x32、斧槍兵X32、藤甲弓兵x16</p>
          <h2>主要任務</h2>
          <div class="hrn1"></div>
          <div class="n1">
            <ol>
        ...
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style="background-color:#375d96;">
              <div class="unititle">
                <nuxt-link to="/batt/The_Fianl_Fortress">決戰東都</nuxt-link>
              </div>
            </td>
          </tr>
