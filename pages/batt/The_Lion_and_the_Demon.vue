        ...
        <div class="n1">
          <ul>
            ...
            <li>
              ...
              >裡、蓋個<nuxt-link to="/building/Archery_Range">射箭場</nuxt-link
            ...
            <li>首先要先快攻耶路撒冷，造兩台巨投和運輸船後，將巨投和一開始的兵力用運輸船從下方繞過去快攻，家裡訓練奴隸兵和匈牙利輕騎兵防禦第一波攻擊以及準備進行下一波攻勢用。再來對付理查時，敵人的精銳長弓兵和弩砲、巨投很煩人，因此要使用大匹的匈牙利輕騎兵來迎擊，然後用火砲或巨投拆掉防禦工事尤其是城堡省得一直造長弓兵。由於其他同盟很常來救，因此要準備阿拉伯奴隸兵迎擊遊俠、以及準備火槍兵迎擊條頓武士。如果能重創這兩個勢力則離勝利便不遠了，接著就把其他的勢力一一消滅即可。
            </li>
            <li>
