    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            ...
            >。玩家必須在阿卡城建立<nuxt-link to="/building/Wonder"
              >世界奇觀</nuxt-link
            >並抵擋十字軍的攻擊。實際上阿卡城並不存在(更正:阿卡城位於以色列北部加利利西部，又譯阿克里)
          </p>
        </div>
        <h2>玩家</h2>
        <div class="hrn1"></div>
        <div class="n1">
          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tc6" colspan="3">
                <nuxt-link to="/civs/Persians">波斯</nuxt-link>哨站（紫色）波斯
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="tc6">
                獅心王理查 （紅色）<nuxt-link to="/civs/Britons"
                  >不列顛</nuxt-link
                >
              </td>
              <td class="tc6">
          ...
          <dl class="dl-horizontal">
            <dt>開場：</dt>
            <dd>
              9位<nuxt-link to="/units/Villager">村民</nuxt-link>、4艘<nuxt-link
                to="/units/Fishing_Ship"
                >漁船</nuxt-link
              >、4艘<nuxt-link to="/units/War_Galley">弩砲戰船</nuxt-link
              >、7位<nuxt-link to="/units/Mameluke">阿拉伯奴隸兵</nuxt-link
              >、4位<nuxt-link to="/units/Heavy_Cavalry_Archer"
                >重裝馬弓騎兵</nuxt-link
              >、6位<nuxt-link to="/units/hero/Archers_of_the_Eyes"
                >神弓手</nuxt-link
              >、2台<nuxt-link to="/units/Onager">中型投石車</nuxt-link>。
            </dd>
            <dt>大地之母單位：</dt>
            <dd>無</dd>
          </dl>
        ...
        <div class="n1">
          <ul>
            <li>
              管理大型的城市很容易會引發混亂。不過重建軍事<nuxt-link
                to="/building"
                >建築</nuxt-link
              >在管理上會有幫助，而且很容易就找到這些軍用建築的舊址。當你準備而建造奇觀的時候，你可以把一些<nuxt-link
                to="/building/House"
                >房屋</nuxt-link
              >拆掉以騰出空間來。
            </li>
            <li>
              雖然先發制人可以取得優勢，但是要小心在<nuxt-link
          ...
          <div class="n1">
            <ul>
              ...
              <li>
                把神弓手駐進<nuxt-link to="/building/Watch_Tower"
                  >箭塔</nuxt-link
                >裡、蓋個<nuxt-link to="/building/Archery_Range"
                  >射箭場</nuxt-link
                >放些<nuxt-link to="/units/Crossbowman">弩兵</nuxt-link
                >進去，然後運用<nuxt-link to="/units/Cavalry_Units"
                  >騎兵</nuxt-link
                >阻止敵人的<nuxt-link to="/units/Siege_Weapons"
                  >攻城武器</nuxt-link
                >。
              </li>
              <li>
                法蘭克人會派<nuxt-link to="/units/Bombard_Cannon"
                  >火砲</nuxt-link
              ...
              <li>
                玩家可以善用漁船賺取食物，建造一小批<nuxt-link
                  to="/units/Naval_Vessels"
                  >海軍</nuxt-link
                >防禦熱那亞的海上攻擊。一開始會有點艱難，不過反擊的時候總會到來。此外，西邊的海上有個充滿黃金的小島，一旦玩家用完主要大陸上的黃金，這邊相當不錯。
              </li>
              <li>
              ...
              <li>
                成就「進攻即是最好的防禦」：在建造世界奇觀前打敗所有敵人。建議的攻擊順序是耶路撒冷、<nuxt-link
                  ...
                  >獅心王理查</nuxt-link
                >，然後是法蘭克人和聖殿騎士、熱那亞，消滅耶路撒冷後可以於地圖的右下角發現大量的金礦。在這些金礦附近建造箭塔守衛，敵人家的礦挖完了會來搶這幾處金礦。
              </li>
              <li>
                首先要先快攻耶路撒冷，造兩台巨投和運輸船後，將巨投和一開始的兵力用運輸船從下方繞過去快攻，家裡訓練奴隸兵和匈牙利輕騎兵防禦第一波攻擊以及準備進行下一波攻勢用。再來對付理查時，敵人的精銳長弓兵和弩砲、巨投很煩人，因此要使用大匹的匈牙利輕騎兵來迎擊，然後用火砲或巨投拆掉防禦工事尤其是城堡省得一直造長弓兵。由於其他同盟很常來救，因此要準備阿拉伯奴隸兵迎擊遊俠、以及準備火槍兵迎擊條頓武士。如果能重創這兩個勢力則離勝利便不遠了，接著就把其他的勢力一一消滅即可。
              </li>
              <li>
        ...
        <div class="n1">
          <ol>
            <li>
              人口上限由75改100，耶路撒冷種族由<nuxt-link to="/civs/Byzantines"
                >拜占庭</nuxt-link
              >改成法蘭克，熱那亞種族由拜占庭改成<nuxt-link to="/civs/Italians"
                >義大利</nuxt-link
              >。
            </li>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="unit4">
              <nuxt-link to="/games/aok">帝王世紀</nuxt-link>第三章之六
            </td>
          </tr>
          <tr>
        ...
        <div class="thanks">感謝！此頁由裕暉、竺叡、亞諭協助編輯</div>
      </div>
    </div>
  </div>
</template>
