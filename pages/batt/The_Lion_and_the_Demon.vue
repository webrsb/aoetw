    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          ...
          <table class="table-bordered" width="100%">
            <tr>
              ...
              <td class="tc2">1,500木頭，500食物，1,000黃金，1,000石頭</td>
          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tc6" width="38%">波斯的警備部隊（紫色）波斯</td>
            </tr>
            <tr>
          ...
          <dl class="dl-horizontal">
            <dt>開場：</dt>
            <dd>
              9位村民、4艘漁船、4艘弩砲戰船、7位阿拉伯奴隸兵、4位重裝馬弓騎兵、6位神弓手、2台中型投石車。
            </dd>
            <dt>大地之母單位：</dt>
            <dd>無</dd>
          </dl>
        ...
        <div class="n1">
          <ul>
            <li>
              管理大型的城市很容易會引發混亂。不過重建軍事建築在管理上會有幫助，而且很容易就找到這些軍用建築的舊址。當你準備而建造奇觀的時候，你可以把一些房屋拆掉以騰出空間來。
            </li>
            <li>
              雖然先發制人可以取得優勢，但是要小心在城牆範圍以外所冒的風險。
            </li>
          </ul>
          <h2>芝麻小事</h2>
          <ul>
            <li>阿克爾城歷史上並不存在</li>
            <li>
              雖然任務的目標是建築世界奇觀並且防禦之，但還是比較建議運用起始資源進行充足的防守。
            </li>
            <li>
              把神弓手駐進箭塔裡、蓋個射箭場放些弩兵進去，然後運用騎兵阻止敵人的攻城武器。
            </li>
            <li>
              法蘭克人會派火砲、耶路撒冷會派巨投，獅心王李察最後會架起他的英雄投石機：神之弓與壞鄰居。
            </li>
            <li>
              玩家可以善用漁船賺取食物，建造一小批海軍防禦熱那亞的海上攻擊。一開始會有點艱難，不過反擊的時候總會到來。此外，西邊的海上有個充滿黃金的小島，一旦玩家用完主要大陸上的黃金，這邊相當不錯。
            </li>
            <li>
              你占據地圖的左側、敵人位於右側：敵人的分布，自上而下順序是熱那亞、法蘭克人、聖殿騎士、獅心王，與耶路撒冷。
            </li>
            <li>
              建議的攻擊順序是耶路撒冷、獅心王查理，然後是法蘭克人和聖殿騎士、熱那亞，消滅理查與耶路撒冷後可以於地圖的右下角發現大量的金礦，反之，也可以先消滅法蘭克人與聖殿騎士，取得右上角的金礦。
            </li>
            <li>
