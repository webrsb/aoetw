    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          ...
          <p>
            <b>馬利戰役（蠍螫）</b
            >為松迪亞塔戰役的第二關劇情關卡，此關描述松迪亞塔，在非洲廣大的大地上尋找願意跟他共同抵抗索索王國的關卡。
          </p>
        </div>
        <h2>玩家</h2>
        <div class="hrn1"></div>
...
<span class="glyphicon glyphicon-star" aria-hidden="true" style="color: #ff911d; margin-left: 5px;"></span>:中立</p>!-->
          ...
          <div class="n1">
            <ol>
              <li>
                將貨車帶去桑加藍（紅色）、拉貝（綠色）、尼日（水藍色）城中插旗廣場。
              </li>
            </ol>
          </div>
          <h2>任務提示</h2>
          ...
          <div class="n1">
            <ul>
              <li>
                保護你的盟軍雖然不是必須的，但是他們會是您復國大計的有力幫手。
              </li>
              <li>你不能升級為帝王時代。</li>
            </ul>
            <h2>斥候</h2>
            ...
            <div class="n1">
              <ul>
                ...
                <li>
                  桑加藍（紅色）是他最強的敵人，他們在西北有一座城堡。他們擁有一支由弓箭手、戰矛兵、弩砲和僧侶組成的軍隊。
                </li>
                <li>
                  在最北邊被一條河和塔樓保護的就是拉貝（綠色）。一旦他們到達了城堡時代，他們就會是強勁的對手。他們訓練長劍兵、騎士和攻城衝撞車。
                </li>
                <li>
                  尼日（水藍色）隱藏在東北山區裡，他們的馬弓騎兵和投石車是威力極大的組合。
                </li>
                <li>
                  瓦加督（藍色）和塔博（黃色）馬利兩座城是支持松迪亞塔的，但他們被敵軍包圍著。他們需要來自松迪亞塔的幫助才能保衛家園。
                </li>
              </ul>
              <h2>攻略</h2>
              <div class="hrn1"></div>
              <div class="n1">
                <ul>
                  <li>
                    1.
                    一開始你的營地凌亂不堪。而你必須盡快升城堡。所以用你唯一的那隻輕騎兵去探索周圍，並且發動所有村民採集食物。
                  </li>
                  <li>
                    2.
                    營地北方有黃色，黃色的西北方有藍色，這兩個國家只要你的部隊抵達他們城鎮中心就會加入你，
                    盡快讓他們加入可以大幅吸引電腦玩家的火力，幫你爭取發展的時間。
                  </li>
                  <li>
                    3.
                    營地西北方有一坨石礦，但是去那裏採集非常危險，不建議採。由於你的附近有兩大坨金礦還有採不完的木頭，可以考慮用市場換石頭來蓋城堡。
                  </li>
                  <li>
                    4.
                    升城堡後，立刻在你的城鎮中心西北方、東北方不遠處各蓋一座城堡，然後用城牆把漏洞圍起來。敵人就完全進不來了，
                    可以專心爆經濟、點科技。提示說綠色有衝撞車，但從來沒看他拿來攻擊過，所以只要有城堡，你就是安全的。
                  </li>
                  <li>
                    5.
                    雖然馬利人在城堡時代擅長步兵，但因為敵人有大量馬弓可以打帶跑，所以在這關還是血多速度快的騎士比較好用。
                    ...
                    讓貨車抵達旗幟就可以讓青色投降，這場遊戲只要對方投降就會自動delete所有部隊跟軍事建築，所以不用怕待會衝不出來。
                  </li>
                  <li>
                    6.
                    用你的騎士敲破青色的城門從裡面出來，接著去弄綠色，他們只有木牆，直接敲破木城門。由於裡面守軍有點多，建議帶著幾隻僧侶，
                    進城後先全軍按停止，讓騎士們掃一下周圍的守軍，然後再讓貨車去達陣。
                  </li>
                  <li>
                    7.
                    然後是紅色，紅色甚至連城牆都沒有，大軍直接大搖大擺的開進去就達陣了。可以說這關只要城堡蓋起來之後一切都會變得很簡單，整體難度不難。
                  </li>
                </ul>
                <h2>細節</h2>
                <div class="hrn1"></div>
                <div class="n1">
                  <ul>
                    <li>
                      基本上貨車帶去桑加藍（紅色）、拉貝（綠色）、尼日（水藍色）城中插旗廣場他們就會棄權投降了，因此可以組織快速部隊直接過去但風險較大。
                    </li>
                    <li>城堡一樣是這關好用的方法但要注意是他們會出衝撞車。</li>
                    <li>如果嫌聖物跑太慢也可直接滅了對方不一定要聖物過去。</li>
                    <li>
                      松迪亞塔找同盟的歷程其實很艱辛萬苦如果有興趣可以去找相關的歷史。
                    </li>
                  </ul>
                </div>
              </div>
