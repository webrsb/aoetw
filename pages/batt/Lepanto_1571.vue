      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          ...
          <ul>
            ...
            <li>
              最無腦的戰法是利用西班牙射速超快的火砲戰船來防衛。由於化學已經幫你研發完成，所以一開始先研發火砲戰船和造船匠，這期間先造個4隻快速火戰船迎擊土耳其的第一波海軍，接著所有碼頭就全力造火砲戰船到右方攔運輸船以及打擊上岸的陸軍，至於已登陸的敵人優先打火砲和巨型投石機（但要注意火砲打船有加成）。左岸靠著第一波沒死的船和箭塔進行聯防，如果不放心再調一兩台火砲戰船去守。
            </li>
          </ul>
          <h3>遊戲內細節</h3>
          <div class="hrn1"></div>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="unit4">
              <nuxt-link to="/games/aoc">征服者入侵</nuxt-link>第四章之六
            </td>
          </tr>
          <tr>
