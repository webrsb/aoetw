        ...
        <div class="n1">
          <div class="row">
            ...
            <div class="col-md-6">
              <ol>
                ...
                <li><a href="The_Maid_of_Orleans.php">奧爾良的少女</a></li>
                <li>
                  <a href="The_Cleansing_of_the_Loire.php">羅亞爾河大掃蕩</a>
                </li>
                <li><a href="The_Rising.php">叛變</a></li>
                <li><a href="The_Siege_of _Paris.php">巴黎攻城戰</a></li>
                <li><a href="A_Perfect_Martyr.php">完美的烈士</a></li>
              </ol>
            </div>
            <div class="col-md-6">
              <img
          ...
          <div class="n1">
            ...
            <ul>
              ...
              <li>
                貞德死後成為西方文化的一個重要角色。從拿破崙時代到現在，法國的政治人物常以她的偉大形象進行宣傳。眾多的作家和作曲家，包括莎士比亞、伏爾泰、席勒、威爾第、馬克吐溫、柴可夫斯基、蕭伯納與布萊希特都創作過有關她的作品，而大量以她為題材的電影、戲劇、和音樂也一直持續發展直到今天。
              </li>
            </ul>
          </div>
        </div>
        ...
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img
                  src="~assets/Ingres_coronation_charles_vii.jpg"
                  width="300"
                  alt=""
                />
