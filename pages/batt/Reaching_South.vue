      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            ...
            >在襲擊河內後，進軍明廷在清化南方的重鎮「茶隆關（今乂安省境內）」的經過。
          </p>
        </div>
        <h2>玩家</h2>
        <div class="hrn1"></div>
        <div class="n1">
          ...
          <table class="table-bordered" width="100%">
            <tr>
              ...
              <td class="tc2">
                550<nuxt-link to="/resource/Wood">木材</nuxt-link
                >／650<nuxt-link to="/resource/Food">食物</nuxt-link
                >／400<nuxt-link to="/resource/Gold">黃金</nuxt-link
                >／300<nuxt-link to="/resource/Stone">石礦</nuxt-link>
              </td>
          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tc6" width="38%">
                琴彭軍（藍色）<nuxt-link to="/civs/Chinese">中國</nuxt-link>
              </td>
              <td class="tc6">
                <div class="p6"></div>
                玩家3
              </td>
              <td class="tc6" width="38%">明朝水師（紫色）中國</td>
            </tr>
            <tr>
              <td class="tc6">
                <div class="p3"></div>
          ...
          <div class="n1">
            <ol>
              ...
              <li>
                摧毀明軍在北邊的<nuxt-link to="/building/Market">市集</nuxt-link
                >，斷絕他們的糧草和貿易補給。
              </li>
            </ol>
          </div>
          ...
          <div class="n1">
            <ol>
              <li>
                摧毀明軍在北邊的營地，這樣他們就不能繼續增援他們的南部城池了。
              </li>
              <li>在明朝水師抵達茶隆關之前擊沉它們。</li>
              <li>摧毀明軍北邊的市場，斷絕他們的糧草和貿易補給。</li>
              <li>
                給當地百姓建造一座<nuxt-link to="/building/Mill">磨坊</nuxt-link
                >。
              </li>
              <li>探索密道。</li>
              <li>
                在河對面的山上建一座<nuxt-link to="/building/Castle"
                  >城堡</nuxt-link
                >。
              </li>
            </ol>
        ...
        <div class="n1">
          <ul>
            ...
            <li>盡量去控制往茶隆關的要道。</li>
            <li>
              明軍鐵壁銅牆，<nuxt-link to="/building/Gate">城門</nuxt-link
              >可能是你唯一能攻破的地方。
            </li>
            <li>對茶隆關的強攻宜速戰速決。</li>
          </ul>
        ...
        <div class="n1">
          <ul>
            <li>
              明朝的邊戍重鎮茶隆關（藍色）就在大越營地的南邊，此城內有精兵把守、外有兵糧支援；地勢險要、易守難攻。他們的援兵從水路（紫色）和陸地（綠色）都源源不斷地輸送而來。
            </li>
            <li>
        ...
        <div class="n1">
          <ul>
            <li>
              首先加緊生產村民，盡速挖下方的石礦然後插一座城堡防守。爆經濟的同時訓練重裝長槍兵和戰矛兵以及一些輕騎兵，因為隨後會有明軍攻來。重裝長槍兵對付騎兵，戰矛兵打弓兵，輕騎兵繞去打攻城武器。明軍以弓兵為主，戰矛兵多訓練一些，有多的黃金也能造藤甲弓兵。別忘了幫左方的當地人蓋磨坊獲取密道資訊。
            </li>
            <li>
              升帝王後將兵整個升級，配兵以戟兵和帝王戰矛兵為主（可依自己的喜好加入藤甲弓兵）再帶幾座火砲就可以出門了。先將上方的市場和綠色的明軍解決掉，接著在攻剋關卡前按照指示探索密道，把船和兵清一清再蓋一座城堡在河對岸的山丘，把藤甲弓兵塞滿，基本上一發就可以擊沉路過的運輸船，再對茶隆關發動總攻勢，最後毀掉對方的世界奇觀後把自己的世界奇觀蓋好即可，非常簡單的一關。
            </li>
          </ul>
          <h2>細節</h2>
          <div class="hrn1"></div>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="unit4">
              <nuxt-link to="/games/aor">王者崛起</nuxt-link>第四章之四
            </td>
          </tr>
          <tr>
