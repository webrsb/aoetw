      ...
      <div class="col-md-8">
        <div class="n1">
          <div class="spw">
            <em
              ...
              />不要搞混了，<nuxt-link to="/units/hero/Yodit">游娣特</nuxt-link
              >這個英雄的頁面在這邊。</em
            >
          </div>
          <div class="ien">
            <em>
              傾國傾城的公主殿下游娣特曾是阿克蘇姆王室未來的接班人。但是她的侄子出於忌妒，誣陷她偷竊了教堂的聖物。從此，她被趕出皇室，流亡國外。在玩家的見證下看這位沒落的公主是如何一步步奪回權力的寶座，成為一代女皇。游娣特公主復仇的故事甚至還震撼了之後數百年的衣索比亞人。</em
            >
        ...
        <div class="n1">
          <div class="row">
            <div class="col-md-12">
              <p>
                <b>游娣特戰役</b>由5個關卡組成。玩家扮演的是<nuxt-link
                  to="/civs/Ethiopians"
                  >衣索比亞人</nuxt-link
                >，顏色是綠色。
              </p>
        ...
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style="background-color:#375d96;">
              <div class="unititle" style="color: #fff;">游娣特</div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
              <div class="unititle">
                ...
                <p><em>阿克蘇姆王朝時留下的紀念碑(游娣特戰役的代表圖像)</em></p>
              </div>
            </td>
          </tr>
          <tr>
