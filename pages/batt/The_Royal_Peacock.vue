        ...
        <div class="n1">
          ...
          <div class="n1">
            <ul>
              ...
              <li>
                和敵人結盟能夠給你喘息的機會，但敵人也會趁機發展。因此若決定以和談為手段，還是應該充實兵力。
              </li>
            ...
            <div class="n1">
              <ul>
                ...
                <li>
                  須伽帝(黃色)率領一支起義軍駐紮在東吁山區。他的手下有大量的社會底層貧困士兵願意隨他一起攻入皇城。只有摧毀他們的營地才能打敗他們。
                </li>
              </ul>
              <h2>細節</h2>
              <div class="hrn1"></div>
              <div class="n1">
                <ul>
                  ...
                  <li>
                    斯彌蕭圖的特別劇情單位 -
                    跛腳失明僧人（以世紀帝國一代的僧侶形象出現）、乞丐（以東亞僧侶的形象出現。）兩者均會會治癒與擋道。也都無法被招降。
                  </li>
                  <li>
                    玩家能操縱的跛腳失明僧人（以世紀帝國二代的僧侶形象出現）在皇宮前無法移動。若要他派上用場，可得讓皇宮外的人花一點點巧思與引誘。
                  </li>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="unit4">
              <nuxt-link to="/next/batt/Bayinnaunga">勃印曩</nuxt-link>
            </td>
          </tr>
          <tr>
            <td class="unit3">文明</td>
            <td class="unit4">
              <nuxt-link to="/next/civs/Burmese">緬甸人</nuxt-link>
            </td>
          </tr>
          <tr>
            <td class="unit" colspan="2" style=" background-color:#375d96;">
