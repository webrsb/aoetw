    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tc6" width="38%">
                希伯崙（藍綠色）<nuxt-link to="/civs/Saracens">薩拉森</nuxt-link>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="tc6">
                阿斯加隆（橘色）<nuxt-link to="/civs/Teutons">條頓</nuxt-link>
              </td>
              <td class="tc6">
                <div class="p4"></div>
                玩家3
              ...
              <td class="tc6">
                泰爾（黃色）<nuxt-link to="/civs/Byzantines">拜占庭</nuxt-link>
              </td>
            </tr>
            <tr>
              <td class="tc6">
              ...
              <td class="tc6">
                提比里亞（藍色）<nuxt-link to="/civs/Persians"
                  >波斯</nuxt-link
                >
              </td>
              <td class="tc6">
              ...
              <td class="tc6">
                的黎波里衛隊（紫色）<nuxt-link to="/civs/Franks"
                  >法蘭克</nuxt-link
                >
              </td>
            </tr>
        ...
        <div class="n1">
          <ul>
            <li>
              經濟發展一下後，石頭夠就在北方蓋城堡幫忙抵擋泰爾海軍，並盡快造出一支騎兵先把的黎波里衛隊消滅掉免得他去煩我們的貿易車隊。
            </li>
            <li>
              過一段時間，阿斯加隆會開始建造世界奇觀，提比里亞也會提議停戰，否則他會去攻打希伯崙。他會分別向玩家要兩次的1000黃金（一定要分別給）。如果同盟的話，陸軍先處理阿斯加隆的軍隊，至少第一波攻擊一定要先把世界奇觀打掉，之後再把剩下的泰爾解決掉即過關。
            </li>
          </ul>
        ...
        <div class="n1">
          <ul>
            <li>
              人口上限由75改100，泰爾在決定版不會建造火砲戰船和火砲（之前的版本會）。與提比里亞的外交問題已修復完畢。還有個遺跡藏在東方的懸崖內，部隊無法抵達因此也不能用遺跡獲勝。
            </li>
          </ul>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="unit4">
              <nuxt-link to="/games/aok">帝王世紀</nuxt-link>第三章之五
            </td>
          </tr>
          <tr>
