      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          ...
          <div class="n1">
            <ul>
              <li>
                玩家在斥侯探索這片地區的時候要小心。這裡到處都有流寇，他們看誰不過眼就會衝上來。
              </li>
              <li>
          ...
          <div class="n1">
            <ul>
              <li>
                你一開始會帶領有一些人馬和雙柱城的單位一起阻擊卡拉克莫爾的大軍，守衛河灘。
              </li>
              <li>
          ...
          <ul>
            ...
            <li>
              由於玩家可以充分利用馬雅軍事單位的速度，鷹勇士和羽箭手就非常有用，
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              在這15分鐘內，如果卡拉克其爾有至少8個單位進入納蘭永城，而納蘭永城只有5個或少於5個的軍事單位，
            </li>
            <li>
              納蘭永城被認為被卡拉克其爾“俘虜”並將叛逃到卡拉克其爾的一方。然後玩家將被要求擊敗納蘭永城。
            </li>
            <li>
