    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          ...
          <p>
            <b>風雲變色</b
            >為加查馬達戰役的第五關劇情關卡，此關描述加查馬達在布巴特之戰中運籌帷幄的經過。
          </p>
        </div>
        <h2>玩家</h2>
        <div class="hrn1"></div>
        <div class="n1">
          ...
          <div class="n1">
            ...
            <div class="n1">
              <ul>
                <li>
                  即使你的英雄犧牲了，也不會導致戰役失敗。（按：加查馬達你真不重要）
                </li>
                <li>滿者伯夷的人口上限為125。</li>
                <li>
                ...
                <li>
                  加查馬達不准我們使用攻城武器襲擊皇城，但大象可以是個良好的替代武器。
                </li>
              </ul>
              <h2>斥候</h2>
              <div class="hrn1"></div>
              <div class="n1">
                <ul>
                  <li>
                    加查馬達
                    (紅色)正坐落於皇城南邊，這座起始小島資源匱乏、沒有戰略縱深，無法承受敵軍的強襲。
                  </li>
                  <li>
                    特魯烏蘭城 (黃色)
                    是滿者伯夷的首都，黑奄‧沃克王的皇宮在東邊。皇城有重兵防禦，戒備森嚴，但不和我們為敵。
                  </li>
                  <li>
                    巽他王國
                    (藍色)是為了一場聯姻而來到特魯烏蘭城的。但現在他們發現自己遭到背叛，打算在皇城裡召集兵馬和我們一決高下。如果我們想要勸他們投降，就必須闖入皇城剿滅他們的軍隊。
                  </li>
                  <li>
                    皇城外的西邊和北邊有一些滿者伯夷村莊 (紫色)，和營地
                    (綠色)。如果我們能趕過去的話就能把他們召集起來。
                  </li>
                  <li>
                    由於加查馬達都把心思放在籌備和親上，沒有時間平定盜寇，導致流寇橫行。而且巽他王國已經收買了這些流寇，所以他們可能會對我們格外敵視，甚至主動進攻。
                  </li>
                </ul>
                <h2>細節</h2>
                <div class="hrn1"></div>
                <div class="n1">
                  <ul>
                    <li>
                      布巴特之戰起源於加查馬達的一次併吞計畫，藉由和親將巽他王國併入滿者伯夷。但由於加查馬達玩弄話術，導致巽他王國驚覺上當（巽他王國認為此次婚姻應該是平行對等的聯姻）而表現出不滿。加查馬達藉此靠著武力企圖襲殺巽他國王、巽他公主為此悲憤自盡。是一場殘酷的政治謀劃。
                    </li>
                    <li>本關無法建造攻城武器。</li>
                    <li>
                      新君哈亞烏魯克在事變後十分震怒，遂將加查馬達流放。雖然後來又將他恢復原職。
                    </li>
                  </ul>
                </div>
              </div>
