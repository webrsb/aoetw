      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          ...
          <dl class="dl-horizontal">
            <dt>開場：</dt>
            <dd>重型弩砲戰船x5，火戰船x2，火砲戰船x2，村民x18。</dd>
            <dt>英雄：</dt>
            <dd>李舜臣將軍（龜甲船）。</dd>
            <dt>大地之母單位：</dt>
            <dd>運輸船。</dd>
          ...
          <ul>
            ...
            <li>
              對方運輸船只會載運精銳日本武士，可提前在海上殲滅，或者沿海地區可以再多蓋一些箭塔、火砲塔。
            </li>
            <li>
              由於海上對方無時無刻都在攻擊，所以在自己的海軍數量上必須維持住，特別注意對方的神風船打龜甲船十分有殺傷力。
            </li>
            <li>
              對方的碼頭臨近都會有城堡、戰船、火砲塔等嚴防，建議可以使用龜甲船搭配火砲船進行遠距離攻擊。
            </li>
            <li>
              由於一開始對方就開始進攻我方，你可以把一些戰船派過去防守，留一部分防日本運輸船。
            </li>
            <li>
              左上的日本侵略者，可以派幾隻騎士跟衝撞車進行殲滅，在中國同盟部分他會提供大量軍隊以及火砲，可以拿來對付日本侵略者，不建議拿去對付對面的日本海軍。
            </li>
          </ul>
          <h3>遊戲內細節</h3>
          <div class="hrn1"></div>
          <ul>
            ...
            <li>
              由於對方海軍優於我方，所以在戰船上部隊數量上，盡可能幾隻龜甲船（防禦力高）搭配火砲船或者戰船來迎戰。
            </li>
            <li>
