        ...
        <div class="n1">
          ...
          <p>
            露梁海戰是一場於1598年12月16日在朝鮮東南外海露梁海域展開的海戰。參戰雙方為<nuxt-link
              to="/civs/Chinese"
              >中國</nuxt-link
            >明朝與朝鮮王朝的聯軍，以及當時征伐朝鮮的日本軍隊。這場<nuxt-link
              to="/batt"
              >戰役</nuxt-link
            >發生在「朝鮮之役」（朝鮮稱「壬辰祖國戰爭」）第二回合衝突（日本稱「慶長之役」）的後期。此次海戰中國明朝和朝鮮王朝的聯軍給與一部日軍殲滅性的打擊，對戰後朝鮮半島200年的和平局面起到了重要作用。
          </p>
        </div>
        <h2>玩家</h2>
        <div class="hrn1"></div>
        <div class="n1">
          ...
          <dl class="dl-horizontal">
            ...
            <dd>
              ...
              >x5，<nuxt-link to="/units/Fire_Ship">火戰船</nuxt-link
              >x2，<nuxt-link to="/units/Cannon_Galleon">火砲戰船</nuxt-link
              >x2，<nuxt-link to="/units/Villager">村民</nuxt-link>x18。
            </dd>
            <dt><nuxt-link to="/units/hero">英雄</nuxt-link>：</dt>
            <dd>
            ...
            <dt>大地之母單位：</dt>
            <dd><nuxt-link to="/units/Transport_Ship">運輸船</nuxt-link>。</dd>
          </dl>
          <h3>主要任務</h3>
          <div class="hrn1"></div>
          <div class="n1">
          ...
          <ul>
            ...
            <li>
              在陸地上資源供給上無需太過擔心，但在海上的戰船相對於日本較疲弱一點，需要龜甲船、火砲戰船的支援。
            </li>
            <li>
              對方運輸船只會載運精銳日本武士，可提前在海上殲滅，或者沿海地區可以再多蓋一些<nuxt-link
            ...
            <li>
              對方的<nuxt-link to="/building/Dock">碼頭</nuxt-link
              >臨近都會有城堡、戰船、火砲塔等嚴防，建議可以使用龜甲船搭配火砲戰船進行遠距離攻擊。
            </li>
            <li>
              由於一開始對方就開始進攻我方，你可以把一些戰船派過去防守，留一部分防日本運輸船。
            </li>
            <li>
              左上的日本侵略者，可以派幾隻<nuxt-link to="/units/Knight"
                >騎士</nuxt-link
              >跟<nuxt-link to="/units/Battering_Ram">衝撞車</nuxt-link
              >進行殲滅，在中國同盟部分他會提供大量軍隊以及火砲，可以拿來對付日本侵略者，不建議拿去對付對面的日本海軍。
            </li>
          </ul>
          <h3>遊戲內細節</h3>
          <div class="hrn1"></div>
          <ul>
            ...
            <li>
              由於對方海軍優於我方，所以在戰船上部隊數量上，盡可能幾隻龜甲船（防禦力高）搭配火砲戰船或者戰船來迎戰。
            </li>
            <li>
              在自己左上有一批日本侵略者，你可以利用中國的援軍來進行攻擊。
            </li>
            <li>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="unit4">
              <nuxt-link to="/games/aoc">征服者入侵</nuxt-link>第四章之八
            </td>
          </tr>
          <tr>
