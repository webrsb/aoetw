        ...
        <div class="n1">
          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tc6">烈日（青色）法蘭克人</td>
              <td class="tc6" width="14%">
                <div class="p3"></div>
                玩家4
              </td>
              <td colspan="3" class="tc6">叛軍補給營地（綠色）法蘭克人</td>
            </tr>
          </table>
          ...
          <ul>
            ...
            <li>
              當探查到綠色的火藥補給營地時，有任務提示說只要摧毀火藥庫（貿易工坊）就能斷絕列日城的火藥補給來源，讓列日城不會出火器兵種。
            </li>
