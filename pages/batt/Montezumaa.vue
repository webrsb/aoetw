    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <div class="ien">
            <em
              >多個世紀以來的武力征服，已經讓阿茲特克人成為中美洲最強大的帝國。可是在加勒比海沿岸蒙提祖馬，出現了從未見過的陌生人時，阿茲特克的國王無法斷定他們到底是征服者或是神。這個龐大帝國的武士，真的能夠以他們原始的黑曜石長矛和棉布護甲，對抗這些騎著馬匹，並配戴金屬裝甲和使用火器的入侵者？在鐵諾茲提朗這個島上的阿茲特克人，將會繼續縱橫美洲，還是被這些外來的征服者所粉碎？</em
            >
          ...
          <p>
            <b>蒙提祖馬</b>是《<nuxt-link to="/games/aoc"
              >世紀帝國II：征服者入侵</nuxt-link
            >》中的阿茲特克系列<nuxt-link to="/batt">戰役</nuxt-link
            >，以特諾奇提特蘭的第9位統治者蒙提祖馬二世命名。這場戰役描繪了<nuxt-link
        ...
        <div class="n1">
          <div class="row">
            <div class="col-md-12">
              <p>
                蒙提祖馬戰役由6個關卡組成。玩家扮演的是<nuxt-link
                  to="/civs/Aztecs"
                  >阿茲特克人</nuxt-link
                >，顏色是綠色的。
              </p>
            ...
            <div class="col-md-12">
              ...
              <div class="n1">
                <ul>
                  <li>
                    儘管戰役的名字是蒙提祖馬，不過主角實際上是蒙提祖馬的侄子庫奧赫特莫克。
                  </li>
                  <li>
                    這場戰役的內容與歷史相去甚多:
                    <ul>
                      <li>
                        實際上庫奧赫特莫克是蒙提祖馬二世的堂兄，而不是侄子。然而庫奧赫特莫克嫁給了蒙提祖馬的女兒。
                      </li>
                      <li>
                        三城同盟的戰役中特斯科科和特拉科潘的背叛歷史上沒有發生過。
                      </li>
                ...
                <ul>
                  <li>
                    儘管如此，戰役內容還是有一些遵循史實，比如其他部落（遊戲內的特斯科科）與阿茲特克人作戰是因為他們不接受阿茲特克人提的新進貢條件（阿茲台克人要求減低25%作為和平代價而進貢的供品數量）。
                  </li>
                </ul>
              </div>
            </div>
        ...
        <table class="table-bordered" width="100%">
          <tr>
            <td class="unit" colspan="2" style="background-color:#375d96;">
              <div class="unititle" style="color: #fff;">蒙提祖馬</div>
            </td>
          </tr>
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img
                  src="~assets/Montezuma_and_cortez.jpg"
                  width="300"
                  alt=""
                />
                <p><em>本系列主角 蒙提祖馬和庫奧赫特莫克</em></p>
              </div>
            </td>
          </tr>
          <tr>
