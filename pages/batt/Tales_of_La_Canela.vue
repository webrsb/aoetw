    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          ...
          <dl class="dl-horizontal">
            <dt>開場單位：</dt>
            <dd>
              法蘭西斯科.德.奧雷利亞納、2位西班牙征服者（HP75）、2位斥侯騎兵（HP265、ATK3+20）。
            </dd>
            <dt>大地之母單位：</dt>
            <dd>無。</dd>
          </dl>
        ...
        <div class="n1">
          ...
          <div class="n1">
            <ul>
              ...
              <li>
                當你的部隊從基多向東開拔，並朝著皮薩羅在蘇馬科山谷的基地前進時，你將在抵達印加遺址之前遇到兩隊叛軍。至少派遣一名最初的斥侯去皮薩羅的基地會見他。然後，廢墟將暫時成為你的基地，你必須抵禦叛軍，直到你在戰役中共累計殺死100名敵軍。一旦敵人撤退，皮薩羅會再來和你聊天，然後你就會勝利。
              </li>
            </ul>
            <h2>趣事</h2>
            <div class="hrn1"></div>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle"><img src="~assets/EI 1.jpg" alt="" /></div>
            </td>
          </tr>
          <tr>
            <td class="unit" colspan="2" style="background-color:#375d96;">
