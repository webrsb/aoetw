...
<span class="glyphicon glyphicon-star" aria-hidden="true" style="color: #ff911d; margin-left: 5px;"></span>:中立</p>!-->
          ...
          <div class="n1">
            ...
            <div class="n1">
              <ul>
                <li>
                  庫姆比薩萊赫是加尼斯帝國前首都，它坐落在我們基地的河對岸。陸地只有一條路通往那裡，所以你也可以考慮通過水路運送軍隊登陸對岸。庫姆比薩萊赫城十分堅固，他們擁有一支未嘗敗績的強大步兵團。
                </li>
                <li>
                  在我們基地的西邊有很多資源，它們分佈在主陸地和周圍的小島上。
                </li>
                <li>
                  蘇曼古魯(橘色)佔據了堅固的庫姆比城，他身邊有重兵把守，不會輕易束手就擒。
                </li>
              </ul>
              <h2>攻略</h2>
              <div class="hrn1"></div>
              <div class="n1">
                <ol>
                  ...
                  <li>
                    以上步驟做好之後敵人基本上進不來。我們要開始做最後進攻準備。由於資源跟時間都十分有限，不能等到後帝才進攻。你至少要點的科技一共有：兵工廠的弓兵相關科技以及步兵相關科技、大學的化學與建築生命值相關科技、修道院加僧侶生命值與跑速的科技、磨坊的農田科技、靶場升級重裝馬騎弓兵、城堡升級精銳飛刀女兵、徵兵制度。
                  </li>
                  <li>
                    點科技的同時，生出約十五隻火炮、20隻馬弓、20隻飛刀女兵。之所以用馬弓不用強弩，是因為馬弓跑得跟飛刀女兵差不多快，一起行動才不會浪費了女兵的機動性。準備好之後把敵人橋上的城牆打掉一格改建為自己的城門。
                    大軍開過去，馬弓跟女兵固守原地模式作為掩護，火炮先拆城牆防禦工事，拆完打奇觀再掃蕩。要特別小心操控火炮的位置，因為敵人兩層城牆之間放著許多弓兵以及巨投跟重投。小心別讓火炮被砸到了。
                  </li>
                  <li>
                    你的死對頭橘色，他的軍隊全部圍在奇觀旁邊，由於時間緊迫不能節外生枝，在你用火炮打奇觀的時候小心不要打到他的軍隊，他就不會弄你（真是豬隊友，隊友奇觀被攻擊都不會守一下）。
                  </li>
                  <li>
                    總體而言，敵人唯一棘手的是頻繁而大量的步兵。（提示說是「未嘗一敗的步兵團來著？）只要方法對了，這關其實沒有網路上說的那麼難。
                  </li>
                  <li>
                ...
                <div class="n1">
                  <ul>
                    ...
                    <li>
                      基本上城堡可以保護到你發展起來，但要注意對方會蓋世界奇觀。
                    </li>
                    <li>除了自己這邊的金礦，其他礦物都散落在小島和最上方。</li>
                    <li>
                      遊戲是說深入虎穴是基於基里納戰役得史實設計，但是根據資料顯示蘇曼古魯是消失並沒死亡且在上一戰役最後逃進山中。
                    </li>
                    <li>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle"><img src="~assets/SUN 5.jpg" alt="" /></div>
            </td>
          </tr>
          <tr>
            <td class="unit" colspan="2" style="background-color:#375d96;">
