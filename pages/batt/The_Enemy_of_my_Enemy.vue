        ...
        <div class="n1">
          ...
          <table class="table-bordered" width="100%">
            <tr>
              ...
              <td class="tc2">木頭800，食物200，黃金300，石頭200</td>
          ...
          <dl class="dl-horizontal">
            <dt>開場：</dt>
            <dd>
              長劍兵x10、騎士x10、弓箭手x8、村民x4、輕騎兵x3、英雄：熙德。
            </dd>
            <dt>大地之母單位：</dt>
            <dd>運輸船x1</dd>
          </dl>
          ...
          <div class="n1">
            <ul>
              ...
              <li>
                這時附近的其他摩爾人，蒙達米特（青色）和回教長老伊滿（紫色），他是一個聖者。只要有一邊不信任，就不曉得下一步怎麼走。西班牙人的叛亂軍隊是由步兵、騎士和輕型衝撞車組成。
              </li>
              <li>
                摩爾人的叛軍會使用弓兵、駱駝騎兵和輕型投石車，無論是那一方的軍隊，都會有僧侶。托雷多擁有堅固的城牆，所以要肯定你有帶備攻城武器。
              </li>
            </ul>
          </div>
          <h3>攻略</h3>
          ...
          <ul>
            ...
            <li>
              首先使用其中一個騎士巡邏到岸邊東部（橋前），有10多隻羊，不要把綿羊帶到蒙達米特（青色）的市場，因為他會接管綿羊。
            </li>
            <li>
              金礦的主要來源有兩個：一個位於西岸，一個位於沿途的東部地，當玩家的單位到達該地區較高的海岸將會有一艘運輸船，建議玩家去釣魚。因為相同數量的漁船比農場消耗的資源更少。
            </li>
            <li>
            ...
            <li>
              4個遺跡分別在
              兩個修道院各1，一個僧侶手拿遺跡卡在木牆內，最後一個在左下方城堡後方。
            </li>
            <li>
              當你準備入侵時，使用攻城器具（無法使用巨型投石車）和騎士摧毀防禦性建築和軍事建築，再用少部分騎士作為掩護讓僧侶可以拿到城內的三個遺跡（城堡後方除外），拿完三個後可以派遣4名僧侶
          ...
          <ul>
            ...
            <li>
              在進入敵營時，可以針對軍營、馬場、弓箭場進行破壞阻斷敵軍生產軍隊，或者派遣大量騎士
              駐守在軍營附近，就近消滅。
            </li>
            <li>
              拿到運輸船後，可以讓他到河道彎道下方（敵軍磨坊附近）等待，以方便接應拿完城堡後的僧侶。
            </li>
            <li>
              如果使用3名僧侶補熙德坦城堡傷害，須注意熙德血量，可以利用巡邏讓熙德可以損血狀況緩和。
            </li>
            <li>
              因為資源有限，大部分黃金掌握在敵軍手上，所以建議有策略性地拿取遺跡，不建議派大軍前往（大軍隊形成會有點慢）。
            </li>
            <li>
              如果想節省僧侶的製造黃金，可以生產一隻僧侶，之後提升修道院科技，利用一隻僧侶去招降敵軍僧侶。
            </li>
          </ul>
          <h3>快速破關</h3>
          <div class="hrn1"></div>
