    ...
    <div class="row" style="margin-top: 50px;">
      ...
      <div class="col-md-8">
        <div class="n1">
          ...
          <p>
            然而，女王胡安娜的姨媽，伊莎貝拉為自己爭奪卡西提爾的王座，她的丈夫斐迪南二世與阿拉貢國王已將他的軍隊帶入卡西提爾。葡萄牙和阿拉貢的軍隊在托羅市會面，決定卡西提爾的命運。
          </p>
        </div>
        <h2>玩家</h2>
        <div class="hrn1"></div>
        <div class="n1">
          ...
          <div class="n1">
            ...
            <div class="n1">
              <ul>
                <li>
                  讓胡安王子與剩餘的阿方索國王軍隊會合。（須由胡安王子抵達紅色軍隊處才可徵招）
                </li>
              ...
              <div class="n1">
                <ol>
                  ...
                  <li>
                    阿拉貢人可以訓練新單位，但是起步階段時你不可以，所以迅速擴張很關鍵。
                  </li>
                  <li>
                    在營地被摧毀之前殺死阿爾巴公爵和門多薩紅衣主教可以讓你在開始階段就利用更多的資源發展並摧毀劇情的一部分。
                  </li>
                  <li>
                    通往伊莎貝拉佔領的薩莫拉城有一座橋，這座橋固若金湯，但是你可以在遠東找到一個灘頭堡，那裡防守鬆散，你可以伺機潛入敵城。
                  </li>
                </ol>
              </div>
            </div>
          ...
          <div class="n1">
            <ol>
              <li>
                ...
                >1名、長劍士4名往玩家進攻。一開始兵力不足，建議先讓胡安王子吸引部分敵軍，打散黃色兵力後再反擊。
              </li>
              <li>
              ...
              <li>
                建議可將現有兵力集結於一處，由胡安王子探路尋找紅色軍隊，遇到數量較多的黃色敵軍就引到我軍處。
              </li>
              <li>
                阿爾巴公爵會在地圖巡邏的黃色單位之中、門多薩紅衣主教會在其中一個黃色軍營裡，殺死他們各可以取得500黃金。
              </li>
              <li>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <p>
                <em>
                  門多薩紅衣主教會在其中一個黃色軍營中（要留意裡面僧侶很多）。</em
                >
              </p>
            </div>
            <div class="col-md-6">
