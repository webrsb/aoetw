    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            <b>君士坦丁堡的城牆</b
            >為阿提拉戰役的第三關劇情關卡，此關原型為公元447年匈奴與東羅馬帝國的維特河戰役（今保加利亞維特河）。
          </p>
        </div>
        <h2>玩家</h2>
        <div class="hrn1"></div>
        <div class="n1">
          ...
          <table class="table-bordered" width="100%">
            <tr>
              ...
              <td class="tc2">1,000木頭，1,000食物，1,200黃金，200石頭</td>
          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tc6" width="38%">君士坦丁堡（藍色）拜占庭</td>
              <td class="tc6">
                <div class="p3" width="12%">玩家3</div>
              </td>
              <td class="tc6" width="38%">馬西安堡（綠色）哥德</td>
            </tr>
            <tr>
              <td class="tc6">
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              只要破壞羅馬的市鎮中心、港口、市場和類似的建築物，就可以迫使羅馬人乖乖的交出貢金。儘管他們會反抗，但在你能夠聚集到
        ...
        <div class="n1">
          <ul>
            <li>
              ...
              (綠色)。雖然馬西安堡並沒有強大的軍隊，但他們的城鎮築有城牆，讓它能防禦匈奴人初期的攻擊。不過，當你破壞了城門之後，這個城鎮也就毀了。
            </li>
            <li>
              菲力普堡 (紅色)
              雖然在初期只有少數的箭塔作防禦，但他們會訓練步兵和輕騎兵等軍隊。
            </li>
            <li>
              君士坦丁堡 (藍色)
          ...
          <div class="n1">
            <ul>
              <li>
                擊敗馬西安堡（綠色）用起始資源立即開始訓練騎士。選擇性的建立射箭場來訓練馬弓騎兵。立即開始反擊馬西亞諾波利斯。蓋攻城武器製造所來生產衝撞車來摧毀馬西安堡的建築，與此同時更不能忘記經濟發展。石頭可以在菲利普堡郊外找到，黃金則是在君士坦丁堡外。
              </li>
              <li>
                擊敗菲利普堡(紅色)用打倒馬西安堡所得得到的黃金進貢來重新訓練軍隊並入侵菲利普堡。善用騎士與馬弓騎兵(或是用輕騎兵省黃金)殺人，並用衝撞車攻擊塔與城鎮中心。一旦菲利普堡被擊敗了，就派兩個僧侶去取得遺跡。君士坦丁堡城郊有個修道院，可以摧毀它來得到供品。
              </li>
              <li>
                擊敗君士坦丁堡（藍色）雖然任務提示和對話堅決反對攻擊君士坦丁堡，有一點耐心的話，打敗他們是完全可能的。在城門外建一座城堡。用馬弓騎兵引誘在外牆內防守的弩兵、僧侶與投石車，解決他們之後，就派衝撞車攻擊城門與塔。衝進城鎮後，開始引誘僧侶與聖騎兵，它們對付大群馬弓騎兵毫無招架之力。用衝撞車攻擊世界奇觀前的城堡。這些應該夠玩家取得足夠的黃金進貢來贏得戰役。
              </li>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/Attila.3.jpg" width="" alt="" />
              </div>
            </td>
          </tr>
          <tr>
