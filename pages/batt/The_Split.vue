      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          ...
          <div class="n1">
            <ol>
              <li>
                奧雷利亞納，貢薩洛.皮薩羅，戴利考拉必須活著。第一部分:尋找<nuxt-link
                  to="/techs/El_Dorado$"
                  >黃金國</nuxt-link
                >
              </li>
            ...
            <ul>
              <li>
                玩家首先必須擊敗當地住民埃爾巴科的反抗，然後他們的大酋長會投降並且答應幫助玩家。玩家需要獲得材料來建造<nuxt-link
                  ...
                  >運輸船</nuxt-link
                >並一邊處理敵對土著人的抵抗。然後玩家必須帶奧雷亞納和四個征服者離開皮薩羅並穿越亞馬遜河，征服伊馬拉並完成三個友好土著的要求來獲取寶貴的地區資料。
              </li>
              <li>
                開始時，玩家在地圖北端擁有一隊征服者、<nuxt-link
              ...
              <li>
                當玩家到埃爾巴科時，只需要摧毀所有的塔樓(海塔)，就能迫使他們投降。玩家可以很輕易的殺死敵軍士兵，但是<nuxt-link
                  to="/units/Kamayuk"
                  >槍隊長</nuxt-link
                >對屬於騎乘單位的征服者來說是很大的威脅。一旦塔被摧毀，大酋長將投降並同意協助玩家進行探索。
              </li>
              <li>
              ...
              <li>
                玩家將獲得只足夠建造碼頭的<nuxt-link to="/resource/Wood"
                  >木頭</nuxt-link
                >，建好了之後會自動獲得一艘西班牙的運輸船。運輸船上有四個征服者，奧雷亞納登上它，剩下的單位都會留下來。玩家應當將船沿亞馬遜河南行。
              </li>
              <li>
