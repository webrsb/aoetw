    ...
    <div class="row" style=" margin-top: 50px;">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            摔落的皇冠是《世紀帝國 II HD:
            非洲王朝》優娣忒戰役的第三個場景。戰役中優娣忒必須面對阿克蘇姆國王達納罕及他的盟友貝根德爾王國，同時還要處理該地區的內戰，最後要阻止達納罕到達西方的路口。
          </p>
        </div>
        <h3>AI</h3>
        ...
        <div class="n1">
          <ul>
            <li>
              你的斥侯回報:我們的人手和村民會在北邊抵達，那是一片不毛之地。這裡資源稀缺，所以我們需要調用所有可發掘的資源來獲得勝利。
            </li>
            <li>
      ...
      <div class="col-md-12">
        ...
        <ul>
          <li>
            開場玩家有5名村民、四名彎刀勇士及三名弓兵。直接往地圖右上走直到遇到兩名弓兵及一隻重裝長槍兵守衛著遺跡，快速解決他們後直接在此蓋城鎮中心。除了收集資源外要記得圍牆，此場景沒有石牆，要善用建築物跟木牆保護自己，然而因為地形關係很多地方都不能蓋建築物，而且樹木也很分散，玩家要謹慎計畫建築位子。往右下走會碰到貝根德爾的城門，貝根德爾的軍隊由弓兵及裝甲步兵組成，建造一支弓兵及矛兵的混合部隊能暫時擋住他們的攻擊，玩家現在要專注晉升到城堡時代。
          </li>
          <li>
            城堡時代後馬上升級弩兵跟兩台投石車，並升級相關弓兵科技，記得也蓋修道院把遺跡放裡面，然後打掉最近的貝根德爾營地。在這裡蓋城堡等軍事建築物以及四座碼頭，達納罕大軍要經過的路都有水域，所以建造重型弩砲戰船跟火炮戰船沿岸轟炸是可以的。升級到帝王時代並建造你的海軍。摧毀城堡跟箭塔之後你會發現達納罕的大軍對你的海軍將束手無策。
          </li>
          <div class="col-md-12">
            <div class="col-md-6">
              <gallery>
