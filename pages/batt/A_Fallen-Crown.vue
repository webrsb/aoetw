    ...
    <div class="row" style="margin-top: 50px;">
      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          <ul>
            <li>
              你的斥候回報:我們的人手和村民會在北邊抵達，那是一片不毛之地。這裡資源稀缺，所以我們需要調用所有可發掘的資源來獲得勝利。
            </li>
            <li>
      ...
      <div class="col-md-12">
        ...
        <ul>
          ...
          <li>
            城堡時代後馬上升級弩兵跟兩台投石車，並升級相關弓兵科技，記得也蓋修道院把遺跡放裡面，然後打掉最近的貝根德爾營地。在這裡蓋城堡等軍事建築物以及四座碼頭，達納罕大軍要經過的路都有水域，所以建造重型弩砲戰船跟火砲戰船沿岸轟炸是可以的。升級到帝王時代並建造你的海軍。摧毀城堡跟箭塔之後你會發現達納罕的大軍對你的海軍將束手無策。
          </li>
          <div class="row">
            <div class="col-md-6">
              <gallery
