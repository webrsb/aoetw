    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          ...
          <p>
            <b>班師勤王</b
            >為加查馬達第二關劇情關卡，此關描述1321年政變中，加查馬達率軍營救主君查雅納迦拉的經過。
          </p>
        </div>
        <h2>玩家</h2>
        <div class="hrn1"></div>
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              賈亞納拉加國王時間不多了，你得快點班師清君側，不然叛軍可能會先一步將他處決。
            </li>
          </ul>
          <h2>斥候</h2>
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              <li>
                加查馬達的軍隊 (紅色)
                已經趕到了皇城東北角，你得依靠百姓在此安營紮寨，伺機攻打皇城。
              </li>
              <li>在你營區北邊有阿爾雅‧塔達宰相的軍隊，他在等候你一起攻城。</li>
              <li>
                賈亞納迦拉國王
                (黃色)被叛軍圍困在皇城裡，儘管禁衛軍都是精銳，但無法抵擋太久。
              </li>
              <li>
                特魯烏蘭城 (橘色)
                已經被叛軍佔領了。他們布置了重兵來防止我們勤王。他們的部隊有強弩兵、劍兵勇士、大象、中型投石車與斧槍兵。逆賊拉克利安‧古狄率軍闖入王城想要逼宮，手下有劍兵勇士、爪刀勇士、輕騎兵、弩兵聽其調遣。
              </li>
              <li>
                皇城外有其他叛軍
            ...
            <div class="n1">
              <ul>
                ...
                <li>
                  拉克利安‧古狄(?-?) -
                  滿者伯夷軍政大臣，於1321年發動政變弒君謀逆。但失敗，遭到加查馬達的平定。
                </li>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/Gajah Mada 2.jpg" width="" alt="" />
              </div>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit4">
              <nuxt-link to="/batt/Usurpation">開疆闢土</nuxt-link>
            </td>
          </tr>
          <tr>
