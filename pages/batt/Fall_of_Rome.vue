      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              你要進攻時，確認有足夠而且已經升級的軍隊，因為你的敵人們會聯手來對付你。
            </li>
          </ul>
        </div>
        <h2>斥候</h2>
        ...
        <div class="n1">
          ...
          <div class="n1">
            <ul>
              ...
              <li>
                而遊戲中的不列顛人，賽爾特人，法蘭克人和條頓人作為敵對文明的使用更加不正確。（尤其阿奎利亞人後來逃難建立威尼斯共和國），義大利文明直到2013年HD版失落帝國資料片才登場。這可能是因為開發者想讓玩家可以面對各種各樣的敵方單位，並看到不同的世界奇觀，以避免戰役冗餘無聊。
              </li>
            </ul>
          </div>
        </div>
