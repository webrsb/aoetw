      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            ...
            >歸爾甫派和吉伯林派戰爭的導火線，並隨著義大利北部淪陷後，其餘的義大利城市為了對抗<nuxt-link
              to="/batt/Barbarossa"
              >巴巴羅薩</nuxt-link
            >而組成倫巴第聯盟（義大利語：Lega Lombarda）。
          </p>
        </div>
        <h2>玩家</h2>
        <div class="hrn1"></div>
        <div class="n1">
          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tc6">
                河道衛兵（紫色）<nuxt-link to="/civs/Franks">法蘭克</nuxt-link>
              </td>
            </tr>
          </table>
          ...
          <dl class="dl-horizontal">
            ...
            <dd>
              ...
              >、8位<nuxt-link to="/units/Pikeman">重裝長槍兵</nuxt-link
              >、4位<nuxt-link to="/units/Monk">憎侶</nuxt-link>、1艘<nuxt-link
                to="/units/Transport_Ship"
                >運輸船</nuxt-link
              >、3艘<nuxt-link to="/units/War_Galley">弩砲戰船</nuxt-link>。
            </dd>
            <dt>大地之母單位：</dt>
            <dd>無。</dd>
          </dl>
        ...
        <div class="n1">
          <ol>
            ...
            <li>
              登陸後，米蘭、河道衛兵會傾其所有兵力攻擊玩家登岸的軍隊，建議帶上足夠的村民、戟兵和戰矛兵，一登岸就插幾座城堡駐兵。要注意的是由於米蘭改義大利人了，所以會有不少的匈牙利輕騎兵和熱那亞弩手，若用條頓武士會被射成智障；也會用攻城器拆除我方的城堡，運用火砲反制並小心控兵。攻略難度比2013版難上一些。
            </li>
            <li>
              成就打法：開局將所有的部隊全運到西側，並在米蘭北方集結。先利用一支長槍兵去打城門，此時敵方的裝甲步兵會有反應，將長槍兵拉走後，再派另一隻長槍兵設不還擊狀態卡城門，其他部隊趁機通過城門。接著慢慢接近大教堂，先解決敵人的僧侶和投石車，其他兵引誘敵人的軍隊掩護僧侶招降大教堂。
            </li>
          </ol>
        </div>
      </div>
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="unit4">
              <nuxt-link to="/games/aok">帝王世紀</nuxt-link>第五章之三
            </td>
          </tr>
          <tr>
