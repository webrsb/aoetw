    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          ...
          <p>
            <b>兵分三路</b
            >為黎利戰役的第五關劇情關卡，此關描述越南黎利奪下茶隆關，進佔明廷交趾布政使司首府「乂安」的經過。
          </p>
        </div>
        <h2>玩家</h2>
        <div class="hrn1"></div>
        <div class="n1">
          ...
          <table class="table-bordered" width="100%">
            <tr>
              ...
              <td class="tc2">900木材／700食物／600黃金／550石礦</td>
          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tc6" width="38%">柳升將軍（藍色）中國</td>
            </tr>
            <tr>
          ...
          <p></p>
          <h3>開場</h3>
          <p>。 英雄 - 李篆x1、裴備x1、劉仁㴬x1、丁禮x1</p>
          <p>
            。 軍事單位 -
            輕騎兵x5、矛象伕x2、雙手劍兵x0-9（視大越義軍的控兵而定）、藤甲弓兵x5-10（視大越義軍的控兵而定）
          </p>
          <p>。 經濟單位 - 村民x5</p>
          <h2>主要任務</h2>
          <div class="hrn1"></div>
        ...
        <div class="n1">
          <ul>
            <li>
              把資源區分散於三個大本營至關重要，在初期我方並沒有軍力兼顧三者。
            </li>
            <li>
              一兩個城鎮被攻陷並不影響戰局，只要還有一座城鎮中心尚存，就有東山再起的機會。
            </li>
        ...
        <div class="n1">
          <ul>
            <li>
              大越將領已經在三路都安營紮寨:
              李篆將軍駐守北路，準備阻擊明朝南下的援軍；丁禮一路往東插入明軍兩大陣地之間，但他的位置可能會被兩路明軍夾擊；劉仁澍和裴備則進軍西路，準備攻打乂安府的西門。
            </li>
            <li>
            ...
            <li>
              哀牢國（灰色）並不參戰，但是如果我們從他們國土上穿越過去的話，他們還是會無法容忍的。他們的軍隊以大象和步兵為主。
            </li>
          </ul>
          <h2>細節</h2>
          <ul>
            ...
            <li>
              儘管科技樹上並未寫明，但在本關中乂安府（水藍）作為越南人，卻能夠訓練火藥單位。用以呼應時代。
            </li>
            <li>
              關卡類似聖女貞德第六關：完美的烈士。有大量英雄在劇情中登場，有各自的特色語音對白。
            </li>
            <li>哀牢為寮國的古稱。</li>
            <li>
              李篆（？-1427），黎利部將，作戰十分勇猛，人稱「君子劍」。在圍攻「東都（今河內市）」時中伏陣歿。以劍兵勇士形象在劇情中登場
            </li>
            <li>
              丁禮（？-1427），黎利部將。在圍攻東都時因為救援友軍遭遇埋伏，被俘虜後斬首。以遊俠形象在劇情中登場。
            </li>
            <li>
              劉仁㴬（？-1433），一作劉仁澍。黎利部將。後黎開國元勛之一、在太祖死後被任命為五大輔臣之一，死於朝廷內的政治清算。以強弩兵形象在劇情中登場
            </li>
            <li>
              裴備（？-？），黎利謀臣，以東方僧侶形象在劇情中登場。具有普通僧侶的能力，但不受修道院科技的影響。
            </li>
          </ul>
        </div>
      </div>
        ...
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img
                  src="~assets/(map)Le_Loi_5.A_Three_Pronged_Attack.jpg"
                  alt=""
                />
              </div>
            </td>
