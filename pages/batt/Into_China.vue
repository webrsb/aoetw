    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          ...
          <p>
            <b>入主中原</b>（舊譯：進入中國）為成吉思汗(戰役)的第三關劇情關卡，此關描述<nuxt-link
              to="/civs/Mongols"
              >蒙古</nuxt-link
        ...
        <div class="n1">
          ...
          <div class="n1">
            <ol>
              <li>突厥更名黨項，人口上限由75改為125，長城內部在海岸附近多了一個海箭塔。</li>
              <li>成就「我曾到過中國」：在金蓋世界奇觀之前滅掉他。拿到攻程兵器和村民後，立刻偷渡到金國領地，在金的城南外插兩座箭塔（要延發一級箭）先射連弩兵再射村民，同時派一人繞過海箭塔和長城的射程把六座火砲拿到手，先轟掉城鎮中心，再把防禦性建築一一拆掉後，把所有村民一掃而光就可以獲得此成就。可以在此地專心發展，隨後滅掉其他三國即可。</li>
            </ol>
          </div>
        </div>
          <h2>芝麻小事</h2>
