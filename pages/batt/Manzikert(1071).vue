<template>
  ...
  <div class="container">
    ...
    <div class="row padtop">
      <div class="col-md-12">
        <h1><strong> 曼奇克托（1071）</strong></h1>
        <div class="hrn1"></div>
      </div>
      <div class="col-md-8">
        <div class="n1">
          <p>
            曼奇克托戰役為公元1071年8月26日在拜占庭帝國與塞爾柱帝國之間發生的一場戰爭，是歷史上最具影響力的戰役之一。其中拜占庭決定性戰敗和其皇帝羅曼努斯四世被俘，導致拜占庭帝國失去了安那托利亞和亞美尼亞的統治權。
          </p>
          <p>
        ...
        <div class="n1">
          ...
          <table class="table-bordered" width="100%">
            <tr>
              ...
              <td class="tc2">木頭500，食物1,000，黃金1,000，石頭0</td>
          ...
          <dl class="dl-horizontal">
            <dt>開場：</dt>
            <dd>
              輕騎兵x13，長劍兵x6，駱駝騎兵x4，馬弓騎兵x6，巨型投石車x2。（中等難度以上無巨投）
            </dd>
            <dt>出場英雄：</dt>
            <dd>無。</dd>
            <dt>大地之母單位：</dt>
          ...
          <div class="n1">
            <ul>
              <li>
                你的土耳其軍隊沒有村民，為了補充你的軍隊，必須征服拜占庭城鎮拿到貢品。
              </li>
              <li>
          ...
          <div class="n1">
            <ul>
              ...
              <li>
                拜占庭很大程度上是靠城牆和箭塔保護，你很可能需要拜占庭重裝奇兵，僧侶和典型的羅馬兵作戰。
              </li>
            </ul>
          </div>
          <h3>攻略</h3>
          ...
          <ul>
            ...
            <li>
              不需要真正擊敗對方所有建築，只要佔領城鎮中心即可（拜占庭軍隊除外）。
            </li>
            <li>
              需要大量攻城武器破城門，由於都是山區只有一條路可走，可能會有伏擊需要騎兵多加掩護。
            </li>
            <li>
              巨型投石車盡量不要死，他是唯一可以遠城破城堡有殺傷力的攻城武器。
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              如果要避免重大傷亡
              ，可以利用貼近城門打趁機溜幾隻騎兵進去城鎮中心裡面。
            </li>
            <li>
              巨型投石車盡量不要陣亡，由於很多高遠地形，很多防禦塔，城堡需要一
              靠他們拆除。
            </li>
            <li>只要擊敗拜占庭軍隊即可，不一定要佔領所有地方。</li>
            <li>
              可以多多利用衝撞車搭配巨型投石車破城門，建議先行佔領卡帕及皮西兩座城池，有利於前面補兵及攻城器具。
            </li>
          </ul>
          <h3>芝麻小事</h3>
          <div class="hrn1"></div>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="unit4">
              <nuxt-link to="/batt/Hastings">哈斯汀斯（1066）</nuxt-link>
            </td>
          </tr>
          <tr>
            <td class="unit3">下一關</td>
            <td class="unit4">
              <nuxt-link to="/batt/Agincourt">亞琴哥特（1415）</nuxt-link>
            </td>
          </tr>
        </table>
