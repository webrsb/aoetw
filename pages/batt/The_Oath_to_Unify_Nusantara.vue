    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          ...
          <p>
            <b>誓統南洋</b
            >為加查馬達戰役的第三關劇情關卡，此關描述加查馬達在成為攝政王輔佐加亞毗濕奴瓦德哈尼女王，征服南洋諸國、確立印尼疆域的經過。
          </p>
        </div>
        <h2>玩家</h2>
        <div class="hrn1"></div>
          ...
          <div class="n1">
            ...
            <div class="n1">
              <ul>
                ...
                <li>
                  我們的北邊是馬來西亞，他和亞洲大陸接壤。島上面的淡馬錫城已經脫離了他們的宗主國，而獨立而成強大的新加坡城。他們和我們爭奪殖民南洋上的無主小島，所以在他們侵擾殖民地時也會主動攻擊我們。淡馬錫以強弩兵、劍兵勇士、重騎兵、火炮、戰艦、爆破船和炮艦為主。
                </li>
              </ul>
              <h2>細節</h2>
              <div class="hrn1"></div>
