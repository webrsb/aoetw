            ...
            <div class="n1">
              ...
              <div class="n1">
                <ul>
                  ...
                  <li>
                    巽他王國&nbsp;-&nbsp;（669-1579）存在於西爪哇的古老政權。
                  </li>
                  <li>淡馬錫&nbsp;-&nbsp;（1299-1398）存在於新加坡的治權。</li>
                  <li>
                    本章節所述之「誓統南洋」，即是著名的「帕拉帕之誓」。首相加查·馬達發誓，若是不能平定印尼諸島則不再吃任何香料與水果。（按：我知道聽起來很北七，但這在滿者伯夷文化中意味著拒絕人世間一切享樂。表現出加查·馬達的決心。）
                  </li>
                </ul>
              </div>
            </div>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/Gajah_Mada/The_Oath_to_Unify_Nusantara_map.png" alt="" />
              </div>
            </td>
          </tr>
          <tr>
