    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            <b>福爾克之役</b
            >是華勒斯教學戰役的第七個劇情關卡，也是該系列的最後一關，它比其他的之前戰役更開放，可以用來回顧前六個關卡，也可以教會玩家關於城堡時代至帝王時代的重要特徵，如攻城單位、城堡和文明的特殊部隊。
          </p>
        </div>
        <h2>玩家</h2>
        <div class="hrn1"></div>
        ...
        <div class="n1">
          ...
          <ul>
            ...
            <li>
              英軍基地以西的森林裡隱藏著同盟華勒斯隊的劍兵勇士。這樣做是因為把所有的單位援軍給玩家之後避免導致華勒斯被擊敗。
            </li>
            <li>
