  ...
  <div class="container">
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            <b>羽蛇神</b>是《<nuxt-link to="/games/aoc"
          ...
          <p>
            這戰役首要的目標是擊敗特拉斯卡拉，遊戲接下來會給予一個二選一的任務，一個是收集20匹馬並帶到插旗子的地方(左下)阻止<nuxt-link
              to="/civs/Spanish"
              >西班牙人</nuxt-link
            >繼續訓練<nuxt-link to="/units/Conquistador">西班牙征服者</nuxt-link
            >，另一個是直接擊敗西班牙人。另外系統還要玩家保護同盟塔巴斯科避免他們被擊敗(史稱中央之戰)，不過即使他們落敗了也不會影響玩家。
          </p>
        </div>
        <h2>玩家</h2>
        <div class="hrn1"></div>
        <div class="n1">
          ...
          <div class="n1">
            <ul>
              ...
              <li>
                科爾特斯距離你的盟友塔巴斯科很近，可以的話盡量救援你的盟友，但如果塔巴斯科被擊敗了也不要灰心。
              </li>
          ...
          <div class="n1">
            <ul>
              ...
              <li>
                特拉斯卡拉在地圖的西邊，他們訓練<nuxt-link to="/units/Archer"
                  >弓兵</nuxt-link
                >、<nuxt-link to="/units/Elite_Skirmisher">戰矛兵</nuxt-link
                >、<nuxt-link to="/units/Monk">僧侶</nuxt-link
                >和鷹勇士。早期的進攻可以減緩他們訓練軍隊。
              </li>
              <li>
                西班牙人科爾特斯位在地圖東部。他們非常強大，擁有西班牙征服者、<nuxt-link
                  to="/units/Bombard_Cannon"
                  >火砲</nuxt-link
                >和固定數量的<nuxt-link to="/units/Cannon_Galleon"
                  >火砲戰船</nuxt-link
                >，這些都是"新世界"文明沒有的。要打敗他們的騎兵和劍兵會需要<nuxt-link
                  to="/units/Siege_Weapons"
                  >攻城武器</nuxt-link
                >，因為他們的堡壘有<nuxt-link to="/building/Bombard_Tower"
                  >火砲塔</nuxt-link
                >保護。
              </li>
            </ul>
          ...
          <ul>
            <li>
              科爾特斯有四座馬圈（用木柵欄建造），一個在地圖的北部，或者科爾代斯基地的西面（就在塔巴斯科的基地的河對面），科爾特斯基地東南有兩個，東北則有一個。作為你的盟友，塔巴斯科，會摧毀部分西方的馬圈，這是你最容易從那裡取出馬匹。但是當馬匹變成你的時候，你的敵人如果看見可能會攻擊馬匹。如果要拿取東南方的馬圈的話就需要對付科爾特斯的西班牙征服者和火砲。一旦你清除了科爾特斯的防守就可輕易地奪取東北方的馬圈。
            </li>
            <li>
              科爾特斯西班牙征服者可以用<nuxt-link to="/units/Spearman"
                >長槍兵</nuxt-link
              >，<nuxt-link to="/building/Watch_Tower">箭塔</nuxt-link
              >和<nuxt-link to="/building/Castle">城堡</nuxt-link
              >對付。另一方面，他們的火砲是一個巨大的威脅，因為他們的射程遠超過箭塔和城堡，比<nuxt-link
                to="/units/Trebuchet"
                >巨型投石機</nuxt-link
              >更有效率，因此你必須讓你的步兵隨時準備攻擊他們。然而，你也可以嘗試用你的僧侶來<nuxt-link
                to="/elements/Conversion"
                >招降</nuxt-link
              >這些<nuxt-link to="/units/Gunpowder_Unit">火藥單位</nuxt-link
              >，因為你不能自己製造它們。招降火砲需要研究<nuxt-link
                to="/techs/Redemption"
                >神聖思想</nuxt-link
              >（因為火砲是攻城單位），為了你僧侶的安全，在招降之前盡量將你的僧侶移動到火砲附近，讓火砲不能攻擊僧侶。受傷的火砲只能由村民修理。而西班牙征服者可以被僧侶治療，因為他們被認為是“<nuxt-link
          ...
          <ul>
            <li>
              初期要先把基地的四周圍一下。在此提供標準難度的成就解法：派一個村民到塔巴斯科那邊蓋碼頭生火艨艟對付西班牙人的火砲戰船，陸上部隊引誘到城鎮中心。石頭夠就幫忙蓋一座城堡防守，並派陸上部隊加強守護直至反攻。
            </li>
          </ul>
          <h3>決定版變更點</h3>
          <div class="hrn1"></div>
