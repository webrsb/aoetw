      ...
      <div class="col-md-8">
        <div class="n1">
          <div class="spw">
            <em
              ><img
                src="~assets/Subotaiicon.png"
                width="50px;"
                alt=""
                style="margin-right:20px;"
              />不要搞混了，<nuxt-link to="/units/hero/Gajah_Mada"
                >加查馬達</nuxt-link
              >這個英雄的頁面在這邊。</em
            >
          </div>
          <div class="ien">
            <em
              >在爪哇島上，一顆新星冉冉升起。加查.馬達，作為滿者伯夷的攝政王，決心要建立一個統治這片大海上數千島嶼的龐大帝國。他能否既效忠於王室，又實現自己的野心抱負？</em
            >
        ...
        <div class="n1">
          ...
          <div class="n1">
            ...
            <ul>
              ...
              <li>加查‧馬達的權力之路：</li>
              加查馬達最早是以皇家侍衛的身分進入滿者伯夷王廷的。在1321年的政變中，他巧妙地運用機智讓國王查雅納迦拉平安逃離王城。並協助其重返王位而一躍成為宮相。隨後主君查雅納迦拉遭到暗殺，其女瓦德哈尼即位，加查馬達依然擔起宮相重任，並大肆擴張領地，讓滿者伯夷成為南洋霸主。在女王之子新君烏魯克登基後，加查馬達依然擔任宮相，並將現今印尼範圍劃入領地之內。真正的權力危機是對巽他王國的併吞聯姻，加查馬達因為聯姻條件難以談攏而將整個事件升級為武裝衝突，最終導致巽他國王被殺、而公主也自盡。這讓主君烏魯克十分不滿，一度將他撤職。雖然隨後又將他召回擔任原職。
              <li>加查馬達評價：</li>
              在印尼普遍被視為民族英雄，由於擔任三代宮相，地位極為尊崇。至今仍然有相關的民俗文藝表演流傳。唯一的負面評價來自於《列王傳》中的紀載。文中指出主君查雅納迦拉遭到御醫毒殺的事件實為加查馬達所策畫，因為主君與加查馬達之妻有染。但此事早已不可追考。
            </ul>
          </div>
        </div>
      </div>
