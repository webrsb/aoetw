    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            <b>揭竿而起</b>為<nuxt-link to="/batt/Suryavarman_I"
              >蘇利耶跋摩一世戰役</nuxt-link
            >的第一關劇情關卡，此關描述<nuxt-link to="/units/hero/Suryavarman_I"
              >蘇利耶跋摩一世</nuxt-link
            >襲殺主君<nuxt-link to="/units/hero/Udayadityavarman_I"
              >優陀耶迭多跋摩一世</nuxt-link
            >、取得吳哥城控制權的經過。
          </p>
        </div>
        ...
        <div class="n1">
          ...
          <table class="table-bordered" width="100%">
            <tr>
              ...
              <td class="tc2">
                900<nuxt-link to="/resource/Wood">木材</nuxt-link
        ...
        <div class="n1">
          <ul>
            <li>
              蘇利耶跋摩一世勇猛過人，親自衝鋒陷陣。但要是他的坐騎<nuxt-link
                to="/units/War_Elephant"
                >戰象</nuxt-link
              >受傷，他就必須返回大營療傷。
            </li>
            <li>
              摧毀優陀耶迭多跋摩一世的大營能阻止敵人反撲的攻勢，但你最終還是得攻入吳哥城。
            </li>
            <li>
              吳哥高城深池，重兵防禦。所以若想攻進城內，你勢必得帶一些<nuxt-link
                to="/units/Siege_Weapons"
                >攻城武器</nuxt-link
              >。
            </li>
            <li>
              高棉的<nuxt-link to="/units/Ballista_Elephant">弩砲象</nuxt-link
              >威力巨大，善於射殺成群的敵人
            </li>
            <li>
              蘇利耶跋摩一世只能升級到<nuxt-link to="/techs/age/Castle_Age"
                >城堡時代</nuxt-link
              >，人口上限為100。
            </li>
          </ul>
          ...
          <div class="n1">
            <ul>
              <li>
                蘇利耶跋摩一世(水藍)在地圖西面紮營，從他的據點隨時可以像吳哥城發起進攻。
              </li>
              <li>
                優陀耶迭多跋摩一世的軍隊(紅色)把他在前線部隊集中在三個營地，其中兩個分別守住了吳哥的西路與南路，另一個營地則守衛著蘇利耶跋摩一世在東南邊的貿易要道。他們偶剛徵募的<nuxt-link
                  to="/units/Pikeman"
                  >重裝長槍兵</nuxt-link
              ...
              <li>
                吳哥城(橘色)在地圖的東北面，他們的守城部隊以<nuxt-link
                  to="/units/Crossbowman"
                  >弩兵</nuxt-link
                >、<nuxt-link to="/units/Infantry_Units">步兵</nuxt-link
                >與輕騎兵為主，但也會訓練<nuxt-link to="/units/Monk"
                  >僧侶</nuxt-link
                >及象兵。
              </li>
              <li>
                優陀耶迭多跋摩一世(黃色)身居於吳哥城中，由貼身侍衛保護。若是城被攻破，這些侍衛會誓死護駕。
              </li>
              <li>
                南邊有一座中立的村莊(灰色)。如果我們能夠把貿易線上的敵人給淨空，我們便能與該村貿易互通。
              </li>
            </ul>
            <h2>細節</h2>
            <div class="hrn1"></div>
            <div class="n1">
              <ul>
                <li>
                  蘇利耶跋摩一世(?-1050)在本關的形象為<nuxt-link
                    to="/units/Elite_Battle_Elephant"
                    >精銳矛象伕</nuxt-link
                  >。
                </li>
                <li>
                  在漢化中，遊戲者2的名稱為「烏達雅耶迭多跋摩的軍隊」，其實指的就是「優陀耶迭多跋摩一世」。
                </li>
                <li>
                  根據說明：在這關中。蘇利耶跋摩一世並不會真的「死掉」。他只是不會再從本關出現了。(那跟死的差別在哪？)
                </li>
                <li>
                  優陀耶迭多跋摩(?-1002)吳哥王朝君主，由於和前任君主闍耶跋摩五世並無血系，因此統治權力十分不穩固。在即位數月後便遭到殺害。
                </li>
              </ul>
            </div>
          </div>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/Suryavarman_I/Usurpation_map.png" alt="" />
              </div>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit4">
              <nuxt-link to="/games/aor">王者崛起</nuxt-link>第二章之一
            </td>
          </tr>
          <tr>
