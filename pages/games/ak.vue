    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          <p>
            非洲王國是AOE
            HD版繼失落的帝國後的第二張資料片，也是世紀帝國第三張資料片，此次主題著重於非洲大陸，四個文明有三個來自於非洲。並且新增了一些遊戲功能。
          </p>
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              <strong>衣索比亞:</strong>讓<a href="http://tinyurl.com/yc45cyps"
                >阿克蘇姆帝國</a
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="unit4">
              帝王世紀 <br />征服者入侵 <br />失落的帝國 <br />王者崛起
            </td>
          </tr>
        </table>
      ...
      <div class="col-md-12">
        ...
        <div class="n1">
          ...
          <ul>
            <li>
              馬弓騎兵花費減少的程度，城堡與帝王時代從-25%/-30%改為-10%/-20%
            </li>
          ...
          <ul>
            <li>
              村民花費，四時代 從 -5%/-10%/-15%/-20% 改為 -10%/-15%/-20%/-25%
              獲得 公會制度、弓兵三防
            </li>
          ...
          <ul>
            <li>
              種田速率從 1.18倍 改為 1.31倍（實際效率成為 輪軸後 +15%，手推車後
              +5%）
            </li>
          </ul>
          西班牙
          ...
          <ul>
            ...
            <li>
              狂戰士、精銳狂戰士：生命值變為54/62(原為52/60)，訓練時間-2秒(原為16秒)
            </li>
