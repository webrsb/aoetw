       ...
       <h3>單位</h3>
        ...
        <div class="n1">
          <ul>
            ...
            <li>
              <strong>馬鐙</strong>:保加利亞特殊科技。斥侯系與保加利亞騎兵攻擊速度+25%。
            </li>
            <li>
              <strong>協議</strong>:保加利亞特殊科技。民兵系近戰護甲+3。
            </li>
          </ul>
         </div>
          <h3>利益</h3>
        ...
        <div class="n1">
          <ul>
            <li>
              <strong>韃靼</strong>:綿羊多50%肉量。單位的高地傷害加成多25%(額外加在一般高地傷害上)。安息人戰術免費。
            </li>
            <li>
              <strong>保加利亞</strong>:民兵系升級免費(但無劍兵勇士)。建造城鎮中心只花50石頭。可蓋堡壘。
            </li>
          </ul>
         </div>
        <h5>團隊利益</h5>
        <div class="n1">
          <ul>
            <li>
              <strong>韃靼</strong>:馬弓騎兵視野+2。
            </li>
            <li>
              <strong>保加利亞</strong>:兵工廠工作效率+50%。
            </li>
          </ul>
         </div>
          <h3>戰役</h3>
