  ...
  <div class="container">
    <div class="row padtop">
      ...
      <div class="col-md-8">
        ...
        <div class="n1">
          <ul>
            <li>
              ...
              >:150肉
              100金，民兵系成本-15食物，除中國，庫曼，哥德，匈奴，高棉，立陶宛，馬雅，蒙古，韃靼之外所有文明皆有。
            </li>
          </ul>
        </div>
        <h5>特殊科技</h5>
        ...
        <div class="n1">
          <ul>
            <li>(精銳)標槍騎兵對長槍兵系攻擊+2。</li>
          </ul>
        </div>
        <h5>不列顛</h5>
        <div class="n1">
          <ul>
            <li>特殊科技戰狼成本增為800木400金(原500木250金)。</li>
          </ul>
        </div>
        <h5>法蘭克</h5>
        <div class="n1">
          <ul>
            <li>騎兵+20%生命值的利益改為封建時代開始。</li>
          </ul>
        </div>
        <h5>印加</h5>
        <div class="n1">
        ...
        <div class="n1">
          <ul>
            <li>雇傭兵重新命名為科維尼安軍隊。</li>
          </ul>
        </div>
        <h5>碼來</h5>
        <div class="n1">
          <ul>
            <li>海港最小射程由0增加為1。需要城垛射孔才能減為0。</li>
            <li>海港基礎攻擊力由6降為3。對船艦額外攻擊由9增加為10。</li>
            <li>強制徵兵將原本的黃金成本改為增加額外食物成本(沒有移除)。</li>
            <li>強制徵兵成本由1000肉600金降為850肉500金。</li>
          </ul>
        </div>
        <h5>馬利</h5>
        <div class="n1">
        ...
        <div class="n1">
          <ul>
            <li>增加(精銳)羽毛箭射手的基礎造價(+5木+5金)。</li>
          </ul>
        </div>
        <h5>蒙古</h5>
        <div class="n1">
          <ul>
            <li>被摧毀的房子不再受游牧科技影響能支撐人口。</li>
          </ul>
        </div>
        <h5>波斯</h5>
        <div class="n1">
        ...
        <div class="n1">
          <ul>
            <li>弓兵系在封建/城堡/帝王時代對標準建築攻擊力+1/+2/+3。</li>
            <li>所有馬弓騎兵在封建/城堡/帝王時代對標準建築攻擊力+2/+3/+4。</li>
            <li>市集造價-100木(之前是-75木)。</li>
            <li>(精銳)奴隸兵減少開火間隔。</li>
            <li>戟兵對奴隸兵攻擊力-5。</li>
          </ul>
        </div>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="unit4">
              Tantalus <br />Forgotten Empires<br />Wicked Witch
            </td>
          </tr>
          <tr>
          ...
          <tr>
            <td class="unit3">遊玩平台</td>
            <td class="unit4">Windows 10</td>
          </tr>
          <tr>
            <td class="unit" colspan="2" style="background-color:#356a98;">
          ...
          <tr>
            ...
            <td class="unit4">
              ...
              <br /><nuxt-link to="/games/aoc">征服者入侵</nuxt-link>
          ...
          <div style="margin-left: 60px;">
            ...
            <div style="margin-left: 10px;">
              <i
                ><b
                  ><a
                    href="https://ageofempires.fandom.com/wiki/Age_of_Empires_II:_Definitive_Edition"
                    target="_blank"
                    >Age of Empires II: Definitive Edition</a
                  ></b
                ></i
              >
            </div>
