<template>
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <table class="table" style="margin-top:50px;">
          ...
          <tr>
            ...
            <td class="t15 trm">
              <img class="gg" src="~assets/ArbalestIcon.jpg"><a href="Arbalest.php"><div>強弩兵</div></a>
            </td>
            <td class="t15 trm not">
              <img class="gg" src="~assets/Imperialskirmishericon.png"><a href="Imperial_Skirmisher.php"><div>帝王戰矛兵</div></a>
            </td>
            <td class="t15 trm ">
              <img class="gg" src="~assets/HeavyCavArcherIcon.jpg"><a href="Heavy_Cavalry_Archer.php"><div>重裝馬弓騎兵</div></a>
            </td>
            <td class="t15 trm ">
              <img class="gg" src="~assets/HandCannoneerIcon.jpg"><a href="Hand_Cannoneer.php"><div>火槍兵</div></a>
            </td>
            <td class="t15 trm not">
              <img class="gg" src="~assets/GenitourIcon.jpg"><a href="Genitour.php"><div>精銳標槍騎兵</div></a>
            </td>
            <td class="t15 trm not">
              <img class="gg" src="~assets/Parthian-Tactics.jpg"><a href="Parthian_Tactics.php"><div>帕提亞戰術</div></a>
            </td>
          </tr>
        </table>
        <table class="table" style="margin-top:50px;">
    ...
    <table class="table" style="margin-top:50px;">
      <tr>
        <td class="trm" colspan="5" style="border-top: none;"> <a href="Town_Center.php"><img class="ng" src="~assets/Towncentericon.png" alt=""></a> 
