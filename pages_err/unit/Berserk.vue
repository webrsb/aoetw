          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4">
                ...
                <br/>
                <img class="gg" src="~assets/Unique-tech.jpg" width="30" alt=""><a href="Chieftains.php">酋長</a>:步兵對<a href="Armor_Class_Cavalry.php">騎兵</a>攻擊+5，對
                <a
        ...
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="unit4">
                <img class="gg" src="~assets/Castle-age-reseach.jpg" alt=""><a href="Castle_Age.php">城堡時代</a>:61
                <br/>
                <img class="gg" src="~assets/Imperial-age-research.jpg" alt=""><a href="Imperial_Age.php">帝王時代</a>:64/75(精銳)</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4">
                <img class="gg" src="~assets/VBRSK.jpg" alt="">精銳狂戰士</td>
            </tr>
            <tr>
              <td class="unit3">升級成本</td>
              <td class="unit4">
                <img class="gg" src="~assets/Elite-unique-research.jpg" alt="">1300食物550黃金</td>
            </tr>
            <tr>
