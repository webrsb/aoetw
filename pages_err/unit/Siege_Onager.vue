          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4">
                ...
                <br/>
                <img src="~assets/Unique-tech.jpg" class="gg" alt=""><a href="Torsion_Engines.php">扭力彈射器</a>：攻城器製造所的單位傷害範圍增加。<a href="Ethiopians.php">衣索比亞</a>限定</td>
            </tr>
            <tr>
        ...
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="unit4">
                <img class="gg" src="~assets/Siege-workshop-logo.jpg" width="30" alt=""><a href="Siege_Workshop.php">攻城器製造所</a>
              </td>
            </tr>
            <tr>
