        ...
        <div class="col-md-12">
          ...
          <div class="n1">下列的單位都是騎兵系單位
            <ul>
              ...
              <li>
                <img class="gg" src="~assets/CataphractIcon.jpg" alt=""><a href="Cataphract.php">聖騎兵</a>(12)→
              ...
              <li>
                <img class="gg" src="~assets/WarElephantIcon.jpg" width="22" alt=""> <a href="War_Elephant.php">戰象</a>→
                <img class="gg" src="~assets/WarElephantIcon.jpg"
                width="22" alt=""> <a href="War_Elephant.php">精銳戰象</a>(<a href="Persians.php">波斯</a>限定)</li>
              <li>
                <img class="gg" src="~assets/Saracenmamluk_icon.png" alt=""><a href="Mameluke.php">奴隸兵</a>(11)→
            ...
            class="n1">
              <div class="col-md-12">
                ...
                <div class="col-md-4">
                  ...
                  <ul>
                    <li>
                      <img class="gg" style="margin: 2px;" src="~assets/MilitiaIcon.jpg" alt=""> <a href="Militia.php">民兵</a>→
