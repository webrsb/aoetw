            ...
            <div class="n1">
              <div class="col-md-12">
                ...
                <div class="col-md-6">
                  ...
                  <ul>
                    <li>
                      <img src="~assets/OrganGunIcon.jpg" alt=""><a href="OrganGun.php">風琴炮</a>→
                      <img src="~assets/OrganGunIcon.jpg" alt=""><a href="OrganGun.php">精銳風琴炮</a>(<a href="Portugese.php">葡萄牙</a>限定)</li>
                  </ul>
                  <ul>
                    <li>
