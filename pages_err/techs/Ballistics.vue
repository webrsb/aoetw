<template>
    ...
    <div class="container">
      ...
      <div class="row padtop">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>彈道學可於<a href="/techsage/Castle_Age">城堡時代</a>在<a href="/building/University">學院</a>研發。可讓弓箭手、船隻、
              <a
              href="/building/Castle">城堡</a>、箭塔(包含<a href="/building/Bombard_Tower">火砲塔</a>)和<a href="/building/Town_Center">城鎮中心</a>對移動目標的準確率大幅上升。</p>
          ...
          <div class="n1">
            <ul>
              <li><a href="/civs/Malians">馬利</a>：彈道學研發時間快80%</li>
            </ul>
          </div>
           <h3>更新日誌</h3>
          <div class="hrn1"></div>
          <div class="n1">
            ...
            <ul>
              <li><a href="/civs/Spanish">西班牙</a>:火炮戰船受彈道學影響。</li>
            </ul>
             <h3><em><a href="/games/aof">失落的帝國</a></em></h3>
            <ul>
              <li><a href="/civs/Spanish">西班牙</a>:即使沒有研發彈道學火炮戰船的攻擊自身有彈道學。</li>
            </ul>
          </div>
           <h3>歷史</h3>
          <div class="hrn1"></div>
        ...
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="unit4">可讓弓箭手、船隻、<a href="/building/Castle">城堡</a>、箭塔(包含<a href="/building/Bombard_Tower">火砲塔</a>)和
                <a
                href="/building/Town_Center">城鎮中心</a>對移動目標的準確率大幅上升。</td>
            </tr>
          </table>
