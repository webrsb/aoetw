<template>
    ...
    <div class="container">
      ...
      <div class="row padtop">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>精銳矛象伕是帝王時代兵種，可訓練於馬廄，與波斯戰像相似，會對周遭單位產生<a href="/elements/Area_of_Effect">擴散傷害</a>，但擴散半徑較小。他們移動緩慢容易受到範圍傷害的單位攻擊，也容易被僧侶招降。</p>
          ...
          <div class="n1">
            ...
            <ul>
              ...
              </li>高棉的矛象伕移動速度快15%，使得他們更不怕<a href="/units/Monk">僧侶</a>，且城堡時代的特殊科技<a href="/techs/Tusk_Swords">象牙劍</a>就可以讓矛象伕攻擊+3，攻擊達到了17，而且兵工廠和馬廄有全騎兵升級科技。絕對是所有大象中近戰威力最強的，不過高棉沒有
              <a
              href="/techs/Faith">忠誠信仰</a>和<a href="/techs/Heresy">異端邪說</a>，這讓高棉的矛象伕容易被僧侶招走。</ul>
            <ul>
          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4"><a href="/units/Pikeman">重裝長槍兵</a>、<a href="/units/Kamayuk">槍隊長</a>、<a href="/Genoese_units/Crossbowman">熱那亞弩手</a>、
                <a
                href="/units/Mameluke">奴隸兵</a>、<a href="/Cavalry_units/Archer">馬弓騎兵</a>、<a href="/units/Monk">僧侶</a>、
                  <a
                  href="/units/Scorpion">弩炮</a>、和<a href="/War_unitsanimal/Elephant">戰象</a>。</td>
            </tr>
            <tr class="tta">
              <td class="unit" colspan="2" style="text-align: center;">
          ...
          <div class="n1">
            <ul>
              ...
              <li><a href="/civs/Khmer">高棉</a>：精銳矛象伕移動速度加快15%。</li>
              <li><a href="/civs/Malay">馬來</a>：精銳矛象伕便宜30%。</li>
          ...
          <div class="n1">
            <ul>
              <li><a href="/civs/Berbers">柏柏</a>：<a href="/techs/Kasbah">聚居堡壘</a>能夠加速<a href="/techs/Conscription">徵兵制度</a>和對精銳矛象伕有利科技的研究時間(快25%)。</li>
              <li><a href="/civs/Huns">匈奴</a>：精銳矛象伕生產效率和升級快20%，<a href="/techs/Bloodlines">品種</a>與
                <a
                href="/techs/Husbandry">畜牧技術</a>研發快20%。</li>
              <li><a href="/civs/Teutons">條頓</a>：精銳矛象伕對僧侶抵抗力更強。</li>
            </ul>
          </div>
           <h3>更新日誌</h3>
          <div class="hrn1"></div>
          <div class="n1">
            ...
            <ul>
              <li><a href="/civs/Malay">馬來</a>:精銳矛象伕最初便宜20%，5.3版後便宜25%，5.7版後便宜30%。</li>
          ...
          <div class="n1">
            <ul>
              <li>完全升級的<a href="/civs/Burmese">緬甸</a>精銳矛象伕會有9的遠防，是所有騎兵單位中最高的(與<a href="/Elephant_units/Archer">象弓騎兵</a>並列)。</li>
              <li>完全升級的<a href="/civs/Khmer">高棉</a>精銳矛象伕有23的攻擊力，是所有單位中除去攻城器和火藥單位外第二高的，只有精銳
                <a
                href="/War_unitsanimal/Elephant">波斯戰象</a>比牠高(24)。</li>
              <li>完全升級的<a href="/civs/Vietnamese">越南</a>精銳矛象伕有370的HP，只輸給精銳<a href="/War_unitsanimal/Elephant">波斯戰象</a>的620HP。</li>
            </ul>
          </div>
           <h3>歷史</h3>
          <div class="hrn1"></div>
        ...
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="unit4">+10對<a href="/armor/Armor_Class_stone_defense">石材建築類</a>
                <br/>+10對<a href="/armor/Armor_Class_Building">建築類</a>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4">
                <img class="gg" src="~assets/Battleelephanticon.png" width="45" alt=""><a href="/units/Battle_Elephant">矛象伕</a>
              </td>
            </tr>
          </table>
        </div>
      ...
      <div class="col-md-12">
        ...
        <div class="n1">
          <div class="col-md-12">
            ...
            <div class="col-md-4"> <a href="/img/Elitebattleelephant.png"><img class="imgn hg" src="~assets/Elitebattleelephant.png" alt=""></a> 
              <p><em>一群精銳矛象伕。</em>
              </p>
            </div>
          </div>
