        ...
        <div class="col-md-8">
          <div class="n1">
            <p>征服者是<nuxt-link to="/games/aoc">征服者入侵</nuxt-link>資料片中<nuxt-link to="/civs/Spanish">西班牙</nuxt-link>的特殊單位，能夠在
              <nuxt-link to="/techsage/Castle_Age">城堡時代</nuxt-link>的<nuxt-link to="/building/Castle">城堡</nuxt-link>中訓練。是個高裝甲且騎馬的火藥單位。</p>
            <p>征服者可以在<nuxt-link to="/techsage/Imperial_Age">帝王時代</nuxt-link>升級為精銳征服者。</div>
           <h3>戰術要點</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
