<template>
    ...
    <div class="container">
      ...
      <div class="row padtop">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>征服者是<nuxt-link to="/games/aoc">征服者入侵</nuxt-link>資料片中<nuxt-link to="/civs/Spanish">西班牙</nuxt-link>的特殊單位，能夠在
              <nuxt-link to="/techs/age/Castle_Age">城堡時代</nuxt-link>的<nuxt-link to="/building/Castle">城堡</nuxt-link>中訓練。是個高裝甲且騎馬的火藥單位。</p>
            <p>征服者可以在<nuxt-link to="/techs/age/Imperial_Age">帝王時代</nuxt-link>升級為精銳征服者。</div>
           <h3>戰術要點</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              <li>征服者是具有高攻擊力的騎兵，但和<nuxt-link to="/Cavalry_units/Archer">馬弓騎兵</nuxt-link>的玩法類似。征服者在機動性和持久性方面比
                <nuxt-link to="/units/Hand_Cannoneer">火槍兵</nuxt-link>具有優勢。雖然他們是最短距離的火藥單位，也不像<nuxt-link to="/Cavalry_units/Archer">馬弓騎兵</nuxt-link>受益於科技的範圍增加，他們的機動性使他們變得強大而且致命，讓他們非常適合使用打帶跑戰術。在團隊中他們可以製造巨量傷害破壞敵人的陣型。征服者經常搭配
                  <nuxt-link to="/units/Knight">騎士</nuxt-link>吸收遠程單位的傷害，而征服者則殺死敵人的<nuxt-link to="/units/Monk">僧侶</nuxt-link>。敵軍騎兵對征服者來說是一個巨大的威脅，尤其是
                    <nuxt-link to="/units/Camel">駱駝騎兵</nuxt-link>。<nuxt-link to="/units/Siege_Weapons">攻城武器</nuxt-link>也是，所以戰鬥時不應該在同一地點停留太久。<nuxt-link to="/units/Halberdier">戟兵</nuxt-link>可以傷到征服者，只要他們能追到征服者。<nuxt-link to="/units/Imperial_Skirmisher">帝王戰矛兵</nuxt-link>也是有效的，雖然不如對付<nuxt-link to="/Cavalry_units/Archer">馬弓騎兵</nuxt-link>那樣有效，而且征服者打他們也很痛。
            </li>
            </ul>
          </div>
           <h3>更多數據</h3>
          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4"><nuxt-link to="/units/Infantry_Units">步兵</nuxt-link>、<nuxt-link to="/units/Battering_Ram">衝撞車</nuxt-link>。</td>
            </tr>
            <tr>
              <td class="tta1" style="width:30%">劣勢(不易對抗)</td>
              <td class="tta4"><nuxt-link to="/units/Kamayuk">槍隊長</nuxt-link>、<nuxt-link to="/units/Berserk">狂戰士</nuxt-link>、<nuxt-link to="/Genoese_units/Crossbowman">熱那亞弩手</nuxt-link>、
                <nuxt-link to="/units/Huskarl">哥德衛隊</nuxt-link>、<nuxt-link to="/units/Condottiero">傭兵</nuxt-link>、<nuxt-link to="/units/Mameluke">奴隸兵</nuxt-link>、
                  <nuxt-link to="/units/Camel">駱駝騎兵</nuxt-link>、<nuxt-link to="/units/Elite_Skirmisher">戰矛兵</nuxt-link>、<nuxt-link to="/units/Eagle_Warrior">鷹勇士</nuxt-link>、
                    <nuxt-link to="/units/Mangonel">投石車</nuxt-link>、<nuxt-link to="/units/Spearman">重裝長槍兵</nuxt-link>、<nuxt-link to="/units/Samurai">日本武士</nuxt-link>。</td>
            </tr>
            <tr class="tta">
              <td class="unit" colspan="2" style="text-align: center;">
            ...
            <tr>
              ...
              <td class="tta4">
                <img class="gg" src="~assets/Husbandry.jpg" width="30" alt=""><nuxt-link to="/techs/Husbandry">畜牧培養</nuxt-link>(+10%)</td>
            </tr>
            <tr>
          ...
          <div class="n1">以下單位擁有對征服者的額外傷害，按造傷殺力排列。
            ...
            <div class="n1"><nuxt-link to="/civs/Persians">波斯</nuxt-link>在團隊加成裡，給予以下單位+2額外攻擊vs<nuxt-link to="/units/Archer_Units">弓兵單位</nuxt-link>。
              <div
              class="col-md-12">
                <div class="col-md-6">
        ...
        <div class="n1">
          <ul>
            <li><nuxt-link to="/civs/Spanish">西班牙</nuxt-link>：兵工廠加成征服者的科技不需花費黃金。</li>
          </ul>
        </div>
         <h3>團隊加成</h3>
        <div class="hrn1"></div>
        <div class="n1">
          <ul>
            <li><nuxt-link to="/civs/Berbers">柏柏</nuxt-link>：<nuxt-link to="/techs/Kasbah">聚居堡壘</nuxt-link>能夠提高征服者的生產速度還有加速徵兵技術的研究時間(快25%)</li>
            ...
            <li><nuxt-link to="/civs/Teutons">條頓</nuxt-link>：征服者更不容易被招降。</li>
            <li><nuxt-link to="/civs/Turks">土耳其</nuxt-link>：征服者訓練速度快20%。</li>
          </ul>
        </div>
         <h3>歷史</h3>
        <div class="hrn1"></div>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/ConquistadorIcon.jpg" width="45" alt="">
              </div>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit4"><nuxt-link to="/units/Cavalry_Units">騎兵</nuxt-link>、<nuxt-link to="/units/Gunpowder_Unit">火藥單位</nuxt-link>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit4">對<nuxt-link to="/armor/Armor_Class_Ram">衝撞車</nuxt-link>攻擊+4/+6(精銳)
              <br/>對<nuxt-link to="/armor/Armor_Class_Building">建築物</nuxt-link>+2</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit4"><nuxt-link to="/armor/Armor_Class_Archer">弓兵</nuxt-link>
              <br/> <nuxt-link to="/armor/Armor_Class_Cavalry_Archer">騎兵</nuxt-link>
          ...
          <tr>
            ...
            <td class="unit4">
              <img class="gg" src="~assets/ConquistadorIcon.jpg" alt="">精銳征服者</td>
          </tr>
          <tr>
            <td class="unit3">升級成本</td>
            <td class="unit4">
              <img class="gg" src="~assets/Elite-unique-research.jpg" alt="">1200食物600黃金</td>
          </tr>
          <tr>
      ...
      <div class="col-md-12">
        ...
        <div class="n1">
          <div class="col-md-12">
            <div class="col-md-4"> <nuxt-link to="/img/Conquistadorgroup.png"><img class="imgn hg" src="~assets/Conquistadorgroup.png" alt=""></nuxt-link> 
              <p><em>一群征服者</em>
              </p>
            </div>
          </div>
