<template>
    ...
    <div class="container">
      ...
      <div class="row padtop">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>卡拉維爾戰船是<a href="/games/ak">非洲王朝</a>資料片中<a href="/civs/Portuguese">葡萄牙</a>的第二個特殊單位。在城堡時代時可以在碼頭中訓練。它是艘可以像弩炮一樣傷害多個單位的戰船。</p>
          ...
          <div class="n1">
            ...
            <p>卡拉維爾戰船在大多數戰鬥表現中都比<a href="/War_units/Galley">弩炮戰船</a>好，然而在1對1的戰鬥中他們會輸給弩炮戰船，精銳卡拉維爾戰船則會輸給重型弩炮戰船。若是論打群架，卡拉維爾戰船則可以輕易地用穿透傷害戰勝他們。</p>
            <p>卡拉維爾戰船只比<a href="/War_units/Galley">弩炮戰船</a>貴一點，但是到城堡時代不需升級就能馬上訓練。在後期如果要同時訓練卡拉維爾戰船和弩炮戰船/
              <a
              href="/units/Galleon">重型弩炮戰船</a>的話玩家的經濟必須相當的好才行。但如果同時有這兩種船隻的話前者可以做輸出主力，後者則做肉盾，足以應付敵方的任何艦隊。</p>
          </div>
           <h3>更多數據</h3>
          <div class="hrn1"></div>
          <div class="n1"></div>
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4"><a href="/units/Transport_Ship">運輸船</a>、<a href="/units/Fishing_Ship">漁船</a>、在岸邊的
                <a
                href="/building/bulding">建築物</a>和近戰單位、<a href="/units/Cannon_Galleon">火炮戰船</a>、群體單位。</td>
            </tr>
            <tr>
              <td class="tta1" style="width:30%">劣勢(不易對抗)</td>
              <td class="tta4"><a href="/units/Fire_Galley">火戰船</a>、<a href="/units/Turtle_Ship">龜甲船</a>、
                <a
                href="/units/Longboat">維京大戰船</a>、箭塔、<a href="/building/Castle">城堡</a>、<a href="/units/Mangonel">投石車</a>、
                  <a
            ...
            <tr>
              ...
              <td class="tta4">
                ...
                <br/>
                <img class="gg" src="~assets/CastleAgeUnique.png" style="margin: 2px;" alt=""><a href="/techs/Carrack">克拉克帆船</a>(護甲+1/+1)</td>
            </tr>
            <tr>
              ...
              <div class="col-md-12">
                <div class="col-md-6">
                  ...
                  <ul>
                    ...
                    <li>
                      <img class="gg" src="~assets/LongboatIcon.jpg" alt=""><a href="/units/Longboat">精銳維京大戰船</a>(<a href="/civs/Vikings">維京</a>限定)</li>
                  </ul>
          ...
          <div class="n1">
            <ul>
              <li><a href="/civs/Portuguese">葡萄牙</a>：卡拉維爾戰船訓練減少15%黃金成本，HP+10％。</li>
            </ul>
          </div>
           <h3>團隊加成</h3> 
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              ...
              <li><a href="/civs/Teutons">條頓</a>：卡拉維爾戰船對招降的抵抗力更強。</li>
            </ul>
          </div>
           <h3>豆知識</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              <li>卡拉維爾戰船會對作弊單位中的<a href="/units/hero/Saboteur">破壞者</a>有額外攻擊加成(從<a href="/games/aoc">征服者入侵</a>資料片開始)，因為該單位屬於船隻單位。</li>
        ...
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="unit4">+6/+7(精銳)對<a href="/armor/Armor_Class_Ship">船</a>
                <br/>+8/+9(精銳)對<a href="/armor/Armor_Class_Building">建築</a>
            ...
            <tr>
              ...
              <td class="unit4">
                <img class="gg" src="~assets/CaravelIcon2.jpg" alt=""><a href="/units/Caravel">精銳卡拉維爾戰船</a>
              </td>
            </tr>
            <tr>
