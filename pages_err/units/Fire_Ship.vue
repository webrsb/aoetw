        ...
        <div class="col-md-8">
          <div class="n1">
            <p>火戰船在城堡時代的時候可以在碼頭中被訓練。這是一艘有"火焰噴射器"的船，對其他的船隻有攻擊加成。火戰船需要很靠近敵方船隻，並且用超級快的速度(每秒4次)。當
              <a
              href="/units/Galley">戰船</a>升級成<a href="/War_units/Galley">弩炮戰船</a>的時候，火蒙衝會自動升級成火戰船。</p>
            <br/>
            <p><strong>不可生產文明：</strong><a href="/civs/Vikings">維京</a>
            </p>
          </div>
           <h3>戰術</h3> 
          <div class="hrn1"></div>
          <div class="n1">
            <p>火戰船能夠壓制大部分的船，並且能夠造成巨大的傷害。火戰船也可以用來對付陸地單位，效果也是不錯。但是，因為火戰船需要很靠近敵人，所以<a href="/units/Demolition_Raft">自爆筏</a>很大的克制噴火船。
              <a
              href="/civs/Koreans">韓國</a>的<a href="/units/Turtle_Ship">龜甲船</a>也能夠威脅到火戰船。火戰船雖然有非常快的攻擊速度，但是每一個"火焰"的攻擊力很低。雖然攻擊力偏低，但是還是能對船造成不俗的傷害。</p>
            <p>儘管火戰船對船有傷害力也有著很高的防禦力，但是城堡時代的火戰船還是比<a href="/War_units/Galley">弩炮戰船</a>的速度慢。所以需要適當的戰術，攻其不備。當火戰船升級成
              <a
              href="/units/Fast_Fire_Ship">重型火戰船</a>後，倒是能夠輕易地追上<a href="/units/Galleon">重型弩砲戰船</a>。</p>
          </div>
          <h3>更多數據</h3>
          <div class="hrn1"></div>
          <div class="n1"></div>
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4"><a href="/units/Transport_Ship">運輸船</a>、<a href="/units/Fishing_Ship">漁船</a>、在岸邊的建築物和近戰單位、
                <a
                href="/War_units/Galley">弩炮戰船</a>、<a href="/units/Cannon_Galleon">火炮戰船</a>。</td>
            </tr>
            <tr>
          ...
          <div class="n1">
            <ul>
              <li><a href="/civs/Berbers">阿茲特克</a>：火戰船訓練速度提高15%。</li>
              <li><a href="/civs/Berbers">柏柏</a>：火戰船移動速度提高10％。</li>
              <li><a href="/civs/Burmese">緬甸</a>：研究<a href="/techs/Faith">忠誠信仰</a>便宜50％。</li>
              <li><a href="/civs/Byzantines">拜占庭</a>：火戰船開火速率快25%。</li>
              <li><a href="/civs/Celts">賽爾特</a>：在視野內的動物不會被轉化</li>
              <li><a href="/civs/Chinese">中國</a>：有利於火戰船科技在城堡/帝王便宜15%/20％</li>
              <li><a href="/civs/Italians">義大利</a>：研究<a href="/techs/Careening">傾側維修術</a>，
                <a
                href="/Dry building/Dock">旱碼頭</a>和<a href="/techs/Shipwright">造船匠</a>便宜50％，升級到快速火戰船便宜50%。</li>
              <li><a href="/civs/Persians">波斯</a>：火戰船在城堡/帝王時代訓練的速度提高15/20% <a href="/techs/Careening">傾側維修術</a>和升級到
                <a
                href="/units/Fast_Fire_Ship">快速火戰船</a>的研發速度在城堡/帝王時代提高15%/20％。研究<a href="/Dry building/Dock">旱碼頭</a>的速度快20％。</li>
              <li><a href="/civs/Portuguese">葡萄牙</a>：火戰船訓練減少15%黃金成本，火戰船+10％HP。</li>
            </ul>
          </div>
           <h3>團隊加成</h3> 
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              ...
              <li><a href="/civs/Teutons">條頓</a>：火戰船對招降的抵抗力更強。</li>
            </ul>
          </div>
          <h3>更新日誌</h3>
          <div class="hrn1"></div>
          <div class="n1">
            ...
            <ul>
              ...
              <li>4.8版本後火戰船會受到<a href="/techs/Ballistics">彈道學</a>的影響。</li>
            </ul>
            ...
            <tr>
              ...
              <tr>
                ...
                <td class="unit4">+3對<a href="/armor/Armor_Class_Ship">船</a> 
                  <br/>+2對<a href="/armor/Armor_Class_Turtle_Ship">龜甲船</a> 
                  <br/>+2對<a href="/armor/Armor_Class_Building">建築</a>
                </td>
              </tr>
              <tr>
