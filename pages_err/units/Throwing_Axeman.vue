<template>
    ...
    <div class="container">
      ...
      <div class="row padtop">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>擲斧兵是<nuxt-link to="/civs/Franks">法蘭克</nuxt-link>的特殊單位，能夠在<nuxt-link to="/techsage/Castle_Age">城堡時代</nuxt-link>的
              <nuxt-link to="/building/Castle">城堡</nuxt-link>中訓練。擲斧兵是一個有範圍近戰攻擊的步兵單位。擲斧兵可以在<nuxt-link to="/techsage/Imperial_Age">帝王時代</nuxt-link>升級為精銳擲斧兵。</p>
          </div>
          <h3>戰術要點</h3>
          <div class="hrn1"></div>
          <div class="n1">
