<template>
    ...
    <div class="container">
      ...
      <div class="row padtop">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>擲斧兵是<nuxt-link to="/civs/Franks">法蘭克</nuxt-link>的特殊單位，能夠在<nuxt-link to="/techs/age/Castle_Age">城堡時代</nuxt-link>的
              <nuxt-link to="/building/Castle">城堡</nuxt-link>中訓練。擲斧兵是一個有範圍近戰攻擊的步兵單位。擲斧兵可以在<nuxt-link to="/techs/age/Imperial_Age">帝王時代</nuxt-link>升級為精銳擲斧兵。</p>
          </div>
          <h3>戰術要點</h3>
          <div class="hrn1"></div>
          <div class="n1">
          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4"><nuxt-link to="/units/Archer">弓箭手</nuxt-link>、<nuxt-link to="/units/Jaguar_Warrior">豹勇士</nuxt-link>、<nuxt-link to="/units/Hand_Cannoneer">火槍兵</nuxt-link>、
                <nuxt-link to="/units/Conquistador">西班牙征服者</nuxt-link>、<nuxt-link to="/units/Slinger">投石手</nuxt-link>、<nuxt-link to="/units/Boyar">貴族鐵騎</nuxt-link>、
                  <nuxt-link to="/units/Cataphract">拜占庭聖騎兵</nuxt-link>、<nuxt-link to="/units/Samurai">日本武士</nuxt-link>、<nuxt-link to="/Teutonic_units/Knight">條頓武士</nuxt-link>。</td>
            </tr>
            <tr class="tta">
              <td class="unit" colspan="2" style="text-align: center;">
          ...
          <div class="n1">
            ...
            <ul>
              ...
              <li>擲斧兵移動速度為0.9。</li>
              <li>擲斧兵(非精銳)的<nuxt-link to="/elements/Frame_delay">開火間隔</nuxt-link>為12。</li>
            ...
            <ul>
              ...
              <li><nuxt-link to="/units/hero/Friar_Tuck">法蘭克</nuxt-link>:引入<nuxt-link to="/techs/Bearded_Axe">倒鉤斧</nuxt-link>。</li>
            </ul>
            <h3><em><nuxt-link to="/games/aof">失落的帝國</nuxt-link></em></h3>
            <ul>
              <li>擲斧兵(非精銳)的開火間隔為10秒。</li>
              <li>升級精銳擲斧兵需要1000食物和750黃金。</li>
              <li><nuxt-link to="/units/hero/Friar_Tuck">法蘭克</nuxt-link>:得到<nuxt-link to="/techs/Squires">護衛</nuxt-link>技術。</li>
            </ul>
        ...
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            ...
            <tr>
              <td colspan="2">
                <div class="unititle">
                  <img src="~assets/TAXEM.jpg" width="45" alt="">
                </div>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <tr>
                ...
                <td class="unit4">
                  <img class="gg" src="~assets/TAXEM.jpg" width="45" alt="">精銳擲斧兵</td>
              </tr>
              <tr>
                <td class="unit3">升級成本</td>
                <td class="unit4">
                  <img class="gg" src="~assets/Elite-unique-research.jpg" alt="">1000食物750黃金</td>
              </tr>
              <tr>
