      ...
      <div class="row padtop">
        ...
        <div class="col-md-8">
          <div class="n1">
            ...
            <p><strong>  不可生產文明:</strong>  <nuxt-link to="/civs/Aztecs">阿茲特克</nuxt-link>、<nuxt-link to="/civs/Incas">印加</nuxt-link>、
              <nuxt-link to="/civs/Mayans">馬雅</nuxt-link>、<nuxt-link to="/civs/Indians">印度</nuxt-link>。</p>
          </div>
          <h3>戰術</h3>
          <div class="hrn1"></div>
          ...
          <div class="n1">
            <ul>
              <li><nuxt-link to="/civs/Berbers">柏柏</nuxt-link>：城堡/帝王時代便宜15%/20%。</li>
              ...
              <li><nuxt-link to="/civs/Chinese">中國</nuxt-link>：對騎士有利的科技研發在城堡/帝王時代各便宜15%/20%。</li>
              <li><nuxt-link to="/civs/Franks">法蘭克</nuxt-link>：騎士血量多20%，研發<nuxt-link to="/techs/Chivalry">騎士精神</nuxt-link>後，
                <nuxt-link to="/techs/Husbandry">畜牧技術</nuxt-link>的研發速度和升級<nuxt-link to="/units/Cavalier">騎兵</nuxt-link>的時間都加快40%</li>
              ...
              <li><nuxt-link to="/civs/Portuguese">葡萄牙</nuxt-link>：騎士黃金成本便宜15%。</li>
          ...
          <div class="n1">
            <ul>
              ...
              <li><nuxt-link to="/civs/Franks">法蘭克</nuxt-link>：騎士+2視野。</li>
              <li><nuxt-link to="/civs/Huns">匈奴</nuxt-link>：騎士生產效率和升級快20%，<nuxt-link to="/techs/Bloodlines">品種</nuxt-link>與
                <nuxt-link to="/techs/Husbandry">畜牧技術</nuxt-link>研發快20%。</li>
              <li><nuxt-link to="/civs/Persians">波斯</nuxt-link>：騎士對<nuxt-link to="/armor/Armor_Class_Archer">射手類</nuxt-link>+2攻擊。</li>
              <li><nuxt-link to="/civs/Teutons">條頓</nuxt-link>：騎士對僧侶抵抗力更強。</li>
            </ul>
          </div>
          <h3>更新日誌</h3>
          <div class="hrn1"></div>
          <div class="n1">
            ...
            <ul>
              <li><nuxt-link to="/civs/Berbers">柏柏</nuxt-link>：一開始騎士在城堡/帝王時代都是便宜20%。在4.8版本後更改為在城堡/帝王時代各便宜15%/20%。。</li>
            </ul>
          </div>
          <h3>趣事</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              ...
              <li>騎士是遊戲中唯四沒有任何攻擊加成的單位(剩下的是<nuxt-link to="/units/Militia">民兵</nuxt-link>、<nuxt-link to="/units/Boyar">貴族鐵騎</nuxt-link>和
                <nuxt-link to="/units/Turtle_Ship">龜甲船</nuxt-link>)。</li>
            </ul>
          </div>
          <h3>歷史</h3>
          <div class="hrn1"></div>
        ...
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            ...
            <tr>
              <td colspan="2">
                <div class="unititle">
                  <img src="~assets/KnightIcon.jpg" alt="" width="45">
                </div>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <tr>
                ...
                <td class="unit4">
                  <img class="gg" src="~assets/CavalierIcon.jpg" alt=""><nuxt-link to="/units/Cavalier">騎兵</nuxt-link>
                </td>
              </tr>
              <tr>
                <td class="unit3">升級成本</td>
                <td class="unit4">
                  <img class="gg" src="~assets/Cavalier-research.jpg" alt="">300食物300黃金</td>
              </tr>
              <tr>
      ...
      <div class="col-md-12">
        ...
        <div class="n1">
          <div class="col-md-12">
            ...
            <div class="col-md-4"> <nuxt-link to="/img/Knight.png"><img class="imgn hg" src="~assets/Knight.png" alt=""></nuxt-link> 
              <p><em>一群騎士。</em>
              </p>
            </div>
          </div>
