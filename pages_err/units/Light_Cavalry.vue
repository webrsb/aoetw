      ...
      <div class="row padtop">
        ...
        <div class="col-md-8">
                ...
                <nuxt-link to="/civs/Byzantines">拜占庭</nuxt-link>、<nuxt-link to="/civs/Celts">賽爾特</nuxt-link>、<nuxt-link to="/civs/Chinese">中國</nuxt-link>、<nuxt-link to="/civs/Ethiopians">衣索比亞</nuxt-link>、
                  <nuxt-link to="/civs/Franks">法蘭克</nuxt-link>、<nuxt-link to="/civs/Goths">哥德</nuxt-link>、<nuxt-link to="/civs/Huns">匈奴</nuxt-link>、<nuxt-link to="/civs/Indians">印度</nuxt-link>、
                    <nuxt-link to="/civs/Italians">義大利</nuxt-link>、<nuxt-link to="/civs/Japanese">日本</nuxt-link>、<nuxt-link to="/civs/Khmer">高棉</nuxt-link>、<nuxt-link to="/civs/Koreans">韓國</nuxt-link>、
                      <nuxt-link to="/civs/Magyars">馬札爾</nuxt-link>、<nuxt-link to="/civs/Malay">馬來</nuxt-link>、<nuxt-link to="/civs/Malians">馬利</nuxt-link>、<nuxt-link to="/civs/Mongols">蒙古</nuxt-link>、
                        <nuxt-link to="/civs/Persians">波斯</nuxt-link>、<nuxt-link to="/civs/Portuguese">葡萄牙</nuxt-link>、<nuxt-link to="/civs/Saracens">薩拉森</nuxt-link>、
                          <nuxt-link to="/civs/Slavs">斯拉夫</nuxt-link>、<nuxt-link to="/civs/Spanish">西班牙</nuxt-link>、<nuxt-link to="/civs/Turks">土耳其</nuxt-link>、<nuxt-link to="/civs/Vietnamese">越南</nuxt-link>、
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="n1">
                 <h4><strong><span class="glyphicon glyphicon-remove noc" aria-hidden="true"></span><span class="" style="margin-left: 2px;">不可訓練</span></strong></h4>  <nuxt-link to="/civs/Aztecs">阿茲特克</nuxt-link>、 <nuxt-link to="/civs/Incas">印加</nuxt-link>、 <nuxt-link to="/civs/Mayans">馬雅</nuxt-link>、
          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4"><nuxt-link to="/units/Skirmisher">矛兵</nuxt-link>、<nuxt-link to="/units/Villager">村民</nuxt-link>，<nuxt-link to="/units/Siege_Weapons">攻城器單位</nuxt-link>、
                <nuxt-link to="/units/Archer_Units">弓兵</nuxt-link>、<nuxt-link to="/units/Monk">僧侶</nuxt-link>。</td>
            </tr>
            <tr>
              <td class="tta1" style="width:30%">劣勢(不易對抗)</td>
              <td class="tta4"><nuxt-link to="/units/Infantry_Units">步兵單位</nuxt-link>、<nuxt-link to="/units/Cavalry_Units">騎兵單位</nuxt-link>
              </td>
            </tr>
            <tr class="tta">
              <td class="unit" colspan="2" style="text-align: center;">
            ...
            <tr>
              ...
              <td class="tta4">
                <img class="gg" src="~assets/ScoutCavalryIcon.jpg" alt=""> <nuxt-link to="/units/Scout_Cavalry">斥侯</nuxt-link>→
                <img class="gg" src="~assets/LightCavalryIcon.jpg"
                alt=""> <nuxt-link to="/units/Light_Cavalry">輕騎兵</nuxt-link>→
                <img class="gg" src="~assets/HussarIcon.jpg"
                alt=""> <nuxt-link to="/units/Hussar">匈牙利輕騎兵</nuxt-link>
                <br/>
            ...
            <tr>
              ...
              <td class="tta4">
                <img src="~assets/Faith.jpg" width="30" alt=""><nuxt-link to="/techs/Faith">忠誠信仰</nuxt-link>
                <br/>
          ...
          <div class="n1">
            <ul>
              <li><nuxt-link to="/civs/Berbers">柏柏</nuxt-link>：城堡/帝王時代各便宜15/20%。(4.8版本前是都20%)</li>
              ...
              <li><nuxt-link to="/civs/Chinese">中國</nuxt-link>：科技研發在封建/城堡/帝王時代各便宜10%/15%/20%。</li>
              <li><nuxt-link to="/civs/Franks">法蘭克</nuxt-link>：輕騎兵血量多20%，研發<nuxt-link to="/techs/Chivalry">騎士精神</nuxt-link>後
                <nuxt-link to="/techs/Husbandry">畜牧培育</nuxt-link>研發速度快40%</li>
              <li><nuxt-link to="/civs/Magyars">馬扎爾</nuxt-link>：免費<nuxt-link to="/techs/Forging">鍛造</nuxt-link>、<nuxt-link to="/techs/Iron_Casting">鑄鐵</nuxt-link>、
                <nuxt-link to="/techs/Blast_Furnace">鼓風爐</nuxt-link>科技，<nuxt-link to="/units/Light_Cavalry">輕騎兵</nuxt-link>生產便宜15%</li>
              <li><nuxt-link to="/civs/Spanish">西班牙</nuxt-link>：<nuxt-link to="/building/Blacksmith">兵工廠</nuxt-link>升級科技免黃金</li>
              <li><nuxt-link to="/civs/Turks">土耳其</nuxt-link>：<nuxt-link to="/units/Light_Cavalry">輕騎兵</nuxt-link>免費升級。</li>
          ...
          <div class="n1">
            <ul>
              ...
              <li><nuxt-link to="/civs/Huns">匈奴</nuxt-link>：輕騎兵生產效率和升級快20%，<nuxt-link to="/techs/Bloodlines">品種</nuxt-link>與
                <nuxt-link to="/techs/Husbandry">畜牧技術</nuxt-link>研發快20%。</li>
              <li><nuxt-link to="/civs/Mongols">蒙古</nuxt-link>：輕騎兵+2視野。</li>
              <li><nuxt-link to="/civs/Teutons">條頓</nuxt-link>：輕騎兵對僧侶抵抗力更強。</li>
            </ul>
          </div>
          <h3>更新日誌</h3>
          <div class="hrn1"></div>
          <div class="n1">
            ...
            <ul>
              <li><nuxt-link to="/civs/Franks">法蘭克</nuxt-link>:引入<nuxt-link to="/techs/Chivalry">騎士精神</nuxt-link>，馬廄工作速率快40%。</li>
              <li><nuxt-link to="/civs/Magyars">馬扎爾</nuxt-link>:輕騎兵便宜10%。</li>
            </ul>
            <h3><em><nuxt-link to="/games/ak">非洲王國</nuxt-link></em></h3>
            <ul>
              <li><nuxt-link to="/civs/Berbers">柏柏</nuxt-link>:最初從城堡時代便宜20%，4.8版本後，變成城堡/帝王各便宜15/20%。</li>
              <li><nuxt-link to="/civs/Franks">法蘭克</nuxt-link>:輕騎兵也能受到文明加成+20%HP。</li>
            </ul>
            <h3><em><nuxt-link to="/games/aor">王者崛起</nuxt-link></em></h3>
            <ul>
              <li><nuxt-link to="/civs/Magyars">馬扎爾</nuxt-link>:在5.5版後輕騎兵現在便宜15%。</li>
            </ul>
          </div>
          <h3>趣事</h3>
          <div class="hrn1"></div>
        ...
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            ...
            <tr>
              <td colspan="2">
                <div class="unititle">
                  <img src="~assets/LightCavalryIcon.jpg" width="45" alt="">
                </div>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4">
                <img class="gg" width="25px" src="~assets/Stableicon.png" alt=""><nuxt-link to="/building/Stable">馬廄</nuxt-link>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4">+10對<nuxt-link to="/armor/Armor_Class_Monk">僧侶類</nuxt-link>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4">
                <img class="gg" src="~assets/Light-cavalry-research.jpg" alt="">500食物600黃金</td>
            </tr>
            <tr>
        ...
        <div class="col-md-12">
          ...
          <div class="n1">
            <div class="col-md-12">
              <div class="col-md-4"> <nuxt-link to="/img/Scoutcavalryline.png"><img class="imgn hg" src="~assets/Scoutcavalryline.png" alt=""></nuxt-link> 
                <p><em>斥侯系。</em>
                </p>
              </div>
              <div class="col-md-4"> <nuxt-link to="/img/Lightcavalry.png"><img class="imgn hg" src="~assets/Lightcavalry.png" alt=""></nuxt-link> 
                <p><em>一群輕騎兵。</em>
                </p>
              </div>
            </div>
