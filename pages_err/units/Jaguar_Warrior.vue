<template>
    ...
    <div class="container">
      ...
      <div class="row padtop">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>豹勇士是<nuxt-link to="/civs/Aztecs">阿茲特克</nuxt-link>的特殊單位，能夠在<nuxt-link to="/techs/age/Castle_Age">城堡時代</nuxt-link>的
              <nuxt-link to="/building/Castle">城堡</nuxt-link>中訓練。豹勇士是一個配備高護甲和對步兵單位有高攻擊力的單位。豹勇士可以在<nuxt-link to="/techs/age/Imperial_Age">帝王時代</nuxt-link>升級為精銳豹勇士。</div>
          <h3>戰術要點</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              <li>豹勇士在面對步兵時有極高的攻擊加成，讓他們在任何1V1除了與<nuxt-link to="/Teutonic_units/Knight">條頓武士</nuxt-link>的戰鬥外都能輕鬆獲勝，若是一群豹勇士的話連條頓武士都不是對手。但在對付
                <nuxt-link to="/units/Archer_Units">弓兵單位</nuxt-link>和<nuxt-link to="/units/Cavalry_Units">騎兵單位</nuxt-link>上則顯得吃力</li>
              <li>豹勇士搭配<nuxt-link to="/units/Eagle_Warrior">鷹勇士</nuxt-link>是非常好的團戰組合。鷹勇士可以消滅大部分豹勇士的威脅，例如:僧侶、騎兵，對弓兵也有極佳的反制效果。豹勇士對步兵的加成也能保護鷹勇士，兩者可說相輔相成。搭配上
                <nuxt-link to="/units/Monk">僧侶</nuxt-link>在城堡時代的阿茲軍隊是令人聞風為之喪膽的。</li>
              <li>對阿茲玩家來說<nuxt-link to="/units/Hand_Cannoneer">火槍兵</nuxt-link>是在戰場上比較需要注意的，可以生產<nuxt-link to="/units/Onager">中型投石車</nuxt-link>或
                <nuxt-link to="/Siege_units/Onager">重型投石車</nuxt-link>作反制。對上<nuxt-link to="/units/Cataphract">聖騎兵</nuxt-link>阿茲雖然沒有<nuxt-link to="/units/Halberdier">戟兵</nuxt-link>但有高攻擊的
                  <nuxt-link to="/units/Pikeman">重裝長槍兵</nuxt-link>替代。</li>
              <li>豹勇士面對<nuxt-link to="/units/Samurai">日本武士</nuxt-link>的情況會依遊戲在何種版本進行而有所不同。若是征服者的版本，在對特殊單位有加成以及更快的攻速下，日本武士總是勝利的一方；但若是HD版本，先攻擊的一方獲勝，因為精銳豹勇士對步兵的加成會是+11而不是+10。</li>
            </ul>
          </div>
          <h3>更多數據</h3>
          <div class="hrn1"></div>
          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4"><nuxt-link to="/units/Skirmisher">矛兵</nuxt-link>、<nuxt-link to="/units/Infantry_Units">步兵</nuxt-link>、
                <nuxt-link to="/building/bulding">建築物</nuxt-link>。</td>
            </tr>
            <tr>
              <td class="tta1" style="width:30%">劣勢(不易對抗)</td>
              <td class="tta4"><nuxt-link to="/units/Archer_Units">弓兵</nuxt-link>、<nuxt-link to="/units/Scorpion">弩炮</nuxt-link>、<nuxt-link to="/units/Mangonel">投石車</nuxt-link>、
                <nuxt-link to="/units/Cataphract">聖騎兵</nuxt-link>、<nuxt-link to="/units/Boyar">貴族鐵騎</nuxt-link>、<nuxt-link to="/units/Hand_Cannoneer">火槍兵</nuxt-link>、
                  <nuxt-link to="/units/Conquistador">征服者</nuxt-link>、<nuxt-link to="/units/Janissary">土耳其火槍兵</nuxt-link>、<nuxt-link to="/units/Slinger">投石手</nuxt-link>、
                    <nuxt-link to="/units/Knight">騎士</nuxt-link>。</td>
            </tr>
            <tr class="tta">
              <td class="unit" colspan="2" style="text-align: center;">
          ...
          <div class="n1">
            <img class="gg" src="~assets/Unique-tech.jpg" width="22" alt=""> <nuxt-link to="/techs/Logistica">後勤學</nuxt-link> 
          ...
          <div class="n1">
            <ul>
              <li><nuxt-link to="/civs/Aztecs">阿茲特克</nuxt-link>：豹勇士生產速度快15%。</li>
            </ul>
          </div>
          <h3>團隊加成</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              <li><nuxt-link to="/civs/Berbers">柏柏</nuxt-link>：<nuxt-link to="/techs/Kasbah">聚居堡壘</nuxt-link>能夠提高豹勇士的生產速度還有加速
                <nuxt-link to="/techs/Garland_Wars">榮冠戰爭</nuxt-link>和<nuxt-link to="/techs/Conscription">徵兵制度</nuxt-link>的研究時間(快25%)。</li>
              ...
              <li><nuxt-link to="/civs/Teutons">條頓</nuxt-link>：豹勇士更不容易被招降。</li>
            </ul>
          </div>
          <h3>更新日誌</h3>
          <div class="hrn1"></div>
          <div class="n1">
            ...
            <ul>
              <li>豹勇士的遠防是0。</li>
              <li>精銳豹勇士對<nuxt-link to="/armor/Armor_Class_Infantry">步兵單位</nuxt-link>攻擊+10。</li>
            </ul>
            <h3><em><nuxt-link to="/games/aof">失落的帝國</nuxt-link></em></h3>
            <ul>
              <li>豹勇士現在的遠防是1。</li>
              <li>精銳豹勇士對<nuxt-link to="/armor/Armor_Class_Infantry">步兵單位</nuxt-link>現在攻擊+11。</li>
            </ul>
          </div>
          <h3>歷史</h3>
          <div class="hrn1"></div>
        ...
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            ...
            <tr>
              <td colspan="2">
                <div class="unititle">
                  <img src="~assets/JaguarWarriorIcon.jpg" width="45" alt="">
                </div>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4"><nuxt-link to="/civs/Persians">阿茲特克</nuxt-link>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4">對<nuxt-link to="/armor/Armor_Class_Infantry">步兵單位</nuxt-link>+10/+11(精銳)
                <br/>對<nuxt-link to="/armor/Armor_Class_Condottiero">傭兵</nuxt-link>+10
                <br/>對<nuxt-link to="/armor/Armor_Class_Eagle_Warrior">鷹勇士</nuxt-link>+2
                <br/>對<nuxt-link to="/armor/Armor_Class_Standard_Building">標準建築物</nuxt-link>+2</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4">
                <img class="gg" src="~assets/JaguarWarriorIcon.jpg" alt="">精銳豹勇士</td>
            </tr>
            <tr>
        ...
        <div class="col-md-12">
          ...
          <div class="hrn1"></div>
          <div class="n1">
            <div class="col-md-4"> <nuxt-link to="/img/Jaguarwarrior.png"><img class="imgn hg" src="~assets/Jaguarwarrior.png" alt=""></nuxt-link> 
              <p><em>一群豹勇士</em>
              </p>
            </div>
            <div class="col-md-4"> <nuxt-link to="/img/Url.jpg"><img class="imgn hg" src="~assets/Url.jpg" alt=""></nuxt-link> 
              <p><em>豹勇士3D圖</em>
              </p>
            </div>
            <div class="col-md-4"> <nuxt-link to="/img/Jaguar_Warrior.jpg"><img class="imgn hg" src="~assets/Jaguar_Warrior.jpg" alt=""></nuxt-link> 
              <p><em>豹勇士</em>
              </p>
            </div>
          </div>
