<template>
    ...
    <div class="container">
      ...
      <div class="row padtop">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>精銳火炮戰船在<a href="/techsage/Imperial_Age">帝王時代</a>的<a href="/building/Dock">碼頭</a>可以訓練。要訓練精銳火炮戰船得先升級精銳火炮戰船科技。升級後射程更遠，攻擊更高，擅長摧毀陸上建築，但對船隻的反應能力較弱。</p>
          </div>
           <h3>戰術</h3> 
          <div class="hrn1"></div>
          <div class="n1">
            <p>精銳火炮戰船的射程遠比城堡和火炮塔遠，而且對建築物有額外傷害加成，可說是"海上的火炮"(速度比火炮稍快)。精銳火炮戰船有不錯的傷害，但是緩慢的開火速率，砲彈飛行時間長，有最小射程限制等缺點讓他們對船隻的攻擊幾乎沒有抵抗能力，尤其是火戰船。</p>
            <p>當火炮戰船在執行岸邊轟炸城堡和箭塔時，火炮戰船身邊應該要有<a href="/War_units/Galley">弩炮戰船</a>和<a href="/units/Fire_Ship">火戰船</a>做護衛保護。</p>
            <p>一般來說，精銳火炮戰船主要用來清理敵方海岸線的建築物，偶爾騷擾範圍內的地面單位。他們不應該用來對付敵方的船隻，而且如果海上威脅沒有完全消失的話，他們很容易就會被消滅。</p>
            <p><a href="/civs/Spanish">西班牙</a>的精銳火炮戰船比其他文明的射速要快(每秒飛行7格而不是每秒飛行1.39格)，而且有彈道學加成可以更容易擊中移動目標。</p>
          </div>
           <h3>文明可訓練與否</h3> 
          <div class="hrn1"></div>
          <div class="row">
            <div class="col-md-12">
              <div class="n1">
                 <h4><strong><span class="glyphicon glyphicon-ok okc" aria-hidden="true"></span><span class="" style="margin-left: 2px;">可訓練</span></strong></h4>  <a href="/civs/Berbers">柏柏</a>、 <a href="/civs/Burmese">緬甸</a>、 <a href="/civs/Byzantines">拜占庭</a>、
                <a
                href="/civs/Indians">印度</a>、 <a href="/civs/Italians">義大利</a>、 <a href="/civs/Japanese">日本</a>、
                  <a
                  href="/civs/Khmer">高棉</a>、 <a href="/civs/Malay">馬來</a>、 <a href="/civs/Persians">波斯</a>、 <a href="/civs/Portuguese">葡萄牙</a>、
                    <a
                    href="/civs/Saracens">薩拉森</a>、 <a href="/civs/Spanish">西班牙</a>、 <a href="/civs/Turks">土耳其</a>、 <a href="/civs/Vietnamese">越南</a>、
                      <a
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="n1">
                 <h4><strong><span class="glyphicon glyphicon-remove noc" aria-hidden="true"></span><span class="" style="margin-left: 2px;">不可訓練</span></strong></h4>  <a href="/civs/Aztecs">阿茲特克</a>、 <a href="/civs/Britons">不列顛</a>、 <a href="/civs/Celts">賽爾特</a>、
                <a
                href="/civs/Chinese">中國</a>、 <a href="/civs/Ethiopians">衣索比亞</a>、 <a href="/civs/Franks">法蘭克</a>、
                  <a
                  href="/civs/Goths">哥德</a>、 <a href="/civs/Huns">匈奴</a>、 <a href="/civs/Incas">印加</a>、 <a href="/civs/Koreans">韓國</a>、
                    <a
                    href="/civs/Magyars">馬扎爾</a>、 <a href="/civs/Malians">馬利</a>、 <a href="/civs/Mayans">馬雅</a>、 <a href="/civs/Mongols">蒙古</a>、
                      <a
          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4"><a href="/building/bulding">建築物</a>。</td>
            </tr>
            <tr>
              <td class="tta1" style="width:30%">劣勢(不易對抗)</td>
              <td class="tta4"><a href="/units/Naval_Vessels">船</a>、<a href="/units/Bombard_Cannon">火炮</a>、
                <a
                href="/units/Monk">僧侶</a>。</td>
            </tr>
            <tr class="tta">
              <td class="unit" colspan="2" style="text-align: center;">
            ...
            <tr>
              ...
              <td class="tta4">
                <img class="gg" style="margin: 2px;" src="~assets/Unique-tech.jpg" alt=""><a href="/techs/Artillery">砲兵</a>(+2，<a href="/civs/Turks">土耳其</a>限定)</td>
            </tr>
            <tr>
              <td class="tta1" style="width:10%">命中率</td>
              <td class="tta4">
                <img class="gg" style="margin: 2px;" src="~assets/Unique-tech.jpg" alt=""><a href="/techs/Arquebus">火繩槍</a>(火藥單位對移動目標命中率提升，<a href="/civs/Portuguese">葡萄牙</a>限定)</td>
            </tr>
            <tr>
              <td class="tta1" style="width:10%">護甲</td>
              <td class="tta4">
                <img class="gg" style="margin: 2px;" src="~assets/Careening.jpg" alt=""><a href="/techs/Careening">傾側維修術</a>(護甲+0/+1)
                <br/>
            ...
            <tr>
              ...
              <td class="tta4">
                <img class="gg" style="margin: 2px;" src="~assets/Drydock.jpg" alt=""><a href="/Dry_building/Dock">旱碼頭</a>(+15%)</td>
            </tr>
            <tr>
              <td class="tta1" style="width:10%">抗招降能力</td>
              <td class="tta4">
                <img class="gg" src="~assets/Faith.jpg" width="22" alt=""><a href="/techs/Faith">忠誠信仰</a>
                <br/>
                <img class="gg" src="~assets/Heresy.png" width="22" alt=""><a href="/techs/Heresy">異端邪說</a> 
              </td>
            </tr>
            <tr>
          ...
          <div class="n1">
            <ul>
              <li><a href="/civs/Berbers">柏柏</a>：精銳火炮戰船移動速度快10%。</li>
              <li><a href="/civs/Burmese">緬甸</a>：<a href="/techs/Faith">忠誠信仰</a>花費便宜50%。</li>
              <li><a href="/civs/Italians">義大利</a>：訓練精銳火炮戰船成本便宜20%。研究<a href="/techs/Careening">傾側維修術</a>，
                <a
                href="/Dry building/Dock">旱碼頭</a>和<a href="/techs/Shipwright">造船匠</a>便宜50％。</li>
              <li><a href="/civs/Persians">波斯</a>：精銳火炮戰船訓練的速度在帝王提高20%。研究<a href="/techs/Careening">傾側維修術</a>、
                <a
                href="/Dry building/Dock">旱碼頭</a>的速度快20％。</li>
              <li><a href="/civs/Portuguese">葡萄牙</a>：訓練精銳火炮戰船的花費減少15%黃金，精銳火炮戰船HP+10％。</li>
              <li><a href="/civs/Spanish">西班牙</a>：精銳火炮戰船自身有彈道學加成而且射速更快。</li>
              <li><a href="/civs/Turks">土耳其</a>：精銳火炮戰船HP+25%。升級精銳火炮戰船話費-50%。</li>
              <li><a href="/civs/Vikings">維京</a>：精銳火炮戰船訓練的費用在帝王減少20%。</li>
            </ul>
          </div>
           <h3>團隊加成</h3> 
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              <li><a href="/civs/Turks">土耳其</a>：精銳火炮戰船訓練速度快20%。</li>
              <li><a href="/civs/Teutons">條頓</a>：精銳火炮戰船對招降的抵抗力更強。</li>
            </ul>
          </div>
           <h3>更新日誌</h3>
          <div class="hrn1"></div>
          <div class="n1">
            ...
            <ul>
              ...
              <li><a href="/civs/Britons">不列顛</a>:不能訓練精銳火炮戰船。</li>
              <li><a href="/civs/Turks">土耳其</a>:精銳火炮戰船有150HP，然後因為bug讓精銳火炮戰船沒有吃到火藥單位HP+50%的文明加成。</li>
            </ul>
            ...
            <ul>
              ...
              <li><a href="/civs/Spanish">西班牙</a>:精銳火炮戰船受彈道學加成而且砲彈速度更快。</li>
              <li><a href="/civs/Turks">土耳其</a>:引進<a href="/techs/Artillery">砲兵</a>，精銳火炮戰船現在HP+25%。</li>
            </ul>
             <h3><em><a href="/games/aof">失落的帝國</a></em></h3>
            <ul>
              <li><a href="/civs/Italians">義大利</a>:精銳火炮戰船便宜15%。</li>
              <li><a href="/civs/Mongols">蒙古</a>:精銳火炮戰船從科技樹移除。</li>
              <li><a href="/civs/Spanish">西班牙</a>:精銳火炮戰船自身有彈道學(不須研發彈道學)而砲彈速度變為7格/秒(~3.6倍快)。</li>
            </ul>
             <h3><em><a href="/games/ak">非洲王朝</a></em></h3>
            <ul>
              <li><a href="/civs/Italians">義大利</a>:4.8版本後精銳火炮戰船現在便宜20%。</li>
            </ul>
          </div>
           <h3>豆知識</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              ...
              <li>精銳火炮戰船是海軍船艦中基礎射程最遠的(15)，也是全單位射程距離第二遠的僅次於<a href="/units/Trebuchet">巨型投石機</a>。
                <a
                href="/civs/Turks">土耳其</a>的精銳火炮戰船因為特殊科技<a href="/techs/Artillery">砲兵</a>的關係可以獲得+2射程，讓他們的精銳火炮戰船跟有研發
                  <a
                  href="/techs/Siege_Engineers">攻城工程師</a>的<a href="/units/Trebuchet">巨型投石機</a>並列射程最遠單位。</li>
        ...
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="unit4"><a href="/units/Gunpowder_Unit">火藥單位</a>、<a href="/units/Naval_Vessels">船</a>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4">+275對<a href="/armor/Armor_Class_Building">建築</a>
                <br/>+40對<a href="/armor/Armor_Class_Siege_Weapon">攻城武器</a>
                <br/>+15對<a href="/armor/Armor_Class_Infantry">步兵</a>
                <br/>+15對<a href="/armor/Armor_Class_Archer">弓兵</a>
                <br/>+15對<a href="/armor/Armor_Class_Cavalry">騎兵</a>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4">
                <img class="gg" src="~assets/CannonGalleonIcon.jpg" alt=""><a href="/units/Cannon_Galleon">火炮戰船</a>
              </td>
            </tr>
          </table>
