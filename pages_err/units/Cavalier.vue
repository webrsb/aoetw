    ...
    <div class="container">
      ...
      <div class="row padtop">
        <div class="col-md-12">
           <h1>騎兵</h1>
          <div class="hrn1"></div>
          <div class="spw"><em><img src="~assets/Attila_the_Hun.png" width="50px;" alt="" style="margin-right:20px;">阿提拉：不要搞錯了！：此頁面和<nuxt-link to="/units/Cavalry_Units">騎兵類單位</nuxt-link>與<nuxt-link to="/armor/Armor_Class_Cavalry">騎兵防禦</nuxt-link>。不同喔！</em>
          </div>
        </div>
        <div class="col-md-8">
          <div class="n1">
            ...
            <div class="col-md-12">
              <div class="n1">
                ...
                <nuxt-link to="/civs/Byzantines">拜占庭</nuxt-link>、 <nuxt-link to="/civs/Celts">賽爾特</nuxt-link>、 <nuxt-link to="/civs/Chinese">中國</nuxt-link>、 <nuxt-link to="/civs/Ethiopians">衣索比亞</nuxt-link>、
                  <nuxt-link to="/civs/Franks">法蘭克</nuxt-link>、 <nuxt-link to="/civs/Goths">哥德</nuxt-link>、 <nuxt-link to="/civs/Huns">匈奴</nuxt-link>、 <nuxt-link to="/civs/Italians">義大利</nuxt-link>、
                    <nuxt-link to="/civs/Japanese">日本</nuxt-link>、 <nuxt-link to="/civs/Khmer">高棉</nuxt-link>、 <nuxt-link to="/civs/Koreans">韓國</nuxt-link>、 <nuxt-link to="/civs/Magyars">馬札爾</nuxt-link>、
                      <nuxt-link to="/civs/Malay">馬來</nuxt-link>、 <nuxt-link to="/civs/Malians">馬利</nuxt-link>、 <nuxt-link to="/civs/Mongols">蒙古</nuxt-link>、 <nuxt-link to="/civs/Persians">波斯</nuxt-link>、
                        <nuxt-link to="/civs/Portuguese">葡萄牙</nuxt-link>、 <nuxt-link to="/civs/Slavs">斯拉夫</nuxt-link>、 <nuxt-link to="/civs/Spanish">西班牙</nuxt-link>、 <nuxt-link to="/civs/Teutons">條頓</nuxt-link>、
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="n1">
                 <h4><strong><span class="glyphicon glyphicon-remove noc" aria-hidden="true"></span><span class="" style="margin-left: 2px;">不可訓練</span></strong></h4>  <nuxt-link to="/civs/Aztecs">阿茲特克</nuxt-link>、 <nuxt-link to="/civs/Incas">印加</nuxt-link>、 <nuxt-link to="/civs/Indians">印度</nuxt-link>、
                <nuxt-link to="/civs/Mayans">馬雅</nuxt-link>、 <nuxt-link to="/civs/Saracens">薩拉森</nuxt-link>。</div>
            </div>
          </div>
           <h3>戰術</h3>
          <div class="hrn1"></div>
          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4"><nuxt-link to="/units/Infantry_Units">步兵</nuxt-link>、<nuxt-link to="/units/Archer_Units">弓兵</nuxt-link>、
                <nuxt-link to="/units/Villager">村民</nuxt-link>、<nuxt-link to="/units/Siege_Weapons">攻城器單位</nuxt-link>、<nuxt-link to="/Cavalry_units/Archer">馬弓騎兵</nuxt-link>、
                  <nuxt-link to="/units/Light_Cavalry">輕騎兵</nuxt-link>。</td>
            </tr>
            <tr>
              <td class="tta1" style="width:30%">劣勢(不易對抗)</td>
              <td class="tta4"><nuxt-link to="/units/Boyar">貴族鐵騎</nuxt-link>、<nuxt-link to="/units/Pikeman">重裝長槍兵</nuxt-link>、<nuxt-link to="/units/Kamayuk">槍隊長</nuxt-link>、
                <nuxt-link to="/units/Berserk">狂戰士</nuxt-link>、<nuxt-link to="/Genoese_units/Crossbowman">熱那亞弩手</nuxt-link>、<nuxt-link to="/Teutonic_units/Knight">條頓武士</nuxt-link>、
                  <nuxt-link to="/units/Mameluke">奴隸兵</nuxt-link>、<nuxt-link to="/units/Camel">駱駝騎兵</nuxt-link>、<nuxt-link to="/units/Monk">僧侶</nuxt-link>和<nuxt-link to="/War_unitsanimal/Elephant">戰象</nuxt-link>。</td>
            </tr>
            <tr class="tta">
              <td class="unit" colspan="2" style="text-align: center;">
            ...
            <tr>
              ...
              <td class="tta4">
                ...
                <br/>
                <img src="~assets/Unique-tech.jpg" class="gg" alt=""><nuxt-link to="/techs/Farimba">驃悍精神</nuxt-link>：馬廄單位攻擊+5。<nuxt-link to="/civs/Malians">馬利</nuxt-link>限定
                <br/>
                ...
                <nuxt-link to="/armor/Armor_Class_Standard_Building">標準建築</nuxt-link>攻擊+3。<nuxt-link to="/civs/Burmese">緬甸</nuxt-link>限定</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="tta4">
                ...
                <br/>
                <img class="gg" src="~assets/CastleAgeUnique.png" alt=""><nuxt-link to="/techs/Chivalry">騎士精神</nuxt-link>：馬廄工作速率快40%。<nuxt-link to="/civs/Franks">法蘭克</nuxt-link>限定</td>
            </tr>
          </table>
           <h3>剋騎兵的單位與建築</h3> 
          <div class="hrn1"></div>
          ...
          <div class="n1">
            <ul>
              <li><nuxt-link to="/civs/Berbers">柏柏</nuxt-link>：騎兵在帝王時代便宜15%/20%。</li>
              <li><nuxt-link to="/civs/Burmese">緬甸</nuxt-link>：<nuxt-link to="/techs/Faith">忠誠信仰</nuxt-link>便宜50%。</li>
              <li><nuxt-link to="/civs/Celts">賽爾特</nuxt-link>：只要在一個賽爾特單位的視野下，羊群不會被牽走</li>
              <li><nuxt-link to="/civs/Chinese">中國</nuxt-link>：對騎兵有利的科技研發在帝王時代各便宜15%/20%。</li>
              <li><nuxt-link to="/civs/Franks">法蘭克</nuxt-link>：騎兵血量多20%，研發<nuxt-link to="/techs/Chivalry">騎士精神</nuxt-link>後，
                <nuxt-link to="/techs/Husbandry">畜牧技術</nuxt-link>的研發速度和升級<nuxt-link to="/units/Paladin">遊俠</nuxt-link>的時間都加快40%</li>
              <li><nuxt-link to="/civs/Magyars">馬扎爾</nuxt-link>：免費<nuxt-link to="/techs/Forging">鍛造</nuxt-link>、<nuxt-link to="/techs/Iron_Casting">鑄造</nuxt-link>和
                <nuxt-link to="/techs/Blast_Furnace">鼓風爐</nuxt-link>科技</li>
              <li><nuxt-link to="/civs/Portuguese">葡萄牙</nuxt-link>：騎兵黃金成本便宜15%。</li>
          ...
          <div class="n1">
            <ul>
              ...
              <li><nuxt-link to="/civs/Franks">法蘭克</nuxt-link>：騎兵+2視野。</li>
              <li><nuxt-link to="/civs/Huns">匈奴</nuxt-link>：騎兵生產效率和升級快20%，<nuxt-link to="/techs/Bloodlines">品種</nuxt-link>與
                <nuxt-link to="/techs/Husbandry">畜牧技術</nuxt-link>研發快20%。</li>
              <li><nuxt-link to="/civs/Persians">波斯</nuxt-link>：騎兵對<nuxt-link to="/armor/Armor_Class_Archer">射手類</nuxt-link>+2攻擊。</li>
              <li><nuxt-link to="/civs/Teutons">條頓</nuxt-link>：騎兵對僧侶抵抗力更強。</li>
            </ul>
          </div>
           <h3>更新日誌</h3>
          <div class="hrn1"></div>
          <div class="n1">
            ...
            <ul>
              <li><nuxt-link to="/civs/Franks">法蘭克</nuxt-link>：引進<nuxt-link to="/techs/Chivalry">騎士精神</nuxt-link>。</li>
            </ul>
          </div>
        </div>
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            ...
            <tr>
              <td colspan="2">
                <div class="unititle">
                  <img src="~assets/CavalierIcon.jpg" width="45" alt="">
                </div>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4">
                <img class="gg" src="~assets/PaladinIcon.jpg" alt=""><nuxt-link to="/units/Paladin">遊俠</nuxt-link>
              </td>
            </tr>
            <tr>
              <td class="unit3">升級成本</td>
              <td class="unit4">
                <img class="gg" src="~assets/Paladin-research.jpg" alt="">1300食物750黃金</td>
            </tr>
            <tr>
      ...
      <div class="col-md-12">
        ...
        <div class="n1">
          <div class="col-md-12">
            <div class="col-md-4"> <nuxt-link to="/img/Knightline.png"><img class="imgn hg" src="~assets/Knightline.png" alt=""></nuxt-link> 
              <p><em>騎士系。</em>
              </p>
            </div>
            <div class="col-md-4"> <nuxt-link to="/img/Cavalier.png"><img class="imgn hg" src="~assets/Cavalier.png" alt=""></nuxt-link> 
              <p><em>一群騎兵。</em>
              </p>
            </div>
          </div>
