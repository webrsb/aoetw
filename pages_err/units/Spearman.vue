    ...
    <div class="container">
      ...
      <div class="row padtop">
        ...
        <div class="col-md-8">
          ...
          <div class="hrn1"></div>
          <div class="n1">
            <p>長槍兵便宜、容易集結，使他們能夠壓倒敵方的騎兵。它們對防止早期的<nuxt-link to="/units/Scout_Cavalry">斥侯</nuxt-link>是很有效，但是對於
              <nuxt-link to="/units/Knight">騎士</nuxt-link>或<nuxt-link to="/Cavalry_units/Archer">馬弓騎兵</nuxt-link>來說，他們應該升級為更有效的<nuxt-link to="/units/Pikeman">重裝長槍兵</nuxt-link>。這是防禦騎馬單位的首選。</p>
          </div>
          <h3>更多數據</h3>
          <div class="hrn1"></div>
          <div class="n1"></div>
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4"><nuxt-link to="/units/Infantry_Units">步兵單位</nuxt-link>、<nuxt-link to="/units/Archer">弓兵</nuxt-link>。</td>
            </tr>
            <tr class="tta">
          ...
          <div class="n1">
            <ul>
              <li><nuxt-link to="/civs/Aztecs">阿茲特克</nuxt-link>：長槍兵生產速度提高15％。</li>
              <li><nuxt-link to="/civs/Burmese">緬甸</nuxt-link>：長槍兵在封建/城堡/帝王時代有 +1/+2/+3 攻擊。</li>
              <li><nuxt-link to="/civs/Byzantines">拜占庭</nuxt-link>：長槍兵便宜25％。</li>
              ...
              <li><nuxt-link to="/civs/Malians">馬利</nuxt-link>：長槍兵在封建/城堡/帝王時代有 +1/+2/+3 遠程護甲。</li>
              ...
              <li><nuxt-link to="/civs/Vikings">維京</nuxt-link>：長槍兵在封建/城堡/帝王時代擁有10％/15％/20％的生命值。</li>
            </ul>
          </div>
          <h3>團隊加成</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              ...
              <li><nuxt-link to="/civs/Goths">哥德</nuxt-link>：長槍兵訓練和升級快20%。研發<nuxt-link to="/techs/Tracking">追縱技術</nuxt-link>、
                <nuxt-link to="/techs/Squires">護衛</nuxt-link>、<nuxt-link to="/techs/Arson">縱火</nuxt-link>科技的時間快20%。</li>
              <li><nuxt-link to="/civs/Teutons">條頓</nuxt-link>：長槍兵更不容易被招降。</li>
            </ul>
          </div>
          <h3>更新日誌</h3>
          <div class="hrn1"></div>
          <div class="n1">
            ...
            <ul>
              <li><nuxt-link to="/civs/Goths">哥德</nuxt-link>:長槍兵在封建/城堡/帝王時代便宜10%/15%/25%。</li>
            </ul>
            <h3><em><nuxt-link to="/games/aoc">征服者入侵</nuxt-link></em></h3>
            <ul>
              <li>長槍兵對<nuxt-link to="/armor/Armor_Class_Camel">駱駝</nuxt-link>與<nuxt-link to="/armor/Armor_Class_Ship">船隻</nuxt-link>有+7攻擊。</li>
              <li><nuxt-link to="/civs/Goths">哥德</nuxt-link>:1.0c版後長槍兵在任何時代都便宜35%。引入<nuxt-link to="/techs/Perfusion">灌注士氣</nuxt-link>
              </li>
              <li>引入<nuxt-link to="/techs/Heresy">異端邪說</nuxt-link>。</li>
            </ul>
            <h3><em><nuxt-link to="/games/aof">失落的帝國</nuxt-link></em></h3>
            <ul>
              <li>長槍兵現在對<nuxt-link to="/armor/Armor_Class_Camel">駱駝</nuxt-link>與<nuxt-link to="/armor/Armor_Class_Ship">船隻</nuxt-link>有+9攻擊。</li>
            </ul>
            <h3><em><nuxt-link to="/games/ak">非洲王國</nuxt-link></em></h3>
            <ul>
              <li>引進<nuxt-link to="/techs/Arson">縱火</nuxt-link>科技。</li>
              <li><nuxt-link to="/civs/Vikings">維京</nuxt-link>:4.8版本引進<nuxt-link to="/techs/Chieftains">酋長</nuxt-link>科技，長槍兵對
                <nuxt-link to="/armor/Armor_Class_Cavalry">騎兵單位</nuxt-link>有+5攻擊。</li>
              <li><nuxt-link to="/civs/Vikings">維京</nuxt-link>:在4.8b版本後，<nuxt-link to="/techs/Chieftains">酋長</nuxt-link>讓長槍兵對駱駝有額外+2攻擊。</li>
            </ul>
        ...
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            ...
            <tr>
              <td colspan="2">
                <div class="unititle">
                  <img src="~assets/SpearmanIcon.jpg" width="45" alt="">
                </div>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4">+15 vs<nuxt-link to="/armor/Armor_Class_Cavalry">騎兵</nuxt-link>
                <br/>+15 vs<nuxt-link to="/armor/Armor_Class_War_Elephant">戰象類</nuxt-link>
                <br/>+12 vs<nuxt-link to="/armor/Armor_Class_Camel">駱駝騎兵</nuxt-link>
                <br/>+9 vs<nuxt-link to="/armor/Armor_Class_Ship">船隻</nuxt-link>
                <br/>+1 vs<nuxt-link to="/armor/Armor_Class_Eagle_Warrior">鷹斥侯</nuxt-link>
            ...
            <tr>
              ...
              <td class="unit4">
                <img class="gg" src="~assets/Pikeman-research.jpg" alt="">215肉90金</td>
            </tr>
            <tr>
      ...
      <div class="col-md-12">
        ...
        <div class="n1">
          ...
          <div class="col-md-4"> <nuxt-link to="/img/Spearman.png"><img class="imgn hg" src="~assets/Spearman.png" alt=""></nuxt-link> 
            <p><em>一群長槍兵</em>
            </p>
          </div>
        </div>
