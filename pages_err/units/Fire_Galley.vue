<template>
    ...
    <div class="container">
      ...
      <div class="row padtop">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>火蒙衝在封建時代時可以在碼頭中被訓練，當把<a href="/units/Galley">戰船</a>升級成<a href="/War_units/Galley">弩砲戰船</a>的時候，火蒙衝也會自動升級成
              <a
              href="/units/Fire_Ship">火戰船</a>。</p>
            <p>火蒙衝、<a href="/units/Demolition_Raft">自爆筏</a>都是在<a href="/games/ak">非洲王國</a>資料片的時候一起推出的，使封建時代海戰才有更多的可看性，而不是只能看到一堆戰船的海戰。</p>
            <p>而<a href="/civs/Vikings">維京</a>成了全文明中唯一不能出火蒙衝的國家，這也使得在<a href="/games/aoc">征服者入侵</a>時代的海戰強國，搖身一變成海戰初期弱勢文明，在
              <a
              href="/techsage/Feudal_Age">封建時代</a>遇到敵方的火蒙衝時，將顯得相當無助。</p>
            <p><strong>不可生產文明：</strong>維京</p>
          </div>
           <h3>戰術</h3> 
          <div class="hrn1"></div>
          <div class="n1">
            <p>因為火蒙衝有著很高的攻速，所以在前期能夠對<a href="/units/Fishing_Ship">漁船</a>、碼頭造成嚴重的威脅，所以在早期的比賽中使用火蒙衝能夠很有效騷擾對方的海上單位。</p>
            <p>當火蒙衝與戰船一對一的時候，火蒙衝能夠輕鬆地打贏<a href="/units/Galley">戰船</a>。但是，如果是在大規模的交戰中，由於因為戰船的高射程，反而是戰船有著較大的優勢。</p>
            <p>火蒙衝也很容易受到<a href="/units/Demolition_Raft">自爆筏</a>的威脅，因為火蒙衝的攻擊距離很近，所以無法在爆炸前打沉
              <a
              href="/units/Demolition_Raft">自爆筏</a>。如果一艘<a href="/units/Demolition_Raft">自爆筏</a>能夠打沉兩艘以上的火蒙衝就是非常划算了！</p>
            <p>值得一提的是，<a href="/units/Demolition_Raft">自爆筏</a>沒辦法一擊必殺火蒙衝，需要搭配其他船隻來解決殘血的火蒙衝。</p>
          </div>
          <h3>更多數據</h3>
          <div class="hrn1"></div>
          <div class="n1"></div>
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4"><a href="/units/Transport_Ship">運輸船</a>、<a href="/units/Fishing_Ship">漁船</a>、在岸邊的建築物和近戰單位、
                <a
                href="/units/Galley">戰船</a>。</td>
            </tr>
            <tr>
              <td class="tta1" style="width:30%">劣勢(不易對抗)</td>
              <td class="tta4"><a href="/units/Demolition_Raft">自爆筏</a>、箭塔、在岸邊的範圍單位。</td>
            </tr>
            <tr class="tta">
              <td class="unit" colspan="2" style="text-align: center;">
            ...
            <tr>
              ...
              <td class="tta4">
                <p>
                  ...
                  alt=""><a href="/techs/Greek_Fire">希臘之火</a>(+1，<a href="/civs/Byzantines">拜占庭</a>限定)</p>
              </td>
            </tr>
            <tr>
          ...
          <div class="n1">
            <ul>
              <li><a href="/civs/Berbers">阿茲特克</a>：火蒙衝訓練速度提高15%。</li>
              <li><a href="/civs/Berbers">柏柏</a>：火蒙衝移動速度提高10％。</li>
              <li><a href="/civs/Burmese">緬甸</a>：研究<a href="/techs/Faith">忠誠信仰</a>便宜50％。</li>
              <li><a href="/civs/Byzantines">拜占庭</a>：火蒙衝開火速率快25%。</li>
              <li><a href="/civs/Celts">賽爾特</a>：在視野內的動物不會被轉化</li>
              <li><a href="/civs/Chinese">中國</a>：有利於火蒙衝科技在城堡/帝王便宜15%/20％</li>
              ...
              <li><a href="/civs/Persians">波斯</a>：火蒙衝在封建/城堡/帝王時代訓練的速度提高10/15/20% <a href="/techs/Careening">傾側維修術</a>和升級到
                <a
                href="/units/Fire_Galley">火戰船</a>的研發速度在城堡/帝王時代提高15%/20％。研究<a href="/Dry building/Dock">旱碼頭</a>的速度快20％。</li>
              <li><a href="/civs/Portuguese">葡萄牙</a>：火蒙衝訓練減少15%黃金成本，火蒙衝+10％HP。</li>
            </ul>
          </div>
           <h3>團隊加成</h3> 
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              ...
              <li><a href="/civs/Teutons">條頓</a>：火蒙衝對招降的抵抗力更強。</li>
            </ul>
          </div>
          <h3>更新日誌</h3>
          <div class="hrn1"></div>
          <div class="n1">
            ...
            <ul>
              <li>火蒙衝有5的遠防。</li>
              <li>火蒙衝有100的HP。</li>
              <li>4.8版本後火蒙衝有95的HP，並且會受到<a href="/techs/Ballistics">彈道學</a>的影響。</li>
            </ul>
        ...
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="unit4">除了<a href="/civs/Vikings">維京</a>以外的所有文明</td>
            </tr>
            <tr>
              <td class="unit3">時代</td>
              <td class="unit4">
                <img class="gg" src="~assets/Feudal-age-reseach.jpg" alt=""><a href="/techsage/Feudal_Age">封建時代</a>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4">+3對<a href="/armor/Armor_Class_Ship">船</a> 
                <br/>+1對<a href="/armor/Armor_Class_Turtle_Ship">龜甲船</a> 
                <br/>+1對<a href="/armor/Armor_Class_Building">建築</a>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4"><a href="/armor/Armor_Class_Ship">船</a>(+6)</td>
            </tr>
            <tr>
