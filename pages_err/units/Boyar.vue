<template>
    ...
    <div class="container">
      ...
      <div class="row padtop">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>貴族鐵騎是<a href="/civs/Slavs">斯拉夫</a>的特殊單位，能夠在<a href="/techsage/Castle_Age">城堡時代</a>的
              <a
              href="/building/Castle">城堡</a>中訓練。貴族鐵騎是擁有極高近防裝甲而且攻擊力高的重裝騎兵單位。貴族鐵騎可以在<a href="/techsage/Imperial_Age">帝王時代</a>升級為精銳貴族鐵騎。</p>
          </div>
           <h3>戰術要點</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              ...
              <li><a href="/units/Monk">僧侶</a>對貴族鐵騎一定的破壞力，因斯拉夫沒有<a href="/techs/Heresy">異端邪說</a>和
                <a
                href="/techs/Faith">忠誠信仰</a>，這也間接的說明了斯拉夫人蠻懼怕僧侶文明。</li>
          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4"><a href="/units/Skirmisher">矛兵系列</a>、大部分近戰單位。</td>
            </tr>
            <tr>
              <td class="tta1" style="width:30%">劣勢(不易對抗)</td>
              <td class="tta4"><a href="/units/Pikeman">重裝長槍兵</a>、<a href="/units/Kamayuk">槍隊長</a>、<a href="/Teutonic_units/Knight">條頓武士</a>、
                <a
                href="/units/Mameluke">奴隸兵</a>、<a href="/units/Camel">駱駝騎兵</a>、<a href="/units/Monk">僧侶</a>、<a href="/War_unitsanimal/Elephant">戰象</a>、
                  <a
                  href="/units/Samurai">日本武士</a>、防禦建築、<a href="/units/Archer_Units">弓兵單位</a>
              </td>
            </tr>
            <tr class="tta">
              <td class="unit" colspan="2" style="text-align: center;">
          ...
          <div class="n1">
            <ul>
              <li><a href="/civs/Berbers">柏柏</a>：<a href="/techs/Kasbah">聚居堡壘</a>能夠提高貴族鐵騎的生產速度</li>
              <li><a href="/civs/Huns">匈奴</a>：<a href="/techs/Bloodlines">品種</a>與<a href="/techs/Husbandry">畜牧技術</a>研發快20%。</li>
              <li><a href="/civs/Teutons">條頓</a>：貴族鐵騎更不容易被招降。</li>
            </ul>
          </div>
           <h3>更新日誌</h3>
          <div class="hrn1"></div>
