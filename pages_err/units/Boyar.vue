<template>
    ...
    <div class="container">
      ...
      <div class="row padtop">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>貴族鐵騎是<nuxt-link to="/civs/Slavs">斯拉夫</nuxt-link>的特殊單位，能夠在<nuxt-link to="/techsage/Castle_Age">城堡時代</nuxt-link>的
              <nuxt-link to="/building/Castle">城堡</nuxt-link>中訓練。貴族鐵騎是擁有極高近防裝甲而且攻擊力高的重裝騎兵單位。貴族鐵騎可以在<nuxt-link to="/techsage/Imperial_Age">帝王時代</nuxt-link>升級為精銳貴族鐵騎。</p>
          </div>
           <h3>戰術要點</h3>
          <div class="hrn1"></div>
          <div class="n1">
