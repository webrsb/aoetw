      ...
      <div class="row padtop">
        ...
        <div class="col-md-8">
          ...
          <div class="n1">
            <div class="col-md-12">
              <div class="col-md-4">
                <img class="hg" width="200" src="~assets/Constablerichemont.png" alt="">
                <p><em>戰役編輯器中的阿朗松公爵。</em>
                </p>
              </div>
              <div class="col-md-5">
                <img class="hg" width="220" src="~assets/Dukeandjoan.png" alt="">
          ...
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style=" background-color:#d01022;">
                <div class="unititle"><nuxt-link to="">阿朗松公爵</nuxt-link>
                </div>
              </td>
            </tr>
            <tr>
              <td colspan="2">
                <div class="unititle">
                  <img src="~assets/Dukedalencon.png" width="80" alt="">
                </div>
              </td>
            </tr>
            <tr>
