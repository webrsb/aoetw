          ...
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style=" background-color:#d01022;">
                <div class="unititle"><nuxt-link to="">重劍兵</nuxt-link>
                </div>
              </td>
            </tr>
            <tr>
              <td colspan="2">
                <div class="unititle">
                  <img src="~assets/Heavyswordsmanicon.jpg" width="80" alt="">
                </div>
              </td>
            </tr>
            <tr>
