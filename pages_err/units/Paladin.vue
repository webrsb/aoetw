<template>
    ...
    <div class="container">
      ...
      <div class="row padtop">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>遊俠，新譯名為聖騎士。遊俠是<a href="/techsage/Imperial_Age">帝王時代</a>兵種，可訓練於<a href="/building/Stable">馬廄</a>，在帝王時代最強勢的兵種之一，對於
              <a
              href="/units/Monk">僧侶</a>、<a href="/units/Camel">駱駝兵種</a>、<a href="/units/Pikeman">長槍兵種</a>較劣勢。</p>
          </div>
          <h3>文明可訓練與否</h3> 
          <div class="hrn1"></div>
          <div class="row">
            <div class="col-md-12">
              <div class="n1">
                 <h4><strong><span class="glyphicon glyphicon-ok okc" aria-hidden="true"></span><span class="" style="margin-left: 2px;">可訓練</span></strong></h4>  <a href="/civs/Byzantines">拜占庭</a>、 <a href="/civs/Franks">法蘭克</a>、 <a href="/civs/Celts">賽爾特</a>、
                <a
                href="/civs/Huns">匈奴</a>、 <a href="/Magyar.php">馬札爾</a>、 <a href="/civs/Persians">波斯</a>、 <a href="/civs/Spanish">西班牙</a>、
                  <a
                  href="/civs/Teutons">條頓</a>。</div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
              <div class="n1">
                 <h4><strong><span class="glyphicon glyphicon-remove noc" aria-hidden="true"></span><span class="" style="margin-left: 2px;">不可訓練</span></strong></h4>  <a href="/civs/Aztecs">阿茲特克</a>、 <a href="/civs/Berbers">柏柏</a>、 <a href="/civs/Britons">不列顛</a>、
                <a
                href="/civs/Burmese">緬甸</a>、 <a href="/civs/Chinese">中國</a>、 <a href="/civs/Ethiopians">衣索比亞</a>、
                  <a
                  href="/civs/Goths">哥德</a>、 <a href="/civs/Incas">印加</a>、 <a href="/civs/Indians">印度</a>、 <a href="/civs/Italians">義大利</a>、
                    <a
                    href="/civs/Japanese">日本</a>、 <a href="/civs/Khmer">高棉</a>、 <a href="/civs/Koreans">韓國</a>、 <a href="/civs/Malay">馬來</a>、
                      <a
                      href="/civs/Malians">馬利</a>、 <a href="/civs/Mayans">馬雅</a>、 <a href="/civs/Mongols">蒙古</a>、 <a href="/civs/Portuguese">葡萄牙</a>、
                        <a
                        href="/civs/Saracens">薩拉森</a>、 <a href="/civs/Slavs">斯拉夫</a>、 <a href="/civs/Turks">土耳其</a>、 <a href="/civs/Vietnamese">越南</a>、
                          <a
          ...
          <div class="n1">遊俠一直以來都是世紀帝國的象徵之一，也算是全遊戲最好使用的兵種，其攻擊、防禦與血量、速度都是頂尖。一隊40隻遊俠可無視任何阻礙，消滅任何準備不足的單位或是建築。
            <a
            href="/civs/Franks">法蘭克</a>遊俠比一般遊俠多12HP，是全遊戲最強大的遊俠。而拜占庭與賽爾特遊俠則是重看不重用。</div>
          <h3>更多數據</h3>
          <div class="hrn1"></div>
          <div class="n1"></div>
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4"><a href="/units/Infantry_Units">步兵</a>、<a href="/units/Archer_Units">弓兵</a>、
                <a
                href="/units/Villager">村民</a>、<a href="/units/Siege_Weapons">攻城器單位</a>、<a href="/Cavalry_units/Archer">馬弓騎兵</a>、
                  <a
                  href="/units/Light_Cavalry">輕騎兵</a>。</td>
            </tr>
            <tr>
              <td class="tta1" style="width:30%">劣勢(不易對抗)</td>
              <td class="tta4"><a href="/units/Boyar">貴族鐵騎</a>、<a href="/units/Pikeman">重裝長槍兵</a>、<a href="/units/Kamayuk">槍隊長</a>、
                <a
                href="/units/Berserk">狂戰士</a>、<a href="/Genoese_units/Crossbowman">熱那亞弩手</a>、<a href="/Teutonic_units/Knight">條頓武士</a>、
                  <a
                  href="/units/Mameluke">奴隸兵</a>、<a href="/units/Camel">駱駝騎兵</a>、<a href="/units/Monk">僧侶</a>和<a href="/War_unitsanimal/Elephant">戰象</a>。</td>
            </tr>
            <tr class="tta">
              <td class="unit" colspan="2" style="text-align: center;">
            ...
            <tr>
              ...
              <td class="tta4">
                ...
                <br/>
                <img class="gg" src="~assets/CastleAgeUnique.png" alt=""><a href="/techs/Chivalry">騎士精神</a>：馬廄工作速率快40%。<a href="/civs/Franks">法蘭克</a>限定</td>
            </tr>
          </table>
        </div>
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <tr>
                ...
                <td class="unit4">
                  <img class="gg" src="~assets/CavalierIcon.jpg" alt=""><a href="/units/Cavalier">騎兵</a>
                </td>
              </tr>
          </table>
        </div>
      ...
      <div class="col-md-12">
        ...
        <div class="n1">
          <ul>
            <li><a href="/civs/Celts">賽爾特</a>：只要在一個賽爾特單位的視野下，羊群不會被牽走</li>
            <li><a href="/civs/Franks">法蘭克</a>：遊俠血量多20%，研發<a href="/techs/Chivalry">騎士精神</a>後，
              <a
              href="/techs/Husbandry">畜牧技術</a>的研發速度都加快40%</li>
            <li><a href="/civs/Magyars">馬扎爾</a>：免費<a href="/techs/Forging">鍛造</a>、<a href="/techs/Iron_Casting">鑄造</a>和
              <a
              href="/techs/Blast_Furnace">鼓風爐</a>科技</li>
        ...
        <div class="n1">
          <ul>
            ...
            <li><a href="/civs/Franks">法蘭克</a>：遊俠+2視野。</li>
            <li><a href="/civs/Huns">匈奴</a>：遊俠生產效率快20%，<a href="/techs/Bloodlines">品種</a>與
              <a
              href="/techs/Husbandry">畜牧技術</a>研發快20%。</li>
            <li><a href="/civs/Persians">波斯</a>：遊俠對<a href="/armor/Armor_Class_Archer">射手類</a>+2攻擊。</li>
            <li><a href="/civs/Teutons">條頓</a>：遊俠對僧侶抵抗力更強。</li>
          </ul>
        </div>
        <h3>更新日誌</h3>
        <div class="hrn1"></div>
        <div class="n1">
          ...
          <ul>
            <li><a href="/civs/Franks">法蘭克</a>：引進<a href="/techs/Chivalry">騎士精神</a>。</li>
          </ul>
        </div>
        <h3>趣事</h3>
        <div class="hrn1"></div>
