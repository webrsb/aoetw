        ...
        <div class="col-md-8">
          <div class="n1">
            <p>弩砲戰船(或稱加利恩帆船)在城堡時代時可以在碼頭中被訓練，特別的是，它升級前射出的是箭，在升級後弩砲戰船射出的反而比較像攻城器弩砲，但卻不同於
              <a
              href="/techs/Carrack">卡拉維爾戰船</a>、<a href="/units/Scorpion">弩砲</a>，弩砲戰船只能攻擊一個單位，攻擊沒有穿透效果。</p>
          </div>
           <h3>戰術</h3> 
          <div class="hrn1"></div>
          <div class="n1">
            <p>在海戰中，重要的是快速升級到城堡時代、研發弩砲戰船，因為這大大減低了研發戰船的時間(60秒→36秒)，而且因為戰船是海戰中相對比較弱小的攻擊單位，所以非常建議趕快升級成弩砲戰船。</p>
            <p>弩砲戰船在任何海戰中都扮演要角的地位，在好的操作之下弩砲戰船、重型弩砲戰船通常能有效的處理<a href="/units/Demolition_Ship">神風船</a>以及
              <a
              href="/units/Cannon_Galleon">火炮戰船</a>。除了防禦箭塔、城堡、攻城器具以外，他們還可以用來攻擊敵方海岸邊的建築、敵人。在大多數情況下，弩砲戰船是會與<a href="/units/Fire_Galley">火戰船</a>配合，一個打近的一個打遠的，並且對
                <a
                href="/units/Transport_Ship">運輸船</a>來說弩砲戰船也是一個很好的保護。</p>
            <p>弩砲戰船最主要是被<a href="/units/Fire_Galley">火戰船</a>克制，但在大部分情況下神風船也嚴重地克制弩砲戰船。
              <a
              href="/units/Longboat">維京大戰船</a>、<a href="/units/Turtle_Ship">龜甲船</a>是嚴重威脅，像是<a href="/units/Trebuchet">巨型投石機</a>、
                <a
                href="/units/Onager">中型投石車</a>、<a href="/units/Bombard_Cannon">火砲</a>也會對艦隊造成毀滅性打擊。
                  <br/>另外，僧侶也是一大威脅，特別是沒有研發<a href="/techs/Faith">忠誠信仰</a>
            </p>
          </div>
          <h3>更多數據</h3>
          <div class="hrn1"></div>
          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4"><a href="/units/Transport_Ship">運輸船</a>、<a href="/units/Fishing_Ship">漁船</a>、在岸邊的建築物和近戰單位。</td>
            </tr>
            <tr>
              <td class="tta1" style="width:30%">劣勢(不易對抗)</td>
              <td class="tta4"><a href="/units/Fire_Galley">火戰船</a>、<a href="/units/Turtle_Ship">龜甲船</a>、
                <a
                href="/units/Longboat">維京大戰船</a>、箭塔、<a href="/building/Castle">城堡</a>、在岸邊的攻城器單位。</td>
            </tr>
            <tr class="tta">
              <td class="unit" colspan="2" style="text-align: center;">
            ...
            <tr>
              ...
              <td class="tta4">
                <img class="gg" src="~assets/Ballistics.jpg" width="30" alt=""><a href="/techs/Ballistics">彈道學</a>:較易擊中移動目標</td>
            </tr>
            <tr>
          ...
          <div class="n1">
            <ul>
              <li><a href="/civs/Berbers">阿茲特克</a>：弩炮戰船訓練速度提高15%。</li>
              <li><a href="/civs/Berbers">柏柏</a>：弩炮戰船移動速度提高10％。</li>
              <li><a href="/civs/Byzantines">緬甸</a>：研究<a href="/techs/Faith">忠誠信仰</a>便宜50％。</li>
              <li><a href="/civs/Celts">賽爾特</a>：在視野內的動物不會被轉化</li>
              <li><a href="/civs/Chinese">中國</a>：有利於弩炮戰船科技在城堡/帝王便宜15%/20％</li>
              <li><a href="/civs/Italians">義大利</a>：研究<a href="/techs/Careening">傾側維修術</a>，
                <a
                href="/Dry building/Dock">旱碼頭</a>和<a href="/techs/Shipwright">造船匠</a>便宜50％，升級到弩砲戰船便宜50%。</li>
              <li><a href="/civs/Persians">波斯</a>：弩炮戰船訓練的速度在城堡/帝王提高15%/20%，<a href="/techs/Careening">傾側維修術</a>和弩砲戰船的研究速度在城堡/帝王提高15%/20％。研究
                <a
                href="/Dry building/Dock">旱碼頭</a>的速度快20％。</li>
              <li><a href="/civs/Portuguese">葡萄牙</a>：弩炮戰船訓練減少15%黃金成本，弩炮戰船+10％HP。</li>
              <li><a href="/civs/Saracens">薩拉森</a>：弩炮戰船攻擊速度提高25%。</li>
              <li><a href="/civs/Spanish">西班牙</a>：在兵工廠升級有利於弩炮戰船的科技不消耗黃金。</li>
              <li><a href="/civs/Turks">土耳其</a>：<a href="/techs/Chemistry">化學</a>免費。</li>
              <li><a href="/civs/Vikings">維京</a>：弩炮戰船在城堡/帝王時代便宜15%/20%。</li>
            </ul>
          </div>
           <h3>團隊加成</h3> 
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              <li><a href="/civs/Japanese">日本</a>：弩炮戰船擁有+50%的視野距離。</li>
              <li><a href="/civs/Malians">馬利</a>：研究<a href="/techs/Chemistry">化學</a>、<a href="/techs/Ballistics">彈道學</a>的速度提高80%</li>
              <li><a href="/civs/Teutons">條頓</a>：弩炮戰船對招降的抵抗力更強。</li>
            </ul>
          </div>
          <h3>更新日誌</h3>
          <div class="hrn1"></div>
          <div class="n1">
            ...
            <ul>
              ...
              <li><a href="/civs/Vikings">維京</a>:弩炮戰船成本便宜20%。</li>
            </ul>
            ...
            <ul>
              <li><a href="/civs/Vikings">維京</a>：弩炮戰船在封建/城堡/帝王時代便宜10%/15%/20%</li>
            </ul>
          </div>
           <h3>豆知識</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              <li>弩炮戰船是遊戲中唯四升級後所有文明都可使用的單位之一(其他三個分別是<a href="/units/Man-at-Arms">裝甲步兵</a>、
                <a
                href="/units/Long_Swordsman">長劍兵</a>和<a href="/units/Capped_Ram">裝甲衝撞車</a>)。</li>
              <li>弩炮戰船會對作弊單位中的<a href="/units/hero/Saboteur">破壞者</a>有額外攻擊加成(從<a href="/games/aoc">征服者入侵</a>資料片開始)，因為該單位屬於船隻單位。</li>
            </ul>
          </div>
          <h3>歷史</h3> 
          <div class="hrn1"></div>
        ...
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="unit4">+9對<a href="/armor/Armor_Class_Ship">船</a>
                <br/>+7對<a href="/armor/Armor_Class_Building">建築</a>
                <br/>+4對<a href="/armor/Armor_Class_Ram">衝撞車</a>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4">
                <img class="gg" src="~assets/Galley.jpg" alt=""><a href="/War_units/Galley">戰船</a>
              </td>
            </tr>
            <tr>
              <td class="unit3">升級到</td>
              <td class="unit4">
                <img class="gg" src="~assets/GalleonAoE2.jpg" alt=""><a href="/units/Galleon">重型弩砲戰船</a>
              </td>
            </tr>
            <tr>
        ...
        <div class="col-md-12">
          ...
          <div class="n1">
            <div class="col-md-12">
              ...
              <div class="col-md-4"> <a href="/img/Wargalley.png"><img class="imgn hg" src="~assets/Wargalley.png" alt=""></a> 
                <p><em>一群弩炮戰船。</em>
                </p>
              </div>
              <div class="col-md-4"> <a href="/img/WarGalleyHD.png"><img class="imgn hg" src="~assets/WarGalleyHD.png" alt=""></a> 
                <p><em>各種弩炮戰船(世紀帝國和征服者入侵資料片)。</em>
                </p>
              </div>
              <div class="col-md-12">
                <div class="col-md-4"> <a href="/img/WarGalleyDLC.png"><img class="imgn hg" src="~assets/WarGalleyDLC.png" alt=""></a> 
