      ...
      <div class="row padtop">
        ...
        <div class="col-md-8">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="n1">
                 <h4><strong><span class="glyphicon glyphicon-remove noc" aria-hidden="true"></span><span class="" style="margin-left: 2px;">不可訓練</span></strong></h4>  <nuxt-link to="/civs/Aztecs">阿茲特克</nuxt-link>、 <nuxt-link to="/civs/Britons">不列顛</nuxt-link>、 <nuxt-link to="/civs/Chinese">中國</nuxt-link>、
                <nuxt-link to="/civs/Franks">法蘭克</nuxt-link>、 <nuxt-link to="/civs/Incas">印加</nuxt-link>、 <nuxt-link to="/civs/Japanese">日本</nuxt-link>、 <nuxt-link to="/civs/Khmer">高棉</nuxt-link>、
                  <nuxt-link to="/civs/Malay">馬來</nuxt-link>、 <nuxt-link to="/civs/Malians">馬利</nuxt-link>、 <nuxt-link to="/civs/Mayans">馬雅</nuxt-link>、 <nuxt-link to="/civs/Portuguese">葡萄牙</nuxt-link>、
                    <nuxt-link to="/civs/Teutons">條頓</nuxt-link>、 <nuxt-link to="/civs/Vietnamese">越南</nuxt-link>、 <nuxt-link to="/civs/Vikings">維京</nuxt-link>。</div>
            </div>
          </div>
          <h3>戰術</h3>
          <div class="hrn1"></div>
          <div class="n1">匈牙利輕騎兵可用於偷襲對手家裡、貿易車隊以及攻城武器和僧侶給予敵人經濟上的打擊。帝王時代初期<nuxt-link to="/civs/Turks">土耳其</nuxt-link>的匈牙利輕騎兵免費升級。當打到大後期時，匈牙利輕騎兵因不需要黃金則有重要的戰略意義，此時沒有匈牙利輕騎兵的國家劣勢會因此浮現出來。</div>
          <h3>更多數據</h3>
          <div class="hrn1"></div>
          <div class="n1"></div>
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4"><nuxt-link to="/units/Skirmisher">矛兵系列</nuxt-link>，攻城器單位。</td>
            </tr>
            <tr>
              ...
              <td class="tta4"><nuxt-link to="/units/Spearman">槍兵</nuxt-link>系，<nuxt-link to="/units/Kamayuk">槍隊長</nuxt-link>，<nuxt-link to="/units/Mameluke">奴隸兵</nuxt-link>，
                <nuxt-link to="/units/Camel">駱駝騎兵</nuxt-link>，<nuxt-link to="/Genoese_units/Crossbowman">熱那亞弩手</nuxt-link>，大部分近戰單位</td>
            </tr>
            <tr class="tta">
              <td class="unit" colspan="2" style="text-align: center;">
            ...
            <tr>
              ...
              <td class="tta4">
                ...
                <br/>
                <img src="~assets/Unique-tech.jpg" class="gg" alt=""><nuxt-link to="/techs/Manipur_Cavalry">曼尼普爾騎兵</nuxt-link>:騎兵對建築物攻擊+3。</td>
            </tr>
            <tr>
          ...
          <div class="n1">
            <ul>
              <li><nuxt-link to="/civs/Berbers">柏柏</nuxt-link>：匈牙利輕騎兵便宜20%。</li>
              ...
              <li><nuxt-link to="/civs/Magyars">馬扎爾</nuxt-link>：免費鍛造.鑄鐵.鼓風爐科技，匈牙利輕騎兵系生產便宜15%</li>
              <li><nuxt-link to="/civs/Mongols">蒙古</nuxt-link>：匈牙利輕騎兵血量多30%。</li>
            </ul>
          </div>
          <h3>團隊加成</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              ...
              <li><nuxt-link to="/civs/Huns">匈奴</nuxt-link>：匈牙利輕騎兵生產效率快20%，<nuxt-link to="/techs/Bloodlines">品種</nuxt-link>與
                <nuxt-link to="/techs/Husbandry">畜牧技術</nuxt-link>研發快20%。</li>
              <li><nuxt-link to="/civs/Mongols">蒙古</nuxt-link>：匈牙利輕騎兵+2視野。</li>
              <li><nuxt-link to="/civs/Teutons">條頓</nuxt-link>：匈牙利輕騎兵對僧侶抵抗力更強。</li>
            </ul>
          </div>
          <h3>更新日誌</h3>
          <div class="hrn1"></div>
          <div class="n1">
            ...
            <ul>
              <li><nuxt-link to="/civs/Italians">義大利</nuxt-link>:沒有匈牙利輕騎兵。</li>
              <li><nuxt-link to="/civs/Magyars">馬扎爾</nuxt-link>:匈牙利輕騎兵便宜10%。</li>
            </ul>
            <h3><em><nuxt-link to="/games/ak">非洲王國</nuxt-link></em></h3>
            <ul>
              <li><nuxt-link to="/civs/Italians">義大利</nuxt-link>:有匈牙利輕騎兵了。</li>
            </ul>
            <h3><em><nuxt-link to="/games/aor">王者崛起</nuxt-link></em></h3>
            <ul>
              <li><nuxt-link to="/civs/Magyars">馬扎爾</nuxt-link>:5.5版本後匈牙利輕騎兵現在便宜15%。</li>
            </ul>
          </div>
          <h3>趣事</h3>
          <div class="hrn1"></div>
          ...
          <div class="n1">
            <div class="col-md-12">
              <div class="col-md-4"> <nuxt-link to="/img/Hussar.png"><img class="imgn hg" src="~assets/Hussar.png" alt=""></nuxt-link> 
                <p><em>一群匈牙利輕騎兵。</em>
                </p>
              </div>
            </div>
        ...
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            ...
            <tr>
              <td colspan="2">
                <div class="unititle">
                  <img src="~assets/HussarIcon.jpg" width="45" alt="">
                </div>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4">+12對<nuxt-link to="/armor/Armor_Class_Monk">僧侶係</nuxt-link>
              </td>
            </tr>
            <tr>
