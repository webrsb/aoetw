<template>
    ...
    <div class="container">
      ...
      <div class="row padtop">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>重型神風船在<a href="/techsage/Imperial_Age">帝王時代</a>的<a href="/building/Dock">碼頭</a>可以訓練。重型神風船上裝滿了爆炸物，可以對敵方的船隻，碼頭，被困在淺灘地地面單位，以及任何靠近岸邊的地方造成巨量傷害。重型神風船比神風船有更好的護甲、HP和更廣的爆炸範圍。他們可說是海上的爆炸桶。</p>
          </div>
           <h3>戰術</h3> 
          <div class="hrn1"></div>
          <div class="n1">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="n1">
                 <h4><strong><span class="glyphicon glyphicon-ok okc" aria-hidden="true"></span><span class="" style="margin-left: 2px;">可訓練</span></strong></h4>  <a href="/civs/Berbers">柏柏</a>、 <a href="/civs/Britons">不列顛</a>、 <a href="/civs/Byzantines">拜占庭</a>、
                <a
                href="/civs/Celts">賽爾特</a>、 <a href="/civs/Chinese">中國</a>、 <a href="/civs/Franks">法蘭克</a>、 <a href="/civs/Goths">哥德</a>、
                  <a
                  href="/civs/Huns">匈奴</a>、 <a href="/civs/Indians">印度</a>、 <a href="/civs/Malians">馬利</a>、 <a href="/civs/Mayans">馬雅</a>、
                    <a
                    href="/civs/Mongols">蒙古</a>、 <a href="/civs/Persians">波斯</a>、 <a href="/civs/Portuguese">葡萄牙</a>、
                      <a
                      href="/civs/Saracens">薩拉森</a>、 <a href="/civs/Spanish">西班牙</a>、 <a href="/civs/Teutons">條頓</a>。
                        <a
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="n1">
                 <h4><strong><span class="glyphicon glyphicon-remove noc" aria-hidden="true"></span><span class="" style="margin-left: 2px;">不可訓練</span></strong></h4>  <a href="/civs/Aztecs">阿茲特克</a>、 <a href="/civs/Burmese">緬甸</a>、 <a href="/civs/Ethiopians">衣索比亞</a>、
                <a
          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4"><a href="/units/Transport_Ship">運輸船</a>、<a href="/units/Fishing_Ship">漁船</a>、在岸邊的建築物和近戰單位、淺灘上的近戰單位。</td>
            </tr>
            <tr>
          ...
          <div class="n1">
            <ul>
              <li><a href="/civs/Berbers">柏柏</a>：重型神風船移動速度快10%。</li>
              <li><a href="/civs/Chinese">中國</a>：有利於重型神風船的科技在帝王時代便宜20％。重型神風船HP+50%。</li>
              <li><a href="/civs/Italians">義大利</a>：研究<a href="/techs/Careening">傾側維修術</a>，
                <a
                href="/Dry building/Dock">旱碼頭</a>和<a href="/techs/Shipwright">造船匠</a>的花費便宜50％。</li>
              <li><a href="/civs/Persians">波斯</a>：重型神風船訓練的速度在帝王提高20%。 <a href="/techs/Careening">傾側維修術</a>和
                <a
                href="/Dry_building/Dock">旱碼頭</a>的研究速度快20％。</li>
              <li><a href="/civs/Portuguese">葡萄牙</a>：訓練重型神風船的花費減少15%黃金，神風船HP+10％。</li>
              <li><a href="/civs/Vikings">維京</a>：重型神風船訓練的費用在帝王減少20%。</li>
            </ul>
          </div>
           <h3>團隊加成</h3> 
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              <li><a href="/civs/Teutons">條頓</a>：重型神風船對招降的抵抗力更強。</li>
            </ul>
          </div>
          <h3>更新日誌</h3>
          <div class="hrn1"></div>
          ...
          <div class="n1">
            <ul>
              <li>重型神風船的基礎攻擊力是遊戲中所有單位第二高的，僅次於<a href="/units/Trebuchet">巨型投石機</a>的200攻擊力。</li>
              <li><a href="/civs/Berbers">柏柏</a>的重型神風船當研發<a href="/Dry_building/Dock">旱碼頭</a>移動速度會是遊戲中第二快的單位，只輸給有研發
                <a
                href="/Dry_building/Dock">旱碼頭</a>和<a href="/techs/Caravan">大商隊</a>的<a href="/units/Trade_Cog">貿易商旅</a>(2.0547)。同時重型神風船也是遊戲中所有軍事單位移動速度最快的。</li>
            </ul>
          </div>
          <h3>歷史</h3>
          <div class="hrn1"></div>
        ...
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="unit4"><a href="#">自殺單位</a>、<a href="/units/Naval_Vessels">船</a>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4">+280對<a href="/armor/Armor_Class_Building">建築</a>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4"><a href="/armor/Armor_Class_Ship">船</a>(+5)</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4">
                <img class="gg" src="~assets/DemoShipIcon.jpg" alt=""><a href="/units/Demolition_Ship">神風船</a>
              </td>
            </tr>
          </table>
        ...
        <div class="col-md-12">
          ...
          <div class="n1">
            <div class="col-md-12">
              ...
              <div class="col-md-4"> <a href="/img/Heavydemo.png"><img class="imgn hg" src="~assets/Heavydemo.png" alt=""></a> 
                <p><em>一群重型神風船。</em>
                </p>
              </div>
              <div class="col-md-4"> <a href="/img/HDemolitionShipHD.png"><img class="imgn hg" src="~assets/HDemolitionShipHD.png" alt=""></a> 
                <p><em>各種重型神風船(世紀帝國和征服者入侵資料片)。</em>
                </p>
              </div>
              <div class="col-md-12">
                <div class="col-md-4"> <a href="/img/HDemolitionShipDLC.png"><img class="imgn hg" src="~assets/HDemolitionShipDLC.png" alt=""></a> 
