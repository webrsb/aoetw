    ...
    <div class="container">
      ...
      <div class="row padtop">
        ...
        <div class="col-md-8">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="n1">
                 <h4><strong><span class="glyphicon glyphicon-remove noc" aria-hidden="true"></span><span class="" style="margin-left: 2px;">不可訓練</span></strong></h4>  <nuxt-link to="/civs/Aztecs">阿茲特克</nuxt-link>、 <nuxt-link to="/civs/Incas">印加</nuxt-link>、 <nuxt-link to="/civs/Italians">義大利</nuxt-link>、
                <nuxt-link to="/civs/Malay">馬來</nuxt-link>、 <nuxt-link to="/civs/Mayans">馬雅</nuxt-link>、 <nuxt-link to="/civs/Portuguese">葡萄牙</nuxt-link>、
                  <nuxt-link to="/civs/Teutons">條頓</nuxt-link>、 <nuxt-link to="/civs/Vikings">維京</nuxt-link>。</div>
            </div>
          </div>
          <h3>戰術</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <p>升級重裝馬弓騎兵非常昂貴，即使在城堡時代屯了大量的 <nuxt-link to="/Cavalry_units/Archer">馬弓騎兵</nuxt-link>，也不會輕易的研發，一般來說上帝王後優先研發的科技為
              <nuxt-link to="/techs/Bracer">謢腕技術</nuxt-link>與 <nuxt-link to="/techs/Chemistry">化學</nuxt-link>，而不是研發重裝馬弓。 <nuxt-link to="/units/Skirmisher">矛兵</nuxt-link>和
        ...
        <div class="n1">
          <ul>
            ...
            <li><nuxt-link to="/civs/Chinese">中國</nuxt-link>：對重裝馬弓騎兵有利的科技在帝王時代便宜20%。</li>
            <li><nuxt-link to="/civs/Franks">法蘭克</nuxt-link>：多20%的血量。</li>
            <li><nuxt-link to="/civs/Huns">匈奴</nuxt-link>：造價便宜20%。
              ...
              <li><nuxt-link to="/civs/Vietnamese">越南</nuxt-link>：血量增加20%。免費<nuxt-link to="/techs/Conscription">徵兵制度</nuxt-link>。</li>
          </ul>
        </div>
        <h3>團隊加成</h3>
        <div class="hrn1"></div>
        <div class="n1">
          <ul>
            ...
            <li><nuxt-link to="/civs/Teutons">條頓</nuxt-link>：重裝馬弓騎兵對僧侶抵抗力更強。</li>
          </ul>
        </div>
        <h3>更新日誌</h3>
        <div class="hrn1"></div>
        <div class="n1">
          ...
          <ul>
            ...
            <li><nuxt-link to="/civs/Huns">匈奴</nuxt-link>:重裝馬弓騎兵便宜30％。。</li>
          </ul>
          <h3><em><nuxt-link to="/games/aof">失落的帝國</nuxt-link></em></h3>
          <ul>
            <li>成本減為40木材65黃金。</li>
            <li><nuxt-link to="/civs/Huns">匈奴</nuxt-link>:重裝馬弓騎兵便宜25％。</li>
            <li><nuxt-link to="/civs/Magyars">馬扎爾</nuxt-link>:5.5版本後特殊科技反曲弓給予重裝馬弓騎兵+1射程。</li>
            <li><nuxt-link to="/civs/Turks">土耳其</nuxt-link>:特殊科技<nuxt-link to="/techs/Sipahi">采邑騎兵</nuxt-link>給予20HP。</li>
          </ul>
          <h3><em><nuxt-link to="/games/ak">非洲王國</nuxt-link></em></h3>
          <ul>
            <li>馬弓騎兵成本再次減到40木材60黃金。</li>
            <li><nuxt-link to="/civs/Franks">法蘭克</nuxt-link>:重裝馬弓騎兵多20％的HP。</li>
            <li><nuxt-link to="/civs/Huns">匈奴</nuxt-link>:現在重裝馬弓騎兵於帝王時代便宜20％。</li>
          </ul>
          <h3><em><nuxt-link to="/games/aor">王者崛起</nuxt-link></em></h3>
          <ul>
            <li><nuxt-link to="/civs/Magyars">馬扎爾</nuxt-link>:5.5版本後特殊科技反曲弓給予重裝馬弓騎兵+1射程和+1攻擊。</li>
          </ul>
        </div>
        <h3>歷史</h3>
        <div class="hrn1"></div>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            <td colspan="2">
              <div class="unititle">
                <img src="~assets/HeavyCavArcherIcon.jpg" width="45" alt="">
              </div>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <tr>
              ...
              <td class="unit4">
                <img class="gg" src="~assets/CavalryArcherIcon.jpg" alt=""><nuxt-link to="/Cavalry_units/Archer">馬弓騎兵</nuxt-link>
              </td>
            </tr>
        </table>
      ...
      <div class="col-md-12">
        ...
        <div class="n1">
          ...
          <div class="col-md-4"> <nuxt-link to="/img/Heavycavalryarcher.png"><img class="imgn hg" src="~assets/Heavycavalryarcher.png" alt=""></nuxt-link> 
            <p><em>一群重裝馬弓騎兵</em>
            </p>
          </div>
        </div>
