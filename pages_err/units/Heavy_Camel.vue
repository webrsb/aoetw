<template>
    ...
    <div class="container">
      ...
      <div class="row padtop">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>重裝駱駝騎兵是<nuxt-link to="/techs/age/Imperial_Age">帝王時代</nuxt-link>兵種，可訓練於<nuxt-link to="/building/Stable">馬廄</nuxt-link>，對於騎兵較有優勢。</p>
          </div>
          <h3>文明可訓練與否</h3> 
          <div class="hrn1"></div>
          <div class="row">
          ...
          <div class="n1"><strong>駱駝為何剋馬？：</strong>
            ...
            <img
            class="img-responsive" src="~assets/camelhorse.jpg" alt="">
              <p>駱駝的確比馬大很多</p>
          </div>
        </div>
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="unit4">
                <img class="gg" src="~assets/Stable-logo.jpg" alt=""><nuxt-link to="/building/Stable">馬廄</nuxt-link>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <tr>
                ...
                <tr>
                  ...
                  <td class="unit4">
                    <img class="gg" src="~assets/Imperialcamel.png" alt="">1200食物600黃金</td>
                </tr>
                <tr>
