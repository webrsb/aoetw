<template>
    ...
    <div class="container">
      ...
      <div class="row padtop">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>槍隊長是<a href="/civs/Incas">印加</a>的特殊單位，能夠在<a href="/techsage/Castle_Age">城堡時代</a>的
              <a
              href="/building/Castle">城堡</a>中訓練。槍隊長是印加的兩個特殊單位之一(另一個為投石手)。它是一個拿著非常長的槍的反騎兵單位，且有1的射程。槍隊長可以在<a href="/techsage/Imperial_Age">帝王時代</a>升級為精銳槍隊長。</p>
          </div>
          <h3>戰術要點</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              <li>槍隊長適合團體做戰因為他們有1的攻擊距離可以攻擊到同伴身後的敵人，可以輕易地對騎兵造成傷害且不必跑來跑去，同時可短時間內大量生產。與<a href="/units/Pikeman">重裝長槍兵</a>一樣槍隊長對大象單位如
                <a
                href="/War_unitsanimal/Elephant">波斯戰象</a>有攻擊加成。</li>
              ...
              <li>槍隊長與重裝長槍兵一樣在面對其他步兵的表現也不盡人意，但他們的攻擊力基值和開火速率都比重裝長槍兵來的高。此外，他們的+1攻擊範圍意味著他們可以對敵方步兵造成嚴重傷亡，即使對手對他們不利。槍隊長與投石手是非常好的搭配，
                <a
                href="/units/Slinger">投石手</a>對付敵方步兵，槍隊長則對付騎兵。也可以加進<a href="/units/Eagle_Warrior">鷹戰士</a>反制弓箭手和攻城武器。雖然研發
                  <a
                  href="/techs/Couriers">信使</a>後可讓槍隊長遠防+2，但還是用鷹勇士對付弓箭手來得好。<a href="/units/Hand_Cannoneer">火槍兵</a>可輕易地擊敗槍隊長。
                    <a
                    href="/civs/Byzantines">拜占庭</a><a href="/units/Cataphract">聖騎兵</a>對步兵的額外傷害和踐踏傷害會讓槍隊長永遠翻不了身。</li>
              <li>印加玩家常見的困境是使用<a href="/units/Halberdier">戟兵</a>還是槍隊長好，這取決於資源的可用性。如果有黃金可用，那麼槍隊長應該永遠是首選，如果沒有足夠的黃金，玩家可以混合著使用。</li>
            </ul>
          </div>
          <h3>更多數據</h3>
          <div class="hrn1"></div>
          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4"><a href="/units/Skirmisher">矛兵</a>、<a href="/units/Cavalry_Units">騎兵單位</a>、
                <a
                href="/Cavalry_units/Archer">馬弓騎兵</a>、<a href="/units/Spearman">長槍兵</a>。</td>
            </tr>
            <tr>
              <td class="tta1" style="width:30%">劣勢(不易對抗)</td>
              <td class="tta4"><a href="/Plumed_units/Archer">羽毛箭射手</a>、<a href="/units/Scorpion">弩炮</a>、
                <a
                href="/units/Mangonel">投石車</a>、<a href="/units/Hand_Cannoneer">火槍兵</a>、<a href="/units/Janissary">土耳其火槍兵</a>、
                  <a
                  href="/units/Monk">僧侶</a>、<a href="/units/Slinger">投石手</a>、<a href="/units/Cataphract">聖騎兵</a>、
                    <a
            ...
            <tr>
              ...
              <td class="tta4">
                ...
                <br/>
                <img class="gg" src="~assets/Platemailarmor.jpg" width="30" alt=""><a href="/techs/Plate_Mail_Armor">步兵板甲</a>(+1/+2)
                <br/>
                <img src="~assets/Unique-tech.jpg" class="gg" alt=""><a href="/techs/Couriers">信使</a>(+1/+2，從<a href="/games/ak">非洲王朝</a>資料片開始)</td>
            </tr>
            <tr>
              <td class="tta1" style="width:10%">速度</td>
              <td class="tta4">
                <img class="gg" src="~assets/Squires.jpg" width="30" alt=""><a href="/techs/Squires">護衛</a>(+10%)
                <br/>
                <img src="~assets/Unique-tech.jpg" class="gg" alt=""><a href="/techs/Couriers">信使</a>(+10%，只在<a href="/games/aof">失落的帝國</a>資料片有)</td>
              <tr>
          ...
          <div class="n1">
            <ul>
              <li><a href="/civs/Berbers">柏柏</a>：<a href="/techs/Kasbah">聚居堡壘</a>能夠提高槍隊長的生產速度還有加速
                <a
                href="/techs/Conscription">徵兵技術</a>、<a href="/techs/Couriers">信使</a>的研究時間(快25%)。</li>
              <li><a href="/civs/Goths">哥德</a>：研發科技<a href="/techs/Tracking">追縱技術</a>、<a href="/techs/Squires">護衛</a>、
                <a
                href="/techs/Arson">縱火</a>的時間快20%。</li>
              <li><a href="/civs/Teutons">條頓</a>：槍隊長更不容易被招降。</li>
            </ul>
          </div>
          <h3>更新日誌</h3>
          <div class="hrn1"></div>
          <div class="n1">
            ...
            <ul>
              ...
              <li><a href="/techs/Arson">縱火</a>引進。</li>
              <li>槍隊長對<a href="/armor/Armor_Class_Camel">駱駝騎兵類</a>+4攻擊，精銳+6。</li>
              <li>4.8改版後槍隊長現在的移動速度是1。</li>
              <li>4.8改版後槍隊長對<a href="/armor/Armor_Class_War_Elephant">戰象單位</a>+20攻擊。</li>
            </ul>
            <h3><em><a href="/games/aor">王者崛起</a></em></h3>
            <ul>
              <li>5.7改版後槍隊長對<a href="/armor/Armor_Class_Camel">駱駝騎兵類</a>+6攻擊，精銳+10。</li>
            </ul>
          </div>
          <h3>歷史</h3>
          <div class="hrn1"></div>
        ...
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="unit4"><a href="/civs/Incas">印加</a>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4">對<a href="/armor/Armor_Class_War_Elephant">戰象類</a>+20
                <br/>對<a href="/armor/Armor_Class_Cavalry">騎兵類</a>+8/+12(精銳)
                <br/>對<a href="/armor/Armor_Class_Camel">駱駝騎兵類</a>+6/+10(精銳)</td>
            </tr>
            <tr>
