<template>
    ...
    <div class="container">
      ...
      <div class="row padtop">
        ...
        <div class="col-md-8">
          <div class="ien"><em><nuxt-link to="/civs/Saracens">薩拉森</nuxt-link>的特殊單位，騎著駱駝的遠距離單位，對付敵人的騎兵非常厲害。</em>
            <p
          ...
          <div class="n1">
            ...
            <p>雖然奴隸兵擁有+11騎兵加成抵免，但奴隸兵同時擁有<nuxt-link to="/armor/Armor_Class_Camel">駱駝</nuxt-link>的防禦類型，因此無法像
              <nuxt-link to="/civs/Byzantines">拜占庭</nuxt-link>的<nuxt-link to="/units/Cataphract">聖騎兵</nuxt-link>抵抗<nuxt-link to="/units/Spearman">長槍兵</nuxt-link>與
                <nuxt-link to="/units/Camel">駱駝騎兵</nuxt-link>的攻擊。奴隸兵也有射手的防禦類型，必須提防<nuxt-link to="/units/Huskarl">哥德衛隊</nuxt-link>與<nuxt-link to="/units/Skirmisher">矛兵</nuxt-link>的攻擊，不過奴隸兵屬於近戰傷害，還是能給予哥德衛隊與矛兵大量的傷害。</p>
          </div>
          <h3>更多數據</h3>
          <div class="hrn1"></div>
          <div class="n1"></div>
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4"><nuxt-link to="/units/Siege_Weapons">攻城武器</nuxt-link>、<nuxt-link to="/Cavalry_units/Archer">馬弓騎兵</nuxt-link>、徒步弓兵、
                <nuxt-link to="/units/Cavalry_Units">騎兵單位</nuxt-link>。</td>
            </tr>
            <tr>
              <td class="tta1" style="width:30%">劣勢(不易對抗)</td>
              <td class="tta4"><nuxt-link to="/units/Pikeman">重裝長槍兵</nuxt-link>、<nuxt-link to="/units/Kamayuk">槍隊長</nuxt-link>、<nuxt-link to="/units/Berserk">狂戰士</nuxt-link>、
            ...
            <tr>
              ...
              <td class="tta4">
                <img class="gg" src="~assets/Unique-tech.jpg" width="30" alt=""><nuxt-link to="/techs/Zealotry">狂熱舉動</nuxt-link>(+30，<nuxt-link to="/civs/Saracens">薩拉森</nuxt-link> 限定)
                <br/>
            ...
            <tr>
              ...
              <td class="tta4">
                ...
                <br/>
                <img class="gg" src="~assets/Blastfurnace.jpg" width="30" alt=""><nuxt-link to="/techs/Blast_Furnace">鼓風爐</nuxt-link>(+2)</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="tta4">
                <img class="gg" src="~assets/Faith.jpg" width="30" alt=""><nuxt-link to="/techs/Faith">忠誠信仰</nuxt-link>(+33%)
                <br/>
            ...
            <div class="n1">
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <ul>
                    <li>
                      <img class="gg" src="~assets/Towncentericon.png" width="22" alt=""><nuxt-link to="/building/Town_Center">城鎮中心</nuxt-link>
                    </li>
                    <li>
                      ...
                      alt=""><nuxt-link to="/units/Guard_Tower">防禦箭塔</nuxt-link>→
                      <img class="gg" src="~assets/Watchtowericon.png"
                ...
                <div class="col-md-12">以下技術可讓以下單位對奴隸兵有額外攻擊力
                  <div class="n1">
                    <img class="gg" src="~assets/CastleAgeUnique.png" width="22" alt=""> <nuxt-link to="/techs/Chieftains">酋長</nuxt-link>(<nuxt-link to="/civs/Vikings">維京</nuxt-link>限定)
                    <div width="22"
                    style="margin:12px 0px;"><strong>+9攻擊</strong>(對<nuxt-link to="/armor/Armor_Class_Cavalry">騎兵類</nuxt-link>+5攻擊，對
                      <nuxt-link to="/armor/Armor_Class_Camel">駱駝騎兵類</nuxt-link>+4攻擊，總共+9)</div>
                    <ul>
                      <li>
        ...
        <div class="n1">
          ...
          <ul>
            <li>奴隸兵的移動速度是1.4。</li>
            <li>奴隸兵對反<nuxt-link to="/armor/Armor_Class_Cavalry">騎兵</nuxt-link>攻擊會承受額外11點傷害。另外他們也增加新的防禦類型:
              <nuxt-link to="/units/Naval_Vessels">船</nuxt-link>，所以他們也會受到反<nuxt-link to="/armor/Armor_Class_Ship">船艦</nuxt-link>攻擊的額外傷害。</li>
          ...
          <ul>
            <li>奴隸兵從<nuxt-link to="/armor/Armor_Class_Ship">船艦</nuxt-link>護甲移除，新增<nuxt-link to="/armor/Armor_Class_Camel">駱駝護甲</nuxt-link>。</li>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="unit4"><nuxt-link to="/civs/Saracens">薩拉森</nuxt-link>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit4">+9/+12(精銳)對<nuxt-link to="/armor/Armor_Class_Cavalry">騎兵</nuxt-link>	
            </td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="unit4"><nuxt-link to="/armor/Armor_Class_Archer">射手</nuxt-link>
              <br/> <nuxt-link to="/armor/Armor_Class_Cavalry">騎兵(+11)</nuxt-link>
              <br/> <nuxt-link to="/armor/Armor_Class_Camel">駱駝</nuxt-link>
          ...
          <tr>
            ...
            <td class="unit4">
              <img class="gg" src="~assets/Mameluke.jpg" alt="">精銳奴隸兵</td>
          </tr>
          <tr>
            <td class="unit3">升級成本</td>
            <td class="unit4">
              <img class="gg" src="~assets/Elite-unique-research.jpg" alt="">600食物500黃金</td>
          </tr>
          <tr>
      ...
      <div class="col-md-12">
        ...
        <div class="hrn1"></div>
        <div class="n1">
          <div class="col-md-4"> <nuxt-link to="/img/Saracenmamluk.png"><img class="imgn hg" src="~assets/Saracenmamluk.png" alt=""></nuxt-link> 
            <p><em>奴隸兵</em>
            </p>
          </div>
          <div class="col-md-4"> <nuxt-link to="/img/Mameluke.png"><img class="imgn hg" src="~assets/Mameluke.png" alt=""></nuxt-link> 
            <p><em>一群奴隸兵</em>
            </p>
          </div>
          <div class="col-md-4"> <nuxt-link to="/img/Mameluke_history.jpg"><img class="imgn hg" src="~assets/Mameluke_history.jpg" alt=""></nuxt-link> 
