<template>
    ...
    <div class="container">
      ...
      <div class="row padtop">
        ...
        <div class="col-md-8">
          <div class="n1">帝王駱駝騎兵是<a href="/techsage/Imperial_Age">帝王時代</a>兵種，可訓練於<a href="/building/Stable">馬廄</a>，對於騎兵較有優勢，為
            <a
            href="/civs/Indians">印度</a>的特殊兵種。</div>
          <h3>戰術</h3>
          <div class="hrn1"></div>
          <div class="n1">在<a href="/civs/Indians">印度</a>文明出現後帝王駱駝騎兵為帝王時代最強大的騎兵之一，因為印度文明並沒有<a href="/units/Cavalier">騎兵</a>所以駱駝兵種成為印度不可或缺的兵種之一。雖然坦度不如騎兵類型但是可以有效的克制對方的騎兵造成重大的傷害。帝王駱駝騎兵雖為印度的特殊兵種，卻不會受到
            <a
            href="/units/Samurai">日本武士</a>的攻擊加成。帝王駱駝基本上你可以把他當成<a href="/units/Paladin">遊俠</a>看待。而帝王駱駝搭配<a href="/units/Elite_Skirmisher">戰矛兵</a>則是
              <a
              href="/civs/Indians">印度</a>在後期簡單又威力無窮的組合。</div>
          <h3>更多數據</h3>
          <div class="hrn1"></div>
          <div class="n1"></div>
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4"><a href="/units/Pikeman">重裝長槍兵</a>、<a href="/Teutonic_units/Knight">條頓武士</a>、
                <a
                href="/Genoese_units/Crossbowman">熱那亞弩手</a>、<a href="/units/Berserk">狂戰士</a>。</td>
            </tr>
            <tr class="tta">
              <td class="unit" colspan="2" style="text-align: center;">
          ...
          <div class="n1">
            <ul>
              <li><a href="/civs/Indians">印度</a>：帝王駱駝騎兵+1/+1防禦。</li>
            </ul>
          </div>
          <h3>團隊加成</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              ...
              <li><a href="/civs/Huns">匈奴</a>：帝王駱駝騎兵生產效率快20%，<a href="/techs/Bloodlines">品種</a>與
                <a
                href="/techs/Husbandry">畜牧技術</a>研發快20%。</li>
              <li><a href="/civs/Indians">印度</a>：帝王駱駝騎兵對<a href="/armor/Armor_Class_Building">建築</a>+6攻擊。</li>
              <li><a href="/civs/Teutons">條頓</a>：帝王駱駝騎兵對僧侶抵抗力更強。</li>
            </ul>
          </div>
          <h3>更新日誌</h3>
          <div class="hrn1"></div>
          <div class="n1">
            ...
            <ul>
              <li>帝王駱駝騎兵的防禦類型有包括<a href="/armor/Armor_Class_Ship">船艦護甲</a>，所以會同時承受反船/反駱駝攻擊加成。</li>
            </ul>
            <h3><em><a href="/games/ak">非洲王國</a></em></h3>
            <ul>
              <li>帝王駱駝騎兵有新的外貌。</li>
              <li>駱駝不再受到<a href="/armor/Armor_Class_Ship">船艦護甲</a>的影響，他們正式有自己的防禦類型：<a href="/armor/Armor_Class_Camel">駱駝</a>護甲。但駱駝仍然對船隻有+5的攻擊。反騎兵攻擊仍然不影響駱駝。</li>
            </ul>
          </div>
          <h3>趣事</h3>
          <div class="hrn1"></div>
        ...
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="unit4"><a href="/civs/Indians">印度</a>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4">+18對<a href="/armor/Armor_Class_Cavalry">騎兵類</a>
                ...
                <br/>+6對<a href="/armor/Armor_Class_Building">建築</a>
              </td>
            </tr>
            <tr>
              <tr>
          ...
          <div class="n1">
            <div class="col-md-12">
              ...
              <div class="col-md-12">
                ...
                <div class="col-md-4"> <a href="/img/Imperial_Camel_AoFE.jpg"><img class="imgn"  class="hg" src="~assets/Imperial_Camel_AoFE.jpg" alt=""></a> 
                  <p><em>3.6版本的帝王駱駝騎兵。</em>
                  </p>
                </div>
              </div>
