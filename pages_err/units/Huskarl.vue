<template>
    ...
    <div class="container">
      ...
      <div class="row padtop">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>哥德衛隊是哥德的特殊單位，能夠在<a href="/techsage/Castle_Age">城堡時代</a>的城堡中訓練。哥德衛隊是一個對箭矢有相當高防禦的單位。哥德衛隊可以在
              <a
              href="/techsage/Imperial_Age">帝王時代</a>升級為精銳哥德衛隊。</p>
          </div>
          <h3>戰術要點</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              <li>哥德衛隊具有優異的攻擊力和速度，但最大的優勢是他們的遠程護甲。當研發了<a href="/techs/Plate_Mail_Armor">步兵板甲</a>(遠防+2)後，對箭矢的傷害幾乎免疫，這讓他們成為弓兵殺手。一群哥德衛隊可以最小損傷摧毀一座城堡。哥德衛隊適合用來對付弓箭手，但是他們也是相當全面的單位，可以處理大多數的威脅，因為他們幾乎免疫炮火。他們的弱點包括
                <a
                href="/units/Knight">騎士</a>，還有速度比他們快的弓箭手(如<a href="/Cavalry_units/Archer">馬弓騎兵</a>、<a href="/units/Mangudai">蒙古突騎</a>、
                  <a
                  href="/Plumed_units/Archer">羽毛箭射手</a>和<a href="/units/War_Wagon">韓國馬戰車</a>）。因為他們可以選擇逃跑或是遠距離慢慢消耗哥德衛隊的血量。</li>
              <li>由於哥德衛隊缺少近戰裝甲，他們打不過<a href="/units/Camel">駱駝騎兵</a>，<a href="/units/Light_Cavalry">輕騎兵</a>和
                <a
                href="/units/Halberdier">戟兵</a>，但是他們能夠擊敗<a href="/units/Eagle_Warrior">鷹勇士</a>。哥德衛隊非常便宜而且生產迅速，所以哥德玩家仍然可以用壓倒性的數量橫掃戰場。一般應該避免跟有高護甲（
                  <a
                  href="/units/Boyar">貴族鐵騎</a>，<a href="/Teutonic_units/Knight">條頓武士</a>）的近戰單位，或對他們（<a href="/units/Jaguar_Warrior">豹勇士</a>、
                    <a
                    href="/units/Cataphract">拜占庭聖騎兵</a>、<a href="/units/Samurai">日本武士</a>）有攻擊加成的單位戰鬥。因為它們對哥德衛隊是致命的。
                      <a
                      href="/War_unitsanimal/Elephant">戰象</a>和<a href="/units/Battle_Elephant">矛象伕</a>的高HP，強大的攻擊和濺射傷害可輕易摧毀哥德衛隊，但必須警惕戟兵的出現。遠程單位如
                        <a
                        href="/units/Throwing_Axeman">擲斧兵</a>，<a href="/units/Gbeto">飛刀女獵手</a>或者<a href="/units/Mameluke">奴隸兵</a>對哥德衛隊也是有效的，儘管哥德衛隊對他們也有額外傷害加成。</li>
              <li><a href="/units/Mangonel">投石車</a>能有效用範圍傷害對付哥德衛隊，而<a href="/units/Scorpion">弩炮</a>因為是穿甲傷害所以無法在哥德衛隊接近它前造成大量傷害而容易被殲滅。
                <a
                href="/units/Hand_Cannoneer">火槍兵</a>可對哥德衛隊造成極大傷害，但需要<a href="/units/Hand_Cannoneer">火槍兵</a>數量足夠而且有近戰單位保護他們遠離哥德衛隊接近，不然還是會慘死在亂刀下(精銳哥德衛隊只需兩刀就可殺死一個
                  <a
                  href="/units/Hand_Cannoneer">火槍兵</a>)。</li>
            </ul>
          </div>
          <h3>更多數據</h3>
          <div class="hrn1"></div>
          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4"><a href="/units/Archer">弓兵</a>、<a href="/building/bulding">建築物</a>和<a href="/units/Eagle_Warrior">鷹勇士</a>、
                <a
                href="/units/Scorpion">弩炮</a>、<a href="/units/Gunpowder_Unit">火藥單位</a>。</td>
            </tr>
            <tr>
              <td class="tta1" style="width:30%">劣勢(不易對抗)</td>
              <td class="tta4"><a href="/units/Mangonel">投石車</a>、大部分的近戰單位。</td>
            </tr>
            <tr class="tta">
            ...
            <tr>
              ...
              <tr>
                ...
                <td class="tta4">
                  ...
                  <br/>
                  <img class="gg" src="~assets/Unique-tech%20(1).jpg" width="30" alt=""><a href="/techs/Perfusion">灌注士氣</a>:兵營工作速率加快2倍，只限兵營訓練的哥德衛隊</td>
              </tr>
              <tr>
                <td class="tta1" style="width:10%">其他</td>
                <td class="tta4">
                  <img class="gg" src="~assets/CastleAgeUnique.png" width="30" alt=""><a href="/techs/Anarchy">無政府狀態</a>:兵營可生產哥德衛隊。</td>
              </tr>
          </table>
          <h3>剋哥德衛隊的單位與建築</h3>
          <div class="hrn1"></div>
          ...
          <div class="n1">
            <ul>
              <li><a href="/civs/Goths">哥德</a>：哥德衛隊造價便宜35%並對<a href="/Armor_Class_standard_building.php">標準建築</a>攻擊+1。</li>
            </ul>
          </div>
          <h3>團隊加成</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              <li><a href="/civs/Berbers">柏柏</a>：<a href="/techs/Kasbah">聚居堡壘</a>能夠提高哥德衛隊的生產速度還有加速
                <a
                href="/techs/Conscription">徵兵制度</a>、<a href="/techs/Anarchy">無政府狀態</a>、<a href="/techs/Perfusion">灌注士氣</a>的研究時間(快25%)。</li>
              <li><a href="/civs/Goths">哥德</a>：研發科技<a href="/techs/Tracking">追縱技術</a>、<a href="/techs/Squires">護衛</a>、
                <a
                href="/techs/Arson">縱火</a>的時間快20%。</li>
              <li><a href="/civs/Teutons">條頓</a>：哥德衛隊更不容易被招降。</li>
            </ul>
          </div>
          <h3>更新日誌</h3>
          <div class="hrn1"></div>
          <div class="n1">
            ...
            <ul>
              ...
              <li>哥德衛隊現在對<a href="/armor/Armor_Class_Archer">弓兵</a>攻擊+3，精銳的+4。</li>
              <li>哥德衛隊現的移動速度為0.9。</li>
              <li><a href="/civs/Goths">哥德</a>:哥德衛隊在城堡/帝王時代訓練便宜15%/35%</li>
            </ul>
            <h3><em><a href="/games/aoc">征服者入侵</a></em></h3>
            <ul>
              <li>哥德衛隊不論精銳與否現在的訓練時間都是16秒。</li>
              <li>哥德衛隊有6的遠程護甲，精銳的遠程護甲是8。</li>
              <li>哥德衛隊現在對<a href="/armor/Armor_Class_Archer">弓兵</a>攻擊+6，精銳的+10。</li>
              <li>哥德衛隊現的移動速度為1.05。</li>
              <li><a href="/civs/Goths">哥德</a>:引入<a href="/techs/Perfusion">灌注士氣</a>和<a href="/techs/Anarchy">無政府狀態</a>。1.0c改版後哥德衛隊現在訓練便宜35%</li>
            </ul>
          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="unit4">對<a href="/Armor_Class_standard_building.php">標準建築</a>+2/+3(精銳)
                ...
                <br/>對<a href="/armor/Armor_Class_Archer">弓兵</a>+6/+10(精銳)</td>
            </tr>
            <tr>
        ...
        <div class="col-md-12">
          ...
          <div class="hrn1"></div>
          <div class="n1">
            <div class="col-md-4"> <a href="/img/Huskarl.png"><img class="imgn hg" width="180" src="~assets/Huskarl.png" alt=""></a> 
              <div
