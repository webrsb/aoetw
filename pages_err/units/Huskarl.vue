    ...
    <div class="container">
      ...
      <div class="row padtop">
        ...
        <div class="col-md-8">
          ...
          <div class="n1">
            <ul>
              <li>哥德衛隊具有優異的攻擊力和速度，但最大的優勢是他們的遠程護甲。當研發了<nuxt-link to="/techs/Plate_Mail_Armor">步兵板甲</nuxt-link>(遠防+2)後，對箭矢的傷害幾乎免疫，這讓他們成為弓兵殺手。一群哥德衛隊可以最小損傷摧毀一座城堡。哥德衛隊適合用來對付弓箭手，但是他們也是相當全面的單位，可以處理大多數的威脅，因為他們幾乎免疫炮火。他們的弱點包括
                <nuxt-link to="/units/Knight">騎士</nuxt-link>，還有速度比他們快的弓箭手(如<nuxt-link to="/Cavalry_units/Archer">馬弓騎兵</nuxt-link>、<nuxt-link to="/units/Mangudai">蒙古突騎</nuxt-link>、
                  <nuxt-link to="/Plumed_units/Archer">羽毛箭射手</nuxt-link>和<nuxt-link to="/units/War_Wagon">韓國馬戰車</nuxt-link>）。因為他們可以選擇逃跑或是遠距離慢慢消耗哥德衛隊的血量。</li>
              <li>由於哥德衛隊缺少近戰裝甲，他們打不過<nuxt-link to="/units/Camel">駱駝騎兵</nuxt-link>，<nuxt-link to="/units/Light_Cavalry">輕騎兵</nuxt-link>和
                <nuxt-link to="/units/Halberdier">戟兵</nuxt-link>，但是他們能夠擊敗<nuxt-link to="/units/Eagle_Warrior">鷹勇士</nuxt-link>。哥德衛隊非常便宜而且生產迅速，所以哥德玩家仍然可以用壓倒性的數量橫掃戰場。一般應該避免跟有高護甲（
                  <nuxt-link to="/units/Boyar">貴族鐵騎</nuxt-link>，<nuxt-link to="/Teutonic_units/Knight">條頓武士</nuxt-link>）的近戰單位，或對他們（<nuxt-link to="/units/Jaguar_Warrior">豹勇士</nuxt-link>、
                    <nuxt-link to="/units/Cataphract">拜占庭聖騎兵</nuxt-link>、<nuxt-link to="/units/Samurai">日本武士</nuxt-link>）有攻擊加成的單位戰鬥。因為它們對哥德衛隊是致命的。
                      <nuxt-link to="/War_unitsanimal/Elephant">戰象</nuxt-link>和<nuxt-link to="/units/Battle_Elephant">矛象伕</nuxt-link>的高HP，強大的攻擊和濺射傷害可輕易摧毀哥德衛隊，但必須警惕戟兵的出現。遠程單位如
                        <nuxt-link to="/units/Throwing_Axeman">擲斧兵</nuxt-link>，<nuxt-link to="/units/Gbeto">飛刀女獵手</nuxt-link>或者<nuxt-link to="/units/Mameluke">奴隸兵</nuxt-link>對哥德衛隊也是有效的，儘管哥德衛隊對他們也有額外傷害加成。</li>
              <li><nuxt-link to="/units/Mangonel">投石車</nuxt-link>能有效用範圍傷害對付哥德衛隊，而<nuxt-link to="/units/Scorpion">弩炮</nuxt-link>因為是穿甲傷害所以無法在哥德衛隊接近它前造成大量傷害而容易被殲滅。
                <nuxt-link to="/units/Hand_Cannoneer">火槍兵</nuxt-link>可對哥德衛隊造成極大傷害，但需要<nuxt-link to="/units/Hand_Cannoneer">火槍兵</nuxt-link>數量足夠而且有近戰單位保護他們遠離哥德衛隊接近，不然還是會慘死在亂刀下(精銳哥德衛隊只需兩刀就可殺死一個
                  <nuxt-link to="/units/Hand_Cannoneer">火槍兵</nuxt-link>)。</li>
            </ul>
          </div>
          <h3>更多數據</h3>
          <div class="hrn1"></div>
          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4"><nuxt-link to="/units/Mangonel">投石車</nuxt-link>、大部分的近戰單位。</td>
            </tr>
            <tr class="tta">
            ...
            <tr>
              ...
              <tr>
                ...
                <td class="tta4">
                  ...
                  <br/>
                  <img class="gg" src="~assets/Unique-tech%20(1).jpg" width="30" alt=""><nuxt-link to="/techs/Perfusion">灌注士氣</nuxt-link>:兵營工作速率加快2倍，只限兵營訓練的哥德衛隊</td>
              </tr>
              <tr>
                <td class="tta1" style="width:10%">其他</td>
                <td class="tta4">
                  <img class="gg" src="~assets/CastleAgeUnique.png" width="30" alt=""><nuxt-link to="/techs/Anarchy">無政府狀態</nuxt-link>:兵營可生產哥德衛隊。</td>
              </tr>
          </table>
          <h3>剋哥德衛隊的單位與建築</h3>
          <div class="hrn1"></div>
          ...
          <div class="n1">
            <ul>
              <li><nuxt-link to="/civs/Goths">哥德</nuxt-link>：哥德衛隊造價便宜35%並對<nuxt-link to="/armor/Armor_Class_standard_building">標準建築</nuxt-link>攻擊+1。</li>
            </ul>
          </div>
          <h3>團隊加成</h3>
          <div class="hrn1"></div>
          <div class="n1">
            <ul>
              <li><nuxt-link to="/civs/Berbers">柏柏</nuxt-link>：<nuxt-link to="/techs/Kasbah">聚居堡壘</nuxt-link>能夠提高哥德衛隊的生產速度還有加速
                <nuxt-link to="/techs/Conscription">徵兵制度</nuxt-link>、<nuxt-link to="/techs/Anarchy">無政府狀態</nuxt-link>、<nuxt-link to="/techs/Perfusion">灌注士氣</nuxt-link>的研究時間(快25%)。</li>
              ...
              <li><nuxt-link to="/civs/Teutons">條頓</nuxt-link>：哥德衛隊更不容易被招降。</li>
            </ul>
          </div>
          <h3>更新日誌</h3>
          <div class="hrn1"></div>
          <div class="n1">
            ...
            <ul>
              ...
              <li>哥德衛隊現在對<nuxt-link to="/armor/Armor_Class_Archer">弓兵</nuxt-link>攻擊+3，精銳的+4。</li>
              <li>哥德衛隊現的移動速度為0.9。</li>
              <li><nuxt-link to="/civs/Goths">哥德</nuxt-link>:哥德衛隊在城堡/帝王時代訓練便宜15%/35%</li>
            </ul>
            <h3><em><nuxt-link to="/games/aoc">征服者入侵</nuxt-link></em></h3>
            <ul>
              <li>哥德衛隊不論精銳與否現在的訓練時間都是16秒。</li>
              <li>哥德衛隊有6的遠程護甲，精銳的遠程護甲是8。</li>
              <li>哥德衛隊現在對<nuxt-link to="/armor/Armor_Class_Archer">弓兵</nuxt-link>攻擊+6，精銳的+10。</li>
              <li>哥德衛隊現的移動速度為1.05。</li>
              <li><nuxt-link to="/civs/Goths">哥德</nuxt-link>:引入<nuxt-link to="/techs/Perfusion">灌注士氣</nuxt-link>和<nuxt-link to="/techs/Anarchy">無政府狀態</nuxt-link>。1.0c改版後哥德衛隊現在訓練便宜35%</li>
            </ul>
        ...
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            ...
            <tr>
              <td colspan="2">
                <div class="unititle">
                  <img src="~assets/HuskarlIcon.jpg" width="45" alt="">
                </div>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4">對<nuxt-link to="/armor/Armor_Class_standard_building">標準建築</nuxt-link>+2/+3(精銳)
                ...
                <br/>對<nuxt-link to="/armor/Armor_Class_Archer">弓兵</nuxt-link>+6/+10(精銳)</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4">
                <img class="gg" src="~assets/HuskarlIcon.jpg" width="45" alt="">精銳哥德衛隊</td>
            </tr>
            <tr>
              <td class="unit3">升級成本</td>
              <td class="unit4">
                <img class="gg" src="~assets/Elite-unique-research.jpg" alt="">1200食物550黃金</td>
            </tr>
            <tr>
