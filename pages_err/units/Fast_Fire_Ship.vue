<template>
    ...
    <div class="container">
      ...
      <div class="row padtop">
        ...
        <div class="col-md-8">
          <div class="n1">
            <p>快速火戰船在<a href="/techsage/Imperial_Age">帝王時代</a>的碼頭可以訓練。這是一艘有"火焰噴射器"的船，對其他的船隻有攻擊加成，但必須靠近敵艦才能進行攻擊。。</p>
            <p>與火戰船相比，快速火戰船的傷害更高護甲也更厚。快速火戰船的速度也比火戰船快，可以追上<a href="/units/Galleon">重型弩砲戰船</a>，但是攻擊速度的話則還是跟火戰船一模一樣。</p>
          </div>
           <h3>戰術</h3> 
          <div class="hrn1"></div>
          <div class="n1">
            <p>儘管快速火戰船在與<a href="/units/Galleon">重型弩砲戰船</a>的對抗中表現更好，但是重型弩炮戰船的低成本和長射程，可以增加偵察的安全性和降低成本
              在大規模的對抗中，重型弩炮戰船可以輕易地運用長射程擊敗一群快速火戰船，但是如果得到其他海軍的適當支援，一支重型火戰船可以輕易地將一群重型弩炮戰船擊沉。快速火戰船在面對
              <a
              href="/units/Turtle_Ship">龜甲船</a>和<a href="/units/Longboat">維京大戰船</a>時也十分脆弱。</p>
            <p>。</p>
          </div>
           <h3>文明可訓練與否</h3> 
          <div class="hrn1"></div>
          <div class="row">
            <div class="col-md-12">
              <div class="n1">
                 <h4><strong><span class="glyphicon glyphicon-ok okc" aria-hidden="true"></span><span class="" style="margin-left: 2px;">可訓練</span></strong></h4>  <a href="/civs/Aztecs">阿茲特克</a>、 <a href="/civs/Berbers">柏柏</a>、 <a href="/civs/Britons">不列顛</a>、
                <a
                href="/civs/Burmese">緬甸</a>、 <a href="/civs/Byzantines">拜占庭</a>、 <a href="/civs/Franks">法蘭克</a>、
                  <a
                  href="/civs/Goths">哥德</a>、 <a href="/civs/Incas">印加</a>、 <a href="/civs/Italians">義大利</a>、 <a href="/civs/Japanese">日本</a>、
                    <a
                    href="/civs/Khmer">高棉</a>、 <a href="/civs/Koreans">韓國</a>、 <a href="/civs/Magyars">馬扎爾</a>、 <a href="/civs/Malay">馬來</a>、
                      <a
                      href="/civs/Mayans">馬雅</a>、 <a href="/civs/Mongols">蒙古</a>、 <a href="/civs/Persians">波斯</a>、 <a href="/civs/Slavs">斯拉夫</a>、
                        <a
                        href="/civs/Spanish">西班牙</a>、 <a href="/civs/Teutons">條頓</a>。 <a href="/civs/Vietnamese">越南</a>。</div>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
              <div class="n1">
                 <h4><strong><span class="glyphicon glyphicon-remove noc" aria-hidden="true"></span><span class="" style="margin-left: 2px;">不可訓練</span></strong></h4>  <a href="/civs/Burmese">緬甸</a>、 <a href="/civs/Celts">賽爾特</a>、 <a href="/civs/Chinese">中國</a>、
                <a
                href="/civs/Ethiopians">衣索比亞</a>、 <a href="/civs/Huns">匈奴</a>、 <a href="/civs/Indians">印度</a>、 <a href="/civs/Malians">馬利</a>、
                  <a
                  href="/civs/Portuguese">葡萄牙</a>、 <a href="/civs/Saracens">薩拉森</a>、 <a href="/civs/Turks">土耳其</a>、
                    <a
          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4"><a href="/units/Transport_Ship">運輸船</a>、<a href="/units/Fishing_Ship">漁船</a>、在岸邊的建築物和近戰單位、
                <a
                href="/units/Galleon">重型弩砲戰船</a>、<a href="/units/Cannon_Galleon">火炮戰船</a>。</td>
            </tr>
            <tr>
              <td class="tta1" style="width:30%">劣勢(不易對抗)</td>
              <td class="tta4"><a href="/units/Demolition_Raft">自爆筏</a>、<a href="/units/Turtle_Ship">龜甲船</a>、
                <a
                href="/units/Longboat">維京大戰船</a>、箭塔、<a href="/building/Castle">城堡</a>、在岸邊的<a href="/units/Siege_Weapons">攻城器</a>單位。</td>
            </tr>
            <tr class="tta">
              <td class="unit" colspan="2" style="text-align: center;">
            ...
            <tr>
              ...
              <td class="tta4">
                <p>
                  ...
                  alt=""><a href="/techs/Greek_Fire">希臘之火</a>(+1，<a href="/civs/Byzantines">拜占庭</a>限定)</td>
            </tr>
            <tr>
          ...
          <div class="n1">
            <ul>
              <li><a href="/civs/Berbers">阿茲特克</a>：快速火戰船訓練速度提高15%。</li>
              <li><a href="/civs/Berbers">柏柏</a>：快速火戰船移動速度提高10％。</li>
              <li><a href="/civs/Byzantines">拜占庭</a>：快速火戰船開火速率快25%。</li>
              ...
              <li><a href="/civs/Persians">波斯</a>：快速火戰船在帝王時代訓練的速度提高20%，研究<a href="/techs/Careening">傾側維修術</a>和
                <a
          ...
          <div class="n1">
            <ul>
              <li><a href="/civs/Malians">馬利</a>：研究<a href="/techs/Ballistics">彈道學</a>的速度提高80%</li>
              <li><a href="/civs/Teutons">條頓</a>：快速火戰船對招降的抵抗力更強。</li>
            </ul>
          </div>
          <h3>更新日誌</h3>
          <div class="hrn1"></div>
          <div class="n1">
            ...
            <ul>
              ...
              <li><a href="/civs/Vikings">維京</a>:火戰船木材成本便宜20%。</li>
            </ul>
            ...
            <ul>
              ...
              <li><a href="/civs/Byzantines">拜占庭</a>:引入<a href="/techs/Greek_Fire">希臘之火</a>。</li>
            </ul>
            <h3><em><a href="/games/ak">非洲王朝</a></em></h3>
            <ul>
              <li>火快速戰船現在有9的遠防並對反船隻攻擊有額外+9護甲。</li>
              <li>引入<a href="/units/Fire_Galley">火蒙衝</a>。</li>
              <li>4.8版本後快速火戰船會受到<a href="/techs/Ballistics">彈道學</a>的影響。</li>
            </ul>
          ...
          <div class="n1">
            <ul>
              ...
              <li>火戰船和<a href="/units/Fast_Fire_Ship">快速火戰船</a>是遊戲中唯二攻擊會同時造成近戰和遠程傷害的單位。</li>
              <li>火戰船會對作弊單位中的<a href="/units/hero/Saboteur">破壞者</a>有額外攻擊加成(從<a href="/games/aoc">征服者入侵</a>資料片開始)，因為該單位屬於船隻單位。</li>
            </ul>
          </div>
          <h3>歷史</h3>
          <div class="hrn1"></div>
        ...
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="unit4">+4對<a href="/armor/Armor_Class_Ship">船</a> 
                <br/>+3對<a href="/armor/Armor_Class_Turtle_Ship">龜甲船</a> 
                <br/>+3對<a href="/armor/Armor_Class_Building">建築</a>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4"><a href="/armor/Armor_Class_Ship">船</a>(+9)</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4">
                <img class="gg" src="~assets/FireShipIcon.jpg" alt=""><a href="/units/Fire_Ship">火戰船</a>
              </td>
            </tr>
          </table>
