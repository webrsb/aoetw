    ...
    <div class="container">
      ...
      <div class="row padtop">
        ...
        <div class="col-md-8">
          <div class="n1">
            ...
            <p>在黑暗時代就可以建造採礦營地，但除非有特別的戰術，ex:黑快、裝甲塔、僧侶海、塔攻..之類，否則不建議在黑暗時代建造採礦營地，雖然採礦營地也是封建時代的建築之一同時也只需要100木；但比起
              <nuxt-link to="/building/Mill">磨坊</nuxt-link>和<nuxt-link to="/building/Lumber_Camp">伐木場</nuxt-link>，在前期有限的資源及人力下，採礦營地絕對不是首選。</p>
          </div>
          <h3>可訓練的單位與技術</h3>
          <div class="hrn1"></div>
          <div class="row">
            <div class="col-md-6">
              <div class="n1">
                ...
                <ul>
                  ...
                  <li>
                    <img class="gg" src="~assets/Stonemining.jpg" alt=""><nuxt-link to="/techs/Stone_Mining">採石技術</nuxt-link>
                  </li>
                </ul>
              </div>
            </div>
            <div class="col-md-6">
              <div class="n1">
                ...
                <ul>
                  ...
                  <li>
                    <img class="gg" src="~assets/Stone_Shaft_Mining.jpg" alt=""><nuxt-link to="/techs/Stone_Shaft_Mining">礦井採石</nuxt-link>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div class="n1">
            <ul>
              <li><nuxt-link to="/civs/Byzantines">拜占庭</nuxt-link>：採礦營地在黑暗/封建/城堡/帝王時代多10%/20%/30%/40%的血量。
                <nuxt-link to="/techs/Town_Watch">城鎮瞭望</nuxt-link>免費</li>
              <li><nuxt-link to="/civs/Chinese">中國</nuxt-link>：對採礦營地有利的科技在封建/城堡/帝王時代各便宜10%/15%/20%。</li>
              <li><nuxt-link to="/civs/Japanese">日本</nuxt-link>：採礦營地的建築成本-50%。</li>
              <li><nuxt-link to="/civs/Malians">馬利</nuxt-link>：採礦營地的建築成本-15%。</li>
              <li><nuxt-link to="/civs/Spanish">西班牙</nuxt-link>：採礦營地建築速度快30%。</li>
            </ul>
          </div>
          <h3>團隊加成</h3>
          <div class="hrn1"></div>
          ...
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style=" background-color:#3c763d;;">
                <div class="unititle"><nuxt-link to="/building/Mining_Camp">採礦營地</nuxt-link>
                </div>
              </td>
            </tr>
            <tr>
        ...
        <div class="col-md-12">
          ...
          <div class="hrn1"></div>
          <div class="n1">
            <div class="col-md-4"> <nuxt-link to="/img/Miningcampaokaoc.png"><img class="imgn hg" width="180" src="~assets/Miningcampaokaoc.png" alt=""></nuxt-link> 
              <div
          ...
          <div class="col-md-4"> <nuxt-link to="/img/Mining_camp_hd.png"><img class="imgn hg" width="200" src="~assets/Mining_camp_hd.png" alt=""></nuxt-link> 
            <div
            class="lightbox-caption" style="width:220px" >
        ...
        <div class="col-md-4"> <nuxt-link to="/img/Spritesheet_mining_camp.png"><img class="imgn hg" width="200" src="~assets/Spritesheet_mining_camp.png" alt=""></nuxt-link> 
          <div
          class="lightbox-caption" style="width:220px" >
