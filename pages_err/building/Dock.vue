<template>
    ...
    <div class="container">
      ...
      <div class="row padtop">
        ...
        <div class="col-md-8">
          ...
          <div class="n1">
            <ul>
              <li>碼頭是經濟和海戰的發展重點，因為碼頭能生產各種船隻，同時也是<a href="/units/Fire_Ship">漁船</a>、<a href="/units/Trade_Cog">貿易商旅</a>的基地。依據地圖的種類來建築、發展。</li>
              <li>當像是在群島的地圖中，碼頭就是一定要的，因為大部分的交戰都是在海上發生。建議在黑暗時代至少建造一個（最好是兩個）碼頭，以便通過生產漁船來提高經濟效益。</li>
              <li>在<a href="/Coasal.php">沿海</a>、<a href="/maps/Baltic">波羅的海</a>、<a href="/maps/Continental">大陸</a>那類型的地圖上，雖然有一部分的水體，但是文明之間並沒有被水體隔開，在許多的情況下碼頭的影響力有限，但還是對經濟有一定的幫助，但海軍就只能用來支援陸上部隊、清除敵方沿海建築物，對遊戲勝敗影響較小。</li>
              <li>在<a href="/Rivers">河流</a>、<a href="/maps/Highland">高地</a>或其他以河流或湖泊為特徵的地圖，碼頭可以成為防禦性結構的一部分，因為河流和湖泊能提供地面部隊防護。在這種狀況下，使用海俊部隊能夠更有效的讓防禦性建築靠近水邊，在這種地圖上的淺灘是陸地部隊可以穿過河流的唯一窄點。</li>
              <li>通常在碼頭附近蓋暸望箭塔和城堡是很有幫助的，因為這些建築能有效的保護碼頭避免敵船的攻擊，還可以將碼頭放在海灣中，因為這會使敵方海軍難以攻擊碼頭。也可以為碼頭提供很好的保護。</li>
            </ul>
             <h3>交易</h3>
            <div class="hrn1"></div>
            <div class="n1">
              <p>貿易商旅被用來在兩個文明（同盟、中立、敵人都可以）碼頭之之間交易產生黃金，在兩個碼頭中間形成貿易路線。空的<a href="/units/Trade_Cog">貿易商旅</a>移動到另一個文明的碼頭，並帶著黃金返航。在群島地圖上的團隊遊戲，貿易商旅的路線就非常重要。</p>
            </div>
             <h3>可訓練的單位與技術</h3>
            <div class="hrn1"></div>
            <div class="row">
            ...
            <table class="table-bordered" width="100%">
              ...
              <tr>
                ...
                <td class="tta4">
                  <img class="gg" src="~assets/Shipwright.jpg" width="30" alt=""><a href="/techs/Shipwright">造船匠</a>:船隻木頭花費-20%，單位生產速度+35%</td>
              </tr>
              <tr>
                <td class="tta1">其他</td>
                <td class="tta4">碼頭可升級成<a href="/building/Harbor">巨港</a>(需要<a href="/techs/Thalassocracy">海上霸主</a>，
                  <a
                  href="/civs/Malay">馬來</a>限定)</td>
              </tr>
            </table>
             <h3>文明加成</h3>
            <div class="hrn1"></div>
            <div class="n1">
              <ul>
                ...
                <li><a href="/civs/Byzantines">拜占庭</a>：在黑暗/封建/城堡/帝王時代，碼頭擁有 +10%/+20%/+30%/+40%
                  HP。<a href="/techs/Town_Watch">城鎮暸望</a>免費</li>
                <li><a href="/civs/Chinese">中國</a>：對碼頭有益的技術在封建/城堡/帝王時代 便宜 10%/15%/20%。</li>
                <li><a href="/civs/Italians">義大利</a>：研發<a href="/techs/Shipwright">造船匠</a>便宜50%。</li>
                <li><a href="/civs/Malians">馬利</a>：碼頭便宜15%。</li>
                <li><a href="/civs/Persians">波斯</a>：碼頭有兩倍的HP，在封建/城堡/帝王時代，訓練速度提高 10%/15%/20%。研發
                  <a
                  href="/techs/Town_Watch">城鎮暸望</a>和<a href="/techs/Town_Patrol">城鎮巡邏</a>速度在封建/城堡/帝王時代提高10%/15%/20%。</li>
                <li><a href="/civs/Spanish">西班牙</a>：碼頭建造速度提高30%。</li>
              </ul>
            </div>
             <h3>團隊加成</h3>
            <div class="hrn1"></div>
            <div class="n1">
              <ul>
                <li><a href="/civs/Malay">馬來</a>：隊伍中的碼頭增加100%的視野。</li>
                <li><a href="/civs/Malians">馬利</a>：研發<a href="/civs/Vikings">磚瓦技術</a>、<a href="/civs/Vikings">建築學</a>和
                  <a
                  href="/civs/Vikings">踏輪起重機</a>速度快80%</li>
                <li><a href="/civs/Vikings">維京</a>：碼頭便宜15%`.</li>
              </ul>
            </div>
          </div>
           <h3>更新日誌</h3>
          ...
          <div class="n1">
            ...
            <ul>
              <li>有<a href="/civs/Vikings">維京</a>做盟友:<a href="/building/Dock">碼頭</a>便宜25%。</li>
            </ul>
            ...
            <ul>
              <li><a href="/units/Trade_Cog">貿易商旅</a>生產多10%黃金。</li>
              <li>引入<a href="/techs/Gillnets">流刺網</a>。</li>
              <li>有<a href="/civs/Vikings">維京</a>做盟友:<a href="/building/Dock">碼頭</a>便宜15%。</li>
            </ul>
             <h3><em><a href="/games/aok">非洲王朝</a></em></h3>
            <ul>
              <li><a href="/units/Trade_Cog">貿易商旅</a>生產多30%黃金。</li>
              <li>引入<a href="/units/Fire_Galley">火蒙衝</a>。</li>
              <li>引入<a href="/units/Demolition_Raft">自爆筏</a>。</li>
            </ul>
          </div>
           <h3>歷史</h3>
          <div class="hrn1"></div>
          ...
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style=" background-color:#3c763d;;">
                <div class="unititle"><a href="/building/Dock">碼頭</a>
                </div>
              </td>
            </tr>
            <tr>
        ...
        <div class="col-md-12">
          ...
          <div class="hrn1"></div>
          <div class="n1">
            <div class="col-md-4"> <a href="/img/DockDarkAge.png"><img class="imgn hg" width="180" src="~assets/DockDarkAge.png" alt=""></a> 
              <div
          ...
          <div class="col-md-4"> <a href="/img/DockFeudalAgeHD.png"><img class="imgn hg" width="200" src="~assets/DockFeudalAgeHD.png" alt=""></a> 
            <div
            class="lightbox-caption" style="width:220px" ;>
        ...
        <div class="col-md-4"> <a href="/img/DockFeudalAgeDLC.png"><img class="imgn hg" width="200" src="~assets/DockFeudalAgeDLC.png" alt=""></a> 
          <div
    ...
    <div class="col-md-12">
      <div class="col-md-4"> <a href="/img/Dockaokaoc.png"><img class="imgn hg" width="200" src="~assets/Dockaokaoc.png" alt=""></a> 
        <div
        class="lightbox-caption" style="width:185px" ;>
    ...
    <div class="col-md-4"> <a href="/img/Dockexpansions.png"><img class="imgn hg" width="200" src="~assets/Dockexpansions.png" alt=""></a> 
      <div
      class="lightbox-caption" style="width:220px" ;>
    ...
    <div class="col-md-4"> <a href="/img/Spritesheet_dock.png"><img class="imgn hg" width="200" src="~assets/Spritesheet_dock.png" alt=""></a> 
      <div
      class="lightbox-caption" style="width:185px" ;>
