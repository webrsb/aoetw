      ...
      <div class="row padtop">
        ...
        <div class="col-md-8">
            ...
            <div class="n1">
              ...
              <p>在高手對戰中，時常看見果樹叢的磨坊有兩種蓋法，一種是空一格蓋，緊貼著果樹叢蓋，其原因是緊貼著蓋採集效率雖高，但面對對方黑暗<nuxt-link to="/units/Militia">民兵</nuxt-link>快攻比較不好圍，而空一格的蓋法將輕輕鬆鬆擋住民兵的快攻。</p>
              <p>
            ...
            <div class="n1">
              <ul>
                ...
                <li><nuxt-link to="/civs/Byzantines">拜占庭</nuxt-link>：磨坊黑暗/封建/城堡/帝王時代多10%/20%/30%/40%的血量。</li>
                <li><nuxt-link to="/civs/Chinese">中國</nuxt-link>：在封建/城堡/帝王時代，對磨坊有加成的科技價格便宜10%/15％/20％。</li>
                <li><nuxt-link to="/civs/Franks">法蘭克</nuxt-link>：<nuxt-link to="/techs/Horse_Collar">馬軛</nuxt-link>、<nuxt-link to="/techs/Heavy_Plow">重犁</nuxt-link>、
                  <nuxt-link to="/techs/Crop_Rotation">輪耕</nuxt-link>科技全部免費。</li>
                <li><nuxt-link to="/civs/Japanese">日本</nuxt-link>：磨坊造價-50%。</li>
                <li><nuxt-link to="/civs/Malians">馬利</nuxt-link>：磨坊造價-15%。</li>
                ...
                <li><nuxt-link to="/civs/Spanish">西班牙</nuxt-link>：磨坊建築速度快30。</li>
              </ul>
            </div>
            <h3>團隊加成</h3>
            <div class="hrn1"></div>
            <div class="n1">
              <ul>
                <li><nuxt-link to="/civs/Malians">馬利</nuxt-link>：研發<nuxt-link to="/techs/Masonry">磚瓦技術</nuxt-link>、<nuxt-link to="/techs/Architecture">建築學</nuxt-link>和
                  <nuxt-link to="/techs/Treadmill_Crane">踏輪起重機</nuxt-link>速度快80%。</li>
              </ul>
            </div>
            <h3>更新日誌</h3>
            <div class="hrn1"></div>
            <div class="n1">
              ...
              <ul>
                <li><nuxt-link to="/building/Farm">農田</nuxt-link>可以使用排隊系統。</li>
          ...
          <div class="col-md-4">
            <table class="table-bordered" width="100%">
              ...
              <tr>
                ...
                <td class="unit4"><nuxt-link to="/building/Mill">磨坊</nuxt-link>
                </td>
              </tr>
              <tr>
