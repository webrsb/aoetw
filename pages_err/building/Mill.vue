    ...
    <div class="container">
      ...
      <div class="row padtop">
        ...
        <div class="col-md-8">
            ...
            <div class="n1">
              <p>磨坊是<a href="/techsage/Dark_Age">黑暗時代</a>的經濟建築之一，<a href="/units/Villager">村民</a>可以將"任何"食物搜集至此。當然這裡也有關於
                <a
                href="/building/Farm">農田</a>的科技可以升級或是備用的農田排序。</p>
              <p>在<a href="/techsage/Dark_Age">黑暗時代</a>有許多重要的經濟建築，而磨坊就是其中之一，不管在遊戲的什麼時期它的位置都不可取代，因為它是
                <a
                href="/units/Villager">村民</a>放置食物的地方，所以將它建在<a href="/Berry_Bush.php">果樹叢</a>、<a href="/unitsanimal/Deer">鹿群</a>此種食物來源的旁邊是最好的，而像是
                  <a
                  href="/Wild_Boar.php">野豬</a>這種可以驅趕或引誘至城鎮中心的的動物就沒有必要再為了牠們而去建造。而實際上在高手對戰中，也很少為了鹿群而去蓋磨坊，他們多數是用驅趕的。</p>
              <p>在進入<a href="/techsage/Feudal_Age">封建時代</a>前會需要兩種<a href="/techsage/Dark_Age">黑暗時代</a>的建築，而磨坊的重要性使得它必定是玩家的優先所選，它甚至還是
                <a
                href="/building/Market">市集</a>、<a href="/building/Farm">農田</a>的前置建築。</p>
              ...
              <p>在高手對戰中，時常看見果樹叢的磨坊有兩種蓋法，一種是空一格蓋，緊貼著果樹叢蓋，其原因是緊貼著蓋採集效率雖高，但面對對方黑暗<a href="/units/Militia">民兵</a>快攻比較不好圍，而空一格的蓋法將輕輕鬆鬆擋住民兵的快攻。</p>
              <p>
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="n1">
                  ...
                  <ul>
                    <li>
                      <img class="gg" src="~assets/Horsecollar.jpg" alt=""><a href="/techs/Horse_Collar">馬軛</a>
                    </li>
                  </ul>
                </div>
              </div>
              <div class="col-md-4">
                <div class="n1">
                  ...
                  <ul>
                    <li>
                      <img class="gg" src="~assets/Heavyplow.jpg" alt=""><a href="/techs/Heavy_Plow">重犁</a>
                    </li>
                  </ul>
                </div>
              </div>
              <div class="col-md-4">
                <div class="n1">
                  ...
                  <ul>
                    <li>
                      <img class="gg" src="~assets/Croprotation.jpg" alt=""><a href="/techs/Crop_Rotation">輪耕</a>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div class="n1">
              <ul>
                ...
                <li><a href="/civs/Byzantines">拜占庭</a>：磨坊黑暗/封建/城堡/帝王時代多10%/20%/30%/40%的血量。</li>
                <li><a href="/civs/Chinese">中國</a>：在封建/城堡/帝王時代，對磨坊有加成的科技價格便宜10%/15％/20％。</li>
                <li><a href="/civs/Franks">法蘭克</a>：<a href="/techs/Horse_Collar">馬軛</a>、<a href="/techs/Heavy_Plow">重犁</a>、
                  <a
                  href="/techs/Crop_Rotation">輪耕</a>科技全部免費。</li>
                <li><a href="/civs/Japanese">日本</a>：磨坊造價-50%。</li>
                <li><a href="/civs/Malians">馬利</a>：磨坊造價-15%。</li>
                ...
                <li><a href="/civs/Spanish">西班牙</a>：磨坊建築速度快30。</li>
              </ul>
            </div>
            <h3>團隊加成</h3>
            <div class="hrn1"></div>
            <div class="n1">
              <ul>
                <li><a href="/civs/Malians">馬利</a>：研發<a href="/techs/Masonry">磚瓦技術</a>、<a href="/techs/Architecture">建築學</a>和
                  <a
                  href="/techs/Treadmill_Crane">踏輪起重機</a>速度快80%。</li>
              </ul>
            </div>
            <h3>更新日誌</h3>
            <div class="hrn1"></div>
            <div class="n1">
              ...
              <ul>
                <li><a href="/building/Farm">農田</a>可以使用排隊系統。</li>
          ...
          <div class="col-md-4">
            <table class="table-bordered" width="100%">
              ...
              <tr>
                ...
                <td class="unit4"><a href="/building/Mill">磨坊</a>
                </td>
              </tr>
              <tr>
