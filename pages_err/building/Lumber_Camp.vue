    ...
    <div class="container">
      ...
      <div class="row padtop">
        ...
        <div class="col-md-8">
          ...
          <div class="n1">
            <ul>
              <li><nuxt-link to="/civs/Byzantines">拜占庭</nuxt-link>：伐木場在黑暗/封建/城堡/帝王時代多10%/20%/30%/40%的血量。
                <nuxt-link to="/techs/Town_Watch">城鎮瞭望</nuxt-link>免費</li>
              <li><nuxt-link to="/civs/Chinese">中國</nuxt-link>：對伐木場有利的科技在封建/城堡/帝王時代各便宜10%/15%/20%。</li>
              <li><nuxt-link to="/civs/Japanese">日本</nuxt-link>：伐木場的建築成本-50%。</li>
              <li><nuxt-link to="/civs/Malians">馬利</nuxt-link>：伐木場的建築成本-15%。</li>
              <li><nuxt-link to="/civs/Spanish">西班牙</nuxt-link>：伐木場建築速度快30%。</li>
            </ul>
          </div>
          <h3>團隊加成</h3>
          <div class="hrn1"></div>
