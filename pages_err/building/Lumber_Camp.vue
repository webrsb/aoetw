      ...
      <div class="row padtop">
        ...
        <div class="col-md-8">
          <div class="n1">
            ...
            <p>在黑暗時代時，木材和食物可以說是在這時最重要的，而大多數玩家會將城鎮中心周遭的3-4棵樹木砍掉，之後就必須建立起第一座伐木場。在進入<a href="/techsage/Feudal_Age">封建時代</a>的前置建築伐木場就是其中之一，而它只需100的木材，所以伐木場與磨坊通常是進入封建時代最經濟又實惠的方式。</p>
          </div>
          <h3>可研發的技術</h3>
          <div class="hrn1"></div>
          <div class="row">
            <div class="col-md-4">
              <div class="n1">
                ...
                <ul>
                  <li>
                    <img class="gg" src="~assets/Doublebitaxe.jpg" alt=""><a href="/techs/Double-Bit_Axe">雙刃斧</a>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div class="col-md-4">
              <div class="n1">
                ...
                <ul>
                  <li>
                    <img class="gg" src="~assets/Twomansaw.jpg" alt=""><a href="/techs/Two-Man_Saw">雙人鋸</a>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div class="n1">
            <ul>
              <li><a href="/civs/Byzantines">拜占庭</a>：伐木場在黑暗/封建/城堡/帝王時代多10%/20%/30%/40%的血量。
                <a
                href="/techs/Town_Watch">城鎮瞭望</a>免費</li>
              <li><a href="/civs/Chinese">中國</a>：對伐木場有利的科技在封建/城堡/帝王時代各便宜10%/15%/20%。</li>
              <li><a href="/civs/Japanese">日本</a>：伐木場的建築成本-50%。</li>
              <li><a href="/civs/Malians">馬利</a>：伐木場的建築成本-15%。</li>
              <li><a href="/civs/Spanish">西班牙</a>：伐木場建築速度快30%。</li>
            </ul>
          </div>
          <h3>團隊加成</h3>
          <div class="hrn1"></div>
