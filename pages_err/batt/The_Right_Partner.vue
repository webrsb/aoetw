          ...
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style=" background-color:#375d96;">
                <div class="unititle"><nuxt-link to="">最佳搭檔</nuxt-link>
                </div>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4"><nuxt-link to="/batt/Path_of_Exile">流亡之路</nuxt-link> </td>
            </tr>
            <tr>
              <td class="unit3">下一關</td>
              <td class="unit4"><nuxt-link to="/A_Fallen-Crown.php">摔落的皇冠</nuxt-link> 
              </td>
            </tr>
          </table>
