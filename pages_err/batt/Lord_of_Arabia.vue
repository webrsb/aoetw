        ...
        <div class="col-md-8">
          ...
          <div class="n1">
            ...
            <table class="table-bordered" width="100%">
              ...
              <tr>
                <td class="tc6" width="15%"><div class="p8">玩家2：</div></td>  <td class="tc6" width="35% ">麥地那（橘色）薩拉森 </td>  <td class="tc6" width="15%" >
          ...
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style="background-color:#375d96;">
                <div class="unititle"><nuxt-link to="">阿拉伯之主</nuxt-link>
                </div>
              </td>
            </tr>
            <tr>
              <td colspan="2">
                <div class="unititle">
                  <img src="~assets/Lord_of_arabia.png" alt="">
                </div>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4"><nuxt-link to="">薩拉森人</nuxt-link>
              </td>
            </tr>
<tr><td class="unit" colspan="2" style="background-color:#375d96;">
            ...
            <tr>
              ...
              <td class="unit4"> <nuxt-link to="/batt/An_Arabian_Knight">阿拉伯騎士</nuxt-link> 
            </tr>
            <tr>
              <td class="unit3">下一關</td>
              <td class="unit4"> <nuxt-link to="/batt/The_Horns_of_Hattin">海丁的號角</nuxt-link> 
              </td>
            </tr>
          </table>
