          ...
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style=" background-color:#375d96;">
                <div class="unititle"><nuxt-link to="#">供養軍隊</nuxt-link>
                </div>
              </td>
            </tr>
            <tr>
              <td colspan="2">
                <div class="unititle">
                  <img src="~assets/Wallacelc2map.png" width="" alt="">
                </div>
              </td>
            </tr>
            <tr>
...
<tr><td class="unit" colspan="2" style=" background-color:#375d96;">
            ...
            <tr>
              ...
              <td class="unit4"> <nuxt-link to="/batt/Marching_and_Fighting">行軍與戰鬥</td>      </tr>      <tr>        <td class="unit3">下一關</td>       <td class="unit4">        <nuxt-link to="/batt/Training_the_Troops">訓練軍隊</nuxt-link>
                </p>
              </td>
            </tr>
          </table>
