          ...
          <div class="col-md-12">
            ...
            <div class="col-md-4">
              ...
              <ul>
                ...
                <li>
                  <img class="gg" src="~assets/KnightIcon.jpg" alt=""><nuxt-link to="/units/Knight">騎士</nuxt-link>*4</li>
                <li>
                  <img class="gg" src="~assets/PikemanIcon.jpg" alt=""><nuxt-link to="/units/Pikeman">重裝長槍兵</nuxt-link>*4</li>
                <li>
                  <img class="gg" src="~assets/CrossbowmanIcon.jpg" alt=""><nuxt-link to="/units/Crossbowman">弩兵</nuxt-link>*12</li>
                <li>
                  <img class="gg" src="~assets/VillagerMaleIcon.jpg" alt=""><nuxt-link to="/units/Villager">村民</nuxt-link>*4</li>
              </ul>
            </div>
            <div class="col-md-4">
              <h3>大地之母</h3>
              <ul>
                <li>
                  <img class="gg" src="~assets/TransportShipIcon.jpg" alt=""><nuxt-link to="/units/Transport_Ship">運輸船</nuxt-link>*2</li>
                <li>
                  <img class="gg" src="~assets/DemoShipIcon.jpg" alt=""><nuxt-link to="/units/Demolition_Ship">神風船</nuxt-link>*2</li>
              </ul>
            </div>
          </div>
           <h3>主要任務</h3>
          ...
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style="background-color:#375d96;">
                <div class="unititle"><nuxt-link to="">羅亞爾河大掃蕩</nuxt-link>
                </div>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4"><nuxt-link to="/games/aok">帝王世紀</nuxt-link>第二章之三</td>
            </tr>
            <tr>
              <td class="unit3">上一關</td>
              <td class="unit4"> <nuxt-link to="/batt/The_Maid_of_Orleans">奧爾良的少女</nuxt-link> 
            </tr>
            <tr>
