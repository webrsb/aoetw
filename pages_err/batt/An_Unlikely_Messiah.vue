          ...
          <div class="n1">
            ...
            <table class="table-bordered" width="100%">
              ...
              <tr>
                ...
                " alt=" "><nuxt-link to="/units/hero/Joan_the_Maid ">農家女貞德</nuxt-link><br/>   <img class="gg
                "  src="~assets/Sieurbertrand.png " alt=" "><nuxt-link to="/units/hero/Sieur_Bertrand
                ">貝查德爵士</nuxt-link><br/>   <img class="gg "  src="~assets/Sieurdemetz.png " alt=" "><nuxt-link to="/units/hero/Sieur_de_Metz
                ">梅茲爵士</nuxt-link>   </dd>   <dt>大地之母單位：</dt>  <dd>  <img class="gg " src="~assets/TransportShipIcon.jpg " alt=" ">          <nuxt-link to="/units/Transport_Ship
                ">運輸船*3</nuxt-link></dd></dl><h3>主要任務</h3><div class="hrn1 "></div><div class="n1
                ...
                ">一個不太可能的彌賽亞</nuxt-link></div>       </td>      </tr>      <tr>       <td colspan="2 " ><div class="unititle "><img src="~assets/Joan1map.png " width="
                ...
                ">戰役</td>       <td class="unit4 "><nuxt-link to="/batt/Joan_of_Arc
                ">聖女貞德</nuxt-link></td>      </tr>      <tr>        <td class="unit3 ">文明</td>       <td class="unit4 "><nuxt-link to="/
                ">法蘭克人</nuxt-link></td>      </tr>
<tr><td class="unit " colspan="2 " style=" background-color:#375d96;
                ...
                ">N/A</td>      </tr>      <tr>        <td class="unit3 ">下一關</td>       <td class="unit4 ">        <nuxt-link to="/batt/The_Maid_of_Orleans
                ">奧爾良的少女</nuxt-link>        </td>      </tr>        </table>     <div class="thanks
