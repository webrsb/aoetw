          ...
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style=" background-color:#375d96;">
                <div class="unititle"><nuxt-link to="">沸騰的湖</nuxt-link>
                </div>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4"><nuxt-link to="/batt/La_Noche_Triste">悲傷之夜</nuxt-link> 
              </td>
            </tr>
            <tr>
              <td class="unit3">下一關</td>
              <td class="unit4"> <nuxt-link to="/batt/Broken_Spears">斷矛</nuxt-link> 
              </td>
            </tr>
          </table>
