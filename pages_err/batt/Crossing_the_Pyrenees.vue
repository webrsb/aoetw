        ...
        <div class="col-md-8">
          ...
          <div class="n1">
            ...
            <table class="table-bordered" width="100%">
              ...
              <tr>
                <td class="tc6" width="15%" "><div class="p8">玩家2：</div></td>  <td class="tc6 " width="35% ">倭馬亞軍隊（橘色）薩拉森 </td>  <td class="tc6 " width="15% "">
          ...
          <table class="table-bordered" width="100%">
            <tr>
              <td class="unit" colspan="2" style=" background-color:#375d96;">
                <div class="unititle"><nuxt-link to="">穿越庇里牛斯山脈</nuxt-link>
                </div>
              </td>
            </tr>
            <tr>
...
<tr><td class="unit" colspan="2" style=" background-color:#375d96;">
            ...
            <tr>
              ...
              <td class="unit4"> <nuxt-link to="/batt/Divide_and_Conquer">縱橫捭闔</nuxt-link> 
            </tr>
            <tr>
              <td class="unit3">下一關</td>
              <td class="unit4"> <nuxt-link to="/batt/Razzia">突襲(風捲殘雲)</nuxt-link> 
              </td>
            </tr>
          </table>
