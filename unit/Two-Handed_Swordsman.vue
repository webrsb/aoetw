        ...
        <div class="col-md-8">
          ...
          <div class="n1">
            <div class="col-md-12">
              ...
              <div class="col-md-4"> <a href="img/Twohandedswordsman.png"><img  class="imgn" class="hg" width="250" src="~assets/Twohandedswordsman.png" alt=""></a> 
                <p><em>一群雙手劍兵</em>
                </p>
              </div>
            </div>
        ...
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="unit4">
                <img class="gg" src="~assets/Champion-research.jpg" alt="">750肉350金</td>
            </tr>
            <tr>
