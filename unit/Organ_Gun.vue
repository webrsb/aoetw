    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            ...
            <tr>
              <td colspan="2">
                <div class="unititle">
                  <img src="~assets/OrganGunIcon.jpg" width="45" alt="">
                </div>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="unit4">
                <img class="gg" src="~assets/OrganGunIcon.jpg" alt="">手風琴砲</td>
            </tr>
            <tr>
              <td class="unit3">升級成本</td>
              <td class="unit4">
                <img class="gg" src="~assets/Elite-unique-research.jpg" alt="">1200食物500黃金</td>
            </tr>
            <tr>
        ...
        <div class="col-md-12">
          ...
          <div class="n1">
            <div class="col-md-12">
              <div class="col-md-4"> <a href="img/Tumblr_nxo1o0aN0R1tnh0y7o8_500.png"><img class="imgn" class="hg" src="~assets/Tumblr_nxo1o0aN0R1tnh0y7o8_500.png" alt=""></a> 
                <p><em>一群手風琴炮。</em>
                </p>
              </div>
              <div class="col-md-4"> <a href="img/6.png"><img class="imgn" class="hg" src="~assets/6.png" alt=""></a> 
