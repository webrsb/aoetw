    ...
    <div class="container">
          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4">
                ...
                <br>
                <img class="gg" src="~assets/CastleAgeUnique.png" width="30" alt=""><a href="Chieftains.php">酋長</a>:步兵對<a href="Armor_Class_Cavalry.php">騎兵</a>攻擊+5，對
                <a
      ...
      <div class="col-md-12">
        ...
        <div class="n1">
          ...
          <div class="col-md-4"> <a href="img/Spearman.png"><img class="imgn" class="hg" src="~assets/Spearman.png" alt=""></a> 
            <p><em>一群長槍兵</em>
            </p>
          </div>
        </div>
