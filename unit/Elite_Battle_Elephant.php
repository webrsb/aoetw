        ...
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="unit4">
                <img class="gg" src="~assets/Battleelephanticon.png" width="45" alt=""><a href="Battle_Elephant.php">矛象伕</a>
      ...
      <div class="col-md-12">
        ...
        <div class="n1">
          <div class="col-md-12">
            ...
            <div class="col-md-4"> <a href="img/Elitebattleelephant.png"><img class="imgn" class="hg" src="~assets/Elitebattleelephant.png" alt=""></a> 
              <p><em>一群精銳矛象伕。</em>
