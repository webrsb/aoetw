        ...
        <div class="col-md-8">
          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4">
                <img src="~assets/Unique-tech.jpg" class="gg" alt=""><a href="Arquebus.php">火繩槍</a>:火藥單位對移動目標的命中率提升。<a href="Portuguese.php">葡萄牙</a>限定</td>
            </tr>
            <tr>
          ...
          <div class="n1">
            ...
            <div class="n1">
              <div class="col-md-12">
                <div class="col-md-4"> <a href="img/Bombardcannon.png"><img  class="imgn" class="hg" width="250" src="~assets/Bombardcannon.png" alt=""></a> 
                  <p><em>火砲</em>
