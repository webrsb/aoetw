        ...
        <div class="col-md-8">
          ...
          <div class="n1">
            <div class="col-md-12">
              ...
              <div class="col-md-4"> <a href="img/Manatarms.png"><img  class="imgn" class="hg" width="250" src="~assets/Manatarms.png" alt=""></a> 
                <p><em>一群裝甲步兵</em>
                </p>
              </div>
            </div>
        ...
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="unit4">
                <img class="gg" src="~assets/Long-swordsman-research.jpg" alt="">200肉65金</td>
            </tr>
            <tr>
