    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4">
                <img class="gg" src="~assets/Blockprinting.jpg" alt=""><a href="Block_Printing.php">雕版印刷術</a>(+3)</td>
            </tr>
            <tr>
              <td class="tta1" style="width:10%">速度</td>
              <td class="tta4">
                <img class="gg" src="~assets/Fervor.jpg" alt=""><a href="Fervor.php">宗教狂熱</a>(+15%)</td>
            </tr>
            <tr>
        ...
        <div class="col-md-12">
          ...
          <div class="n1">
            <div class="col-md-12">
              <div class="col-md-4"> <a href="img/Missionary.png"><img class="imgn" class="hg" src="~assets/Missionary.png" alt=""></a> 
                <p><em>一群傳教士</em>
                </p>
              </div>
              <div class="col-md-4"> <a href="img/Missionary1.png"><img class="imgn" class="hg" src="~assets/Missionary1.png" alt=""></a> 
                <p><em>傳教士美術畫</em>
                </p>
              </div>
            </div>
