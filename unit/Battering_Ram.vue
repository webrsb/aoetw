        ...
        <div class="col-md-8">
          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4">
                <img class="gg" src="~assets/Unique-tech.jpg" width="30" alt=""><a href="Furor_Celtica.php">賽爾特狂暴</a>:攻城器製造所的單位+40% HP。<a href="Celts.php">賽爾特</a>限定</td>
            </tr>
            <tr>
              <td class="tta1" style="width:10%">攻擊力</td>
              <td class="tta4">
                <img class="gg" src="~assets/Siegeengineers.jpg" alt=""><a href="Siege_Engineers.php">攻城工程師</a>:對<a href="Armor_Class_Building.php">建築物</a>攻擊加成+20%。</td>
            </tr>
            <tr>
              <td class="tta1" style="width:10%">防禦</td>
              <td class="tta4">
                <img class="gg" src="~assets/CastleAgeUnique.png" width="30" alt=""><a href="Ironclad.php">鋼鐵甲</a>:攻城武器近戰護甲+4，<a href="Teutons.php">條頓</a>限定</td>
            </tr>
            <tr>
              <td class="tta1" style="width:10%">速度</td>
              <td class="tta4">
                <img class="gg" src="~assets/Unique-tech.jpg" width="30" alt=""><a href="Drill.php">演習</a>:攻城器製造所的單位移動速度+50%，<a href="Mongols.php">蒙古</a>限定</td>
              <tr>
        ...
        <div class="col-md-4">
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="unit4">
                <img class="gg" src="~assets/Capped-ram-research.jpg" alt="">300食物</td>
            </tr>
            <tr>
