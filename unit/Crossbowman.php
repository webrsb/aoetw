    ...
    <div class="container">
          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4">
                ...
                <br>
                <img src="~assets/CastleAgeUnique.png" class="gg" alt=""><a href="Obsidian_Arrows.php">黑曜石之箭</a>:射箭場弓兵單位對<a href="Armor_Class_Standard_Building.php">標準建築</a>和
                <a
            ...
            <tr>
              ...
              <td class="tta4">
                ...
                <br>
                <img src="~assets/CastleAgeUnique.png" class="gg" alt=""><a href="Pavise.php">巨盾</a> (+1/+1，非洲王朝資料片後的<a href="Italians.php">義大利</a>限定)</td>
            </tr>
            <tr>
            ...
            class="n1">
              ...
              <div class="n1">
                <ul>
                  ...
                  <li><a href="Britons.php">不列顛</a>：弩兵生產和升級快20%。研發<a href="Thumb _Ring.php">拇指環</a>速度快20%。</li>
      ...
      <div class="col-md-4">
        <table class="table-bordered" width="100%">
          ...
          <tr>
            ...
            <td class="unit4">
              <img class="gg" src="~assets/ArbalestIcon.jpg" alt=""><a href="Arbalest.php">強弩兵</a>
      ...
      <div class="col-md-12">
        ...
        <div class="n1">
          ...
          <div class="col-md-4"> <a href="img/Crossbowman.png"><img class="imgn" class="hg" src="~assets/Crossbowman.png" alt=""></a> 
            <p><em>一群弩兵</em>
