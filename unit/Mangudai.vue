<template>
    ...
    <div class="container">
          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4">
                ...
                <br>
                <img class="gg" src="~assets/Parthian-Tactics.jpg" width="30" alt=""><a href="Parthian_Tactics.php">帕提亞戰術</a>:+2對<a href="Armor_Class_Spearman.php">長槍兵</a> 
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="tta4">
                <img class="gg" src="~assets/Thumb_Ring.png" width="30" alt=""><a href="Thumb _Ring.php">拇指環</a>:增加命中率至100%
                <br>
            ...
            <tr>
              ...
              <td class="tta4">
                ...
                <br>
                <img class="gg" src="~assets/Parthian-Tactics.jpg" width="30" alt=""><a href="Parthian_Tactics.php">帕提亞戰術</a>(+1/+2)</td>
            </tr>
            <tr>
            ...
            <div class="n1">
              <div class="col-md-12">
                ...
                <div class="col-md-6">
                  ...
                  <ul>
                    <li>
                      <img class="gg" src="~assets/Imperialskirmishericon.png" alt=""> <a href="Imperial_Skirmisher.php">帝王戰矛兵</a> (<a href="Vietnamese.php">越南</a>及同盟限定)</li>
                    <li>
                  ...
                  <ul>
                    ...
                    <li>
                      <img class="gg" style="margin: 2px;" src="~assets/CamelArcherIcon.jpg" alt=""><a href="Camel_Archer.php">精銳駱駝弓騎兵</a>(<a href="Berbers.php">柏柏</a>限定)</li>
                    <li>
                  ...
                  <ul>
                    ...
                    <li>
                      <img class="gg" style="margin: 2px;" src="~assets/CamelArcherIcon.jpg" alt=""><a href="Camel_Archer.php">駱駝弓騎兵</a>(<a href="Berbers.php">柏柏</a>限定)</li>
                  </ul>
      ...
      <div class="col-md-12">
        ...
        <div class="hrn1"></div>
        <div class="n1">
          <div class="col-md-4"> <a href="img/Mangudai.png"><img class="imgn" class="hg" width="180" src="~assets/Mangudai.png" alt=""></a> 
            <div
        ...
        <div class="col-md-4"> <a href="img/Mangudai_real_life.jpg"><img class="imgn" class="hg" width="200" src="~assets/Mangudai_real_life.jpg" alt=""></a> 
          <div
          class="lightbox-caption" style="width:220px" ;>
            <p><em>真實歷史上的蒙古突騎。</em>
            </p>
      ...
      <div class="col-md-4"> <a href="img/Mangudai_Preview.jpg"><img class="imgn" class="hg" width="200" src="~assets/Mangudai_Preview.jpg" alt=""></a> 
        <div
