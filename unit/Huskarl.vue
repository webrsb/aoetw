    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <tr>
                ...
                <td class="tta4">
                  <img class="gg" src="~assets/CastleAgeUnique.png" width="30" alt=""><a href="Anarchy.php">無政府狀態</a>:兵營可生產哥德衛隊。</td>
              </tr>
          </table>
          <h3>剋哥德衛隊的單位與建築</h3>
          <div class="hrn1"></div>
        ...
        <div class="col-md-12">
          ...
          <div class="hrn1"></div>
          <div class="n1">
            <div class="col-md-4"> <a href="img/Huskarl.png"><img class="imgn" class="hg" width="180" src="~assets/Huskarl.png" alt=""></a> 
              <div
