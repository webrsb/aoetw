    ...
    <div class="container">
      ...
      <div class="row" style=" margin-top: 50px;">
        ...
        <div class="col-md-8">
          ...
          <table class="table-bordered" width="100%">
            ...
            <tr>
              ...
              <td class="tta4">
                <img class="gg" style="margin: 2px;" src="~assets/Unique-tech.jpg" alt=""><a href="Artillery.php">砲兵</a>(+2，<a href="Turks.php">土耳其</a>限定)</td>
            </tr>
            <tr>
              <td class="tta1" style="width:10%">命中率</td>
              <td class="tta4">
                <img class="gg" style="margin: 2px;" src="~assets/Unique-tech.jpg" alt=""><a href="Arquebus.php">火繩槍</a>(火藥單位對移動目標命中率提升，<a href="Portuguese.php">葡萄牙</a>限定)</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="tta4">
                <img class="gg" style="margin: 2px;" src="~assets/Drydock.jpg" alt=""><a href="Dry_Dock.php">旱碼頭</a>(+15%)</td>
            </tr>
            <tr>
        ...
        <div class="col-md-12">
          ...
          <div class="n1">
            <div class="col-md-12">
              <div class="col-md-4"> <a href="img/Cannongalleon.png"><img class="imgn" class="hg" src="~assets/Cannongalleon.png" alt=""></a> 
                <p><em>一群火炮戰船。</em>

                </p>
              </div>
              <div class="col-md-4"> <a href="img/CGHD.png"><img class="imgn" class="hg" src="~assets/CGHD.png" alt=""></a> 
                <p><em>各種火炮戰船(世紀帝國和征服者入侵資料片)。</em>

                </p>
              </div>
              <div class="col-md-4"> <a href="img/CGDLC.png"><img class="imgn" class="hg" src="~assets/CGDLC.png" alt=""></a> 
